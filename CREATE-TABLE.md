##  CREATE TABLE {#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6} 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Administrator's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN015) and [ CREATE TYPE ](CREATE-TYPE.md#GUID-E72E3EE6-DE95-4F58-8941-E2F76D0EAE80) for more information about creating objects 
...
To specify the *zonemap_clause* , you must have the permissions necessary to create a zone map. Refer to the  " [ Prerequisites ](CREATE-MATERIALIZED-ZONEMAP.md#GUID-1E5048FC-3D28-49BC-80FE-7871568B4702__CACECGEF) "  section in the documentation on ` CREATE ` ` MATERIALIZED ` ` ZONEMAP ` . 
...
![Description of relational_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/relational_table.gif)[ Description of the illustration relational_table.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/relational_table.md)
...
![Description of object_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/object_table.gif)[ Description of the illustration object_table.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/object_table.md)( *object_table_substitution::=* , *object_properties::=* , *oid_clause::=* , *oid_index_clause::=* , *physical_properties::=* , *table_properties::=* ) 

*XMLType_table* ::= 

  
![Description of xmltype_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmltype_table.gif)[ Description of the illustration xmltype_table.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmltype_table.md)   
...
![Description of object_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/object_properties.gif)[ Description of the illustration object_properties.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/object_properties.md)( *constraint::=* , *CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126822* ) 

*oid_clause* ::= 

![Description of oid_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/oid_clause.gif)[ Description of the illustration oid_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/oid_clause.md)

*oid_index_clause* ::= 

![Description of oid_index_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/oid_index_clause.gif)[ Description of the illustration oid_index_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/oid_index_clause.md)( *physical_attributes_clause::=* ) 

*physical_properties* ::= 

![Description of physical_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/physical_properties.gif)[ Description of the illustration physical_properties.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/physical_properties.md)( *deferred_segment_creation::=* , *segment_attributes_clause::=* , *table_compression::=* , *inmemory_table_clause::=* , *ilm_clause::=* , *heap_org_table_clause::=* , *index_org_table_clause::=* , *external_table_clause::=* ) 
...
![Description of table_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/table_properties.gif)[ Description of the illustration table_properties.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/table_properties.md)( *column_properties::=* , *read_only_clause::=* , *indexing_clause::=* , *table_partitioning_clauses::=* , *attribute_clustering_clause::=* , *parallel_clause::=* , *enable_disable_clause::=* , *row_movement_clause::=* , *logical_replication_clause::=* , *flashback_archive_clause::=* , *subquery::=* ) 

*column_properties* ::= 

![Description of column_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/column_properties.gif)[ Description of the illustration column_properties.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/column_properties.md)( *object_type_col_properties::=* , *nested_table_col_properties::=* , *varray_col_properties::=* , *LOB_storage_clause::=* , *LOB_partition_storage::=* , *XMLType_column_properties::=* , *json_storage_clause::=* ) 
...
![Description of xmltype_column_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmltype_column_properties.gif)[ Description of the illustration xmltype_column_properties.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmltype_column_properties.md)( *XMLType_storage::=* , *XMLSchema_spec::=* ) 

*XMLType_storage* ::= 

![Description of xmltype_storage.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmltype_storage.gif)[ Description of the illustration xmltype_storage.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmltype_storage.md)( *LOB_parameters::=* ) 
...
![Description of domain_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/domain_clause.gif)[ Description of the illustration domain_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/domain_clause.md)
...
![Description of partitionset_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/partitionset_clauses.gif)[ Description of the illustration partitionset_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/partitionset_clauses.md)
...
See here for usage details of the [ ON COMMIT ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2189569) clause. 
...
[ *Oracle Database Concepts* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT211) for information on temporary tables and  " [ Creating a Table: Temporary Table Example ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153132) " 
...
When you create a sharded table, you must specify a tablespace set in which to create the table. There is no default tablespace set for sharded tables. See [ CREATE TABLESPACE SET ](CREATE-TABLESPACE-SET.md#GUID-877951F1-B2A5-4907-9F0F-EF4F1884E8C4) for more information. 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Administrator’s Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN)
...
Specify the name of the table or object table to be created. The name must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . 

> **note:** See Also: 

[ *Oracle Database Administrator’s Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN) for more on sharded tables. 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Administrator’s Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-388FB5AD-A2DE-4951-833B-A98239F99F50) for complete information on creating application common objects 
...
Specify the name of a column of the table. The name must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . 
...
" [ Data Types ](Data-Types.md#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483) "  for information on ` LONG ` columns and on Oracle-supplied data types 
...
Refer to the [ DEFAULT COLLATION ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__DEFAULTCOLLATION-34502CA8) clause for more information on the default collation for a table. 
...
" [ Creating a Table with a DEFAULT ON NULL Column Value: Example ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAIGEJE) " 
...
" [ Creating a Table with an Identity Column: Examples ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAHCAFF) " 
...
The ` AS ` *column_expression* clause determines the content of the column. Refer to  " [ Column Expressions ](Column-Expressions.md#GUID-B16B2D82-5D4B-485B-AE20-160EC0C7137A) "  for more information on *column_expression* . 
...
" [ Column Expressions ](Column-Expressions.md#GUID-B16B2D82-5D4B-485B-AE20-160EC0C7137A) "  for additional information and restrictions on *column_expression* 
...
" [ Adding a Virtual Table Column: Example ](ALTER-TABLE.md#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__BABIDDJJ) "  and [ *Oracle Database Administrator's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN11004) for examples of creating tables with virtual columns 
...
Specify the name of the valid time dimension. The name must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . Oracle Database creates an ` INVISIBLE ` virtual column with this name of data type ` NUMBER ` in *table* . 
...
The names you specify for *start_time_column* and *end_time_column* must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . 
...
" [ REF Constraint Examples ](constraint.md#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1015744) " 
...
If you omit this clause, then the default collation for the table is set to the effective schema default collation of the schema containing the table. Refer to the [ DEFAULT_COLLATION ](ALTER-SESSION.md#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B__DEFAULT_COLLATION-39CF7241) clause of ` ALTER ` ` SESSION ` for more information on the effective schema default collation. 
...
[ CREATE TABLESPACE ](CREATE-TABLESPACE.md#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9) for more information on tablespaces 
...
" [ Conventional and Direct-Path INSERT ](INSERT.md#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423__I2191836) "  for information on direct-path ` INSERT ` operations, including restrictions 
...
" [ Index-Organized Table Example ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153235) " 
...
" [ Substitutable Table and Column Examples ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2090577) " 
...
" [ Creating a Table: Multilevel Collection Example ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2139603) "  for examples using *nested_item* and ` COLUMN_VALUE `
...
" [ Partitioning Examples ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153324) " 
...
Range partitioning is subject to the restrictions listed in  " [ Restrictions on Partitioning in General ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD) "  . The following additional restrictions apply: 
...
The ` INTERVAL ` clause is subject to the restrictions listed in  " [ Restrictions on Partitioning in General ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD) "  and  " [ Restrictions on Range Partitioning ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAEBCJE) "  . The following additional restrictions apply: 
...
[ *Oracle Database Concepts* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT112) for more information about partition bounds and  " [ Range Partitioning Example ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2093664) " 
...
List partitioning is subject to the restrictions listed in  " [ Restrictions on Partitioning in General ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD) "  . The following additional restrictions apply: 
...
Automatic list partitioning is subject to the restrictions listed in  " [ Restrictions on List Partitioning ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RESTRICTIONSONLISTPARTITIONING-55951AEA) "  . The following additional restrictions apply: 
...
" [ Extended Data Types ](Data-Types.md#GUID-8EFA29E9-E8D8-40A6-A43E-954908C954A4) "  for more information on extended data types 
...
Hash partitioning is subject to the restrictions listed in  " [ Restrictions on Partitioning in General ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD) "  . The following additional restrictions apply: 
...
The ` INTERVAL ` clause has the same semantics for composite range partitioning that it has for range partitioning. Refer to  " [ INTERVAL Clause ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABGCEFI) "  for more information. 
...
Specify ` AUTOMATIC ` to create an automatic list-range, list-list, list-hash, or list-interval composite-partitioned table. This type of table enables the database to create additional partitions on demand. The optional ` STORE ` ` IN ` clause lets you specify one or more tablespaces into which the database will store data for the automatically created partitions. The ` AUTOMATIC ` and ` STORE ` ` IN ` clauses have the same semantics here as they have for noncomposite list partitions. Refer to [ AUTOMATIC ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__AUTOMATIC-2B1E29C6) and [ STORE IN ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__STOREIN-2B1E2BB5) in the documentation on *list_partitions* for the full semantics of these clauses. Automatic composite-partitioned tables are subject to the restrictions listed in [ Restrictions on Composite List Partitioning ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RESTRICTIONSONCOMPOSITELISTPARTITIO-55963A50) and [ Restrictions on Automatic List Partitioning ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RESTRICTIONSONAUTOMATICLISTPARTITIO-55966662) . 

Restrictions on Composite List Partitioning 

Composite list partitioning is subject to the same restrictions as described in  " [ Restrictions on Composite Range Partitioning ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CHDFBDBC) "  . 
...
Composite hash partitioning is subject to the same restrictions as described in  " [ Restrictions on Composite Range Partitioning ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CHDFBDBC) "  . 
...
Reference partitioning is subject to the restrictions listed in [ Restrictions on Partitioning in General ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD) . The following additional restrictions apply: 
...
[ *Oracle Database VLDB and Partitioning Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG00224) for more information on partitioning by reference and  " [ Reference Partitioning Example ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFDECD) " 
...
[ CREATE MATERIALIZED ZONEMAP ](CREATE-MATERIALIZED-ZONEMAP.md#GUID-1E5048FC-3D28-49BC-80FE-7871568B4702) for more information on zone maps 
...
*constraint* for more information on constraints and  " [ Creating a Table: ENABLE/DISABLE Examples ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153176) " 

ENABLE Clause 

Use this clause if you want the constraint to be applied to the data in the table. This clause is described fully in  " [ ENABLE Clause ](constraint.md#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1010237) "  in the documentation on constraints. 

DISABLE Clause 

Use this clause if you want to disable the integrity constraint. This clause is described fully in  " [ DISABLE Clause ](constraint.md#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1002349) "  in the documentation on constraints. 
...
> **note:** See Also: 
  ...
  * [ CREATE INDEX ](CREATE-INDEX.md#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE) for a description of *index_attributes* , the *global_partitioned_index* and *local_partitioned_index* clauses, ` NOSORT ` , and the *logging_clause* in relation to indexes 
...
You can subsequently use the *exchange_partition_subpart* clause of ` ALTER ` ` TABLE ` to exchange partitions or subpartitions between the two tables. Refer to [ exchange_partition_subpart ](ALTER-TABLE.md#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__EXCHANGE_PARTITION_SUBPART-2C9E8EFA) in the documentation on ` ALTER ` ` TABLE ` for more information. 
...
For object tables, *subquery* can contain either one expression corresponding to the table type, or the number of top-level attributes of the table type. Refer to [ SELECT ](SELECT.md#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) for more information. 
...
" [ Object Column and Table Examples ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153366) " 
...
When you insert into ` persons ` or ` books ` , you can specify values for the attributes of ` person_t ` or any of its subtypes. Examples of insert statements appear in  " [ Inserting into a Substitutable Tables and Columns: Examples ](INSERT.md#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423__I2085891) "  . 

You can extract data from such tables using built-in functions and conditions. For examples, see the functions [ TREAT ](TREAT.md#GUID-037C0CD3-C256-4A02-80E0-C6F15147C5BF) and [ SYS_TYPEID ](SYS_TYPEID.md#GUID-4E3D45A1-7433-495D-9062-88505A1496E0) , and the  " [ IS OF type Condition ](IS-OF-type-Condition.md#GUID-7254E4C7-0194-4C1F-A3B2-2CFB0AD907CD) "  condition. 
...
" [ Creating a Directory: Examples ](CREATE-DIRECTORY.md#GUID-8E9C569A-1B06-42C4-9586-0EF83437001A__I2092417) "  to see how the ` admin ` directory was created 

XMLType Examples 

This section contains brief examples of creating an ` XMLType ` table or ` XMLType ` column. For a more expanded version of these examples, refer to  " [ Using XML in SQL Statements ](Using-XML-in-SQL-Statements.md#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14) "  . 
...
The following example creates an XMLSchema-based table. The XMLSchema must already have been created (see  " [ Using XML in SQL Statements ](Using-XML-in-SQL-Statements.md#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14) "  for more information): 
