...
See Also:
  ...
  * [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN01503) for more information about the privileges required to create tables using types 
...
![Description of relational_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/relational_table.gif)[Description of the illustration relational_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/relational_table.html)
...
![Description of object_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/object_table.gif)[Description of the illustration object_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/object_table.html)([object_table_substitution::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126754), [object_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126768), [oid_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149035), [oid_index_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149044), [physical_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126711), [table_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126725)) 

XMLType_table::= 

  
![Description of xmltype_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmltype_table.gif)[Description of the illustration xmltype_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmltype_table.html)  
...
![Description of json_collection_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_collection_table.gif)[Description of the illustration json_collection_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_collection_table.html)
...
![Description of relational_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/relational_properties.gif)[Description of the illustration relational_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/relational_properties.html)
...
![Description of xmltype_virtual_columns.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmltype_virtual_columns.gif)[Description of the illustration xmltype_virtual_columns.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmltype_virtual_columns.html)
...
![Description of domain_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/domain_clause.gif)[Description of the illustration domain_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/domain_clause.html)
...
![Description of immutable_table_no_drop_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_table_no_drop_clause.gif)[Description of the illustration immutable_table_no_drop_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_table_no_drop_clause.html)
...
![Description of immutable_table_no_delete_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_table_no_delete_clause.gif)[Description of the illustration immutable_table_no_delete_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_table_no_delete_clause.html)
...
![Description of immutable_row_version_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_row_version_clause.gif)[Description of the illustration immutable_row_version_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_row_version_clause.html)
...
![Description of immutable_data_format_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_data_format_clause.gif)[Description of the illustration immutable_data_format_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_data_format_clause.html)
...
![Description of blockchain_drop_table_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_drop_table_clause.gif)[Description of the illustration blockchain_drop_table_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_drop_table_clause.html)
...
![Description of blockchain_row_retention_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_row_retention_clause.gif)[Description of the illustration blockchain_row_retention_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_row_retention_clause.html)
...
![Description of blockchain_hash_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_hash_clause.gif)[Description of the illustration blockchain_hash_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_hash_clause.html)
...
![Description of blockchain_row_version_user_chain_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_row_version_user_chain_clause.gif)[Description of the illustration blockchain_row_version_user_chain_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_row_version_user_chain_clause.html)
...
![Description of blockchain_system_chains_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_system_chains_clause.gif)[Description of the illustration blockchain_system_chains_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_system_chains_clause.html)
...
![Description of blockchain_data_format_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_data_format_clause.gif)[Description of the illustration blockchain_data_format_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_data_format_clause.html)
...
![Description of external_table_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/external_table_clause.gif)[Description of the illustration external_table_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/external_table_clause.html)([external_table_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146275)) 

external_table_data_props::= 

![Description of external_table_data_props.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/external_table_data_props.gif)[Description of the illustration external_table_data_props.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/external_table_data_props.html)(`opaque_format_spec`: This clause specifies the access parameters for the `ORACLE_LOADER`, `ORACLE_DATAPUMP`, `ORACLE_HDFS`, and `ORACLE_HIVE` access drivers. See [Oracle Database Utilities](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL1358) for descriptions of these parameters.) 
...
![Description of hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hash_partitions.gif)[Description of the illustration hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hash_partitions.html)([individual_hash_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126179), [hash_partitions_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125987)) 

individual_hash_partitions::= 

![Description of individual_hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/individual_hash_partitions.gif)[Description of the illustration individual_hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/individual_hash_partitions.html)([read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH)) 

hash_partitions_by_quantity::= 

![Description of hash_partitions_by_quantity.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hash_partitions_by_quantity.gif)[Description of the illustration hash_partitions_by_quantity.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hash_partitions_by_quantity.html)([table_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129627), [index_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215029)) 

list_partitions::= 

![Description of list_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partitions.gif)[Description of the illustration list_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partitions.html)([list_values_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125928), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282), [external_part_subpart_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__EXTERNAL_PART_SUBPART_DATA_PROPS-5AD95928)) 

composite_range_partitions::= 

![Description of composite_range_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_range_partitions.gif)[Description of the illustration composite_range_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_range_partitions.html)([subpartition_by_range::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDDHAA). [subpartition_by_list::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153057), [subpartition_by_hash::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129906), [range_partition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABJIIJB)) 

composite_hash_partitions::= 

![Description of composite_hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_hash_partitions.gif)[Description of the illustration composite_hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_hash_partitions.html)([subpartition_by_range::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDDHAA), [subpartition_by_list::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153057), [subpartition_by_hash::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129906), [individual_hash_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126179), [hash_partitions_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125987)) 

composite_list_partitions::= 

![Description of composite_list_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_list_partitions.gif)[Description of the illustration composite_list_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_list_partitions.html)([subpartition_by_range::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDDHAA). [subpartition_by_list::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153057), [subpartition_by_hash::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129906), [list_partition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIBDHH)) 

reference_partitioning::= 

![Description of reference_partitioning.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/reference_partitioning.gif)[Description of the illustration reference_partitioning.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/reference_partitioning.html)([constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAEDFIB), [reference_partition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEJDCI)) 

reference_partition_desc::= 

![Description of reference_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/reference_partition_desc.gif)[Description of the illustration reference_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/reference_partition_desc.html)([table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282)) 

system_partitioning::= 

![Description of system_partitioning.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/system_partitioning.gif)[Description of the illustration system_partitioning.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/system_partitioning.html)([reference_partition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEJDCI)) 

consistent_hash_partitions::= 

![Description of consistent_hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/consistent_hash_partitions.gif)[Description of the illustration consistent_hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/consistent_hash_partitions.html)
...
![Description of directory_based_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/directory_based_partitions.gif)[Description of the illustration directory_based_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/directory_based_partitions.html)
...
![Description of composite_directory_based_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_directory_based_partitions.gif)[Description of the illustration composite_directory_based_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_directory_based_partitions.html)
...
![Description of directory_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/directory_partition_desc.gif)[Description of the illustration directory_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/directory_partition_desc.html)
...
![Description of consistent_hash_with_subpartitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/consistent_hash_with_subpartitions.gif)[Description of the illustration consistent_hash_with_subpartitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/consistent_hash_with_subpartitions.html)

partitionset_clauses::= 

![Description of partitionset_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/partitionset_clauses.gif)[Description of the illustration partitionset_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/partitionset_clauses.html)([range_partitionset_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RANGE_PARTITIONSET_CLAUSE-5AD999FA), [list_partitionset_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__LIST_PARTITIONSET_CLAUSE-5AD9A082)

range_partitionset_clause::= 

![Description of range_partitionset_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_partitionset_clause.gif)[Description of the illustration range_partitionset_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_partitionset_clause.html)

range_partitionset_desc::= 

![Description of range_partitionset_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_partitionset_desc.gif)[Description of the illustration range_partitionset_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_partitionset_desc.html)

list_partitionset_clause::= 

![Description of list_partitionset_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partitionset_clause.gif)[Description of the illustration list_partitionset_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partitionset_clause.html)

list_partitionset_desc::= 

![Description of list_partitionset_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partitionset_desc.gif)[Description of the illustration list_partitionset_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partitionset_desc.html)

range_partition_desc::= 

![Description of range_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_partition_desc.gif)[Description of the illustration range_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_partition_desc.html)([range_values_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125922), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282), [range_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEGHJB), [list_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146352), [individual_hash_subparts::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215074), [hash_subparts_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIDCDG)) 

list_partition_desc::= 

![Description of list_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partition_desc.gif)[Description of the illustration list_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partition_desc.html)([list_values_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125928), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282), [range_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEGHJB), [list_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146352), [individual_hash_subparts::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215074), [hash_subparts_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIDCDG)) 

subpartition_template::= 

![Description of subpartition_template.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_template.gif)[Description of the illustration subpartition_template.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_template.html)([range_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEGHJB), [list_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146352), [individual_hash_subparts::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215074)) 

subpartition_by_range::= 

![Description of subpartition_by_range.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_by_range.gif)[Description of the illustration subpartition_by_range.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_by_range.html)([subpartition_template::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129934)) 

subpartition_by_list::= 

![Description of subpartition_by_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_by_list.gif)[Description of the illustration subpartition_by_list.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_by_list.html)([subpartition_template::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129934)) 

subpartition_by_hash::= 

![Description of subpartition_by_hash.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_by_hash.gif)[Description of the illustration subpartition_by_hash.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_by_hash.html)([subpartition_template::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129934)) 

range_subpartition_desc::= 

![Description of range_subpartition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_subpartition_desc.gif)[Description of the illustration range_subpartition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_subpartition_desc.html)([range_values_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125922), [read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH), [external_part_subpart_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__EXTERNAL_PART_SUBPART_DATA_PROPS-5AD95928)) 

list_subpartition_desc::= 

![Description of list_subpartition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_subpartition_desc.gif)[Description of the illustration list_subpartition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_subpartition_desc.html)([list_values_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125928), [read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH), [external_part_subpart_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__EXTERNAL_PART_SUBPART_DATA_PROPS-5AD95928)) 

individual_hash_subparts::= 

![Description of individual_hash_subparts.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/individual_hash_subparts.gif)[Description of the illustration individual_hash_subparts.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/individual_hash_subparts.html)([read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH)) 
...
See Also:
  ...
  * [Oracle Database Administratorâs Guide ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN)
...
See Also:
  ...
  * [Managing Immutable Tables](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-2CEEE181-1171-4C18-8604-2F26FC8EC7EA)

  * [Managing Blockchain Tables](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-43470B0C-DE4A-4640-9278-B066901C3926)
...
For examples see [Add Annotations at Table Creation: Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_IW4_F25_NVB)

For the full semantics of the annotations clause see [annotations_clause](annotations_clause.html#GUID-1AC16117-BBB6-4435-8794-2B99F8F68052). 
...
See Also:
  ...
  * [DBMS_CLOUD](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS-GUID-6CCC322D-26A9-47E7-8FF5-5FF23807C968)

  * [Managing External Tables](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-F6948F0E-0557-4C42-9145-1897DE974CC3)
...
See Also:
  ...
  * `ALTER TABLE` ... "[PROJECT COLUMN Clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJAFACGH)" for information on the effect of changing the default property of the column projection 
...
See Also:
  ...
  * To set the `UNDO_RETENTION` initialization parameter, see [Setting the Minimum Undo Retention Period ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-C1272948-3E08-45D9-BD5A-D6461E249EFB)

  * `CREATE` `TABLE` clause [LOB_storage_parameters](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128955) for more information on simplified LOB storage using SecureFiles 
