[Previous](CREATE-SYNONYM.html) [Next](CREATE-TABLESPACE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN015) and [CREATE TYPE](CREATE-TYPE.html#GUID-E72E3EE6-DE95-4F58-8941-E2F76D0EAE80) for more information about creating objects 

  * [ALTER TABLE](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877) and [DROP TABLE](DROP-TABLE.html#GUID-39D89EDC-155D-4A24-837E-D45DDA757B45) for information on modifying and dropping tables 
...
To specify the `zonemap_clause`, you must have the permissions necessary to create a zone map. Refer to the "[Prerequisites](CREATE-MATERIALIZED-ZONEMAP.html#GUID-1E5048FC-3D28-49BC-80FE-7871568B4702__CACECGEF)" section in the documentation on `CREATE` `MATERIALIZED` `ZONEMAP`. 
...
See Also:
  ...
  * [CREATE INDEX](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE)* [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN01503) for more information about the privileges required to create tables using types 
...
![Description of create_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_table.gif)[Descriptionof the illustration create_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_table.md)([relational_table::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149006), [object_table::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2214901), [XMLType_table::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2234923), [JSON_Collection_table::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_H1B_SZP_XBC) ) 
...
![Description of relational_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/relational_table.gif)[Descriptionof the illustration relational_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/relational_table.md)
...
([relational_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146032), [immutable_table_clauses](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__GUID-1E99412D-763E-425C-93F7-8EAB74588808) ,[blockchain_table_clauses::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__GUID-C14323E5-7D9B-464E-865C-4399DB1E0052) ,[physical_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126711), [table_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126725)) 
...
![Description of object_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/object_table.gif)[Descriptionof the illustration object_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/object_table.md)([object_table_substitution::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126754), [object_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126768), [oid_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149035), [oid_index_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149044), [physical_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126711), [table_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126725)) 

XMLType_table::= 

  
![Description of xmltype_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmltype_table.gif)[Descriptionof the illustration xmltype_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmltype_table.md)  


([XMLType_storage::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2218838), [XMLSchema_spec::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABJDCGH), [XMLType_virtual_columns::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFIGHD), [oid_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149035), [oid_index_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149044), [physical_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126711), [table_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126725)) 
...
![Description of json_collection_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_collection_table.gif)[Descriptionof the illustration json_collection_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_collection_table.md)
...
![Description of relational_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/relational_properties.gif)[Descriptionof the illustration relational_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/relational_properties.md)
...
([column_definition::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGEDHJE), [virtual_column_definition::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABCHBHE), [period_definition::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAEJCEG), [out_of_line_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJADJGEC), [out_of_line_ref_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJABCJJF), [supplemental_logging_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_EHZ_WTG_BDC), [domain_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__GUID-2EDD53F8-C199-4B5F-B8CC-3FFA4A8BD8A7)) 
...
![Description of column_definition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/column_definition.gif)[Descriptionof the illustration column_definition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/column_definition.md)( [datatype_domain::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_RS4_PZY_FBC),[identity_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAECCFH), [inline_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAGIICD), [inline_ref_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAHIEIJ), [annotations_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_RL1_GYD_GVB)) 
...
![Description of virtual_column_definition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/virtual_column_definition.gif)[Descriptionof the illustration virtual_column_definition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/virtual_column_definition.md)([datatype::=](Data-Types.md#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483__SECTION_KLC_CHG_DDC),[evaluation_edition_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJACADGB), [unusable_editions_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJACHEDG), [constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAEDFIB)) 
...
![Description of object_table_substitution.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/object_table_substitution.gif)[Descriptionof the illustration object_table_substitution.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/object_table_substitution.md)

object_properties::= 

![Description of object_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/object_properties.gif)[Descriptionof the illustration object_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/object_properties.md)([constraint::=](constraint.md#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAEDFIB), [CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126822](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126822)) 

oid_clause::= 

![Description of oid_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/oid_clause.gif)[Descriptionof the illustration oid_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/oid_clause.md)

oid_index_clause::= 

![Description of oid_index_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/oid_index_clause.gif)[Descriptionof the illustration oid_index_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/oid_index_clause.md)([physical_attributes_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129582)) 

physical_properties::= 

![Description of physical_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/physical_properties.gif)[Descriptionof the illustration physical_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/physical_properties.md)([deferred_segment_creation::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGBDDBC), [segment_attributes_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2214991), [table_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129627), [inmemory_table_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGBJJJG), [ilm_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAIDBJE), [heap_org_table_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGBBCEF), [index_org_table_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129638), [external_table_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129649)) 
...
![Description of segment_attributes_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/segment_attributes_clause.gif)[Descriptionof the illustration segment_attributes_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/segment_attributes_clause.md)([physical_attributes_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129582), [logging_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129672)) 
...
![Description of inmemory_table_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/inmemory_table_clause.gif)[Descriptionof the illustration inmemory_table_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/inmemory_table_clause.md)([inmemory_attributes::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGHDDGE), [inmemory_column_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGFJCBF)) 

inmemory_attributes::= 

![Description of inmemory_attributes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/inmemory_attributes.gif)[Descriptionof the illustration inmemory_attributes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/inmemory_attributes.md)([inmemory_memcompress::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGJJGCD), [inmemory_priority::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGFADAI), [inmemory_distribute::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGHBAEI), [inmemory_duplicate::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGIBBBA)) 
...
![Description of table_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/table_properties.gif)[Descriptionof the illustration table_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/table_properties.md)([column_properties::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146083), [read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [table_partitioning_clauses::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129707), [attribute_clustering_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGGFJJD), [parallel_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129718), [enable_disable_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129729), [row_movement_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2204697), [logical_replication_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_WMZ_QTB_GNB), [flashback_archive_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDGEHC), [subquery::=](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2126435)) 

column_properties::= 

![Description of column_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/column_properties.gif)[Descriptionof the illustration column_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/column_properties.md)([object_type_col_properties::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129742), [nested_table_col_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215015), [varray_col_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149052), [LOB_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2218765), [LOB_partition_storage::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129787), [XMLType_column_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129798),[json_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__GUID-BDF03F4F-2FE5-44FB-8072-5AAED6B98021)) 
...
![Description of nested_table_col_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nested_table_col_properties.gif)[Descriptionof the illustration nested_table_col_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nested_table_col_properties.md)([substitutable_column_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215008), [object_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126768), [physical_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126711), [column_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146083)) 

varray_col_properties::= 

![Description of varray_col_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/varray_col_properties.gif)[Descriptionof the illustration varray_col_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/varray_col_properties.md)([substitutable_column_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215008), [varray_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABCACAI)) 

varray_storage_clause::= 

![Description of varray_storage_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/varray_storage_clause.gif)[Descriptionof the illustration varray_storage_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/varray_storage_clause.md)([LOB_parameters::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149089)) 

LOB_storage_clause::= 

![Description of lob_storage_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lob_storage_clause.gif)[Descriptionof the illustration lob_storage_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lob_storage_clause.md)([LOB_storage_parameters::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABGHDEA)) 

LOB_storage_parameters::= 

![Description of lob_storage_parameters.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lob_storage_parameters.gif)[Descriptionof the illustration lob_storage_parameters.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lob_storage_parameters.md)([LOB_parameters::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149089), [storage_clause::=](storage_clause.html#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15__CJACEJGB)) 

LOB_parameters::= 

![Description of lob_parameters.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lob_parameters.gif)[Descriptionof the illustration lob_parameters.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lob_parameters.md)([LOB_deduplicate_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFCEJE), [LOB_compression_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFHIFJ), [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF)) 

Note:

Several of the LOB parameters are no longer needed if you are using SecureFiles for LOB storage. Refer to [LOB_storage_parameters](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128955) for more information. 
...
![Description of xmltype_virtual_columns.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmltype_virtual_columns.gif)[Descriptionof the illustration xmltype_virtual_columns.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmltype_virtual_columns.md)
...
![Description of domain_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/domain_clause.gif)[Descriptionof the illustration domain_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/domain_clause.md)
...
![Description of immutable_table_no_drop_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_table_no_drop_clause.gif)[Descriptionof the illustration immutable_table_no_drop_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_table_no_drop_clause.md)
...
![Description of immutable_table_no_delete_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_table_no_delete_clause.gif)[Descriptionof the illustration immutable_table_no_delete_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_table_no_delete_clause.md)
...
![Description of immutable_row_version_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_row_version_clause.gif)[Descriptionof the illustration immutable_row_version_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_row_version_clause.md)
...
![Description of immutable_data_format_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/immutable_data_format_clause.gif)[Descriptionof the illustration immutable_data_format_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/immutable_data_format_clause.md)
...
![Description of blockchain_drop_table_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_drop_table_clause.gif)[Descriptionof the illustration blockchain_drop_table_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_drop_table_clause.md)
...
![Description of blockchain_row_retention_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_row_retention_clause.gif)[Descriptionof the illustration blockchain_row_retention_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_row_retention_clause.md)
...
![Description of blockchain_hash_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_hash_clause.gif)[Descriptionof the illustration blockchain_hash_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_hash_clause.md)
...
![Description of blockchain_row_version_user_chain_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_row_version_user_chain_clause.gif)[Descriptionof the illustration blockchain_row_version_user_chain_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_row_version_user_chain_clause.md)
...
![Description of blockchain_system_chains_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_system_chains_clause.gif)[Descriptionof the illustration blockchain_system_chains_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_system_chains_clause.md)
...
![Description of blockchain_data_format_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/blockchain_data_format_clause.gif)[Descriptionof the illustration blockchain_data_format_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/blockchain_data_format_clause.md)
...
![Description of external_table_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/external_table_clause.gif)[Descriptionof the illustration external_table_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/external_table_clause.md)([external_table_data_props::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146275)) 

external_table_data_props::= 

![Description of external_table_data_props.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/external_table_data_props.gif)[Descriptionof the illustration external_table_data_props.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/external_table_data_props.md)(`opaque_format_spec`: This clause specifies the access parameters for the `ORACLE_LOADER`, `ORACLE_DATAPUMP`, `ORACLE_HDFS`, and `ORACLE_HIVE` access drivers. See [Oracle Database Utilities](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL1358) for descriptions of these parameters.) 
...
![Description of table_partitioning_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/table_partitioning_clauses.gif)[Descriptionof the illustration table_partitioning_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/table_partitioning_clauses.md)([range_partitions::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146287), [list_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146309), [hash_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146298), [composite_range_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146320), [composite_list_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFDCFF) [composite_hash_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJABBBAI), [reference_partitioning::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDECCA), [system_partitioning::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFAEHI), [consistent_hash_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CONSISTENT_HASH_PARTITIONS-5427C96E), [directory_based_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_VC5_S4H_2YB),[composite_directory_based_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_VWB_T4H_2YB),[consistent_hash_with_subpartitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CONSISTENT_HASH_WITH_SUBPARTITIONS-5427D4BC), [partitionset_clauses::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__PARTITIONSET_CLAUSES-5427E11B)) 

range_partitions::= 

![Description of range_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_partitions.gif)[Descriptionof the illustration range_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_partitions.md)([range_values_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125922), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282), [external_part_subpart_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__EXTERNAL_PART_SUBPART_DATA_PROPS-5AD95928)) 
...
![Description of hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hash_partitions.gif)[Descriptionof the illustration hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hash_partitions.md)([individual_hash_partitions::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126179), [hash_partitions_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125987)) 

individual_hash_partitions::= 

![Description of individual_hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/individual_hash_partitions.gif)[Descriptionof the illustration individual_hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/individual_hash_partitions.md)([read_only_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH)) 

hash_partitions_by_quantity::= 

![Description of hash_partitions_by_quantity.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hash_partitions_by_quantity.gif)[Descriptionof the illustration hash_partitions_by_quantity.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hash_partitions_by_quantity.md)([table_compression::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129627), [index_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215029)) 

list_partitions::= 

![Description of list_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partitions.gif)[Descriptionof the illustration list_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partitions.md)([list_values_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125928), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282), [external_part_subpart_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__EXTERNAL_PART_SUBPART_DATA_PROPS-5AD95928)) 

composite_range_partitions::= 

![Description of composite_range_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_range_partitions.gif)[Descriptionof the illustration composite_range_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_range_partitions.md)([subpartition_by_range::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDDHAA). [subpartition_by_list::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153057), [subpartition_by_hash::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129906), [range_partition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABJIIJB)) 

composite_hash_partitions::= 

![Description of composite_hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_hash_partitions.gif)[Descriptionof the illustration composite_hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_hash_partitions.md)([subpartition_by_range::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDDHAA), [subpartition_by_list::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153057), [subpartition_by_hash::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129906), [individual_hash_partitions::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2126179), [hash_partitions_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125987)) 

composite_list_partitions::= 

![Description of composite_list_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_list_partitions.gif)[Descriptionof the illustration composite_list_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_list_partitions.md)([subpartition_by_range::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDDHAA). [subpartition_by_list::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153057), [subpartition_by_hash::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129906), [list_partition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIBDHH)) 

reference_partitioning::= 

![Description of reference_partitioning.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/reference_partitioning.gif)[Descriptionof the illustration reference_partitioning.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/reference_partitioning.md)([constraint::=](constraint.md#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAEDFIB), [reference_partition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEJDCI)) 

reference_partition_desc::= 

![Description of reference_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/reference_partition_desc.gif)[Descriptionof the illustration reference_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/reference_partition_desc.md)([table_partition_description::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282)) 

system_partitioning::= 

![Description of system_partitioning.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/system_partitioning.gif)[Descriptionof the illustration system_partitioning.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/system_partitioning.md)([reference_partition_desc::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEJDCI)) 

consistent_hash_partitions::= 

![Description of consistent_hash_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/consistent_hash_partitions.gif)[Descriptionof the illustration consistent_hash_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/consistent_hash_partitions.md)
...
![Description of directory_based_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/directory_based_partitions.gif)[Descriptionof the illustration directory_based_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/directory_based_partitions.md)
...
![Description of composite_directory_based_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/composite_directory_based_partitions.gif)[Descriptionof the illustration composite_directory_based_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/composite_directory_based_partitions.md)
...
![Description of directory_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/directory_partition_desc.gif)[Descriptionof the illustration directory_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/directory_partition_desc.md)
...
![Description of consistent_hash_with_subpartitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/consistent_hash_with_subpartitions.gif)[Descriptionof the illustration consistent_hash_with_subpartitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/consistent_hash_with_subpartitions.md)

partitionset_clauses::= 

![Description of partitionset_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/partitionset_clauses.gif)[Descriptionof the illustration partitionset_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/partitionset_clauses.md)([range_partitionset_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RANGE_PARTITIONSET_CLAUSE-5AD999FA), [list_partitionset_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__LIST_PARTITIONSET_CLAUSE-5AD9A082)

range_partitionset_clause::= 

![Description of range_partitionset_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_partitionset_clause.gif)[Descriptionof the illustration range_partitionset_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_partitionset_clause.md)

range_partitionset_desc::= 

![Description of range_partitionset_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_partitionset_desc.gif)[Descriptionof the illustration range_partitionset_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_partitionset_desc.md)

list_partitionset_clause::= 

![Description of list_partitionset_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partitionset_clause.gif)[Descriptionof the illustration list_partitionset_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partitionset_clause.md)

list_partitionset_desc::= 

![Description of list_partitionset_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partitionset_desc.gif)[Descriptionof the illustration list_partitionset_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partitionset_desc.md)

range_partition_desc::= 

![Description of range_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_partition_desc.gif)[Descriptionof the illustration range_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_partition_desc.md)([range_values_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125922), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282), [range_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEGHJB), [list_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146352), [individual_hash_subparts::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215074), [hash_subparts_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIDCDG)) 

list_partition_desc::= 

![Description of list_partition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_partition_desc.gif)[Descriptionof the illustration list_partition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_partition_desc.md)([list_values_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125928), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282), [range_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEGHJB), [list_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146352), [individual_hash_subparts::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215074), [hash_subparts_by_quantity::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIDCDG)) 

subpartition_template::= 

![Description of subpartition_template.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_template.gif)[Descriptionof the illustration subpartition_template.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_template.md)([range_subpartition_desc::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEGHJB), [list_subpartition_desc::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146352), [individual_hash_subparts::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215074)) 

subpartition_by_range::= 

![Description of subpartition_by_range.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_by_range.gif)[Descriptionof the illustration subpartition_by_range.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_by_range.md)([subpartition_template::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129934)) 

subpartition_by_list::= 

![Description of subpartition_by_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_by_list.gif)[Descriptionof the illustration subpartition_by_list.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_by_list.md)([subpartition_template::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129934)) 

subpartition_by_hash::= 

![Description of subpartition_by_hash.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/subpartition_by_hash.gif)[Descriptionof the illustration subpartition_by_hash.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/subpartition_by_hash.md)([subpartition_template::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129934)) 

range_subpartition_desc::= 

![Description of range_subpartition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/range_subpartition_desc.gif)[Descriptionof the illustration range_subpartition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/range_subpartition_desc.md)([range_values_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125922), [read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH), [external_part_subpart_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__EXTERNAL_PART_SUBPART_DATA_PROPS-5AD95928)) 

list_subpartition_desc::= 

![Description of list_subpartition_desc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/list_subpartition_desc.gif)[Descriptionof the illustration list_subpartition_desc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/list_subpartition_desc.md)([list_values_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125928), [read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH), [external_part_subpart_data_props::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__EXTERNAL_PART_SUBPART_DATA_PROPS-5AD95928)) 

individual_hash_subparts::= 

![Description of individual_hash_subparts.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/individual_hash_subparts.gif)[Descriptionof the illustration individual_hash_subparts.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/individual_hash_subparts.md)([read_only_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [partitioning_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJADDEEH)) 
...
![Description of table_partition_description.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/table_partition_description.gif)[Descriptionof the illustration table_partition_description.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/table_partition_description.md)([deferred_segment_creation::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGBDDBC), [read_only_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__READ_ONLY_CLAUSE-5314A287), [indexing_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAJBJII), [segment_attributes_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2214991), [table_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129627), [prefix_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGHDCBC), [inmemory_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGBJBFH), [segment_attributes_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2214991), [LOB_storage_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2218765), [varray_col_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2149052), [nested_table_col_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215015)) 

partitioning_storage_clause::= 

![Description of partitioning_storage_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/partitioning_storage_clause.gif)[Descriptionof the illustration partitioning_storage_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/partitioning_storage_clause.md)([table_compression::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129627), [index_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215029), [inmemory_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGBJBFH), [LOB_partitioning_storage::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEACJG)) 

inmemory_clause::= 

![Description of inmemory_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/inmemory_clause.gif)[Descriptionof the illustration inmemory_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/inmemory_clause.md)([inmemory_memcompress::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGJJGCD), [inmemory_attributes::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGHDDGE)) 

attribute_clustering_clause::= 

![Description of attribute_clustering_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/attribute_clustering_clause.gif)[Descriptionof the illustration attribute_clustering_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/attribute_clustering_clause.md)([clustering_join::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGIAIBF), [cluster_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGFAFAE), [clustering_when::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGJACCH), [zonemap_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGJCEGI)) 
...
![Description of enable_disable_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enable_disable_clause.gif)[Descriptionof the illustration enable_disable_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enable_disable_clause.md)([using_index_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2146364), `exceptions_clause` not supported in `CREATE` `TABLE` statements) 

using_index_clause::= 

![Description of using_index_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_index_clause.gif)[Descriptionof the illustration using_index_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_index_clause.md)([create_index::=](CREATE-INDEX.md#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2125762), [index_properties::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2168216)) 

index_properties::= 

![Description of index_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_properties.gif)[Descriptionof the illustration index_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_properties.md)([global_partitioned_index::=](CREATE-INDEX.md#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2126415), [local_partitioned_index::=](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2125897)âpart of `CREATE` `INDEX`, [index_attributes::=](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2182500), `domain_index_clause` and `XMLIndex_clause`: not supported in `using_index_clause`) 

index_attributes::= 

![Description of index_attributes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_attributes.gif)[Descriptionof the illustration index_attributes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_attributes.md)([physical_attributes_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129582), [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF), [index_compression::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215029), `partial_index_clause` and `parallel_clause`: not supported in `using_index_clause`) 
...
See here for usage details of the [ON COMMIT](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2189569) clause. 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT211) for information on temporary tables and "[Creating a Table: Temporary Table Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153132)"
...
When you create a sharded table, you must specify a tablespace set in which to create the table. There is no default tablespace set for sharded tables. See [CREATE TABLESPACE SET](CREATE-TABLESPACE-SET.html#GUID-877951F1-B2A5-4907-9F0F-EF4F1884E8C4) for more information. 

Oracle Sharding is based on the Oracle Partitioning feature. Therefore, a sharded table must be a partitioned or composite-partitioned table. When creating a sharded table, you must specify one of the `table_partitioning_clauses`. See [table_partitioning_clauses](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215406) for the full semantics of these clauses. 
...
See Also:
  ...
  * [Using Oracle Sharding](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SHARD-GUID-0F39B1FB-DCF9-4C8A-A2EA-88705B90C5BF)* [Oracle Database Administratorâs Guide ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN)
...
See Also:
  ...
  * [Managing Immutable Tables](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-2CEEE181-1171-4C18-8604-2F26FC8EC7EA)* [Managing Blockchain Tables](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-43470B0C-DE4A-4640-9278-B066901C3926)
...
Specify the name of the table or object table to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 

See Also:

[Oracle Database Administratorâs Guide ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN) for more on sharded tables. 
...
See Also:
  ...
  * [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN-GUID-15D1391E-7FAB-46A8-9F1F-9F59045B71EC) for more information on the `DEFAULT_SHARING` initialization parameter 

  * [Oracle Database Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-388FB5AD-A2DE-4951-833B-A98239F99F50) for complete information on creating application common objects 
...
Specify the name of a column of the table. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
The absolute maximum number of columns in a table is 1000, if the `MAX_COLUMNS` initialization parameter = `STANDARD`, or 4096 columns if `MAX_COLUMNS` = `EXTENDED`. See [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN-GUID-916B35D1-364E-41C6-A025-E2D32533D08E) for more on the `MAX_COLUMNS` initialization parameter. 
...
"[Data Types](Data-Types.html#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483)" for information on `LONG` columns and on Oracle-supplied data types 
...
See Also:
  ...
  * [Using Lock-Free Reservation](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS-GUID-BC3FB52F-839A-4E83-A477-3B38855F1C7F) of the Database Development Guide. 

  * Columns section in [Tables and Table Clusters](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT-GUID-6CD9E011-9F12-4CBD-9D37-7A41F3EB4F27) of Database Concepts. 
...
Refer to the [DEFAULT COLLATION](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__DEFAULTCOLLATION-34502CA8) clause for more information on the default collation for a table. 
...
See Also:
  ...
  * "[CLUSTER Clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2171985)" for information on creating a cluster table 

  * [Managing Hash Clusters](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-EC3F7A6F-3648-48AA-8737-FFCC6E4964CF)
...
`INVISIBLE` columns are user-specified hidden columns. To display or assign a value to an `INVISIBLE` column, you must specify its name explicitly. For example: 
  ...
  * You can configure SQL*Plus to allow `INVISIBLE` column information to be viewed with the `DESCRIBE` command. Refer to [SQL*Plus User's Guide and Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SQPUG303) for more information. 
...
To determine whether a column is a system-generated hidden column, query the `HIDDEN_COLUMN` and `USER_GENERATED` columns of the `ALL_`, `DBA_`, and `USER_TAB_COLS` data dictionary views. Refer to [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN20276) for more information. 
...
"[About SQL Expressions](About-SQL-Expressions.html#GUID-68789A5C-B142-496F-ADEE-837F75F95B2B)" for the syntax of `expr`
...
"[Creating a Table with a DEFAULT ON NULL Column Value: Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAIGEJE)"
...
For examples see [Add Annotations at Table Creation: Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_IW4_F25_NVB)For the full semantics of the annotations clause see [annotations_clause](annotations_clause.html#GUID-1AC16117-BBB6-4435-8794-2B99F8F68052). 
...
"[Creating a Table with an Identity Column: Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAHCAFF)"
...
Column encryption requires that a system administrator with appropriate privileges has initialized the security module, opened a keystore, and set an encryption key. Refer to [Transparent Data Encryption](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBTDE10137) for general information about column encryption and to [security_clauses](ALTER-SYSTEM.html#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__BGBCEDHJ) for related `ALTER` `SYSTEM` statements. 
...
Use this clause to specify the integrity algorithm to be used. Valid integrity algorithms are `SHA-1` and `NOMAC`. 
  ...
  * If you specify `NOMAC`, then TDE does not add a MAC and does not perform the integrity check. This saves 20 bytes of disk space per encrypted value. Refer to [Transparent Data Encryption](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBTDE10146) for more information on using `NOMAC` to save disk space and improve performance. 




All encrypted columns in a table must use the same integrity algorithm. If you already have a table column using the `SHA-1` algorithm, then you cannot use the `NOMAC` parameter to encrypt another column in the same table. Refer to the [REKEY encryption_spec](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJAEGJGI) clause of `ALTER` `TABLE` to learn how to change the integrity algorithm used by all encrypted columns in a table. 
...
The following considerations apply when specifying `SALT` or `NO` `SALT` for encrypted columns: 
  ...
  * If you want to use the column as an index key, then you must specify `NO` `SALT`. Refer to [Transparent Data Encryption](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBTDE9538) for a description of "salt" in this context. 
...
The `COLLATE` clause lets you specify a data-bound collation for the virtual column. For `column_collation_name`, specify a valid named collation or pseudo-collation. If you omit this clause, then the column is assigned the default collation for the table as it stands at the time the column is created, unless the column belongs to a foreign key, in which case it inherits the collation from the corresponding column of the parent key. Refer to the [DEFAULT COLLATION](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__DEFAULTCOLLATION-34502CA8) clause for more information on the default collation for a table. 

You can specify the `COLLATE` clause only if the `COMPATIBLE` initialization parameter is set to `12.2` or greater, and the `MAX_STRING_SIZE` initialization parameter is set to `EXTENDED`. 

VISIBLE | INVISIBLE

Use this clause to specify whether virtual column is `VISIBLE` or `INVISIBLE`. The default is `VISIBLE`. For complete information, refer to "[VISIBLE | INVISIBLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAGDBIC)". 
...
The `AS` `column_expression` clause determines the content of the column. Refer to "[Column Expressions](Column-Expressions.html#GUID-B16B2D82-5D4B-485B-AE20-160EC0C7137A)" for more information on `column_expression`. 
...
You must specify this clause if `column_expression` refers to an editioned PL/SQL function. Use this clause to specify the edition that is searched during name resolution of the editioned PL/SQL functionâthe evaluation edition. 
...
[Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS1328) for more information on specifying the evaluation edition for a virtual column 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1163) for more information on optimization with function-based indexes 
...
Notes on Virtual Columns
  ...
  * A query that specifies in its `FROM` clause a table containing a virtual column is eligible for result caching. Refer to "[RESULT_CACHE Hint](Comments.html#GUID-F4B4ECC4-E1FE-40FB-AE05-D7B8AA001986)" for more information on result caching. 
...
"[Column Expressions](Column-Expressions.html#GUID-B16B2D82-5D4B-485B-AE20-160EC0C7137A)" for additional information and restrictions on `column_expression`
...
The names you specify for `start_time_column` and `end_time_column` must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
See Also:
  ...
  * [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS967) for more information on Temporal Validity 

  * `SELECT` [flashback_query_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2112818) for more information on Oracle Flashback Query 

  * `ALTER` `TABLE` [add_period_clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJAEGCFI) and [drop_period_clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJAJHJEJ) for information how to add and drop a valid time dimension 
...
Use these clauses to create constraints on the table columns. You must specify a `PRIMARY` `KEY` constraint for an index-organized table, and it cannot be `DEFERRABLE`. Refer to [constraint](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE) for syntax and description of these constraints as well as examples. 
...
"[REF Constraint Examples](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1015744)"
...
If you omit this clause, then the default collation for the table is set to the effective schema default collation of the schema containing the table. Refer to the [DEFAULT_COLLATION](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B__DEFAULT_COLLATION-39CF7241) clause of `ALTER` `SESSION` for more information on the effective schema default collation. 

You can override the tableâs default collation and assign a data-bound collation to a particular column by specifying the `COLLATE` clause in the `column_definition` or `virtual_column_definition` clause of `CREATE` `TABLE` or `ALTER` `TABLE`, or the `modify_col_properties` or `modify_virtcol_properties` clause of `ALTER` `TABLE`. 
...
[Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-2AC4EE67-D3C0-4E26-87AD-2DA4584F874A) for full information on default collations and data-bound collations 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT304) for general information on segment allocation and [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10307) for more information about the `DEFERRED_SEGMENT_CREATION` initialization parameter 
...
See Also:
  ...
  * [physical_attributes_clause](physical_attributes_clause.html#GUID-A15063A9-3237-43D3-B0AE-D01F6E80B393) and [storage_clause](physical_attributes_clause.html#GUID-A15063A9-3237-43D3-B0AE-D01F6E80B393__I1026834) for a description of these clauses 

  * "[Creating a Table: Storage Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153121)"
...
[CREATE TABLESPACE](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9) for more information on tablespaces 
...
Refer to [logging_clause](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E) for a full description of this clause. 
...
"[Conventional and Direct-Path INSERT](INSERT.html#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423__I2191836)" for information on direct-path `INSERT` operations, including restrictions 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT89198) for more information on Hybrid Columnar Compression, which is a feature of certain Oracle storage systems 
...
[Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS236) for information about the `DBMS_COMPRESSION` package, which helps you choose the correct compression level for an application, and [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN13948) for more information about table compression, including examples 
...
Table compression is subject to the following restrictions:
  ...
  * Data segments of BasicFiles LOBs are not compressed. For information on compression of SecureFiles LOBs, see [LOB_compression_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIJJHI). 
...
You can optionally use the `inmemory_attributes` clause to specify how table data is stored in the IM column store. This clause enables you to specify the data compression method and the data population priority. In an Oracle RAC environment, it also enables you to specify how the data is distributed and duplicated across Oracle RAC instances. Refer to the [inmemory_attributes](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGIDFIC) clause for more information. 

  * Specify `NO` `INMEMORY` to disable the table for the IM column store. 

  * Specify the `inmemory_column_clause` to enable or disable specific table columns for the IM column store, and to specify the data compression method for specific columns. Refer to the [inmemory_clause](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9__CEGCFHJD) for more information. 
...
If you omit this clause, then the table is assigned the default IM column store settings for the tablespace in which it is created. Refer to the [inmemory_clause](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9__CEGCFHJD) of `CREATE` `TABLESPACE` for more information on specifying the default IM column store settings for a tablespace. 
...
The `INMEMORY_CLAUSE_DEFAULT` initialization parameter enables you to specify a default IM column store clause for new tables and materialized views. Refer to [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10350) for more information on the `INMEMORY_CLAUSE_DEFAULT` initialization parameter. 
...
[Oracle Database In-Memory Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=INMEM-GUID-BFA53515-7643-41E5-A296-654AB4A9F9E7) for an overview of the IM column store 
...
The `inmemory_attributes` clause has the same semantics for table partitions as for tables. Refer to the [inmemory_attributes](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGIDFIC) clause for full information. 
...
[IM Full Text Columns](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=INMEM-GUID-42A8CB2F-6C45-4488-8256-E15CC7AFF306). 
...
This clause has the same semantics in `CREATE` `TABLE` and `ALTER` `TABLE`, with the following additional restriction: You can specify only the `ADD` `POLICY` clause for `CREATE` `TABLE`. Refer to the [ilm_clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJADBBDI) for the full semantics of this clause. 
...
This clause has the same semantics in `CREATE` `TABLE` and `ALTER` `TABLE`. Refer to [ilm_policy_clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJAJGGED) for the full semantics of this clause. 
...
"[External Table Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153251)"
...
"[Index-Organized Table Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153235)"
...
See Also:
  ...
  * [DBMS_CLOUD](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS-GUID-6CCC322D-26A9-47E7-8FF5-5FF23807C968)* [Managing External Tables](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-F6948F0E-0557-4C42-9145-1897DE974CC3)
...
See Also:
  ...
  * "[External Table Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153251)"* `ALTER TABLE` ... "[PROJECT COLUMN Clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJAFACGH)" for information on the effect of changing the default property of the column projection 

  * [Oracle Database Data Warehousing Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG014), [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN01507), and [Oracle Database Utilities](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL011) for information on the uses for external tables 
...
Oracle Database Utilities for information about the [`ORACLE_LOADER`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL012), [`ORACLE_DATAPUMP`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL500), [`ORACLE_HDFS`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL-GUID-597D7F45-D37F-49CE-A7E5-C92C7D707AE9), and [`ORACLE_HIVE`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL-GUID-597D7F45-D37F-49CE-A7E5-C92C7D707AE9) access drivers 
...
The optional `ACCESS` `PARAMETERS` clause lets you assign values to the parameters of the specific access driver for this external table. 
  ...
  * The `opaque_format_spec` specifies all access parameters for the `ORACLE_LOADER`, `ORACLE_DATAPUMP`, `ORACLE_HDFS`, and `ORACLE_HIVE` access drivers. See Oracle Database Utilities for descriptions of the [`ORACLE_LOADER`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL012), [`ORACLE_DATAPUMP`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL500), [`ORACLE_HDFS`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL-GUID-597D7F45-D37F-49CE-A7E5-C92C7D707AE9), and [`ORACLE_HIVE`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL-GUID-597D7F45-D37F-49CE-A7E5-C92C7D707AE9) access parameters. 
...
See Also:
  ...
  * [Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB102) for detailed information about LOBs, including guidelines for creating gigabyte LOBs 

  * "[Creating a Table: LOB Column Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2116140)"
...
[Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB4444) for more information about SecureFiles LOBs 
...
The LOB locator is always stored inline regardless of where the LOB value is stored. You cannot change the value of `STORAGE` `IN` `ROW` once it is set except by moving the table. See the [move_table_clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__I2085301) in the `ALTER` `TABLE` documentation for more information. 
...
See Also:
  ...
  * To set the `UNDO_RETENTION` initialization parameter, see [Setting the Minimum Undo Retention Period ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-C1272948-3E08-45D9-BD5A-D6461E249EFB)* `CREATE` `TABLE` clause [LOB_storage_parameters](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128955) for more information on simplified LOB storage using SecureFiles 

  * [Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB4444) for more information on using SecureFiles 

  * [flashback_mode_clause](ALTER-DATABASE.html#GUID-8069872F-E680-4511-ADD8-A4E30AF67986__I2155821) of `ALTER` `DATABASE` for information on putting a database in flashback mode 

  * "[Creating an Undo Tablespace: Example](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9__I2153390)"
...
[Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB4444) for more information about LOB deduplication and [Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS600) for information about about the `DBMS_LOB` package 
...
[Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB4444) for more information on server-side LOB storage and Oracle Database PL/SQL Packages and Types Reference for information about client-side LOB compression using the [`UTL_COMPRESS`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS381) supplied package and for information about the [`DBMS_LOB`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS600) package 
...
[Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB4444) for more information on LOB encryption and [Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS600) for information the `DBMS_LOB` package 

CACHE | NOCACHE | CACHE READS

Refer to [CACHE | NOCACHE | CACHE READS](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215507) for information on these clauses. 
...
The `substitutable_column_clause` has the same behavior as described for [object_type_col_properties](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128922). 

See Also:

"[Substitutable Table and Column Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2090577)"
...
"[Creating a Table: Multilevel Collection Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2139603)" for examples using `nested_item` and `COLUMN_VALUE`
...
[ALTER TABLE](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877) for information about modifying nested table column storage characteristics 
...
See Also:
  ...
  * "[Nested Table Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153200)" and "[Creating a Table: Multilevel Collection Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2139603)"
...
`XMLType` tables and columns data can be stored as transportable binary XML, binary XML, or a set of objects in object-relational storage. 
  ...
  * Specify `TRANSPORTABLE BINARY XML` to store XML data in a transportable format that is scalable and distributed. See [Create Tables and Columns as Transportable Binary XML](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__SECTION_ASR_YTJ_RVB) for examples. 
...
In earlier releases, binary XML data is stored by default in a BasicFiles LOB. Beginning with Oracle Database 11g Release 2 (11.2.0.2), if the `COMPATIBLE` initialization parameter is 11.2 or higher and you do not specify `BASICFILE` or `SECUREFILE`, then binary XML data is stored in a SecureFiles LOB whenever possible. If SecureFiles LOB storage is not possible then the binary XML data is stored in a BasicFiles LOB. This can occur if either of the following is true: 
    ...
    * A setting in file `init`.`ora` prevents SecureFiles LOB storage. For example, see parameter `DB_SECUREFILE` in [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10290). 
...
[Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB4444) for more information on SecureFiles LOBs 

XMLSchema_spec 

Refer to the [XMLSchema_spec](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2215293) for the full semantics of this clause. 
...
See Also:
  ...
  * "[XMLType Column Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2139746)" for examples of `XMLType` columns in object-relational tables and "[Using XML in SQL Statements](Using-XML-in-SQL-Statements.html#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14)" for an example of creating an XMLSchema 

  * Oracle XML DB Developer's Guide for more information on [`XMLType` columns](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB0400) and tables and on creating [XMLSchemas](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB0800)* [Oracle Database PL/SQL Packages and Types Reference ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS377)for information on the `DBMS_XMLSCHEMA` package 
...
[Oracle XML DB Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB0300) for examples of how to use this clause in an XML environment 
...
[Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN002) for information on viewing the indexing property of a table, table partition, or table subpartition. 
...
The [partial_index_clause](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__BGEBGEAH) of `CREATE` `INDEX` for more information on partial indexes 
...
"[Partitioning Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153324)"
...
Range partitioning is subject to the restrictions listed in "[Restrictions on Partitioning in General](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD)". The following additional restrictions apply: 
...
The `INTERVAL` clause is subject to the restrictions listed in "[Restrictions on Partitioning in General](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD)" and "[Restrictions on Range Partitioning](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAEBCJE)". The following additional restrictions apply: 
...
[Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG00221) for more information on interval partitioning 

PARTITION partition 

If you specify a partition name, then the name `partition` must conform to the rules for naming schema objects and their part as described in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". If you omit `partition`, then the database generates a name as described in "[Notes on Partitioning in General](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CHDFAGGH)". 
...
If `table` is partitioned on a `DATE` column, and if the date format does not specify the first two digits of the year, then you must use the `TO_DATE` function with the `YYYY` 4-character format mask for the year. The `RRRR` format mask is not supported in this clause. The date format is determined implicitly by `NLS_TERRITORY` or explicitly by `NLS_DATE_FORMAT`. Refer to [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG003) for more information on these initialization parameters. 

See Also:

[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT112) for more information about partition bounds and "[Range Partitioning Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2093664)"

table_partition_description

Use the `table_partition_description` to define the physical and storage characteristics of the table. 

The clauses `deferred_segment_creation`, `segment_attributes_clause`, `table_compression`, `inmemory_clause`, and `ilm_clause` have the same function as described for the [physical_properties](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128663) of the table as a whole. 

Use the `indexing_clause` to set the indexing property for a range, list, system, or reference table partition. Refer to the [indexing_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAFJABE) for more information. 

The `prefix_compression` clause and `OVERFLOW` clause, have the same function as described for the [index_org_table_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128766). 
...
List partitioning is subject to the restrictions listed in "[Restrictions on Partitioning in General](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD)". The following additional restrictions apply: 
...
Automatic list partitioning is subject to the restrictions listed in "[Restrictions on List Partitioning](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RESTRICTIONSONLISTPARTITIONING-55951AEA)". The following additional restrictions apply: 
...
You can change an automatic list-partitioned table to a regular list-partitioned table, and vice versa. You can also change the tablespaces into which the database will store data for automatically created list partitions. See the clause [alter_automatic_partitioning](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__ALTER_AUTOMATIC_PARTITIONING-552E7598) of `ALTER` `TABLE` for more information. 
...
The partitioning key column for a list partition can be an extended data type column, which has a maximum size of 32767 bytes. In this case, the list of values that you want to specify for a partition may exceed the 4K byte limit. You can work around this limitation by using one of the following methods:
  ...
  * Use a hash function, such as `STANDARD_HASH`, in the partition key column to create unique identifiers of lengths less than 4K bytes. See [STANDARD_HASH](STANDARD_HASH.html#GUID-4A68DACE-CFCF-443B-8651-B6CEAA7C4FD7) for more information. 
...
"[Extended Data Types](Data-Types.html#GUID-8EFA29E9-E8D8-40A6-A43E-954908C954A4)" for more information on extended data types 

table_partition_description

The subclauses of the `table_partition_description` have the same behavior as described for range partitions in [table_partition_description](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABHFEGC). 
...
Hash partitioning is subject to the restrictions listed in "[Restrictions on Partitioning in General](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD)". The following additional restrictions apply: 
...
Use the `indexing_clause` to set the indexing property for a hash partition. Refer to the [indexing_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAFJABE) for more information. 
...
If your enterprise has or will have databases using different character sets, then use caution when partitioning on character columns. The sort sequence of characters is not identical in all character sets. Refer to [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG014) for more information on character set support. 
...
The `table_compression` clause has the same function as described for the [table_properties](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128916) of the table as a whole. 

The `prefix_compression` clause and the `OVERFLOW` clause have the same function as described for the [index_org_table_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128766). 
...
[Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG00222) for more information on hash partitioning 
...
The `INTERVAL` clause has the same semantics for composite range partitioning that it has for range partitioning. Refer to "[INTERVAL Clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABGCEFI)" for more information. 

Specify [subpartition_by_range](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIHBBF), [subpartition_by_hash](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABJAFIB) or [subpartition_by_list](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABEGDBF) to indicate the type of subpartitioning you want for each composite range partition. Within these clauses you can specify a subpartition template, which establishes default subpartition characteristics for subpartitions created as part of this statement or subsequently created subpartitions. 
...
After establishing the type of subpartitioning you want for the table, and optionally a subpartition template, you must define at least one range partition. 
  ...
  * You must specify the [range_values_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABGHDFA), which has the same requirements as for noncomposite range partitions. 

  * Use the [table_partition_description](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFBIHA) to define the physical and storage characteristics of the each partition. 
...
"[Composite-Partitioned Table Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2101488)" for examples of composite range partitioning and [Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG002) for examples of composite list partitioning 
...
After establishing the type of subpartitioning you want for each composite partition, and optionally defining a subpartition template, you must define at least one list partition.
  ...
  * In the `list_partition_desc`, you must specify the [list_values_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABCDDIA), which has the same requirements as for noncomposite list partitions. 
...
Specify `AUTOMATIC` to create an automatic list-range, list-list, list-hash, or list-interval composite-partitioned table. This type of table enables the database to create additional partitions on demand. The optional `STORE` `IN` clause lets you specify one or more tablespaces into which the database will store data for the automatically created partitions. The `AUTOMATIC` and `STORE` `IN` clauses have the same semantics here as they have for noncomposite list partitions. Refer to [AUTOMATIC](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__AUTOMATIC-2B1E29C6) and [STORE IN](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__STOREIN-2B1E2BB5) in the documentation on `list_partitions` for the full semantics of these clauses. Automatic composite-partitioned tables are subject to the restrictions listed in [Restrictions on Composite List Partitioning](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RESTRICTIONSONCOMPOSITELISTPARTITIO-55963A50) and [Restrictions on Automatic List Partitioning](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__RESTRICTIONSONAUTOMATICLISTPARTITIO-55966662). 

Restrictions on Composite List Partitioning

Composite list partitioning is subject to the same restrictions as described in "[Restrictions on Composite Range Partitioning](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CHDFBDBC)". 
...
After establishing the type of subpartitioning you want for the table, you must specify [individual_hash_partitions](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAFBCJC) or [hash_partitions_by_quantity](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJACBFBI). 

Restrictions on Composite Hash Partitioning

Composite hash partitioning is subject to the same restrictions as described in "[Restrictions on Composite Range Partitioning](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CHDFBDBC)". 
...
Use the `subpartition_by_range` clause to indicate that the database should subpartition by range each partition in `table`. The subpartitioning column list is unrelated to the partitioning key but is subject to the same restrictions (see [column](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABGEHCB)). 

You can use the `subpartition_template` to specify default subpartition characteristic values. See [subpartition_template](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABHJECD). The database uses these values for any subpartition in this partition for which you do not explicitly specify the characteristic. 
...
List subpartitioning is subject to the same restrictions as described in [Restrictions on Composite Range Partitioning](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CHDFBDBC). 

subpartition_by_hash

Use the `subpartition_by_hash` clause to indicate that the database should subpartition by hash each partition in `table`. The subpartitioning column list is unrelated to the partitioning key but is subject to the same restrictions (see [column](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABJHGCA)). 

You can define the subpartitions using the `subpartition_template` or the `SUBPARTITIONS` `integer` clause. See [subpartition_template](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABHJECD). In either case, for optimal load balancing you should specify a number of partitions that is a power of 2. 
...
If the parent table is an interval-partitioned table, then partitions in the reference-partitioned child table that correspond to interval partitions in the parent table will be created during inserts into the child table. When an interval partition in a child table is created, the partition name is inherited from the associated parent table partition. If the child table has a table-level default tablespace, then it will be used as the tablespace for the new interval partition. Otherwise, the tablespace will be inherited from the parent table partition. Refer to [Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG14103) for more information on referencing an interval-partitioned table. 
...
Use this optional clause to specify partition names and to define the physical and storage characteristics of the partition. The subclauses of the `table_partition_description` have the same behavior as described for range partitions in [table_partition_description](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFBIHA). 
...
Reference partitioning is subject to the restrictions listed in [Restrictions on Partitioning in General](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABIICCD). The following additional restrictions apply: 
...
[Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG00224) for more information on partitioning by reference and "[Reference Partitioning Example](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABFDECD)"
...
Refer to [Oracle Database Data Cartridge Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI2801) for information on the uses for system partitioning and "[References to Partitioned Tables and Indexes](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.html#GUID-FED2E424-3F06-4B2B-88D2-DE043CA6E0E4)"
...
[Oracle Database Data Warehousing Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG8916) for more information on attribute clustering 
...
[CREATE MATERIALIZED ZONEMAP](CREATE-MATERIALIZED-ZONEMAP.html#GUID-1E5048FC-3D28-49BC-80FE-7871568B4702) for more information on zone maps 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1223) for more information on how the database maintains the least recently used (LRU) list 
...
[logging_clause](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E) for a description of the `logging_clause` when specified as part of `LOB_parameters`
...
See Also:
  ...
  * [Oracle Call Interface Programmer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNOCI10103) and [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1226) for general information about result caching 

  * [Oracle Database Performance Tuning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGDBA295) for information about using this clause 

  * Oracle Database Reference for information about the [`RESULT_CACHE_MODE`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10270) initialization parameter and the [`*_TABLES`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN23286) data dictionary views 

  * "[RESULT_CACHE Hint](Comments.html#GUID-F4B4ECC4-E1FE-40FB-AE05-D7B8AA001986)" and "[NO_RESULT_CACHE Hint](Comments.html#GUID-E3514C53-015B-4FF3-8C63-F37F3A14D8AF)" for information about the hints 
...
[parallel_clause](parallel_clause.html#GUID-59C9EBF3-A45E-4EE5-ABE7-0DA0FCF6C4B5) for more information on this clause 
...
[constraint](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE) for more information on constraints and "[Creating a Table: ENABLE/DISABLE Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153176)"

ENABLE Clause

Use this clause if you want the constraint to be applied to the data in the table. This clause is described fully in "[ENABLE Clause](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1010237)" in the documentation on constraints. 

DISABLE Clause

Use this clause if you want to disable the integrity constraint. This clause is described fully in "[DISABLE Clause](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1002349)" in the documentation on constraints. 
...
See Also:
  ...
  * [CREATE INDEX](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE) for a description of [index_attributes](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2075657), the [global_partitioned_index](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2150212) and [local_partitioned_index](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2135151) clauses, `NOSORT`, and the `logging_clause` in relation to indexes 

  * [constraint](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE) for information on the `using_index_clause` and on `PRIMARY` `KEY` and `UNIQUE` constraints 

  * "[Explicit Index Control Example](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1002834)" for an example of using an index to enforce a constraint 
...
See Also:
  ...
  * [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS01011) for general information on using Flashback Time Travel 

  * [ALTER FLASHBACK ARCHIVE](ALTER-FLASHBACK-ARCHIVE.html#GUID-285814C9-06ED-4BDB-BB19-E2BA6505C850) for information on changing the quota and retention attributes of the flashback archive, as well as adding or changing tablespace storage for the flashback archive 
...
See Also:
  ...
  * The `ALTER` `SESSION` [Semantics](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B__CCHEHEJJ) clause to learn how to configure row archival visibility for a session 

  * The `ALTER` `TABLE` [[NO] ROW ARCHIVAL](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJABCCEH) clause to learn how to enable or disable an existing table for row archival 
...
You can subsequently use the `exchange_partition_subpart` clause of `ALTER` `TABLE` to exchange partitions or subpartitions between the two tables. Refer to [exchange_partition_subpart](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__EXCHANGE_PARTITION_SUBPART-2C9E8EFA) in the documentation on `ALTER` `TABLE` for more information. 
...
For object tables, `subquery` can contain either one expression corresponding to the table type, or the number of top-level attributes of the table type. Refer to [SELECT](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) for more information. 
...
Oracle Database Data Warehousing Guide for more information on [materialized views](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG008) and [query rewrite](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG018)
...
See Also:
  ...
  * [Oracle Database SecureFiles and Large Objects Developer's Guide ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB008)for a discussion of why and when to copy `LONG` data to a LOB 

  * "[Conversion Functions](Single-Row-Functions.html#GUID-0E5115DD-F906-4F04-BB70-DF62DD4BBF91)" for a description of how to use the `TO_LOB` function 

  * [SELECT](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) for more information on the `order_by_clause`

  * [Oracle Database SQL Tuning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL344) for information on statistics gathering when using the `AS` `subquery` clause 
...
[storage_clause](physical_attributes_clause.html#GUID-A15063A9-3237-43D3-B0AE-D01F6E80B393__I1026834) for information on these parameters 
...
"[Object Column and Table Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2153366)"
...
See Also:
  ...
  * [CREATE TYPE](CREATE-TYPE.html#GUID-E72E3EE6-DE95-4F58-8941-E2F76D0EAE80) for more information about creating object types 

  * "[User-Defined Types](Data-Types.html#GUID-7CF27C66-9908-4C02-9401-06C2F2C4021C)", "[About User-Defined Functions](About-User-Defined-Functions.html#GUID-4EB3E236-8216-471C-BA44-23D87BDFEA67)", "[About SQL Expressions](About-SQL-Expressions.html#GUID-68789A5C-B142-496F-ADEE-837F75F95B2B)", [CREATE TYPE](CREATE-TYPE.html#GUID-E72E3EE6-DE95-4F58-8941-E2F76D0EAE80), and [Oracle Database Object-Relational Developer's Guide ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADOBJ00805)for more information about using `REF` types 
...
The semantics of these clauses are documented in the corresponding sections under relational tables. See [physical_properties](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128663) and [table_properties](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2128916). 
...
See Also:
  ...
  * [Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS377) for information on the `DBMS_XMLSCHEMA` package 

  * [Oracle XML DB Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB0400) for information on creating and working with XML data 

  * "[XMLType Table Examples](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2130736)"
...
See Also:
  ...
  * [Using Oracle Sharding](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SHARD-GUID-0F39B1FB-DCF9-4C8A-A2EA-88705B90C5BF)
...
When you insert into `persons` or `books`, you can specify values for the attributes of `person_t` or any of its subtypes. Examples of insert statements appear in "[Inserting into a Substitutable Tables and Columns: Examples](INSERT.html#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423__I2085891)". 

You can extract data from such tables using built-in functions and conditions. For examples, see the functions [TREAT](TREAT.html#GUID-037C0CD3-C256-4A02-80E0-C6F15147C5BF) and [SYS_TYPEID](SYS_TYPEID.html#GUID-4E3D45A1-7433-495D-9062-88505A1496E0), and the "[IS OF type Condition](IS-OF-type-Condition.html#GUID-7254E4C7-0194-4C1F-A3B2-2CFB0AD907CD)" condition. 
...
The following statement creates an external table that represents a subset of the sample table `hr`.`departments`. The `TYPE` clause specifies that the access driver type for the table is `ORACLE_LOADER`. The `ACCESS` `PARAMETERS()` clause specifies parameter values for the `ORACLE_LOADER` access driver. These parameters are shown in italics and form the `opaque_format_spec`. The syntax for `opaque_format_spec` depends on the access driver type and is outside the scope of this document. Refer to [Oracle Database Utilities](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SUTIL012) for details on the `ORACLE_LOADER` access driver and the `opaque_format_spec` syntax. 
...
"[Creating a Directory: Examples](CREATE-DIRECTORY.html#GUID-8E9C569A-1B06-42C4-9586-0EF83437001A__I2092417)" to see how the `admin` directory was created 

XMLType Examples

This section contains brief examples of creating an `XMLType` table or `XMLType` column. For a more expanded version of these examples, refer to "[Using XML in SQL Statements](Using-XML-in-SQL-Statements.html#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14)". 
...
The following example creates an XMLSchema-based table. The XMLSchema must already have been created (see "[Using XML in SQL Statements](Using-XML-in-SQL-Statements.html#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14)" for more information): 
...
See Also:
  ...
  * "[Using XML in SQL Statements](Using-XML-in-SQL-Statements.html#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14)" for an example of adding a constraint 

  * "[Creating an Index on an XMLType Table: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2113966)" for an example of creating an index 

  * "[Creating an XMLType View: Example](CREATE-VIEW.html#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30__I2117764)" for an example of creating an `XMLType` view 
...
For information about partitioned table maintenance operations, see [Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG003). 
