...
![Description of tz_offset.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tz_offset.gif)[Descriptionof the illustration tz_offset.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tz_offset.md)
