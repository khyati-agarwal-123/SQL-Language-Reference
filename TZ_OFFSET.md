##  TZ_OFFSET {#GUID-D2007072-34C2-4971-BD2B-64D93A3D7A31} 

Syntax 

![Description of tz_offset.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tz_offset.gif)[ Description of the illustration tz_offset.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tz_offset.md)
