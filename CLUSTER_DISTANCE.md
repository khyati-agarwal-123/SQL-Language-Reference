...
![Description of cluster_distance.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_distance.gif)[Description of the illustration cluster_distance.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_distance.html)

Analytic Syntax

cluster_distance_analytic::= 

![Description of cluster_distance_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_distance_analytic.gif)[Description of the illustration cluster_distance_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_distance_analytic.html)
