##  CLUSTER_DISTANCE {#GUID-21E611E3-2F15-4DF1-B648-9A36E8D5CE4D} 

Syntax 

*cluster_distance* ::= 

![Description of cluster_distance.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_distance.gif)[ Description of the illustration cluster_distance.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_distance.md)
...
The syntax of the ` CLUSTER_DISTANCE ` function can use an optional ` GROUPING ` hint when scoring a partitioned model. See [ GROUPING Hint ](Comments.md#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A) . 
