##  SET ROLE {#GUID-863F9B6F-82B4-4C49-8E3A-3BA33AE79CAB} 
...
![Description of set_role.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_role.gif)[ Description of the illustration set_role.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_role.md)
