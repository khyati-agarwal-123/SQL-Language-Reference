[Previous](ALTER-USER.html) [Next](ANALYZE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [CREATE VIEW](CREATE-VIEW.html#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30) for information on redefining a view and [ALTER MATERIALIZED VIEW](ALTER-MATERIALIZED-VIEW.html#GUID-29EE5682-AE42-4879-ABAD-E34E66ADD233) for information on revalidating an invalid materialized view 

  * [Oracle Database Data Warehousing Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG001) for general information on data warehouses 

  * [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1859) for more about dependencies among schema objects 
...
![Description of alter_view.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_view.gif)[Descriptionof the illustration alter_view.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_view.md)([out_of_line_constraint::=](constraint.md#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJADJGEC)âpart of [constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAEDFIB) syntax), [annotations_clause](annotations_clause.html#GUID-1AC16117-BBB6-4435-8794-2B99F8F68052)
...
Use the `MODIFY` `CONSTRAINT` clause to change the `RELY` or `NORELY` setting of an existing view constraint. Refer to "[Notes on View Constraints](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__BABFCAIF)" for general information on view constraints. 
...
Use the `ADD` clause to add a constraint to `view`. Refer to [constraint](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE) for information on view constraints and their restrictions. 
...
Use these clauses to specify whether the view becomes an editioned or noneditioned object if editioning is later enabled for the schema object type `VIEW` in `schema`. The default is `EDITIONABLE`. For information about altering editioned and noneditioned objects, see [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS1287). 

See Also:

[CREATE VIEW](CREATE-VIEW.html#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30) for information about editioning views 
...
To recompile the view `customer_ro` (created in "[Creating a Read-Only View: Example](CREATE-VIEW.html#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30__I2105040)"), issue the following statement: 
