...
![Description of fuzzy_match.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fuzzy_match.gif)[Descriptionof the illustration fuzzy_match.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fuzzy_match.md)
...
![Description of phonic_encode.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/phonic_encode.gif)[Descriptionof the illustration phonic_encode.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/phonic_encode.md)
