[Previous](User-Defined-Operators.html) [Next](graph_table-operator.html) JavaScript must be enabled to correctly display this content 
...
![Description of fuzzy_match.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fuzzy_match.gif)[Description of the illustration fuzzy_match.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fuzzy_match.html)
...
![Description of phonic_encode.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/phonic_encode.gif)[Description of the illustration phonic_encode.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/phonic_encode.html)
...
[← Previous](User-Defined-Operators.md)
