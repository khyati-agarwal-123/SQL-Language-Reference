...
![Description of stddev_pop.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stddev_pop.gif)[Descriptionof the illustration stddev_pop.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stddev_pop.md)
...
See Also:
  ...
  * "[Aggregate Functions](Aggregate-Functions.html#GUID-62BE676B-AF18-4E63-BD14-25206FEA0848)" and [VAR_POP](VAR_POP.html#GUID-B62FB4A4-BD1F-47B0-B412-31A98B70C2E4)* "[About SQL Expressions](About-SQL-Expressions.html#GUID-68789A5C-B142-496F-ADEE-837F75F95B2B)" for information on valid forms of `expr`
