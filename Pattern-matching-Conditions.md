...
![Description of like_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/like_condition.gif)[Description of the illustration like_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/like_condition.html)
...
![Description of regexp_like_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/regexp_like_condition.gif)[Description of the illustration regexp_like_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/regexp_like_condition.html)
...
See Also:
  ...
  * [LIKE Condition](Pattern-matching-Conditions.html#GUID-0779657B-06A8-441F-90C5-044B47862A0A)

  * [REGEXP_INSTR](REGEXP_INSTR.html#GUID-D21B53A1-83E2-4722-9BBB-638470715DD6) , [REGEXP_REPLACE](REGEXP_REPLACE.html#GUID-EA80A33C-441A-4692-A959-273B5A224490), and [REGEXP_SUBSTR](REGEXP_SUBSTR.html#GUID-2903904D-455F-4839-A8B2-1731EF4BD099) for functions that provide regular expression support 
