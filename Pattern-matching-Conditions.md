##  Pattern-matching Conditions {#GUID-3FA7F5AB-AC64-4200-8F90-294101428C26} 

The pattern-matching conditions compare character data. 

###  LIKE Condition {#GUID-0779657B-06A8-441F-90C5-044B47862A0A} 
...
![Description of like_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/like_condition.gif)[ Description of the illustration like_condition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/like_condition.md)
...
[ Table 6-8 ](Pattern-matching-Conditions.md#GUID-0779657B-06A8-441F-90C5-044B47862A0A__CJADEBJE) describes the ` LIKE ` conditions. 
...
###  REGEXP_LIKE Condition {#GUID-D2124F3A-C6E4-4CCA-A40E-2FFCABFD8E19} 
...
This condition complies with the POSIX regular expression standard and the Unicode Regular Expression Guidelines. For more information, refer to [ Oracle Regular Expression Support ](Oracle-Regular-Expression-Support.md#GUID-969230D6-FC1A-4C75-BF2A-6B1BE909DED6) . 
