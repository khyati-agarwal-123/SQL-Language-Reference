[Previous](SYSTIMESTAMP.html) [Next](TANH.html) JavaScript must be enabled to correctly display this content 
...
![Description of tan.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tan.gif)[Description of the illustration tan.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tan.html)
