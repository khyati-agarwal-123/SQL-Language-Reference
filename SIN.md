[Previous](SIGN.html) [Next](SINH.html) JavaScript must be enabled to correctly display this content 
...
![Description of sin.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sin.gif)[Description of the illustration sin.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sin.html)
