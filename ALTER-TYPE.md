...
![Description of alter_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_type.gif)[Description of the illustration alter_type.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_type.html)(`alter_type_clause`: See [Oracle Database PL/SQL Language Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNPLS2186) for the syntax of this clause.) 
