[Previous](Using-Extensible-Indexing.html) [Next](book-index.html) JavaScript must be enabled to correctly display this content 

  1. [SQL Language Reference ](index.html)2. [ Extended Examples](Extended-Examples.html)
...
See Also:
  ...
  * [XMLDATA Pseudocolumn](XMLDATA-Pseudocolumn.html#GUID-EBB52EE8-57B4-4DCA-A17E-351DE5CFA934) for information on the `XMLDATA` pseudocolumn 

  * "[Creating an XMLType View: Example](CREATE-VIEW.html#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30__I2117764)"* [Creating an Index on an XMLType Table: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2113966)
