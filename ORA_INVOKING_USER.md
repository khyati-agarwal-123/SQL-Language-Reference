[Previous](ORA_HASH.html) [Next](ORA_INVOKING_USERID.html) JavaScript must be enabled to correctly display this content 
...
![Description of ora_invoking_user.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_invoking_user.gif)[Description of the illustration ora_invoking_user.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_invoking_user.html)
