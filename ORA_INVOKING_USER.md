...
![Description of ora_invoking_user.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_invoking_user.gif)[Descriptionof the illustration ora_invoking_user.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_invoking_user.md)
