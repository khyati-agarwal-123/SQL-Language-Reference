...
![Description of sqrt.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sqrt.gif)[Descriptionof the illustration sqrt.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sqrt.md)
