##  RTRIM {#GUID-95A7DAFB-F7AB-48F4-BE24-64B3C7A840AA} 

Syntax 

![Description of rtrim.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rtrim.gif)[ Description of the illustration rtrim.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rtrim.md)
