[Previous](Literals.html) [Next](Nulls.html) JavaScript must be enabled to correctly display this content 
...
For lists of number and datetime format model elements, see [Table 2-16](Format-Models.html#GUID-096CA64F-1DA3-4C49-A18B-ECC7518EE56C__BABIGFBA "This table presents each Oracle built-in datatype \(middle column\), its description \(right-hand column\), and its code \(left-hand column\) used internally by Oracle.") and [Table 2-18](Format-Models.html#GUID-EAB212CF-C525-4ED8-9D3F-C76D08EEBC7A__CDEHIFJA "This table presents each Oracle built-in datatype \(middle column\), its description \(right-hand column\), and its code \(left-hand column\) used internally by Oracle."). 
...
See Also:
  ...
  * [ALTER SESSION](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B) for information on changing the values of these parameters and [Format Model Examples](Format-Models.html#GUID-A4CCA8BD-1679-432E-96BA-22FB46FF23E0) for examples of using format models 

  * [TO_CHAR (datetime)](TO_CHAR-datetime.html#GUID-0C3EEFD1-AE3D-452D-BF23-2FC95664E78F), [TO_CHAR (number)](TO_CHAR-number.html#GUID-00DA076D-2468-41AB-A3AC-CC78DBA0D9CB), and [TO_DATE](TO_DATE.html#GUID-D226FA7C-F7AD-41A0-BB1D-BD8EF9440118)* [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10128) and [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG003) for information on these parameters 
...
This remainder of this section describes how to use the following format models:
  ...
  * [Number Format Models](Format-Models.html#GUID-24E16D8D-25E4-4BD3-A38D-CE1399F2897C)* [Datetime Format Models](Format-Models.html#GUID-49B32A81-0904-433E-B7FE-51606672183A)

  * [Format Model Modifiers](Format-Models.html#GUID-7FF68D9E-C7E2-4CA1-9DDB-5CC7169EEEEA)
...
X | XXXX xxxx | Returns the hexadecimal value of the specified number of digits. If the specified number is not an integer, then Oracle Database rounds it to an integer. Restrictions: This element accepts only positive values or 0. Negative values return an error. You can precede this element only with 0 (which returns leading zeroes) or FM. Any other elements return an error. If you specify neither 0 nor FM with X, then the return always has one leading blank. Refer to the format model modifier FM for more information.  
  
[Table 2-17](Format-Models.html#GUID-096CA64F-1DA3-4C49-A18B-ECC7518EE56C__BABFJEAA "The first column shows actual numbers, the second column shows how that number appears in a format mask, and the third column shows the number returned by the combination of number and format mask.") shows the results of the following query for different values of `number` and `'fmt'`: 
...
[ALTER SESSION](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B) and [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG003) for information on the NLS parameters 

#### Datetime Format Elements 

A datetime format model is composed of one or more datetime format elements as listed in [Table 2-18](Format-Models.html#GUID-EAB212CF-C525-4ED8-9D3F-C76D08EEBC7A__CDEHIFJA "This table presents each Oracle built-in datatype \(middle column\), its description \(right-hand column\), and its code \(left-hand column\) used internally by Oracle."). 
  ...
  * Many datetime format elements are padded with blanks or leading zeroes to a specific length. Refer to the format model modifier [FM](Format-Models.html#GUID-7FF68D9E-C7E2-4CA1-9DDB-5CC7169EEEEA__BABDAEDF) for more information. 
...
[Format Model Modifiers](Format-Models.html#GUID-7FF68D9E-C7E2-4CA1-9DDB-5CC7169EEEEA) and [String-to-Date Conversion Rules](Format-Models.html#GUID-5B755E80-3CB2-4901-BBCF-F0FC764E0BB5) for more information 
...
[Table 2-19](Format-Models.html#GUID-515DFB76-E853-432F-BFEC-F1C62306BEC5__BABGDDFB "The first column shows literal suffixes that can be added to datetime format elements. The remaining columns describe the suffix and provide examples.") lists suffixes that can be added to datetime format elements: 
...
[Format Model Modifiers](Format-Models.html#GUID-7FF68D9E-C7E2-4CA1-9DDB-5CC7169EEEEA) for a description of the `fm` format element 
...
[Table 2-22](Format-Models.html#GUID-C6EB69EF-74DB-4C10-A02E-210D31616552__G195161 "The first column lists the attributes of the XMLFormat object type. The second and third column provide the datatype and purpose of each attribute, respectively.") lists and describes the attributes of the `XMLFormat` object. The function that implements this type follows the table. 

See Also:

  * [SYS_XMLAGG](SYS_XMLAGG.html#GUID-BEDD241D-360A-46A2-AEBF-C8B70E465D75) for information on the `SYS_XMLAgg` function 

  * [SYS_XMLGEN](SYS_XMLGEN.html#GUID-1AC25984-F4AB-468E-BF53-561275AD44E8) for information on the `SYS_XMLGen` function 

  * [Oracle XML DB Developerâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB1600) for more information on the implementation of the `XMLFormat` object and its use 
...
The data type for this attribute is `VARCHAR2(4000)` if the initialization parameter `MAX_STRING_SIZE` `=` `STANDARD`, and `VARCHAR2(32767)` if `MAX_STRING_SIZE` `=` `EXTENDED`. See [Extended Data Types](Data-Types.html#GUID-8EFA29E9-E8D8-40A6-A43E-954908C954A4) for more information. 
