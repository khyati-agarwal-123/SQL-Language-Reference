...
![Description of skewness_samp.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/skewness_samp.gif)[Descriptionof the illustration skewness_samp.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/skewness_samp.md)
