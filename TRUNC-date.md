##  TRUNC (datetime) {#GUID-BC82227A-2698-4EC8-8C1A-ABECC64B0E79} 

Syntax 

*trunc_datetime* ::= 

![Description of trunc_date.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/trunc_date.gif)[ Description of the illustration trunc_date.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/trunc_date.md)
