[Previous](TRIM.html) [Next](trunc-interval.html) JavaScript must be enabled to correctly display this content 
...
![Description of trunc_date.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/trunc_date.gif)[Description of the illustration trunc_date.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/trunc_date.html)
