##  CREATE DISKGROUP {#GUID-039A1373-1F3F-4A53-A152-8EBC348FB880} 
...
> **note:** See Also: 
  ...
  * [ ` V$ASM_OPERATION ` ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN30173) for information on monitoring Oracle ASM operations 
...
![Description of create_diskgroup.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_diskgroup.gif)[ Description of the illustration create_diskgroup.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_diskgroup.md)
...
Specify the name of the disk group. The name must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . However, disk groups are not schema objects. 
...
` NORMAL ` ` REDUNDANCY ` is the default if you omit the ` REDUNDANCY ` clause. Therefore, if you omit this clause, you must create at least two failure groups, or the create operation will fail. 
  ...
  * ` EXTENDED ` ` REDUNDANCY ` is a disk group that has all the features of a flex disk group in addition to being highly available in an extended cluster environment. The cluster contains nodes that span multiple physically separated sites. For more see [ About Oracle ASM Extended Disk Groups ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=OSMTG-GUID-5A0CD2C9-3BE4-45FB-B5B6-5CD58D7F89EA)
...
You cannot change the redundancy level after the disk group has been created, with the following exception: You can convert a normal or high redundancy disk group to a flex disk group. For more information, see the [ convert_redundancy_clause ](ALTER-DISKGROUP.md#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557__CONVERT_REDUNDANCY_CLAUSE-57C1BAB2) of ` ALTER ` ` DISKGROUP ` . 
...
[ *Oracle Automatic Storage Management Administrator's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=OSTMG137) for more information about quorum and regular disks and failure groups 
...
` ` The [ ` ASM_DISKSTRING ` ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10248) initialization parameter for more information on specifying the search string 
...
Use this clause to set attribute values for the disk group. You can view the current attribute values by querying the ` V$ASM_ATTRIBUTE ` view. [ Table 13-2 ](CREATE-DISKGROUP.md#GUID-039A1373-1F3F-4A53-A152-8EBC348FB880__BGEDFCIB) lists the attributes you can set with this clause. All attribute values are strings. 

**Table: Disk Group Attributes** 
...
Specify at least the first two digits of a valid Oracle Database release number. Refer to [ *Oracle Database Administrator's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN001) for information on specifying valid version numbers. For example, you can specify ` compatibility ` as '11.2' or '12.1'. 

> **note:** See Also: 

[ *Oracle Automatic Storage Management Administrator's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=OSTMG10045) for more information on managing these attribute settings 
