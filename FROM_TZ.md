##  FROM_TZ {#GUID-84384FF7-6462-480C-BC40-60087016857B} 

Syntax 

![Description of from_tz.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/from_tz.gif)[ Description of the illustration from_tz.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/from_tz.md)
