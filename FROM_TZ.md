[Previous](FLOOR.html) [Next](from_vector.html) JavaScript must be enabled to correctly display this content 
...
![Description of from_tz.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/from_tz.gif)[Description of the illustration from_tz.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/from_tz.html)
