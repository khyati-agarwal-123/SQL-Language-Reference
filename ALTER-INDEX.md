[Previous](ALTER-HIERARCHY.html) [Next](ALTER-INDEXTYPE.html) JavaScript must be enabled to correctly display this content 
...
[CREATE INDEX](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE) for information on creating an index 
...
![Description of alter_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_index.gif)[Descriptionof the illustration alter_index.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_index.md)([deallocate_unused_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128693), [allocate_extent_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEHEDB), [shrink_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEFECBA), [parallel_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEEFAG), [physical_attributes_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEJFAAH), [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF), [partial_index_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEDFJHI), [rebuild_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEJJJJ), [alter_index_partitioning::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128532)) 

(The `ODCI_parameters` are documented in [Oracle Database Data Cartridge Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI270).) 
...
![Description of rebuild_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rebuild_clause.gif)[Descriptionof the illustration rebuild_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rebuild_clause.md)([parallel_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEEFAG), [physical_attributes_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEJFAAH), [index_compression::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128566), [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF), [partial_index_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEDFJHI)) 

(The `ODCI_parameters` are documented in [Oracle Database Data Cartridge Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI270). The `XMLIndex_parameters_clause` is documented in [Oracle XML DB Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB0500). 
...
![Description of alter_index_partitioning.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_index_partitioning.gif)[Descriptionof the illustration alter_index_partitioning.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_index_partitioning.md)([modify_index_default_attrs::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2129868), [add_hash_index_partition::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEAJJI), [modify_index_partition::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGECEJHE), [rename_index_partition::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEFBIII), [drop_index_partition::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEDHDBA), [split_index_partition::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEHAAIB), [coalesce_index_partition::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEBFHBI), [modify_index_subpartition::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128786)) 

modify_index_default_attrs::= 

![Description of modify_index_default_attrs.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/modify_index_default_attrs.gif)[Descriptionof the illustration modify_index_default_attrs.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/modify_index_default_attrs.md)([physical_attributes_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEJFAAH), [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF)) 

add_hash_index_partition::= 

![Description of add_hash_index_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/add_hash_index_partition.gif)[Descriptionof the illustration add_hash_index_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/add_hash_index_partition.md)([index_compression::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128566), [parallel_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEEFAG)) 

coalesce_index_partition::= 

![Description of coalesce_index_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/coalesce_index_partition.gif)[Descriptionof the illustration coalesce_index_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/coalesce_index_partition.md)([parallel_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEEFAG)) 

modify_index_partition::= 

![Description of modify_index_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/modify_index_partition.gif)[Descriptionof the illustration modify_index_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/modify_index_partition.md)([deallocate_unused_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128693), [allocate_extent_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEHEDB), [physical_attributes_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEJFAAH), [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF), [index_compression::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128566)) 

rename_index_partition::= 

![Description of rename_index_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rename_index_partition.gif)[Descriptionof the illustration rename_index_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rename_index_partition.md)

drop_index_partition::= 

![Description of drop_index_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_index_partition.gif)[Descriptionof the illustration drop_index_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_index_partition.md)

split_index_partition::= 

![Description of split_index_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/split_index_partition.gif)[Descriptionof the illustration split_index_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/split_index_partition.md)([parallel_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEEFAG)) 

index_partition_description::= 

![Description of index_partition_description.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_partition_description.gif)[Descriptionof the illustration index_partition_description.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_partition_description.md)([segment_attributes_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEBDJGG), [index_compression::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128566)) 
...
![Description of segment_attributes_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/segment_attributes_clause.gif)[Descriptionof the illustration segment_attributes_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/segment_attributes_clause.md)([physical_attributes_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEJFAAH), `TABLESPACE` `SET`: not supported with `ALTER` `INDEX`, [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF)) 

modify_index_subpartition::= 

![Description of modify_index_subpartition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/modify_index_subpartition.gif)[Descriptionof the illustration modify_index_subpartition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/modify_index_subpartition.md)([allocate_extent_clause::=](ALTER-INDEX.md#GUID-D8F648E7-8C07-4C89-BB71-862512536558__BGEEHEDB), [deallocate_unused_clause::=](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2128693)) 
...
[Oracle Database Data Cartridge Developer's Guide ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI270)for information on the `LOADING` and `FAILED` states of domain indexes 

index_ilm_clause

Please refer to [index_ilm_clause](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__GUID-1F45221B-597D-424E-B629-8F6F0FAEE72C) in `CREATE INDEX` for full semantics. 
...
Refer to [deallocate_unused_clause](deallocate_unused_clause.html#GUID-016A106B-47D4-4FFF-8A3B-2DF19A5FE9FF) for a full description of this clause. 
...
Refer to [ALTER TABLE](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877) for a complete description of this clause. 
...
Refer to [allocate_extent_clause](allocate_extent_clause.html#GUID-DA6B3DC2-84B5-4404-AD96-5ABF7341580F) for a full description of this clause. 
...
For complete information on this clause, refer to [shrink_clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__I2192484) in the documentation on `CREATE` `TABLE`. 
...
"[Enabling Parallel Queries: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2135988)"
...
See Also:
  ...
  * the physical attributes parameters in [CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6)* "[Modifying Real Index Attributes: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2135975)" and "[Changing MAXEXTENTS: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2136067)"
...
See Also:
  ...
  * [Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG010) for more information about parallel DML 
...
[Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG004) for more information about partition maintenance operations and "[Rebuilding Unusable Index Partitions: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2136031)"
...
"[Storing Index Blocks in Reverse Order: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2135935)"
...
"[Rebuilding an Index in Parallel: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2135962)"
...
The `index_compression` clauses have the same semantics for `CREATE` `INDEX` and `ALTER` `INDEX`. For full information on these clauses, refer to [index_compression](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__BABHDBHE) in the documentation on `CREATE` `INDEX`. 
...
Refer to the [logging_clause](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E) for a full description of this clause. 
...
If you have installed Oracle Text, then you can rebuild your Oracle Text domain indexes using parameters specific to that product. For more information on those parameters, refer to [Oracle Text Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CCREF0101). 
...
See Also:
  ...
  * [Oracle Database Data Cartridge Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI270) for more information on indextype routines for domain indexes 
...
[Oracle XML DB Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB0500) for more information on `XMLIndex`, including the syntax and semantics of the `XMLIndex_parameters_clause`
...
The `CREATE` `INDEXTYPE` [storage_table_clause](CREATE-INDEXTYPE.html#GUID-4A7BD0EC-B3E5-4D1D-95C5-C8B52D01D8CE__BABEHBBD) and [Oracle Database Data Cartridge Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI290) for information on creating system-managed domain indexes 
...
Specify `UNUSABLE` to mark the index or index partition(s) or index subpartition(s) `UNUSABLE`. The space allocated for an index or index partition or subpartition is freed immediately when the object is marked `UNUSABLE`. An unusable index must be rebuilt, or dropped and re-created, before it can be used. While one partition is marked `UNUSABLE`, the other partitions of the index are still valid. You can execute statements that require the index if the statements do not access the unusable partition. You can also split or rename the unusable partition before rebuilding it. Refer to `CREATE` `INDEX` ... [USABLE | UNUSABLE](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__BABCHJDH) for more information. 
...
Use this clause to specify whether the index is visible or invisible to the optimizer. Refer to "[VISIBLE | INVISIBLE](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__BABBCCAA)" in `CREATE` `INDEX` for a full description of this clause. 
...
See Also:
  ...
  * [Building Domain Indexes](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI-GUID-E370B5E4-BAC0-49C6-B17D-830B3A507FB4) of the Data Cartridge Developer's Guide. 

  * [Extensible Indexing Interface](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI-GUID-78B9066F-6262-447D-80C1-EFB39C6930F1) of the Data Cartridge Developer's Guide. 

  * [Renaming an Index: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2136004)
...
To determine whether an index contains orphaned index entries, you can query the `ORPHANED_ENTRIES` column of the `USER_`, `DBA_`, `ALL_INDEXES` data dictionary views. Refer to [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN20088) for more information. 
...
See Also:
  ...
  * [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN014) for more information on space management and coalescing indexes 

  * [COALESCE Clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__CJAEDGDD) for information on coalescing the space of an index-organized table 

  * [shrink_clause](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__I2192484) for an alternative method of compacting index segments 
...
[Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN26958) for information on the `USER_OBJECT_USAGE` data dictionary view 
...
"[Modifying Default Attributes: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2136125)"
...
To determine whether an index partition contains orphaned index entries, you can query the `ORPHANED_ENTRIES` column of the `USER_`, `DBA_`, `ALL_PART_INDEXES` data dictionary views. Refer to [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN20086) for more information. 
...
"[Marking an Index Unusable: Examples](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2136020)"

UNUSABLE Clause

This clause has the same function for index partitions that it has for the index as a whole. Refer to "[USABLE | UNUSABLE](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2160588)". 
...
"[Renaming an Index Partition: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2136078)"
...
"[Dropping an Index Partition: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2100242)"
...
"[Splitting a Partition: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2136094)"
...
The following statement rebuilds index `ord_customer_ix` (created in "[Creating an Index: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2105550)") so that the bytes of the index block are stored in reverse order: 
...
The following statement sets the parallel attributes for index `upper_ix` (created in "[Creating a Function-Based Index: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2105548)") so that scans on the index will be parallelized: 
...
The following statements use the `cost_ix` index, which was created in "[Creating a Range-Partitioned Global Index: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2105538)". Partition `p1` of that index was dropped in "[Dropping an Index Partition: Example](ALTER-INDEX.html#GUID-D8F648E7-8C07-4C89-BB71-862512536558__I2100242)". The first statement marks index partition `p2` as `UNUSABLE`: 
...
The following statement renames an index partition of the `cost_ix` index (created in "[Creating a Range-Partitioned Global Index: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2105538)"): 
...
The following statement splits partition `p2` of index `cost_ix` (created in "[Creating a Range-Partitioned Global Index: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2105538)") into `p2a` and `p2b`: 
...
The following statement alters the default attributes of local partitioned index `prod_idx`, which was created in "[Creating an Index on a Hash-Partitioned Table: Example](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2105539)". Partitions added in the future will use 5 initial transaction entries: 
