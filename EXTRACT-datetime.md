##  EXTRACT (datetime) {#GUID-36E52BF8-945D-437D-9A3C-6860CABD210E} 

Syntax 

*extract_datetime* ::= 

![Description of extract_datetime.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/extract_datetime.gif)[ Description of the illustration extract_datetime.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/extract_datetime.md)
