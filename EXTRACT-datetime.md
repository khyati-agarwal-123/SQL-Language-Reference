...
![Description of extract_datetime.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/extract_datetime.gif)[Descriptionof the illustration extract_datetime.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/extract_datetime.md)
