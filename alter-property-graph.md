[Previous](ALTER-PROFILE.html) [Next](ALTER-RESOURCE-COST.html) JavaScript must be enabled to correctly display this content 
...
![Description of alter_property_graph.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_property_graph.gif)[Descriptionof the illustration alter_property_graph.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_property_graph.md)
