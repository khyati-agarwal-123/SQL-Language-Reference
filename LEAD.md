##  LEAD {#GUID-0A0481F1-E98F-4535-A739-FCCA8D1B5B77} 

Syntax 

![Description of lead.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lead.gif)[ Description of the illustration lead.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lead.md)

> **note:** See Also: 

" [ Analytic Functions ](Analytic-Functions.md#GUID-527832F7-63C0-4445-8C16-307FA5084056) "  for information on syntax, semantics, and restrictions, including valid forms of *value_expr* 
