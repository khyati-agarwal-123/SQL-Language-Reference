...
![Description of multiset_union.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/multiset_union.gif)[Descriptionof the illustration multiset_union.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/multiset_union.md)
