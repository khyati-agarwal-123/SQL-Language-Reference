[Previous](vector_serialize.html) [Next](WIDTH_BUCKET.html) JavaScript must be enabled to correctly display this content 
...
![Description of vsize.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/vsize.gif)[Description of the illustration vsize.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/vsize.html)
