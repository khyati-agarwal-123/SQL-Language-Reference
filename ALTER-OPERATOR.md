##  ALTER OPERATOR {#GUID-F00A0AC8-36C8-4EAC-A9BB-B3D42C5EEEDE} 
...
![Description of drop_binding_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_binding_clause.gif)[ Description of the illustration drop_binding_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_binding_clause.md)
...
You cannot use this clause to drop the only binding associated with this operator. Instead you must use the ` DROP ` ` OPERATOR ` statement. Refer to [ DROP OPERATOR ](DROP-OPERATOR.md#GUID-48E60BB4-9490-4B8B-B08E-D17EAEBDDD7E) for more information. 
...
The following example compiles the operator ` eq_op ` (which was created in  " [ Creating User-Defined Operators: Example ](CREATE-OPERATOR.md#GUID-62676C58-6F57-4572-8C09-7984A8E3EE9F__I2099937) "  ): 
