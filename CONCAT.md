##  CONCAT {#GUID-D8723EA5-C93A-45C3-83FB-1F3D2A4CEAF2} 

Syntax 

![Description of concat.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/concat.gif)[ Description of the illustration concat.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/concat.md)
