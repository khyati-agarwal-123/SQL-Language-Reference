...
![Description of to_char_number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_char_number.gif)[Descriptionof the illustration to_char_number.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_char_number.md)
