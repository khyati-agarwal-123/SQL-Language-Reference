...
![Description of nls_charset_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_charset_id.gif)[Descriptionof the illustration nls_charset_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_charset_id.md)
