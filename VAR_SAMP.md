##  VAR_SAMP {#GUID-314D5831-0E26-4ABF-9F46-35F78F97DA52} 

Syntax 

![Description of var_samp.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/var_samp.gif)[ Description of the illustration var_samp.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/var_samp.md)
...
Refer to the analytic example for [ VAR_POP ](VAR_POP.md#GUID-B62FB4A4-BD1F-47B0-B412-31A98B70C2E4) . 
