[Previous](SQL-Statements-ALTER-LIBRARY-to-ALTER-SESSION.html) [Next](ALTER-LOCKDOWN-PROFILE.html) JavaScript must be enabled to correctly display this content 
...
This statement does not change the declaration or definition of an existing library. To redeclare or redefine a library, use the "[CREATE LIBRARY](CREATE-LIBRARY.html#GUID-F042ABC9-2BF5-4E65-9D52-216D6228B288)" with the `OR` `REPLACE` clause. 
