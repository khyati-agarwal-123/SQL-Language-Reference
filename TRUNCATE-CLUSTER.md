[Previous](SET-TRANSACTION.html) [Next](TRUNCATE-TABLE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [DELETE](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7) and [DROP CLUSTER](DROP-CLUSTER.html#GUID-531F7DE2-AA2A-400E-BC9A-4CBEEA7B7156) for information on other ways of dropping data from a cluster 

  * [TRUNCATE TABLE](TRUNCATE-TABLE.html#GUID-B76E5846-75B5-4876-98EC-439E15E4D8A4) for information on truncating a table 
...
![Description of truncate_cluster.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/truncate_cluster.gif)[Descriptionof the illustration truncate_cluster.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/truncate_cluster.md)
