...
![Description of truncate_cluster.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/truncate_cluster.gif)[Description of the illustration truncate_cluster.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/truncate_cluster.html)
