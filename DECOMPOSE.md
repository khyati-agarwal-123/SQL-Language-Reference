##  DECOMPOSE {#GUID-3E772756-F12C-4827-99A5-F7CF4F11A25A} 

Syntax 

![Description of decompose.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/decompose.gif)[ Description of the illustration decompose.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/decompose.md)
