...
![Description of alter_materialized_zonemap.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_materialized_zonemap.gif)[Description of the illustration alter_materialized_zonemap.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_materialized_zonemap.html)

alter_zonemap_attributes::= 

![Description of alter_zonemap_attributes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_zonemap_attributes.gif)[Description of the illustration alter_zonemap_attributes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_zonemap_attributes.html)
