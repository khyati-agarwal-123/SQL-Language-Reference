[Previous](CORR.html) [Next](COS.html) JavaScript must be enabled to correctly display this content 
...
The significance of tau-b is the probability that the correlation indicated by tau-b was due to chanceâa value of 0 to 1. A small value indicates a significant correlation for positive values of tau-b (or anticorrelation for negative values of tau-b).
