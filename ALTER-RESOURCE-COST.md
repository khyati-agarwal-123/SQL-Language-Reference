[Previous](alter-property-graph.html) [Next](ALTER-ROLE.html) JavaScript must be enabled to correctly display this content 
...
[CREATE PROFILE](CREATE-PROFILE.html#GUID-ABC7AE4D-64A8-4EA9-857D-BEF7300B64C3) for information on all resources and on establishing resource limits 
...
![Description of alter_resource_cost.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_resource_cost.gif)[Descriptionof the illustration alter_resource_cost.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_resource_cost.md)
