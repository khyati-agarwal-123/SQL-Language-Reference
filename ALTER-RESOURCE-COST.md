...
![Description of alter_resource_cost.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_resource_cost.gif)[Description of the illustration alter_resource_cost.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_resource_cost.html)
