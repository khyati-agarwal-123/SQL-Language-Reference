[Previous](XMLCDATA.html) [Next](XMLCOMMENT.html) JavaScript must be enabled to correctly display this content 
...
![Description of xmlcolattval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlcolattval.gif)[Description of the illustration xmlcolattval.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlcolattval.html)
...
Refer to the example for [XMLFOREST](XMLFOREST.html#GUID-68E5C67E-CE97-4BF8-B7FF-2365E062C363) to compare the output of these two functions. 
