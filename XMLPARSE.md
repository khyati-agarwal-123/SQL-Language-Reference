...
![Description of xmlparse.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlparse.gif)[Descriptionof the illustration xmlparse.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlparse.md)
