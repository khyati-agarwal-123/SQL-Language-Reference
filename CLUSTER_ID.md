[Previous](CLUSTER_DISTANCE.html) [Next](CLUSTER_PROBABILITY.html) JavaScript must be enabled to correctly display this content 
...
![Description of cluster_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_id.gif)[Descriptionof the illustration cluster_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_id.md)

Analytic Syntax

cluster_id_analytic::= 

![Description of cluster_id_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_id_analytic.gif)[Descriptionof the illustration cluster_id_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_id_analytic.md)
...
The syntax of the `CLUSTER_ID` function can use an optional `GROUPING` hint when scoring a partitioned model. See [GROUPING Hint](Comments.html#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A). 
