...
![Description of cluster_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_id.gif)[Description of the illustration cluster_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_id.html)

Analytic Syntax

cluster_id_analytic::= 

![Description of cluster_id_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_id_analytic.gif)[Description of the illustration cluster_id_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_id_analytic.html)
