...
![Description of create_materialized_zonemap.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_materialized_zonemap.gif)[Description of the illustration create_materialized_zonemap.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_materialized_zonemap.html)

create_zonemap_on_table::= 

![Description of create_zonemap_on_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_zonemap_on_table.gif)[Description of the illustration create_zonemap_on_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_zonemap_on_table.html)

create_zonemap_as_subquery::= 

![Description of create_zonemap_as_subquery.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_zonemap_as_subquery.gif)[Description of the illustration create_zonemap_as_subquery.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_zonemap_as_subquery.html)

zonemap_attributes::= 

![Description of zonemap_attributes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/zonemap_attributes.gif)[Description of the illustration zonemap_attributes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/zonemap_attributes.html)

zonemap_refresh_clause::= 

![Description of zonemap_refresh_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/zonemap_refresh_clause.gif)[Description of the illustration zonemap_refresh_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/zonemap_refresh_clause.html)
