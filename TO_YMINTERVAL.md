[Previous](to_vector.html) [Next](TRANSLATE.html) JavaScript must be enabled to correctly display this content 
...
![Description of to_yminterval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_yminterval.gif)[Description of the illustration to_yminterval.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_yminterval.html)

ym_iso_format::= 

![Description of ym_iso_format.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ym_iso_format.gif)[Description of the illustration ym_iso_format.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ym_iso_format.html)
