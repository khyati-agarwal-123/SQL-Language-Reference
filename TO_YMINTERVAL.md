##  TO_YMINTERVAL {#GUID-5DEBA096-7AC3-4B18-A4BE-D36FC9BDB450} 

Syntax 

![Description of to_yminterval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_yminterval.gif)[ Description of the illustration to_yminterval.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_yminterval.md)

*ym_iso_format* ::= 

![Description of ym_iso_format.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ym_iso_format.gif)[ Description of the illustration ym_iso_format.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ym_iso_format.md)
