[Previous](TAN.html) [Next](TIMESTAMP_TO_SCN.html) JavaScript must be enabled to correctly display this content 
...
![Description of tanh.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tanh.gif)[Description of the illustration tanh.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tanh.html)
