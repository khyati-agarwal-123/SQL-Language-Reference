...
![Description of tanh.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tanh.gif)[Descriptionof the illustration tanh.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tanh.md)
