[Previous](GROUPING_ID.html) [Next](INITCAP.html) JavaScript must be enabled to correctly display this content 
...
![Description of hextoraw.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hextoraw.gif)[Description of the illustration hextoraw.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hextoraw.html)
...
"[RAW and LONG RAW Data Types](Data-Types.html#GUID-4FD497DD-3331-4C25-9147-3CEBEFDBFF22)" and [RAWTOHEX](RAWTOHEX.html#GUID-F86E3B5B-7FEE-47FD-A0C2-2FC55DC21C9E)
