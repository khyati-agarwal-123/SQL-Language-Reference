[Previous](TO_APPROX_PERCENTILE.html) [Next](TO_BINARY_FLOAT.html) JavaScript must be enabled to correctly display this content 
...
![Description of to_binary_double.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_binary_double.gif)[Description of the illustration to_binary_double.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_binary_double.html)
