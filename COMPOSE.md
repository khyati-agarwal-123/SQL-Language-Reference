##  COMPOSE {#GUID-A16E7D53-E7F8-46A6-B3F8-BA322D129019} 

Syntax 

![Description of compose.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/compose.gif)[ Description of the illustration compose.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/compose.md)
