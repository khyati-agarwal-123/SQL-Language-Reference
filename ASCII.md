##  ASCII {#GUID-871D4171-FF70-475E-BC82-9B8F46239A5D} 

Syntax 

![Description of ascii.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ascii.gif)[ Description of the illustration ascii.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ascii.md)
