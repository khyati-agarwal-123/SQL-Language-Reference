##  DROP OPERATOR {#GUID-48E60BB4-9490-4B8B-B08E-D17EAEBDDD7E} 
...
> **note:** See Also: 
  ...
  * " [ User-Defined Operators ](User-Defined-Operators.md#GUID-6025E56E-8429-42E2-B5A6-6048B5D1AF25) "  and [ *Oracle Database Data Cartridge Developer's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI2100) for more information on operators in general 
...
![Description of drop_operator.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_operator.gif)[ Description of the illustration drop_operator.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_operator.md)
