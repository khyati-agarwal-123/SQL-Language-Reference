...
![Description of approx_median.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_median.gif)[Descriptionof the illustration approx_median.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_median.md)
...
See Also:
  ...
  * [MEDIAN](MEDIAN.html#GUID-DE15705A-AC18-4416-8487-B9E1D70CE01A)* [APPROX_PERCENTILE](APPROX_PERCENTILE.html#GUID-70D54091-EE2F-4283-A10B-1AB5A1242FE2) which returns, for a given percentile, the approximate value that corresponds to that percentile by way of interpolation. `APPROX_MEDIAN` is the specific case of `APPROX_PERCENTILE` where the percentile value is 0.5. 
