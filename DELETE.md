[Previous](CREATE-VIEW.html) [Next](DISASSOCIATE-STATISTICS.html) JavaScript must be enabled to correctly display this content 
...
![Description of delete.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/delete.gif)[Description of the illustration delete.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/delete.html)([DML_table_expression_clause::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2122534), [where_clause::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2122549), [returning_clause::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2122564), [error_logging_clause::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__CEGCHDJF), [from_using_clause::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__SECTION_QS3_4WS_DYB)) 

DML_table_expression_clause::= 

![Description of dml_table_expression_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dml_table_expression_clause.gif)[Description of the illustration dml_table_expression_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dml_table_expression_clause.html)([partition_extension_clause::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__BABEAAJA), [subquery::=](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2126435), [subquery_restriction_clause::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2122580), [table_collection_expression::=](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2122595)) 
...
[Oracle Database Data Cartridge Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI4210) for more information on these routines 
...
"[References to Partitioned Tables and Indexes](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.html#GUID-FED2E424-3F06-4B2B-88D2-DE043CA6E0E4)" and "[Deleting Rows from a Partition: Example](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2126857)"
...
Starting with Oracle Database 12c Release 2 (12.2), the `DELETE` statement accepts remote LOB locators as bind variables. Refer to the âDistributed LOBsâ chapter in [Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB-GUID-7E450E86-3E4E-4714-A164-FD36B93722F6) for more information. 

See Also:

"[References to Objects in Remote Databases](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.html#GUID-61D0B206-A5EA-473F-AD04-7067D6E3914C)" for information on referring to database links and "[Deleting Rows from a Remote Database: Example](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2126841)"
...
[ALTER SESSION](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B)
...
Use the `where_clause` to delete only rows that satisfy the condition. The condition can reference the object from which you are deleting and can contain a subquery. You can delete rows from a remote object only if you are using Oracle Database distributed functionality. Refer to [Conditions](Conditions.html#GUID-C2E3ED44-16E7-4924-9125-E1693B1022A8) for the syntax of `condition`. 

If this clause contains a `subquery` that refers to remote objects, then the `DELETE` operation can run in parallel as long as the reference does not loop back to an object on the local database. However, if the `subquery` in the `DML_table_expression_clause` refers to any remote objects, then the `DELETE` operation will run serially without notification. Refer to the [parallel_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2159323) in the `CREATE` `TABLE` documentation for additional information. 
...
See Also:
  ...
  * "[Using the RETURNING Clause: Example](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7__I2126877)"
...
The `error_logging_clause` has the same behavior in `DELETE` statement as it does in an `INSERT` statement. Refer to the `INSERT` statement [error_logging_clause](INSERT.html#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423__BGBEIACB) for more information. 
...
For an example that deletes nested table rows, refer to "[Table Collections: Examples](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2071643)". 
...
The following statement deletes the rows from the table product_price_history where currency_code is âEURâ:
