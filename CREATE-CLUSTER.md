[Previous](CREATE-AUDIT-POLICY-Unified-Auditing.html) [Next](CREATE-CONTEXT.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT608) for general information on clusters 

  * [Oracle Database SQL Tuning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL850) for suggestions on when to use clusters 
...
![Description of create_cluster.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_cluster.gif)[Descriptionof the illustration create_cluster.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_cluster.md)([datatype::=](Data-Types.md#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483__SECTION_KLC_CHG_DDC),[physical_attributes_clause::=](CREATE-CLUSTER.md#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2127411), [size_clause::=](size_clause.html#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517__CHDEAIID), [cluster_range_partitions::=](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__CACHDBII)) 
...
![Description of cluster_range_partitions.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_range_partitions.gif)[Descriptionof the illustration cluster_range_partitions.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_range_partitions.md)([range_values_clause::=](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2125922), [table_partition_description::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2127282)) 
...
Specify is the name of the cluster to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
[CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) for information on adding tables to a cluster, "[Creating a Cluster: Example](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2105033)", and "[Adding Tables to a Cluster: Example](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2129354)"
...
"[Cluster Keys: Example](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2129341)"
...
"[Data Types](Data-Types.html#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483)" for information on data types 
...
If you omit this clause, then columns in the cluster key inherit the effective schema default collation of the schema containing the cluster. Refer to the [DEFAULT_COLLATION](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B__DEFAULT_COLLATION-39CF7241) clause of `ALTER` `SESSION` for more information on the effective schema default collation. 
...
See Also:
  ...
  * See "[HASHKEYS Clause](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2143441)" for information on creating a hash cluster. 

  * [Managing Hash Clusters](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-ADB821B7-70D2-4829-956A-F74436754BCF) for more information. 
...
[CREATE INDEX](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE) for information on creating a cluster index and [Oracle Database Concepts ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT608)for general information in indexed clusters 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT609) for more information on how Oracle Database allocates space for clusters and "[Hash Clusters: Examples](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2129365)"
...
"[Single-Table Hash Clusters: Example](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2129381)"
...
This clause has the same behavior for a cluster that it has for a table. Refer to "[NOROWDEPENDENCIES | ROWDEPENDENCIES](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJAEEGDA)" in `CREATE` `TABLE` for information. 
...
The `cluster_range_partitions` clause has the same semantics as the `range_partitions` clause of `CREATE` `TABLE`, except that here you cannot specify the `INTERVAL` clause. For complete information, refer to [range_partitions](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABJDACD) in the documentation on `CREATE` `TABLE`. 

See Also:

"[Range-Partitioned Hash Clusters: Example](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__CACCJEAG)"
