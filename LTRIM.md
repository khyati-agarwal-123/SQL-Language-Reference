##  LTRIM {#GUID-81B3D53C-0BBC-4485-B057-C8012CD6E40F} 

Syntax 

![Description of ltrim.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ltrim.gif)[ Description of the illustration ltrim.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ltrim.md)
