[Previous](SUBSTR.html) [Next](SYS_CONNECT_BY_PATH.html) JavaScript must be enabled to correctly display this content 
...
![Description of sum.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sum.gif)[Description of the illustration sum.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sum.html)
