##  SUM {#GUID-5610BE2C-CFE5-446F-A1F7-B924B5663220} 

Syntax 

![Description of sum.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sum.gif)[ Description of the illustration sum.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sum.md)
