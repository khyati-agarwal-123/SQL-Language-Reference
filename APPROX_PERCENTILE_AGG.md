...
![Description of approx_percentile_agg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_percentile_agg.gif)[Descriptionof the illustration approx_percentile_agg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_percentile_agg.md)
...
See Also:
  ...
  * [APPROX_PERCENTILE_DETAIL](APPROX_PERCENTILE_DETAIL.html#GUID-F9A0B9B5-671F-43CA-9FA7-69A2DD174F54)* [TO_APPROX_PERCENTILE](TO_APPROX_PERCENTILE.html#GUID-463702B2-9199-41ED-AE03-865CABAD3E23)
