...
![Description of set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set.gif)[Descriptionof the illustration set.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set.md)
