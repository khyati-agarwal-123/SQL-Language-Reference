##  SET {#GUID-533164AC-B4F0-4FCE-ADA4-85C925CB8D14} 

Syntax 

![Description of set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set.gif)[ Description of the illustration set.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set.md)
