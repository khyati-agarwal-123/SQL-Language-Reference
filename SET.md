[Previous](SESSIONTIMEZONE.html) [Next](SIGN.html) JavaScript must be enabled to correctly display this content 
...
![Description of set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set.gif)[Description of the illustration set.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set.html)
