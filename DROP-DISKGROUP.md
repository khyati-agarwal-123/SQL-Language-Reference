##  DROP DISKGROUP {#GUID-6F77FABB-3365-448F-8E2B-9B776904182C} 
...
![Description of drop_diskgroup.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_diskgroup.gif)[ Description of the illustration drop_diskgroup.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_diskgroup.md)
...
The following statement drops the Oracle ASM disk group ` dgroup_01 ` , which was created in  " [ Creating a Diskgroup: Example ](CREATE-DISKGROUP.md#GUID-039A1373-1F3F-4A53-A152-8EBC348FB880__CACIHAAD) "  , and all of the files in the disk group: 
