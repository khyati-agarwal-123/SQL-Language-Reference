[Previous](ora_shardspace_name-pseudocolumn.html) [Next](ROWNUM-Pseudocolumn.html) JavaScript must be enabled to correctly display this content 
...
Values of the `ROWID` pseudocolumn have the data type `ROWID` or `UROWID`. Refer to [Rowid Data Types](Data-Types.html#GUID-4231B94A-97E9-4B59-91EB-E7B2D0DA438C) and [UROWID Data Type](Data-Types.html#GUID-E9F3AE1C-AA6D-4262-A15F-778833251361) for more information. 
