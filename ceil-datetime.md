[Previous](CAST.html) [Next](ceil-interval.html) JavaScript must be enabled to correctly display this content 
...
![Description of ceil_datetimes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ceil_datetimes.gif)[Description of the illustration ceil_datetimes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ceil_datetimes.html)
