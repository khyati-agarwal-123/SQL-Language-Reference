[Previous](TO_NCHAR-character.html) [Next](TO_NCHAR-number.html) JavaScript must be enabled to correctly display this content 
...
![Description of to_nchar_date.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_nchar_date.gif)[Descriptionof the illustration to_nchar_date.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_nchar_date.md)
