##  TRUNCATE TABLE {#GUID-B76E5846-75B5-4876-98EC-439E15E4D8A4} 
...
" [ Restrictions on Truncating Tables ](TRUNCATE-TABLE.md#GUID-B76E5846-75B5-4876-98EC-439E15E4D8A4__CHDDGIHF) " 

Syntax 

*truncate_table* ::= 

![Description of truncate_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/truncate_table.gif)[ Description of the illustration truncate_table.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/truncate_table.md)
...
[ *Oracle Database Administrator’s Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-022C5C7F-2EC9-44CB-A74B-CC01600BCC17) for more information about materialized view logs and the ` TRUNCATE ` statement 
