[Previous](TRUNCATE-CLUSTER.html) [Next](UPDATE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [DELETE](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7) and [DROP TABLE](DROP-TABLE.html#GUID-39D89EDC-155D-4A24-837E-D45DDA757B45) for information on other ways of removing data from a table 

  * [TRUNCATE CLUSTER](TRUNCATE-CLUSTER.html#GUID-90C16956-644E-4E28-A53D-BB34ED630561) for information on truncating a cluster 
...
"[Restrictions on Truncating Tables](TRUNCATE-TABLE.html#GUID-B76E5846-75B5-4876-98EC-439E15E4D8A4__CHDDGIHF)"

Syntax 

truncate_table::= 

![Description of truncate_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/truncate_table.gif)[Descriptionof the illustration truncate_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/truncate_table.md)
...
[Oracle Database Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-022C5C7F-2EC9-44CB-A74B-CC01600BCC17) for more information about materialized view logs and the `TRUNCATE` statement 
...
This setting is useful as an alternative to deleting all rows of a very large tableâwhen the number of rows is very large, the table entails many thousands of extents, and when data is to be reinserted in the future.
