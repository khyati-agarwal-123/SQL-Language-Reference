[Previous](ALTER-MATERIALIZED-ZONEMAP.html) [Next](alter-mle-module.html) JavaScript must be enabled to correctly display this content 
...
![Description of alter_mle_env.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_mle_env.gif)[Descriptionof the illustration alter_mle_env.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_mle_env.md)
...
See Also:
  ...
  * [MLE JavaScript Modules and Environments](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MLEJS-GUID-32E2D1BB-37A0-4BA8-AD29-C967A8CA0CE1)* [CREATE MLE ENV](create-mle-env.html#GUID-419C81FD-338D-495F-85CD-135D4D316718)
