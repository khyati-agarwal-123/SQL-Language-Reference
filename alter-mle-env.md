...
![Description of alter_mle_env.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_mle_env.gif)[Description of the illustration alter_mle_env.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_mle_env.html)
...
See Also:
  ...
  * [MLE JavaScript Modules and Environments](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MLEJS-GUID-32E2D1BB-37A0-4BA8-AD29-C967A8CA0CE1)
