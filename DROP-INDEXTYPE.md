...
![Description of drop_indextype.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_indextype.gif)[Descriptionof the illustration drop_indextype.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_indextype.md)
