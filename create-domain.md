##  CREATE DOMAIN {#GUID-17D3A9C6-D993-4E94-BF6B-CACA56581F41} 
...
![Description of create_domain.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_domain.gif)[ Description of the illustration create_domain.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_domain.md)
...
![Description of enum_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enum_list.gif)[ Description of the illustration enum_list.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enum_list.md)
...
![Description of enum_item_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enum_item_list.gif)[ Description of the illustration enum_item_list.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enum_item_list.md)
...
![Description of enum_alias_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enum_alias_list.gif)[ Description of the illustration enum_alias_list.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enum_alias_list.md)
...
![Description of result_expr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/result_expr.gif)[ Description of the illustration result_expr.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/result_expr.md)
...
![Description of constraint_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/constraint_clause.gif)[ Description of the illustration constraint_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/constraint_clause.md)
