...
![Description of create_domain.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_domain.gif)[Description of the illustration create_domain.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_domain.html)
...
![Description of create_single_column_domain.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_single_column_domain.gif)[Description of the illustration create_single_column_domain.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_single_column_domain.html)([datatype::=](Data-Types.html#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483__SECTION_KLC_CHG_DDC)) 
...
![Description of enum_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enum_list.gif)[Description of the illustration enum_list.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enum_list.html)
...
![Description of enum_item_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enum_item_list.gif)[Description of the illustration enum_item_list.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enum_item_list.html)
...
![Description of enum_alias_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enum_alias_list.gif)[Description of the illustration enum_alias_list.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enum_alias_list.html)
...
![Description of column_properties_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/column_properties_clause.gif)[Description of the illustration column_properties_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/column_properties_clause.html)
...
![Description of create_flexible_domain.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_flexible_domain.gif)[Description of the illustration create_flexible_domain.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_flexible_domain.html)[datatype::=](Data-Types.html#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483__SECTION_KLC_CHG_DDC),[CASE Expressions](CASE-Expressions.html#GUID-CA29B333-572B-4E1D-BA64-851FABDBAE96)
...
![Description of result_expr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/result_expr.gif)[Description of the illustration result_expr.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/result_expr.html)
...
![Description of constraint_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/constraint_clause.gif)[Description of the illustration constraint_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/constraint_clause.html)
