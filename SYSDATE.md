##  SYSDATE {#GUID-807F8FC5-D72D-4F4D-B66D-B0FE1A8FA7D2} 

Syntax 

![Description of sysdate.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sysdate.gif)[ Description of the illustration sysdate.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sysdate.md)
