[Previous](SYS_XMLGEN.html) [Next](SYSTIMESTAMP.html) JavaScript must be enabled to correctly display this content 
...
![Description of sysdate.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sysdate.gif)[Description of the illustration sysdate.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sysdate.html)
