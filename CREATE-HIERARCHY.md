...
![Description of create_hierarchy.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_hierarchy.gif)[Description of the illustration create_hierarchy.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_hierarchy.html)
...
![Description of hier_using_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_using_clause.gif)[Description of the illustration hier_using_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_using_clause.html)

level_hier_clause::= 

![Description of level_hier_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_hier_clause.gif)[Description of the illustration level_hier_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_hier_clause.html)

hier_attrs_clause::= 

![Description of hier_attrs_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_attrs_clause.gif)[Description of the illustration hier_attrs_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_attrs_clause.html)

hier_attr_clause::= 

![Description of hier_attr_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_attr_clause.gif)[Description of the illustration hier_attr_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_attr_clause.html)

hier_attr_name::= 

![Description of hier_attr_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_attr_name.gif)[Description of the illustration hier_attr_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_attr_name.html)
