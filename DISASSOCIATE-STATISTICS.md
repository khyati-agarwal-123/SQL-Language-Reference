...
![Description of disassociate_statistics.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/disassociate_statistics.gif)[Descriptionof the illustration disassociate_statistics.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/disassociate_statistics.md)
