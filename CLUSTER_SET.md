[Previous](CLUSTER_PROBABILITY.html) [Next](COALESCE.html) JavaScript must be enabled to correctly display this content 
...
![Description of cluster_set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_set.gif)[Descriptionof the illustration cluster_set.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_set.md)

Analytic Syntax

cluster_set_analytic::= 

![Description of cluster_set_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_set_analytic.gif)[Descriptionof the illustration cluster_set_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_set_analytic.md)
...
The syntax of the `CLUSTER_SET` function can use an optional `GROUPING` hint when scoring a partitioned model. See [GROUPING Hint](Comments.html#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A). 
