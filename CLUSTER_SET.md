...
![Description of cluster_set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_set.gif)[Description of the illustration cluster_set.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_set.html)

Analytic Syntax

cluster_set_analytic::= 

![Description of cluster_set_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_set_analytic.gif)[Description of the illustration cluster_set_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_set_analytic.html)
