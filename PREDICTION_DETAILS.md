##  PREDICTION_DETAILS {#GUID-D7261A56-E729-4882-B48D-CDD343C53810} 

Syntax 

*prediction_details* ::= 

![Description of prediction_details.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_details.gif)[ Description of the illustration prediction_details.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_details.md)
...
The syntax of the ` PREDICTION_DETAILS ` function can use an optional ` GROUPING ` hint when scoring a partitioned model. See [ GROUPING Hint ](Comments.md#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A) . 
