[Previous](PREDICTION_COST.html) [Next](PREDICTION_PROBABILITY.html) JavaScript must be enabled to correctly display this content 
...
![Description of prediction_details.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_details.gif)[Descriptionof the illustration prediction_details.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_details.md)

prediction_details_ordered::= 

![Description of prediction_details_ordered.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_details_ordered.gif)[Descriptionof the illustration prediction_details_ordered.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_details_ordered.md)

Analytic Syntax

prediction_details_analytic::= 

![Description of prediction_details_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_details_analytic.gif)[Descriptionof the illustration prediction_details_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_details_analytic.md)
...
The syntax of the `PREDICTION_DETAILS` function can use an optional `GROUPING` hint when scoring a partitioned model. See [GROUPING Hint](Comments.html#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A). 
