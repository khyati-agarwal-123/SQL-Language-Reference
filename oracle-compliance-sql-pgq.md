[Previous](oracle-compliance-sql-mda.html) [Next](Oracle-Compliance-with-FIPS-127-2.html) JavaScript must be enabled to correctly display this content 
...
Table [Table C-4](oracle-compliance-sql-pgq.html#GUID-2984AEEA-BB05-4209-B144-57DB2B8D5878__TABLE_TWG_1FW_LBC "SQL/PGQ support") describes Oracle's support for the features of SQL/PGQ. 
