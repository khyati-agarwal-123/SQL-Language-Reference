[Previous](Comments.html) [Next](Database-Object-Names-and-Qualifiers.html) JavaScript must be enabled to correctly display this content 
...
In this reference, each type of object is described in the section devoted to the statement that creates the database object. These statements begin with the keyword `CREATE`. For example, for the definition of a cluster, see [CREATE CLUSTER](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7). 
