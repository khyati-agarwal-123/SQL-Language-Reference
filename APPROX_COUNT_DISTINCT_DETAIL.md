[Previous](APPROX_COUNT_DISTINCT_AGG.html) [Next](APPROX_MEDIAN.html) JavaScript must be enabled to correctly display this content 
...
![Description of approx_count_distinct_detail.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_count_distinct_detail.gif)[Description of the illustration approx_count_distinct_detail.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_count_distinct_detail.html)
