[Previous](ALTER-VIEW.html) [Next](ASSOCIATE-STATISTICS.html) JavaScript must be enabled to correctly display this content 
...
If you want to collect optimizer statistics, use the `DBMS_STATS` package, which lets you collect statistics in parallel, global statistics for partitioned objects, and helps you fine tune your statistics collection in other ways. See [Oracle Database PL/SQL Packages and Types Reference ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS059)for more information on the `DBMS_STATS` package. 
...
![Description of analyze.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/analyze.gif)[Descriptionof the illustration analyze.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/analyze.md)
...
![Description of validation_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/validation_clauses.gif)[Descriptionof the illustration validation_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/validation_clauses.md)

into_clause::= 

![Description of into_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/into_clause.gif)[Descriptionof the illustration into_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/into_clause.md)
...
Specify a table to be analyzed. When you analyze a table, the database collects statistics about expressions occurring in any function-based indexes as well. Therefore, be sure to create function-based indexes on the table before analyzing the table. Refer to [CREATE INDEX](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE) for more information about function-based indexes. 
...
See Also:
  ...
  * [ASSOCIATE STATISTICS](ASSOCIATE-STATISTICS.html#GUID-BD02BA6A-32A7-4093-A6B6-BAE860C0F834)* [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN-GUID-8865F65B-EF6D-44A5-B0A1-3179EFF0C36A) for information on the data dictionary views 
...
Note:
  ...
  * In some cases, analyzing an index with the `ANALYZE` statement takes an inordinate amount of time to complete. In these cases, you can use a SQL query to validate the index. If the query determines that there is an inconsistency between a table and the index, then you can use the `ANALYZE` statement for a thorough analysis of the index. Refer to [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN14215) for more information. 
...
See Also:
  ...
  * [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN-GUID-8865F65B-EF6D-44A5-B0A1-3179EFF0C36A) for information on the data dictionary views 

  * "[Analyzing an Index: Example](ANALYZE.html#GUID-535CE98E-2359-4147-839F-DCB3772C1B0E__I2154661)"
...
[Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN-GUID-8865F65B-EF6D-44A5-B0A1-3179EFF0C36A) for information on the data dictionary views and "[Analyzing a Cluster: Example](ANALYZE.html#GUID-535CE98E-2359-4147-839F-DCB3772C1B0E__I2115909)"
...
[Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN11526) for more information about validating tables, indexes, clusters, and materialized views 
...
"[Validating a Table: Example](ANALYZE.html#GUID-535CE98E-2359-4147-839F-DCB3772C1B0E__I2115898)"* For a table, Oracle Database verifies the integrity of each of the data blocks and rows. For an index-organized table, the database also generates compression statistics (optimal prefix compression count) for the primary key index on the table.
  ...
  * For an index, Oracle Database verifies the integrity of each data block in the index and checks for block corruption. This clause does not confirm that each row in the table has an index entry or that each index entry points to a row in the table. You can perform these operations by validating the structure of the table with the [CASCADE](ANALYZE.html#GUID-535CE98E-2359-4147-839F-DCB3772C1B0E__I2111178) clause. 
...
[Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN-GUID-8865F65B-EF6D-44A5-B0A1-3179EFF0C36A) for information on these views 
...
See Also:
  ...
  * The `DBMS_IOT` package in [Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS018) for information on the packaged SQL scripts 

  * "[Listing Chained Rows: Example](ANALYZE.html#GUID-535CE98E-2359-4147-839F-DCB3772C1B0E__I2115921)"
...
"[Deleting Statistics: Example](ANALYZE.html#GUID-535CE98E-2359-4147-839F-DCB3772C1B0E__I2115827)"
...
The following statement analyzes the `personnel` cluster (created in "[Creating a Cluster: Example](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2105033)"), all of its tables, and all of their indexes, including the cluster index: 
