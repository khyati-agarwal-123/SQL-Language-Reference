...
![Description of analyze.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/analyze.gif)[Description of the illustration analyze.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/analyze.html)
...
![Description of validation_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/validation_clauses.gif)[Description of the illustration validation_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/validation_clauses.html)

into_clause::= 

![Description of into_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/into_clause.gif)[Description of the illustration into_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/into_clause.html)
...
See Also:
  ...
  * [ASSOCIATE STATISTICS](ASSOCIATE-STATISTICS.html#GUID-BD02BA6A-32A7-4093-A6B6-BAE860C0F834)
...
"[Validating a Table: Example](ANALYZE.html#GUID-535CE98E-2359-4147-839F-DCB3772C1B0E__I2115898)"
