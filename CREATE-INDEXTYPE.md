##  CREATE INDEXTYPE {#GUID-4A7BD0EC-B3E5-4D1D-95C5-C8B52D01D8CE} 
...
![Description of create_indextype.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_indextype.gif)[ Description of the illustration create_indextype.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_indextype.md)

*using_type_clause* ::= 

![Description of using_type_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_type_clause.gif)[ Description of the illustration using_type_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_type_clause.md)

*array_DML_clause* ::= 

![Description of array_dml_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/array_dml_clause.gif)[ Description of the illustration array_dml_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/array_dml_clause.md)
...
Specify the name of the indextype to be created. The name must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . 
