...
![Description of json_object.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_object.gif)[Description of the illustration json_object.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_object.html)
...
![Description of json_object_content.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_object_content.gif)[Description of the illustration json_object_content.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_object_content.html)
...
![Description of entry.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/entry.gif)[Description of the illustration entry.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/entry.html)
...
![Description of regular_entry.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/regular_entry.gif)[Description of the illustration regular_entry.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/regular_entry.html)
...
![Description of format_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/format_clause.gif)[Description of the illustration format_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/format_clause.html)
...
![Description of wildcard.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/wildcard.gif)[Description of the illustration wildcard.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/wildcard.html)
