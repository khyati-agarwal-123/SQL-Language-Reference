##  ALTER MATERIALIZED VIEW {#GUID-29EE5682-AE42-4879-ABAD-E34E66ADD233} 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Administrator’s Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-A422B474-4BED-4A60-AEDB-E93630746083) for information on materialized views in a replication environment 
...
![Description of annotations_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/annotations_clause.gif)[ Description of the illustration annotations_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/annotations_clause.md)
...
![Description of annotations_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/annotations_list.gif)[ Description of the illustration annotations_list.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/annotations_list.md)
...
![Description of annotation.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/annotation.gif)[ Description of the illustration annotation.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/annotation.md)
...
![Description of annotation_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/annotation_name.gif)[ Description of the illustration annotation_name.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/annotation_name.md)
...
![Description of annotation_value.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/annotation_value.gif)[ Description of the illustration annotation_value.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/annotation_value.md)
...
![Description of alter_mv_refresh.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_mv_refresh.gif)[ Description of the illustration alter_mv_refresh.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_mv_refresh.md)
...
Specify new values for the ` PCTFREE ` , ` PCTUSED ` , and ` INITRANS ` parameters (or, when used in the ` USING ` ` INDEX ` clause, for the ` INITRANS ` parameter only) and the storage characteristics for the materialized view. Refer to [ ALTER TABLE ](ALTER-TABLE.md#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877) for information on the ` PCTFREE ` , ` PCTUSED ` , and ` INITRANS ` parameters and to *storage_clause* for information about storage characteristics. 
...
" [ Complete Refresh: Example ](ALTER-MATERIALIZED-VIEW.md#GUID-29EE5682-AE42-4879-ABAD-E34E66ADD233__I2226866) " 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Administrator’s Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-31D07B2A-4B42-4B26-BB6F-0BA90FC0FB0D) for detailed information about primary key materialized views 
...
" [ Compiling a Materialized View: Example ](ALTER-MATERIALIZED-VIEW.md#GUID-29EE5682-AE42-4879-ABAD-E34E66ADD233__I2226906) " 
...
" [ Splitting Table Partitions: Examples ](ALTER-TABLE.md#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877__I2110367) "  for a partitioning maintenance example that would require this ` ALTER ` ` MATERIALIZED ` ` VIEW ` example 
