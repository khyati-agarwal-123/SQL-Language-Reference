[Previous](Compound-Expressions.html) [Next](Column-Expressions.html) JavaScript must be enabled to correctly display this content 
...
![Description of case_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/case_expression.gif)[Description of the illustration case_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/case_expression.html)

simple_case_expression::= 

![Description of simple_case_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/simple_case_expression.gif)[Description of the illustration simple_case_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/simple_case_expression.html)

searched_case_expression::= 

![Description of searched_case_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/searched_case_expression.gif)[Description of the illustration searched_case_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/searched_case_expression.html)

else_clause::= 

![Description of else_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/else_clause.gif)[Description of the illustration else_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/else_clause.html)
...
See Also:
  ...
  * Appendix C in [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-AFCE41ED-775B-4A00-AF38-C436776AE0C5) for the collation derivation and determination rules for the `CASE` expression 

  * [Numeric Precedence](Data-Types.html#GUID-4C0B65DB-E751-4957-A1ED-5044BAFA7812) for information on numeric precedence 

  * [COALESCE](COALESCE.html#GUID-3F9007A7-C0CA-4707-9CBA-1DBF2CDE0C87) and [NULLIF](NULLIF.html#GUID-445FC268-7FFA-4850-98C9-D53D88AB2405) for alternative forms of `CASE` logic 

  * [Oracle Database Data Warehousing Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG02012) for examples using various forms of the `CASE` expression 
