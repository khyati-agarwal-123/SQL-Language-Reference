...
![Description of case_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/case_expression.gif)[Descriptionof the illustration case_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/case_expression.md)

simple_case_expression::= 

![Description of simple_case_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/simple_case_expression.gif)[Descriptionof the illustration simple_case_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/simple_case_expression.md)

searched_case_expression::= 

![Description of searched_case_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/searched_case_expression.gif)[Descriptionof the illustration searched_case_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/searched_case_expression.md)

else_clause::= 

![Description of else_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/else_clause.gif)[Descriptionof the illustration else_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/else_clause.md)
