##  CASE Expressions {#GUID-CA29B333-572B-4E1D-BA64-851FABDBAE96} 

` CASE ` expressions let you use ` IF ` ... ` THEN ` ... ` ELSE ` logic in SQL statements without having to invoke procedures. The syntax is: 

![Description of case_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/case_expression.gif)[ Description of the illustration case_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/case_expression.md)
...
![Description of else_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/else_clause.gif)[ Description of the illustration else_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/else_clause.md)
