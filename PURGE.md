[Previous](NOAUDIT-Unified-Auditing.html) [Next](RENAME.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [FLASHBACK TABLE](FLASHBACK-TABLE.html#GUID-FA9AF2FD-2DAD-4387-9E62-14AFC26EA85C) for information on retrieving dropped tables from the recycle bin 

  * [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10264) for information on using the `RECYCLEBIN` initialization parameter to control whether dropped tables go into the recycle bin 
...
![Description of purge.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/purge.gif)[Descriptionof the illustration purge.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/purge.md)
