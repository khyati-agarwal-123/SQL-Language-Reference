[Previous](CREATE-DATABASE.html) [Next](CREATE-DIMENSION.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS00907) for information about accessing remote tables or views with PL/SQL functions, procedures, packages, and data types 

  * [Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN029) for information on distributed database systems 
  ...
  * [ALTER DATABASE LINK](ALTER-DATABASE-LINK.html#GUID-0259D771-9D04-4D86-A94D-61B621A3918A) for information on altering a database link when the password of a connection or authentication user changes. 

  * [DROP DATABASE LINK](DROP-DATABASE-LINK.html#GUID-89856C55-29FB-4B52-84A9-E53B8D115864) for information on dropping existing database links 

  * [INSERT](INSERT.html#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423), [UPDATE](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5), [DELETE](DELETE.html#GUID-156845A5-B626-412B-9F95-8869B988ABD7), and [LOCK TABLE](LOCK-TABLE.html#GUID-4C00C6D9-C5C5-46CC-AD33-A64001744A4C) for using links in DML operations 
...
![Description of create_database_link.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_database_link.gif)[Descriptionof the illustration create_database_link.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_database_link.md)([dblink::=](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.md#GUID-3B6E39A1-A538-4A8C-A314-932851A22777__BABGJDDB)) 

dblink_authentication::= 

![Description of dblink_authentication.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dblink_authentication.gif)[Descriptionof the illustration dblink_authentication.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dblink_authentication.md)
...
[Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN029) for more information about shared database links 
...
"[Defining a Public Database Link: Example](CREATE-DATABASE-LINK.html#GUID-D966642A-B19E-449D-9968-1121AF06D793__I2133775)"
...
See Also:
  ...
  * [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=GUID-FD266F6F-D047-4EBB-8D96-B51B1DCA2D61) for information on the `GLOBAL_NAMES`, `OPEN_LINKS`, and `OPEN_LINKS_PER_INSTANCE` initialization parameters 

  * "[RENAME GLOBAL_NAME Clause](ALTER-DATABASE.html#GUID-8069872F-E680-4511-ADD8-A4E30AF67986__I2141769)" (an `ALTER` `DATABASE` clause) for information on changing the database global name 
...
See Also:
  ...
  * [CREATE FUNCTION](CREATE-FUNCTION.html#GUID-156AEDAC-ADD0-4E46-AA56-6D1F7CA63306) for more information on invoker-rights functions 

  * "[Defining a CURRENT_USER Database Link: Example](CREATE-DATABASE-LINK.html#GUID-D966642A-B19E-449D-9968-1121AF06D793__I2143859)"
...
[Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN029) for information on specifying remote databases 
