...
![Description of create_database_link.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_database_link.gif)[Description of the illustration create_database_link.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_database_link.html)([dblink::=](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.html#GUID-3B6E39A1-A538-4A8C-A314-932851A22777__BABGJDDB)) 

dblink_authentication::= 

![Description of dblink_authentication.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dblink_authentication.gif)[Description of the illustration dblink_authentication.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dblink_authentication.html)
