[Previous](CREATE-PFILE.html) [Next](create-pmem-filestore.html) JavaScript must be enabled to correctly display this content 
...
When you create a PDB, you can specify new names for any potential colliding service names. See the clause [service_name_convert](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__SERVICE_NAME_CONVERT-5754C12A). If you discover a service name collision after a PDB is created, you must not attempt to operate the PDB that causes a collision with an existing service name. If the colliding name is that of the PDB's default service, then you must rename the PDB. If the colliding name is that of a user-created service within the PDB, then you must drop that service and create one in its place, with a non-colliding name, that has the same purpose and properties. 

See Also:

  * [Oracle Multitenant Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI) for more information on multi-tenant architecture and concepts. 

  * [ALTER PLUGGABLE DATABASE](ALTER-PLUGGABLE-DATABASE.html#GUID-A29491AD-8F0F-4E52-9D94-57FC3FF8FBC7) and [DROP PLUGGABLE DATABASE](DROP-PLUGGABLE-DATABASE.html#GUID-4A663783-E184-417A-8BE1-703E1CDBA30B) for information on modifying and dropping PDBs 
...
See [Oracle Multitenant Administratorâs Guide ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-B26D56E1-B958-444F-864C-8AFDFF1566A6) for more information on the prerequisites to PDB creation. 

Syntax

create_pluggable_database::= 

![Description of create_pluggable_database.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pluggable_database.gif)[Descriptionof the illustration create_pluggable_database.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pluggable_database.md)([create_pdb_from_seed::=](CREATE-PLUGGABLE-DATABASE.md#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBFIDF), [create_pdb_clone::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHDFDDG), [create_pdb_from_xml::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHEJDJD)) 

create_pdb_from_seed::= 

![Description of create_pdb_from_seed.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pdb_from_seed.gif)[Descriptionof the illustration create_pdb_from_seed.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pdb_from_seed.md)([pdb_dba_roles::=](CREATE-PLUGGABLE-DATABASE.md#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHJEJCB), [parallel_pdb_creation_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__PARALLEL_PDB_CREATION-53B657E9), [default_tablespace::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBCAJI), [file_name_convert::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHIICFG), [service_name_convert::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__SERVICE_NAME_CONVERT-575466E9), [pdb_storage_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBHJEI), [path_prefix_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHGABFD), [tempfile_reuse_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBAFHJ), [user_tablespaces_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACEADIC), [standbys_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACBFHBB), [logging_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACGFJGB), [create_file_dest_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACGJDFB)) 

pdb_dba_roles::= 

![Description of pdb_dba_roles.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pdb_dba_roles.gif)[Descriptionof the illustration pdb_dba_roles.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pdb_dba_roles.md)

parallel_pdb_creation_clause::= 

![Description of parallel_pdb_creation_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/parallel_pdb_creation_clause.gif)[Descriptionof the illustration parallel_pdb_creation_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/parallel_pdb_creation_clause.md)

default_tablespace::= 

![Description of default_tablespace.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/default_tablespace.gif)[Descriptionof the illustration default_tablespace.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/default_tablespace.md)([datafile_tempfile_spec::=](file_specification.md#GUID-580FA726-F712-4410-90CF-783A2DA89688__CHDHEGJH), [extent_management_clause::=](CREATE-DATABASE.html#GUID-ECE717DF-F116-4151-927C-2E51BB9DD39C__BGEIBGJH)) 
...
![Description of file_name_convert.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/file_name_convert.gif)[Descriptionof the illustration file_name_convert.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/file_name_convert.md)

service_name_convert::= 

![Description of service_name_convert.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/service_name_convert.gif)[Descriptionof the illustration service_name_convert.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/service_name_convert.md)

path_prefix_clause::= 

![Description of path_prefix_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/path_prefix_clause.gif)[Descriptionof the illustration path_prefix_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/path_prefix_clause.md)

tempfile_reuse_clause::= 

![Description of tempfile_reuse_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tempfile_reuse_clause.gif)[Descriptionof the illustration tempfile_reuse_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tempfile_reuse_clause.md)

user_tablespaces_clause::= 

![Description of user_tablespaces_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/user_tablespaces_clause.gif)[Descriptionof the illustration user_tablespaces_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/user_tablespaces_clause.md)

standbys_clause::= 

![Description of standbys_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/standbys_clause.gif)[Descriptionof the illustration standbys_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/standbys_clause.md)
...
![Description of create_file_dest_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_file_dest_clause.gif)[Descriptionof the illustration create_file_dest_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_file_dest_clause.md)

create_pdb_clone::= 

![Description of create_pdb_clone.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pdb_clone.gif)[Descriptionof the illustration create_pdb_clone.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pdb_clone.md)([parallel_pdb_creation_clause::=](CREATE-PLUGGABLE-DATABASE.md#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__PARALLEL_PDB_CREATION-53B657E9), [default_tablespace::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBCAJI), [pdb_storage_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBHJEI), [file_name_convert::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHIICFG), [service_name_convert::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__SERVICE_NAME_CONVERT-575466E9), [path_prefix_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHGABFD), [tempfile_reuse_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBAFHJ), [user_tablespaces_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACEADIC), [standbys_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACBFHBB), [logging_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACGFJGB), [create_file_dest_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACGJDFB), [keystore_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__KEYSTORE_CLAUSE-5AD7BB55), [pdb_refresh_mode_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__PDB_REFRESH_MODE_CLAUSE-532F10A5)) 

keystore_clause::= 

![Description of keystore_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/keystore_clause.gif)[Descriptionof the illustration keystore_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/keystore_clause.md)
...
![Description of create_pdb_from_xml.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pdb_from_xml.gif)[Descriptionof the illustration create_pdb_from_xml.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pdb_from_xml.md)([source_file_name_convert::=](CREATE-PLUGGABLE-DATABASE.md#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHEJFID), [source_file_directory::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACIAJHI), [file_name_convert::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHIICFG), [service_name_convert::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__SERVICE_NAME_CONVERT-575466E9), [default_tablespace::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBCAJI), [pdb_storage_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBHJEI), [path_prefix_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHGABFD), [tempfile_reuse_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBAFHJ), [user_tablespaces_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACEADIC), [standbys_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACBFHBB), [logging_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACGFJGB), [create_file_dest_clause::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACGJDFB)) 

create_pdb_from_mirror_copy::= 

![Description of create_pdb_from_mirror_copy.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pdb_from_mirror_copy.gif)[Descriptionof the illustration create_pdb_from_mirror_copy.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pdb_from_mirror_copy.md)

using_snapshot_clause ::= 

![Description of using_snapshot_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_snapshot_clause.gif)[Descriptionof the illustration using_snapshot_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_snapshot_clause.md)

container_map_clause ::= 

![Description of container_map_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/container_map_clause.gif)[Descriptionof the illustration container_map_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/container_map_clause.md)
...
![Description of source_file_name_convert.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/source_file_name_convert.gif)[Descriptionof the illustration source_file_name_convert.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/source_file_name_convert.md)

source_file_directory::= 

![Description of source_file_directory.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/source_file_directory.gif)[Descriptionof the illustration source_file_directory.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/source_file_directory.md)

create_pdb_decrypt_from_xml::= 

![Description of create_pdb_decrypt_from_xml.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pdb_decrypt_from_xml.gif)[Descriptionof the illustration create_pdb_decrypt_from_xml.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pdb_decrypt_from_xml.md)

Semantics

pdb_name

Specify the name of the PDB to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". The first character of a PDB name must be an alphabet character. The remaining characters can be alphanumeric or the underscore character (`_`). 
...
[Creating and Removing Application Containers and Seeds ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-E2B95068-D16D-438D-9A0B-974540988990)
...
[Creating a PDB from Scratch](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-CCA938BD-52BE-422C-86AF-576D3E02B96B)
...
This clause lets you grant one or more roles to the `PDB_DBA` role. Use this clause to grant roles that have the privileges required by the administrative user of the PDB. For `role`, specify a predefined role. For a list of predefined roles, refer to [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG4414). 
...
If you specify this clause, then Oracle Database creates a smallfile tablespace and sets it as the default permanent tablespace for the PDB. Oracle Database will assign the default tablespace to any non-`SYSTEM` user for whom a different permanent tablespace is not specified. The `default_tablespace` clause has the same semantics that it has for the `CREATE` `DATABASE` statement. For full information, refer to [default_tablespace](CREATE-DATABASE.html#GUID-ECE717DF-F116-4151-927C-2E51BB9DD39C__I2186890) in the documentation on `CREATE` `DATABASE`. 
...
When creating a tablespace, you can override the default logging attribute by specifying the [logging_clause](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9__CJAICHIG) of the `CREATE` `TABLESPACE` statement. 
...
The clause [AS PROXY FROM](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__ASPROXYFROM-562EA9D6) of `create_pdb_clone` for information on creating a proxy PDB 
...
[Cloning a PDB ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-05702CEB-A43C-452C-8081-4CA68DDA8007)
...
[Creating a PDB as a Proxy PDB ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-4453DF44-5D16-4581-9CBF-0C7BCA85DE82)
...
Use this clause to specify storage limits for the new PDB. Refer to [pdb_storage_clause](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACJAAGI) for the full semantics of this clause. 

file_name_convert

Use this clause to determine how the database generates the names of files for the new PDB. Refer to [file_name_convert](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CACHDCDF) for the full semantics of this clause. 

service_name_convert

Use this clause to determine how the database renames services for the new PDB. Refer to [service_name_convert::=](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__SERVICE_NAME_CONVERT-575466E9) for the full semantics of this clause. 

path_prefix_clause

Use this clause to ensure that all directory object paths associated with the PDB are restricted to the specified directory or its subdirectories. Refer to [path_prefix_clause](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHIIGHJ) for the full semantics of this clause. 

tempfile_reuse_clause

Specify `TEMPFILE` `REUSE` to instruct the database to format and reuse a temp file associated with the new PDB if it already exists. Refer to [tempfile_reuse_clause](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__CCHBGHCI) for the full semantics of this clause. 
...
See Also:
  ...
  * `ALTER` `PLUGGABLE` `DATABASE` [REFRESH](ALTER-PLUGGABLE-DATABASE.html#GUID-A29491AD-8F0F-4E52-9D94-57FC3FF8FBC7__REFRESH-2AECEDD3) for information on refreshing a PDB manually 

  * `ALTER` `PLUGGABLE` `DATABASE` [pdb_refresh_mode_clause](ALTER-PLUGGABLE-DATABASE.html#GUID-A29491AD-8F0F-4E52-9D94-57FC3FF8FBC7__PDB_REFRESH_MODE_CLAUSE-531D291C) for information on changing the refresh mode of a PDB 

  * [Oracle Database Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN-GUID-B99FE87D-151B-4350-84B3-BB5E7150E414) for more information on refreshable PDBs 
...
[Relocating a PDB ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-75519361-3DA2-4558-A7E5-64BC16FAFC7D)
...
These clauses are useful only if you are creating a PDB that you plan to reference from a proxy PDB. This type of PDB is called a referenced PDB. Refer to [HOST and PORT](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC__HOST-562D36AD) for the full semantics of these clauses. 
...
See Also:
  ...
  * [Plugging In an Unplugged PDB ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-3132C4E5-8734-458B-8B0C-EFC77A45FFA3)* [Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS73527) for more information on the `DBMS_PDB` package 
...
See Also:
  ...
  * [pdb_unplug_clause](ALTER-PLUGGABLE-DATABASE.html#GUID-A29491AD-8F0F-4E52-9D94-57FC3FF8FBC7__PDB_UNPLUG_CLAUSEPDBSUNPLUGGING-2AEE4D78) of `ALTER` `PLUGGABLE` `DATABASE`

  * [Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS73527) for more information on the `DBMS_PDB` package 
