##  CREATE ATTRIBUTE DIMENSION {#GUID-62722AB0-2136-4BC9-8E76-CBEA13C15196} 
...
![Description of join_path_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/join_path_clause.gif)[ Description of the illustration join_path_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/join_path_clause.md)

*join_condition* ::= 

![Description of join_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/join_condition.gif)[ Description of the illustration join_condition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/join_condition.md)

*join_condition_elem* ::= 

![Description of join_condition_elem.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/join_condition_elem.gif)[ Description of the illustration join_condition_elem.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/join_condition_elem.md)

*attributes_clause* ::= 

![Description of attributes_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/attributes_clause.gif)[ Description of the illustration attributes_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/attributes_clause.md)
...
![Description of key_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/key_clause.gif)[ Description of the illustration key_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/key_clause.md)

*alternate_key_clause* ::= 

![Description of alternate_key_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alternate_key_clause.gif)[ Description of the illustration alternate_key_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alternate_key_clause.md)

*dim_order_clause* ::= 

![Description of dim_order_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_order_clause.gif)[ Description of the illustration dim_order_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_order_clause.md)

*all_clause* ::= 

![Description of all_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/all_clause.gif)[ Description of the illustration all_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/all_clause.md)
