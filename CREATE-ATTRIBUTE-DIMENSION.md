...
![Description of create_attribute_dimension.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_attribute_dimension.gif)[Description of the illustration create_attribute_dimension.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_attribute_dimension.html)
...
![Description of attr_dim_using_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/attr_dim_using_clause.gif)[Description of the illustration attr_dim_using_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/attr_dim_using_clause.html)
...
![Description of join_path_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/join_path_clause.gif)[Description of the illustration join_path_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/join_path_clause.html)

join_condition::= 

![Description of join_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/join_condition.gif)[Description of the illustration join_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/join_condition.html)

join_condition_elem ::= 

![Description of join_condition_elem.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/join_condition_elem.gif)[Description of the illustration join_condition_elem.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/join_condition_elem.html)

attributes_clause::= 

![Description of attributes_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/attributes_clause.gif)[Description of the illustration attributes_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/attributes_clause.html)

attr_dim_attributes_clause::= 

![Description of attr_dim_attribute_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/attr_dim_attribute_clause.gif)[Description of the illustration attr_dim_attribute_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/attr_dim_attribute_clause.html)

attr_dim_level_clause::= 

![Description of attr_dim_level_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/attr_dim_level_clause.gif)[Description of the illustration attr_dim_level_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/attr_dim_level_clause.html)

key_clause::= 

![Description of key_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/key_clause.gif)[Description of the illustration key_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/key_clause.html)

alternate_key_clause::= 

![Description of alternate_key_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alternate_key_clause.gif)[Description of the illustration alternate_key_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alternate_key_clause.html)

dim_order_clause::= 

![Description of dim_order_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_order_clause.gif)[Description of the illustration dim_order_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_order_clause.html)

all_clause::= 

![Description of all_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/all_clause.gif)[Description of the illustration all_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/all_clause.html)
