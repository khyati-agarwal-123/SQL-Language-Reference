##  About SQL Operators {#GUID-CF1DBF8D-966F-4E5E-8AC8-9BF777B984D8} 
...
###  Unary and Binary Operators {#GUID-6A0C265F-3A7E-4E1C-8F79-8C6BCA26CFBA} 
...
###  Operator Precedence {#GUID-FEF44762-F45C-41D9-B380-F6A61AD25338} 
...
[ Table 4-1 ](About-SQL-Operators.md#GUID-FEF44762-F45C-41D9-B380-F6A61AD25338__BCFJDBDD) lists the levels of precedence among SQL operators from high to low. Operators listed on the same line have the same precedence. 
...
[ Hierarchical Query Operators ](Hierarchical-Query-Operators.md#GUID-4CC13EEB-846A-4254-93FC-E91E678BD302) and [ Hierarchical Queries ](Hierarchical-Queries.md#GUID-0118DF1D-B9A9-41EB-8556-C6E7D6A5A84E) for information on the ` PRIOR ` operator, which is used only in hierarchical queries 
