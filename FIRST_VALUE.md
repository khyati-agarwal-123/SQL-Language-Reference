##  FIRST_VALUE {#GUID-D454EC3F-370C-4C64-9B11-33FCB10D95EC} 

Syntax 

![Description of first_value.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/first_value.gif)[ Description of the illustration first_value.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/first_value.md)
...
You cannot nest analytic functions by using ` FIRST_VALUE ` or any other analytic function for *expr* . However, you can use other built-in function expressions for *expr* . Refer to  " [ About SQL Expressions ](About-SQL-Expressions.md#GUID-68789A5C-B142-496F-ADEE-837F75F95B2B) "  for information on valid forms of *expr* . 
