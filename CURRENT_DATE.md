...
![Description of current_date.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/current_date.gif)[Descriptionof the illustration current_date.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/current_date.md)
