...
![Description of bitmap_bucket_number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_bucket_number.gif)[Descriptionof the illustration bitmap_bucket_number.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_bucket_number.md)
