[Previous](BITMAP_BIT_POSITION.html) [Next](BITMAP_CONSTRUCT_AGG.html) JavaScript must be enabled to correctly display this content 
...
![Description of bitmap_bucket_number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_bucket_number.gif)[Description of the illustration bitmap_bucket_number.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_bucket_number.html)
