...
![Description of json_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_condition.gif)[Description of the illustration json_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_condition.html)
...
![Description of is_json_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_json_condition.gif)[Description of the illustration is_json_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_json_condition.html)
...
![Description of is_json_args.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_json_args.gif)[Description of the illustration is_json_args.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_json_args.html)
...
![Description of json_modifier_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_modifier_list.gif)[Description of the illustration json_modifier_list.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_modifier_list.html)
...
![Description of json_column_modifier.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_column_modifier.gif)[Description of the illustration json_column_modifier.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_column_modifier.html)
...
![Description of json_scalar_modifier.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_scalar_modifier.gif)[Description of the illustration json_scalar_modifier.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_scalar_modifier.html)
...
![Description of json_equal_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_equal_condition.gif)[Description of the illustration json_equal_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_equal_condition.html)
...
![Description of json_exists_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_exists_condition.gif)[Description of the illustration json_exists_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_exists_condition.html)(`JSON_basic_path_expression`: See [Oracle Database JSON Developerâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-8241AE93-89BE-40E6-89E2-8F9C1A9244F4)) 

JSON_passing_clause::= 

![Description of json_passing_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_passing_clause.gif)[Description of the illustration json_passing_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_passing_clause.html)

JSON_exists_on_error_clause::= 

![Description of json_exists_on_error_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_exists_on_error_clause.gif)[Description of the illustration json_exists_on_error_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_exists_on_error_clause.html)

JSON_exists_on_empty_clause::= 

![Description of json_exists_on_empty_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_exists_on_empty_clause.gif)[Description of the illustration json_exists_on_empty_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_exists_on_empty_clause.html)
...
![Description of json_textcontains_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_textcontains_condition.gif)[Description of the illustration json_textcontains_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_textcontains_condition.html)(`JSON_basic_path_expression`: See [Oracle Database JSON Developerâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-8241AE93-89BE-40E6-89E2-8F9C1A9244F4)) 
