##  SQL For JSON Conditions {#GUID-08C75404-6E58-4EBE-A8B4-0B6041B0DB63} 
...
![Description of json_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_condition.gif)[ Description of the illustration json_condition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_condition.md)

###  IS JSON Condition {#GUID-99B9493D-2929-4A09-BA39-A56F8E7319DA} 
...
![Description of is_json_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_json_condition.gif)[ Description of the illustration is_json_condition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_json_condition.md)
...
![Description of is_json_args.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_json_args.gif)[ Description of the illustration is_json_args.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_json_args.md)
...
![Description of json_modifier_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_modifier_list.gif)[ Description of the illustration json_modifier_list.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_modifier_list.md)
...
![Description of json_column_modifier.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_column_modifier.gif)[ Description of the illustration json_column_modifier.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_column_modifier.md)
...
![Description of json_scalar_modifier.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_scalar_modifier.gif)[ Description of the illustration json_scalar_modifier.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_scalar_modifier.md)
  ...
  * If you specify ` STRICT ` , then this condition considers only strict JSON syntax to be well-formed JSON data. If you specify ` LAX ` , then this condition also considers lax JSON syntax to be well-formed JSON data. The default is ` LAX ` . Refer to [ *Oracle Database JSON Developer’s Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-1B6CFFBE-85FE-41DD-BA14-DD1DE73EAB20) for more information on strict and lax JSON syntax. 
...
###  JSON_EQUAL Condition {#GUID-35C7012D-FCDB-4106-88C1-CABA78326896} 

Syntax 

![Description of json_equal_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_equal_condition.gif)[ Description of the illustration json_equal_condition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_equal_condition.md)
...
> **note:** See Also: 
  ...
  * [ *Oracle Database JSON Developer’s Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN) for more information. 




###  JSON_EXISTS Condition {#GUID-57762C80-0C8A-4B18-9BA7-9B3F5ABDC988} 
...
###  JSON_TEXTCONTAINS Condition {#GUID-DEF7941B-1267-44E7-8514-5CD448503179} 
