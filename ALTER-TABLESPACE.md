...
![Description of datafile_tempfile_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/datafile_tempfile_clauses.gif)[Description of the illustration datafile_tempfile_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/datafile_tempfile_clauses.html)([file_specification::=](file_specification.html#GUID-580FA726-F712-4410-90CF-783A2DA89688__CJADEBBF)). 

tablespace_logging_clauses::= 

![Description of tablespace_logging_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tablespace_logging_clauses.gif)[Description of the illustration tablespace_logging_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tablespace_logging_clauses.html)([logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF)) 
...
![Description of tablespace_state_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tablespace_state_clauses.gif)[Description of the illustration tablespace_state_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tablespace_state_clauses.html)

autoextend_clause::= 

![Description of autoextend_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/autoextend_clause.gif)[Description of the illustration autoextend_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/autoextend_clause.html)([size_clause::=](size_clause.html#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517__CHDEAIID)) 
...
![Description of alter_tablespace_encryption.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_tablespace_encryption.gif)[Description of the illustration alter_tablespace_encryption.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_tablespace_encryption.html)([tablespace_encryption_spec::=](ALTER-TABLESPACE.html#GUID-CA074861-55D3-4768-8995-43D4DA26365D__TABLESPACE_ENCRYPTION_SPEC-5AD7225F), [ts_file_name_convert::=](ALTER-TABLESPACE.html#GUID-CA074861-55D3-4768-8995-43D4DA26365D__TS_FILE_NAME_CONVERT-5AD72585)) 
...
![Description of ts_file_name_convert.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ts_file_name_convert.gif)[Description of the illustration ts_file_name_convert.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ts_file_name_convert.html)
