[Previous](DROP-PACKAGE.html) [Next](drop-pmem-filestore.html) JavaScript must be enabled to correctly display this content 
...
![Description of drop_pluggable_database.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_pluggable_database.gif)[Descriptionof the illustration drop_pluggable_database.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_pluggable_database.md)
...
[Removing a PDB](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MULTI-GUID-AE0FC673-3D8C-417E-B671-B2CE465E8DC3)
