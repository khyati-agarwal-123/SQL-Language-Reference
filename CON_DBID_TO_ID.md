##  CON_DBID_TO_ID {#GUID-9F38A14F-8E6A-4A4A-96D5-52E4480A8926} 

Syntax 

![Description of con_dbid_to_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_dbid_to_id.gif)[ Description of the illustration con_dbid_to_id.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_dbid_to_id.md)
