[Previous](EXISTSNODE.html) [Next](EXTRACT-datetime.html) JavaScript must be enabled to correctly display this content 
...
![Description of exp.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/exp.gif)[Description of the illustration exp.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/exp.html)
