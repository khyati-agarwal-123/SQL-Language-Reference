[Previous](ALTER-PLUGGABLE-DATABASE.html) [Next](ALTER-PROCEDURE.html) JavaScript must be enabled to correctly display this content 
...
![Description of alter_pmem_fs.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_pmem_fs.gif)[Descriptionof the illustration alter_pmem_fs.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_pmem_fs.md)  
