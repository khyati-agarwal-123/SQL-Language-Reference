...
![Description of alter_pmem_fs.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_pmem_fs.gif)[Description of the illustration alter_pmem_fs.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_pmem_fs.html)  
