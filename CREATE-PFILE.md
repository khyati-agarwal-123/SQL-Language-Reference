...
![Description of create_pfile.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pfile.gif)[Description of the illustration create_pfile.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pfile.html)
