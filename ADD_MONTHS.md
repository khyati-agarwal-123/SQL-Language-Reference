[Previous](ACOS.html) [Next](ANY_VALUE.html) JavaScript must be enabled to correctly display this content 
...
![Description of add_months.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/add_months.gif)[Description of the illustration add_months.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/add_months.html)
