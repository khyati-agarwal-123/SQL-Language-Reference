...
![Description of add_months.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/add_months.gif)[Descriptionof the illustration add_months.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/add_months.md)
