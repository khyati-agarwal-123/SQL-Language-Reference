...
![Description of approx_count_distinct.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_count_distinct.gif)[Descriptionof the illustration approx_count_distinct.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_count_distinct.md)
