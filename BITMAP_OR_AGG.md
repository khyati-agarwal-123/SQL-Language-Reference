[Previous](BITMAP_COUNT.html) [Next](BIT_OR_AGG.html) JavaScript must be enabled to correctly display this content 
...
![Description of bitmap_or_agg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_or_agg.gif)[Description of the illustration bitmap_or_agg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_or_agg.html)
