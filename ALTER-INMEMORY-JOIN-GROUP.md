##  ALTER INMEMORY JOIN GROUP {#GUID-AF24F413-BB14-4B5D-93BF-9EB31ACFEBEC} 
...
The following example adds a column to the ` prod_id1 ` join group created in [ Examples ](CREATE-INMEMORY-JOIN-GROUP.md#GUID-87CA7034-4F80-4D46-8EE1-5CC865C2D676__EXAMPLES-439B00F8) in the documentation on ` CREATE ` ` INMEMORY ` ` JOIN ` ` GROUP ` : 
