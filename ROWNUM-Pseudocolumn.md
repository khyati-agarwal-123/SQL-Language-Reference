[Previous](ROWID-Pseudocolumn.html) [Next](XMLDATA-Pseudocolumn.html) JavaScript must be enabled to correctly display this content 
...
Note:
  ...
  * The `ROW_NUMBER` built-in SQL function provides superior support for ordering the results of a query. Refer to [ROW_NUMBER](ROW_NUMBER.html#GUID-D5A157F8-0F53-45BD-BF8C-AE79B1DB8C41) for more information. 

  * The `row_limiting_clause` of the `SELECT` statement provides superior support for limiting the number of rows returned by a query. Refer to [row_limiting_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__BABHFGAA) for more information. 
...
Refer to the function [ROW_NUMBER](ROW_NUMBER.html#GUID-D5A157F8-0F53-45BD-BF8C-AE79B1DB8C41) for an alternative method of assigning unique numbers to rows. 
