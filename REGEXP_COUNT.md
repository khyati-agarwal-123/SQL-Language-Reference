##  REGEXP_COUNT {#GUID-5148AF2E-9CED-497D-A78D-3A7847A45276} 

Syntax 

![Description of regexp_count.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/regexp_count.gif)[ Description of the illustration regexp_count.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/regexp_count.md)
...
` REGEXP_COUNT ` ignores subexpression parentheses in *pattern* . For example, the pattern ` '(123(45))' ` is equivalent to ` '12345' ` . For a listing of the operators you can specify in *pattern* , refer to [ Oracle Regular Expression Support ](Oracle-Regular-Expression-Support.md#GUID-969230D6-FC1A-4C75-BF2A-6B1BE909DED6) . 
