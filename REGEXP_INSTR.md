[Previous](REGEXP_COUNT.html) [Next](REGEXP_REPLACE.html) JavaScript must be enabled to correctly display this content 
...
![Description of regexp_instr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/regexp_instr.gif)[Descriptionof the illustration regexp_instr.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/regexp_instr.md)
...
See Also:
  ...
  * [INSTR](INSTR.html#GUID-47E3A7C4-ED72-458D-A1FA-25A9AD3BE113) and [REGEXP_SUBSTR](REGEXP_SUBSTR.html#GUID-2903904D-455F-4839-A8B2-1731EF4BD099)* [REGEXP_REPLACE](REGEXP_REPLACE.html#GUID-EA80A33C-441A-4692-A959-273B5A224490) and [REGEXP_LIKE Condition](Pattern-matching-Conditions.html#GUID-D2124F3A-C6E4-4CCA-A40E-2FFCABFD8E19)* Appendix C in [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-AFCE41ED-775B-4A00-AF38-C436776AE0C5) for the collation determination rules, which define the collation `REGEXP_INSTR` uses to compare characters from `source_char` with characters from `pattern`
...
View and run related examples on Oracle Live SQL at [REGEXP_INSTR pattern matching](https://livesql.oracle.com/apex/livesql/docs/sqlrf/regexp_instr/find-location.md)
