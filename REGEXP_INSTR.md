##  REGEXP_INSTR {#GUID-D21B53A1-83E2-4722-9BBB-638470715DD6} 

Syntax 

![Description of regexp_instr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/regexp_instr.gif)[ Description of the illustration regexp_instr.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/regexp_instr.md)
