##  COMMENT {#GUID-65F447C4-6914-4823-9691-F15D52DB74D7} 
...
![Description of comment.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/comment.gif)[ Description of the illustration comment.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/comment.md)
...
Specify the text of the comment. Refer to  " [ Text Literals ](Literals.md#GUID-1824CBAA-6E16-4921-B2A6-112FB02248DA) "  for a syntax description of *'string'* . 
