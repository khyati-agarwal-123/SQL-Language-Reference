[Previous](CALL.html) [Next](SQL-Statements-COMMIT-to-CREATE-JAVA.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * "[Comments](Comments.html#GUID-79B6B8FD-2DD4-471E-B9E0-0C8D20B058F6)" for more information on associating comments with SQL statements and schema objects 

  * [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN002) for information on the data dictionary views that display comments 
...
![Description of comment.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/comment.gif)[Descriptionof the illustration comment.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/comment.md)
...
Specify the text of the comment. Refer to "[Text Literals](Literals.html#GUID-1824CBAA-6E16-4921-B2A6-112FB02248DA)" for a syntax description of `'string'`. 
