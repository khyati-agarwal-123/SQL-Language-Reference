[Previous](SQL-Statements-COMMIT-to-CREATE-JAVA.html) [Next](CREATE-ANALYTIC-VIEW.html) JavaScript must be enabled to correctly display this content 
...
Until you commit a transaction:
  ...
  * You can roll back (undo) any changes made during the transaction with the `ROLLBACK` statement (see [ROLLBACK](ROLLBACK.html#GUID-94551F0C-A47F-43DE-BC68-9B1C1ED38C93)). 
...
See Also:
  ...
  * [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT016) for more information on transactions 

  * [SET TRANSACTION](SET-TRANSACTION.html#GUID-F11E1E30-5871-48D1-8266-F80A1DF126A1) for more information on specifying characteristics of a transaction 
...
![Description of commit.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/commit.gif)[Descriptionof the illustration commit.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/commit.md)
...
[SET TRANSACTION](SET-TRANSACTION.html#GUID-F11E1E30-5871-48D1-8266-F80A1DF126A1) and [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1122) for more information on named transactions 

Specify a comment to be associated with the current transaction. The '`text`' is a quoted literal of up to 255 bytes that Oracle Database stores in the data dictionary view `DBA_2PC_PENDING` along with the transaction ID if a distributed transaction becomes in doubt. This comment can help you diagnose the failure of a distributed transaction. 

See Also:

[COMMENT](COMMENT.html#GUID-65F447C4-6914-4823-9691-F15D52DB74D7) for more information on adding comments to SQL statements 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1119) for more information on asynchronous commit 
...
[Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN032) for more information on these topics 
