...
![Description of feature_set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_set.gif)[Description of the illustration feature_set.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_set.html)

Analytic Syntax

feature_set_analytic::= 

![Description of feature_set_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_set_analytic.gif)[Description of the illustration feature_set_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_set_analytic.html)
