##  FEATURE_SET {#GUID-55582346-F1D6-447E-851A-D4912982EB28} 

Syntax 

*feature_set* ::= 

![Description of feature_set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_set.gif)[ Description of the illustration feature_set.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_set.md)

Analytic Syntax 

*feature_set_analytic* ::= 

![Description of feature_set_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_set_analytic.gif)[ Description of the illustration feature_set_analytic.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_set_analytic.md)
