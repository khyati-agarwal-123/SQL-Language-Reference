[Previous](XMLDIFF.html) [Next](XMLEXISTS.html) JavaScript must be enabled to correctly display this content 
...
![Description of xmlelement.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlelement.gif)[Description of the illustration xmlelement.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlelement.html)

XML_attributes_clause::= 

![Description of xml_attributes_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xml_attributes_clause.gif)[Description of the illustration xml_attributes_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xml_attributes_clause.html)
...
For an explanation of the `ENTITYESCAPING` and `NONENTITYESCAPING` keywords, refer to [Oracle XML DB Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB1620). 
...
"[Extended Data Types](Data-Types.html#GUID-8EFA29E9-E8D8-40A6-A43E-954908C954A4)" for more information on `MAX_STRING_SIZE`
