...
![Description of domain_name_function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/domain_name_function.gif)[Descriptionof the illustration domain_name_function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/domain_name_function.md)
