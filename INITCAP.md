...
![Description of initcap.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/initcap.gif)[Descriptionof the illustration initcap.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/initcap.md)
