...
![Description of nls_collation_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_collation_id.gif)[Descriptionof the illustration nls_collation_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_collation_id.md)
