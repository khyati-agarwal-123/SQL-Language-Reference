...
![Description of con_id_to_con_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_id_to_con_name.gif)[Descriptionof the illustration con_id_to_con_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_id_to_con_name.md)
