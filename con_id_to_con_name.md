[Previous](CON_GUID_TO_ID.html) [Next](con_id_to_dbid.html) JavaScript must be enabled to correctly display this content 
...
![Description of con_id_to_con_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_id_to_con_name.gif)[Description of the illustration con_id_to_con_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_id_to_con_name.html)
