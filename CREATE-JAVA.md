...
![Description of create_java.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_java.gif)[Description of the illustration create_java.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_java.html)
...
See Also:
  ...
  * [Oracle Database Java Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=JJDEV13085)
