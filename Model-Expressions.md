##  Model Expressions {#GUID-83D3FD56-8346-4D3F-A49E-5FE41FE19257} 
...
![Description of model_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/model_expression.gif)[ Description of the illustration model_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/model_expression.md)
...
[ The MODEL clause: Examples ](SELECT.md#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2171160) for an example of using an analytic function on the right-hand side of a model rule 
...
[ CV ](CV.md#GUID-32E56E9C-4F59-486E-8E4C-F332284C5EA7) and *model_clause* 
