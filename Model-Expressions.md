[Previous](JSON-Object-Access-Expressions.html) [Next](Object-Access-Expressions.html) JavaScript must be enabled to correctly display this content 
...
A model expression is used only in the `model_clause` of a `SELECT` statement and then only on the right-hand side of a model rule. It yields a value for a cell in a measure column previously defined in the `model_clause`. For additional information, refer to [model_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2172805). 

model_expression::= 

![Description of model_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/model_expression.gif)[Description of the illustration model_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/model_expression.html)
...
[The MODEL clause: Examples](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2171160) for an example of using an analytic function on the right-hand side of a model rule 
...
[CV](CV.html#GUID-32E56E9C-4F59-486E-8E4C-F332284C5EA7) and [model_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2172805)
