...
![Description of stats_one_way_anova.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_one_way_anova.gif)[Descriptionof the illustration stats_one_way_anova.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_one_way_anova.md)
