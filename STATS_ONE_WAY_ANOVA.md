##  STATS_ONE_WAY_ANOVA {#GUID-CC614CE5-56CB-4A54-8571-6FEAD2D2E75F} 

Syntax 

![Description of stats_one_way_anova.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_one_way_anova.gif)[ Description of the illustration stats_one_way_anova.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_one_way_anova.md)
...
**Table: STATS_ONE_WAY_ANOVA Return Values** 
