##  NVL {#GUID-3AB61E54-9201-4D6A-B48A-79F4C4A034B2} 

Syntax 

![Description of nvl.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nvl.gif)[ Description of the illustration nvl.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nvl.md)
