##  NLSSORT {#GUID-781C6FE8-0924-4617-AECB-EE40DE45096D} 

Syntax 

![Description of nlssort.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nlssort.gif)[ Description of the illustration nlssort.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nlssort.md)
...
Refer to  " [ Extended Data Types ](Data-Types.md#GUID-8EFA29E9-E8D8-40A6-A43E-954908C954A4) "  for more information on the ` MAX_STRING_SIZE ` initialization parameter. 
