##  NLS_CHARSET_DECL_LEN {#GUID-5F0939C0-4AFB-4CEA-9899-BDE85B9B2F11} 

Syntax 

![Description of nls_charset_decl_len.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_charset_decl_len.gif)[ Description of the illustration nls_charset_decl_len.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_charset_decl_len.md)
