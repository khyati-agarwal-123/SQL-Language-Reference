...
![Description of nls_charset_decl_len.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_charset_decl_len.gif)[Description of the illustration nls_charset_decl_len.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_charset_decl_len.html)
