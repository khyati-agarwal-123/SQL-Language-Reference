##  XMLSERIALIZE {#GUID-F2D5ECE7-3838-4DD5-BE8F-2AEE7890AA1C} 

Syntax 

![Description of xmlserialize.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlserialize.gif)[ Description of the illustration xmlserialize.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlserialize.md)( *datatype::=* ) 
...
Specify the ` VERSION ` clause to use the version you provide as *string_literal* in the XML declaration ( ` ` ). 
