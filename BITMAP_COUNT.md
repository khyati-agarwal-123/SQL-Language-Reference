...
![Description of bitmap_count.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_count.gif)[Descriptionof the illustration bitmap_count.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_count.md)
