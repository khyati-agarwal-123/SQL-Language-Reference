##  BITMAP_COUNT {#GUID-F1A3261E-7DA9-4FEF-8413-E38907C856BA} 
...
![Description of bitmap_count.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_count.gif)[ Description of the illustration bitmap_count.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_count.md)
