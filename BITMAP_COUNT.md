[Previous](BITMAP_CONSTRUCT_AGG.html) [Next](BITMAP_OR_AGG.html) JavaScript must be enabled to correctly display this content 
...
![Description of bitmap_count.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_count.gif)[Description of the illustration bitmap_count.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_count.html)
