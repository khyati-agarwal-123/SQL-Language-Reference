...
![Description of to_single_byte.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_single_byte.gif)[Descriptionof the illustration to_single_byte.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_single_byte.md)
