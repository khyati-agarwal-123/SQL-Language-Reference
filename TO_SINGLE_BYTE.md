##  TO_SINGLE_BYTE {#GUID-36364630-C62C-46C5-B29B-EFE3DFB5AA6D} 

Syntax 

![Description of to_single_byte.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_single_byte.gif)[ Description of the illustration to_single_byte.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_single_byte.md)
