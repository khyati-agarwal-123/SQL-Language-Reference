[Previous](ALTER-TYPE.html) [Next](ALTER-VIEW.html) JavaScript must be enabled to correctly display this content 
...
[Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG003) for detailed information about user authentication methods 
...
![Description of alter_user.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_user.gif)[Descriptionof the illustration alter_user.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_user.md)([size_clause::=](size_clause.md#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517__CHDEAIID)) 

container_data_clause::= 

![Description of container_data_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/container_data_clause.gif)[Descriptionof the illustration container_data_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/container_data_clause.md)

proxy_clause::= 

![Description of proxy_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/proxy_clause.gif)[Descriptionof the illustration proxy_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/proxy_clause.md)

db_user_proxy_clauses::= 

![Description of db_user_proxy_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/db_user_proxy_clauses.gif)[Descriptionof the illustration db_user_proxy_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/db_user_proxy_clauses.md)
...
[CREATE USER](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C) for information on the keywords and parameters and [CREATE PROFILE](CREATE-PROFILE.html#GUID-ABC7AE4D-64A8-4EA9-857D-BEF7300B64C3) for information on assigning limits on database resources to a user 
...
See Also:
  ...
  * [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG10005) for guidelines on creating passwords 

  * [Configuring Authentication ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-7CB647A2-B39E-435C-A2F3-55D248D19062)
...
Refer to [CREATE USER](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C) for more information on this clause. 
...
[Oracle Database Enterprise User Security Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBIMI152) for more information on globally and externally identified users, "[Changing User Identification: Example](ALTER-USER.html#GUID-9FCD038D-8193-4241-85CD-2F4723B27D44__I2115766)", and "[Changing User Authentication: Examples](ALTER-USER.html#GUID-9FCD038D-8193-4241-85CD-2F4723B27D44__I2115777)"
...
Use this clause to change the default collation for the schema owned by the user. The new default collation is assigned to tables, views, and materialized views that are subsequently created in the schema. It does not influence default collations for existing tables views, and materialized views. Refer to the [DEFAULT COLLATION Clause](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C__DEFAULTCOLLATIONCLAUSE-39EC6E26) clause of `CREATE` `USER` for the full semantics of this clause. 
...
"[Assigning a Tablespace Group: Example](ALTER-USER.html#GUID-9FCD038D-8193-4241-85CD-2F4723B27D44__I2147599)"
...
See Also:
  ...
  * For more on the semantics of the ENABLE EDITIONS clause see the corresponding section in [CREATE USER](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C__GUID-C016DFF7-F942-42FE-9BB2-FFCEEA3ADB9D)* [Enabling Editions for a User](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS-GUID-FF93CEED-D23A-48D3-8FD7-5B0FB22024DF)

  * [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN30660) for more information about the `V$EDITIONABLE_TYPES` dynamic performance view 
...
Refer to [[HTTP] DIGEST Clause](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C__HTTPDIGESTCLAUSE-3743BE20) in the documentation on `CREATE` `USER` for more information on this clause. 
...
See Also:
  ...
  * [Configuring Privilege and Role Authorization](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-23E95383-6A3E-4F70-91D6-143BF2CC1DE5) of the Oracle Database Security Guide. 
...
[Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG803) for more information about enabling common users to view information about PDB objects 
...
See Also:
  ...
  * Oracle Security Overview for an overview of [database security](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG002) and for information on [middle-tier systems and proxy authentication](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG003)* [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG003) for more information on proxies and their use of the database and "[Proxy Users: Examples](ALTER-USER.html#GUID-9FCD038D-8193-4241-85CD-2F4723B27D44__I2115788)"
...
The following statement changes the password of the user `sidney` (created in "[Creating a Database User: Example](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C__I2103003)") `second_2nd_pwd` and default tablespace to the tablespace `example`: 
...
The following statement assigns the `new_profile` profile (created in "[Creating a Profile: Example](CREATE-PROFILE.html#GUID-ABC7AE4D-64A8-4EA9-857D-BEF7300B64C3__I2092094)") to the sample user `sh`: 
...
The following statement changes the authentication mechanism of user `app_user1` (created in "[Creating a Database User: Example](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C__I2103003)"`)`: 
...
The following statement assigns `tbs_grp_01` (created in "[Adding a Temporary Tablespace to a Tablespace Group: Example](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9__I2204334)") as the tablespace group for user `sh`: 
...
The following statement alters the user `app_user1`. The example permits the `app_user1` to connect through the proxy user `sh`. The example also allows `app_user1` to enable its `warehouse_user` role (created in "[Creating a Role: Example](CREATE-ROLE.html#GUID-B2252DC5-5AE7-49B7-9048-98062993E450__I2082342)") when connected through the proxy `sh`: 
...
To show basic syntax, this example uses the sample database Sales History user (`sh`) as the proxy. Normally a proxy user would be an application server or middle-tier entity. For information on creating the interface between an application user and a database by way of an application server, refer to [Oracle Call Interface Programmer's Guide.](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNOCI16559)

See Also:

  * "[Creating External Database Users: Examples](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C__I2094003)" to see how to create the `app_user` user 

  * "[Creating a Role: Example](CREATE-ROLE.html#GUID-B2252DC5-5AE7-49B7-9048-98062993E450__I2082342)" to see how to create the `dw_user` role 
