...
![Description of alter_user.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_user.gif)[Description of the illustration alter_user.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_user.html)([size_clause::=](size_clause.html#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517__CHDEAIID)) 

container_data_clause::= 

![Description of container_data_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/container_data_clause.gif)[Description of the illustration container_data_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/container_data_clause.html)

proxy_clause::= 

![Description of proxy_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/proxy_clause.gif)[Description of the illustration proxy_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/proxy_clause.html)

db_user_proxy_clauses::= 

![Description of db_user_proxy_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/db_user_proxy_clauses.gif)[Description of the illustration db_user_proxy_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/db_user_proxy_clauses.html)
...
See Also:
  ...
  * For more on the semantics of the ENABLE EDITIONS clause see the corresponding section in [CREATE USER](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C__GUID-C016DFF7-F942-42FE-9BB2-FFCEEA3ADB9D)

  * [Enabling Editions for a User](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS-GUID-FF93CEED-D23A-48D3-8FD7-5B0FB22024DF)
...
See Also:
  ...
  * Oracle Security Overview for an overview of [database security](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG002) and for information on [middle-tier systems and proxy authentication](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG003)

  * [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG003) for more information on proxies and their use of the database and "[Proxy Users: Examples](ALTER-USER.html#GUID-9FCD038D-8193-4241-85CD-2F4723B27D44__I2115788)"
