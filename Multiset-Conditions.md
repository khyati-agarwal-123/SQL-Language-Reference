[Previous](Model-Conditions.html) [Next](Pattern-matching-Conditions.html) JavaScript must be enabled to correctly display this content 
...
![Description of is_a_set_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_a_set_condition.gif)[Descriptionof the illustration is_a_set_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_a_set_condition.md)
...
The preceding example requires the table `customers_demo` and a nested table column containing data. Refer to "[Multiset Operators](Multiset-Operators.html#GUID-793FCBB0-A97C-4884-BCAC-DD0542EA746B)" to create this table and nested table column. 
...
![Description of is_empty_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_empty_condition.gif)[Descriptionof the illustration is_empty_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_empty_condition.md)
...
![Description of member_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/member_condition.gif)[Descriptionof the illustration member_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/member_condition.md)
...
![Description of submultiset_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/submultiset_condition.gif)[Descriptionof the illustration submultiset_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/submultiset_condition.md)
