[Previous](JSON_ARRAYAGG.html) [Next](JSON_MERGEPATCH.html) JavaScript must be enabled to correctly display this content 
...
![Description of json_dataguide.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_dataguide.gif)[Description of the illustration json_dataguide.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_dataguide.html)
...
[JSON Data Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-219FC30E-89A7-4189-BC36-7B961A24067C)

Examples

The following example uses the `j_purchaseorder` table, which is created in "[Creating a Table That Contains a JSON Document: Example](JSON_TABLE.html#GUID-3C8E63B5-0B94-4E86-A2D3-3D4831B67C62__CJAHAAJE)". This table contains a column of JSON data called `po_document`. This example returns a flat data guide for each year group. 
