[Previous](round-interval.html) [Next](ROUND_TIES_TO_EVEN-number.html) JavaScript must be enabled to correctly display this content 
...
![Description of round_number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/round_number.gif)[Description of the illustration round_number.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/round_number.html)
...
See Also:
  ...
  * [FLOOR (number)](FLOOR.html#GUID-67F61AC7-C097-4397-A122-213157BF584F) and [CEIL (number)](CEIL.html#GUID-6DCC9AFB-9B80-4C27-AF63-5AA3B1E43660), [TRUNC (number)](TRUNC-number.html#GUID-911AE7FE-E04A-471D-8B0E-9C50EBEFE07D) and [MOD](MOD.html#GUID-E12A3928-2C50-45B0-B8C3-82432C751B8C) for information on functions that perform related operations 
