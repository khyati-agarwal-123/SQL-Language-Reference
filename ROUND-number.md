##  ROUND (number) {#GUID-849F6C45-0D72-4464-9C0F-8B6822BA85E1} 

Syntax 

*round_number* ::= 

![Description of round_number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/round_number.gif)[ Description of the illustration round_number.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/round_number.md)
