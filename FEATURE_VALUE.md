...
![Description of feature_value.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_value.gif)[Description of the illustration feature_value.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_value.html)

Analytic Syntax

feature_value_analytic::= 

![Description of feature_value_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_value_analytic.gif)[Description of the illustration feature_value_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_value_analytic.html)
