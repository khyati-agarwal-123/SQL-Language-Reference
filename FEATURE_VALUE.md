[Previous](FEATURE_SET.html) [Next](FIRST.html) JavaScript must be enabled to correctly display this content 
...
![Description of feature_value.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_value.gif)[Descriptionof the illustration feature_value.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_value.md)

Analytic Syntax

feature_value_analytic::= 

![Description of feature_value_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_value_analytic.gif)[Descriptionof the illustration feature_value_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_value_analytic.md)
...
The syntax of the `FEATURE_VALUE` function can use an optional `GROUPING` hint when scoring a partitioned model. See [GROUPING Hint](Comments.html#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A). 
