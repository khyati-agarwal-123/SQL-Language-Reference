[Previous](JSON_TRANSFORM.html) [Next](json-type-constructor.html) JavaScript must be enabled to correctly display this content 
...
![Description of json_value.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value.gif)[Description of the illustration json_value.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value.html)

JSON_basic_path_expression::= 

(`JSON_basic_path_expression`: See [SQL/JSON Path Expressions](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-7B610884-39CD-4910-85E7-C251D342D879)) 

JSON_value_returning_clause::= 

![Description of json_value_returning_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_returning_clause.gif)[Description of the illustration json_value_returning_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_returning_clause.html)

JSON_value_return_type::= 

![Description of json_value_return_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_return_type.gif)[Description of the illustration json_value_return_type.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_return_type.html)
...
![Description of json_value_return_object_instance.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_return_object_instance.gif)[Description of the illustration json_value_return_object_instance.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_return_object_instance.html)
...
![Description of json_value_mapper_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_mapper_clause.gif)[Description of the illustration json_value_mapper_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_mapper_clause.html)

JSON_value_on_error_clause::= 

![Description of json_value_on_error_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_on_error_clause.gif)[Description of the illustration json_value_on_error_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_on_error_clause.html)

JSON_value_on_empty_clause::= 

![Description of json_value_on_empty_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_on_empty_clause.gif)[Description of the illustration json_value_on_empty_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_on_empty_clause.html)
...
![Description of json_value_on_mismatch_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_on_mismatch_clause.gif)[Description of the illustration json_value_on_mismatch_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_on_mismatch_clause.html)
...
See Also:
  ...
  * [JSON TRANSFORM](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-7BED994B-EAA3-4FF0-824D-C12ADAB862C1) of the JSON Developer's Guide.

  * Appendix C in [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-AFCE41ED-775B-4A00-AF38-C436776AE0C5) for the collation derivation rules, which define the collation assigned to the value returned by this function when it is a character value 
...
If `expr` is not a text literal of well-formed JSON data using strict or lax syntax, then the function returns null by default. You can use the `JSON_value_on_error_clause` to override this default behavior. Refer to the [JSON_value_on_error_clause](JSON_VALUE.html#GUID-C7F19D36-1E75-4CB2-AE67-ADFBAD23CBC2__CJAHDAFG). 
...
For examples see [Using JSON_VALUE To Instantiate a User-Defined Object Type Instance](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-622170D8-7BAD-4F5F-86BF-C328451FC3BE) of the JSON Developer's Guide.
...
See Also:
  ...
  * [SQL/JSON Function JSON_VALUE](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-0565F0EE-5F13-44DD-8321-2AC142959215) for a conceptual understanding in the JSON Developer's Guide.

  * Refer to "[Data Types](Data-Types.html#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483)" for more information on the preceding data types. 

  * If the data type is not large enough to hold the return value, then this function returns null by default. You can use the `JSON_value_on_error_clause` to override this default behavior. Refer to the [JSON_value_on_error_clause](JSON_VALUE.html#GUID-C7F19D36-1E75-4CB2-AE67-ADFBAD23CBC2__CJAHDAFG). 
