##  JSON_VALUE {#GUID-C7F19D36-1E75-4CB2-AE67-ADFBAD23CBC2} 

Syntax 

![Description of json_value.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value.gif)[ Description of the illustration json_value.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value.md)
