...
![Description of json_value.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value.gif)[Descriptionof the illustration json_value.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value.md)
...
![Description of json_value_returning_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_returning_clause.gif)[Descriptionof the illustration json_value_returning_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_returning_clause.md)

JSON_value_return_type::= 

![Description of json_value_return_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_return_type.gif)[Descriptionof the illustration json_value_return_type.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_return_type.md)
...
![Description of json_value_return_object_instance.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_return_object_instance.gif)[Descriptionof the illustration json_value_return_object_instance.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_return_object_instance.md)
...
![Description of json_value_mapper_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_mapper_clause.gif)[Descriptionof the illustration json_value_mapper_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_mapper_clause.md)

JSON_value_on_error_clause::= 

![Description of json_value_on_error_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_on_error_clause.gif)[Descriptionof the illustration json_value_on_error_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_on_error_clause.md)

JSON_value_on_empty_clause::= 

![Description of json_value_on_empty_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_on_empty_clause.gif)[Descriptionof the illustration json_value_on_empty_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_on_empty_clause.md)
...
![Description of json_value_on_mismatch_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_value_on_mismatch_clause.gif)[Descriptionof the illustration json_value_on_mismatch_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_value_on_mismatch_clause.md)
