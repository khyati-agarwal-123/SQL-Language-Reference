##  JSON Object Access Expressions {#GUID-09D1A154-335D-484E-A7A2-DA1983CD511C} 
...
![Description of array_step.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/array_step.gif)[ Description of the illustration array_step.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/array_step.md)
...
A JSON object access expression cannot return a value larger than 4K bytes. If the value surpasses this limit, then the expression returns null. To obtain the actual value, instead use the [ JSON_QUERY ](JSON_QUERY.md#GUID-6D396EC4-D2AA-43D2-8F5D-08D646A4A2D9) function or the [ JSON_VALUE ](JSON_VALUE.md#GUID-C7F19D36-1E75-4CB2-AE67-ADFBAD23CBC2) function and specify an appropriate return type with the ` RETURNING ` clause. 
...
[ *Oracle Database JSON Developer’s Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-7249417B-A337-4854-8040-192D5CEFD576) for more information on querying JSON data using dot-notation syntax 
