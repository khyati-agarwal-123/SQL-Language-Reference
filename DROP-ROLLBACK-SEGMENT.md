...
![Description of drop_rollback_segment.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_rollback_segment.gif)[Description of the illustration drop_rollback_segment.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_rollback_segment.html)
