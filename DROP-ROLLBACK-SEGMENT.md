[Previous](DROP-ROLE.html) [Next](DROP-SEQUENCE.html) JavaScript must be enabled to correctly display this content 
...
![Description of drop_rollback_segment.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_rollback_segment.gif)[Descriptionof the illustration drop_rollback_segment.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_rollback_segment.md)
...
The following syntax drops the rollback segment created in "[Creating a Rollback Segment: Example](CREATE-ROLLBACK-SEGMENT.html#GUID-14AE3104-5B33-4E53-8E6F-6B2F037B52E9__CCHIHJDF)": 
