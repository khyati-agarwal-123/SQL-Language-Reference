[Previous](LISTAGG.html) [Next](LNNVL.html) JavaScript must be enabled to correctly display this content 
...
![Description of ln.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ln.gif)[Description of the illustration ln.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ln.html)
