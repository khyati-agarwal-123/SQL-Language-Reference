##  ADMINISTER KEY MANAGEMENT {#GUID-E5B2746F-19DC-4E94-83EC-A6A5C84A3EA9} 
...
![Description of administer_key_management.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/administer_key_management.gif)[ Description of the illustration administer_key_management.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/administer_key_management.md)( *keystore_management_clauses::=* , *key_management_clauses::=* , *secret_management_clauses::=* ) 

*keystore_management_clauses* ::= 

![Description of keystore_management_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/keystore_management_clauses.gif)[ Description of the illustration keystore_management_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/keystore_management_clauses.md)( *create_keystore::=* , *open_keystore::=* , *close_keystore::=* , *backup_keystore::=* , *alter_keystore_password::=* , *merge_into_new_keystore::=* , *merge_into_existing_keystore::=* ) 

*create_keystore* ::= 

![Description of create_keystore.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_keystore.gif)[ Description of the illustration create_keystore.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_keystore.md)

*open_keystore* ::= 

![Description of open_keystore.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/open_keystore.gif)[ Description of the illustration open_keystore.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/open_keystore.md)

*close_keystore* ::= 

![Description of close_keystore.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/close_keystore.gif)[ Description of the illustration close_keystore.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/close_keystore.md)

*backup_keystore* ::= 

![Description of backup_keystore.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/backup_keystore.gif)[ Description of the illustration backup_keystore.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/backup_keystore.md)
...
![Description of isolate_keystore.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/isolate_keystore.gif)[ Description of the illustration isolate_keystore.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/isolate_keystore.md)

*unite_keystore* ::= 

![Description of unite_keystore.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/unite_keystore.gif)[ Description of the illustration unite_keystore.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/unite_keystore.md)

*key_management_clauses* ::= 

![Description of key_management_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/key_management_clauses.gif)[ Description of the illustration key_management_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/key_management_clauses.md)( *set_key::=* , *create_key::=* , *use_key::=* , *set_key_tag::=* , *export_keys::=* , *import_keys::=* , *migrate_key::=* , *reverse_migrate_key::=* ) 

*set_key* ::= 

![Description of set_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_key.gif)[ Description of the illustration set_key.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_key.md)

*create_key* ::= 

![Description of create_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_key.gif)[ Description of the illustration create_key.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_key.md)

*use_key* ::= 

![Description of use_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_key.gif)[ Description of the illustration use_key.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_key.md)

*set_key_tag* ::= 

![Description of set_key_tag.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_key_tag.gif)[ Description of the illustration set_key_tag.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_key_tag.md)

*export_keys* ::= 

![Description of export_keys.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/export_keys.gif)[ Description of the illustration export_keys.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/export_keys.md)

*import_keys* ::= 

![Description of import_keys.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/import_keys.gif)[ Description of the illustration import_keys.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/import_keys.md)

*migrate_key* ::= 

![Description of migrate_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/migrate_key.gif)[ Description of the illustration migrate_key.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/migrate_key.md)

*reverse_migrate_key* ::= 

![Description of reverse_migrate_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/reverse_migrate_key.gif)[ Description of the illustration reverse_migrate_key.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/reverse_migrate_key.md)

*move_keys* ::= 

![Description of move_keys.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/move_keys.gif)[ Description of the illustration move_keys.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/move_keys.md)

*secret_management_clauses* ::= 

![Description of secret_management_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/secret_management_clauses.gif)[ Description of the illustration secret_management_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/secret_management_clauses.md)( *add_update_secret::=* , *delete_secret::=* ) 

*add_update_secret* ::= 

![Description of add_update_secret.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/add_update_secret.gif)[ Description of the illustration add_update_secret.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/add_update_secret.md)

*delete_secret* ::= 

![Description of delete_secret.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/delete_secret.gif)[ Description of the illustration delete_secret.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/delete_secret.md)
...
![Description of delete_secret_seps.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/delete_secret_seps.gif)[ Description of the illustration delete_secret_seps.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/delete_secret_seps.md)
