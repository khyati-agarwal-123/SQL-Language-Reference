[Previous](ROWNUM-Pseudocolumn.html) [Next](Operators.html) JavaScript must be enabled to correctly display this content 
...
Now suppose you have created an XMLSchema-based table like the `xwarehouses` table created in [Using XML in SQL Statements](Using-XML-in-SQL-Statements.html#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14). You could then use the `XMLDATA` column to set the properties of the underlying columns, as shown in the following statement: 
