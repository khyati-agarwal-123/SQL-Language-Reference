##  XMLDATA Pseudocolumn {#GUID-EBB52EE8-57B4-4DCA-A17E-351DE5CFA934} 
...
Now suppose you have created an XMLSchema-based table like the ` xwarehouses ` table created in [ Using XML in SQL Statements ](Using-XML-in-SQL-Statements.md#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14) . You could then use the ` XMLDATA ` column to set the properties of the underlying columns, as shown in the following statement: 
