##  LPAD {#GUID-0C27B59A-A6CF-43D3-BF4B-07A3D0F2CE20} 

Syntax 

![Description of lpad.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lpad.gif)[ Description of the illustration lpad.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lpad.md)
