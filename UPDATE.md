[Previous](TRUNCATE-TABLE.html) [Next](How-to-Read-Syntax-Diagrams.html) JavaScript must be enabled to correctly display this content 
...
![Description of update.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/update.gif)[Descriptionof the illustration update.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/update.md)([DML_table_expression_clause::=](UPDATE.md#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__BABGGJCE), [update_set_clause::=](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2126876), [where_clause::=](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2126344), [returning_clause::=](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2126358), [error_logging_clause::=](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__BCEEAAGC), [from_using_clause::=](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__SECTION_CQ3_4XS_DYB)) 

DML_table_expression_clause::= 

![Description of dml_table_expression_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dml_table_expression_clause.gif)[Descriptionof the illustration dml_table_expression_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dml_table_expression_clause.md)([partition_extension_clause::=](UPDATE.md#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__CHDBBDEI), [subquery::=](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2126435)\--part of `SELECT`, [subquery_restriction_clause::=](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2126407), [table_collection_expression::=](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2126867)) 
...
![Description of update_set_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/update_set_clause.gif)[Descriptionof the illustration update_set_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/update_set_clause.md)
...
![Description of from_using_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/from_using_clause.gif)[Descriptionof the illustration from_using_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/from_using_clause.md)
...
See [order_by_clause::=](Analytic-Functions.html#GUID-527832F7-63C0-4445-8C16-307FA5084056__ORDER_BY_CLAUSE-1E92A06C)
...
See Also:
  ...
  * [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT220) for detailed information about parallel execution 
...
"[Restrictions on the DML_table_expression_clause](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2079307)" and "[Updating a Table: Examples](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2189758)"
...
See Also:
  ...
  * [Oracle Database Data Cartridge Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADDCI4200) for more information on the indextype update routines 

  * [CREATE MATERIALIZED VIEW](CREATE-MATERIALIZED-VIEW.html#GUID-EE262CA4-01E5-4618-B659-6165D993CA1B) for information on creating updatable materialized views 
...
"[References to Partitioned Tables and Indexes](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.html#GUID-FED2E424-3F06-4B2B-88D2-DE043CA6E0E4)" and "[Updating a Partition: Example](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2130226)"
...
"[Correlated Update: Example](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2068234)"
...
[ALTER SESSION](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B) for information on the `SKIP_UNUSABLE_INDEXES` session parameter 
...
If `column` is part of the partitioning key of a partitioned table, then `UPDATE` will fail if you change a value in the column that would move the row to a different partition or subpartition, unless you enable row movement. Refer to the `row_movement_clause` of [CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) or [ALTER TABLE](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877). 
...
You can use the `flashback_query_clause` within the subquery to update `table` with past data. Refer to the [flashback_query_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2112818) of `SELECT` for more information on this clause. 

See Also:

  * [SELECT](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) and "[Using Subqueries](Using-Subqueries.html#GUID-53A705B6-0358-4E2B-92ED-A83DE83DFD20)"* [parallel_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CJACIHHF) in the [CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) documentation 
...
[Expressions](Expressions.html#GUID-E7A5363C-AEE9-4809-99C1-1A9C6E3AE017) for the syntax of `expr` and "[Updating an Object Table: Example](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2135485)"
...
"[Updating an Object Table: Example](UPDATE.html#GUID-027A462D-379D-4E35-8611-410F3AC8FDA5__I2135485)"
...
The `where_clause` lets you restrict the rows updated to those for which the specified `condition` is true. If you omit this clause, then the database updates all rows in the table or view. Refer to [Conditions](Conditions.html#GUID-C2E3ED44-16E7-4924-9125-E1693B1022A8) for the syntax of `condition`. 
...
See [order_by_clause ](Analytic-Functions.html#GUID-527832F7-63C0-4445-8C16-307FA5084056__GUID-666C34CD-99A1-4974-A898-AD1ACD8CA42E)
...
[Oracle Database PL/SQL Language Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNPLS012) for information on using the `BULK` `COLLECT` clause to return multiple values to collection variables 

error_logging_clause

The `error_logging_clause` has the same behavior in an `UPDATE` statement as it does in an `INSERT` statement. Refer to the `INSERT` statement [error_logging_clause](INSERT.html#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423__BGBEIACB) for more information. 
...
The following statement creates two object tables, `people_demo1` and `people_demo2`, of the `people_typ` object created in [Table Collections: Examples](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2071643). The example shows how to update a row of `people_demo1` by selecting a row from `people_demo2`: 
...
For an example that uses a correlated subquery to update nested table rows, refer to "[Table Collections: Examples](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2071643)". 
