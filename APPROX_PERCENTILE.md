...
![Description of approx_percentile.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_percentile.gif)[Descriptionof the illustration approx_percentile.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_percentile.md)
...
See Also:
  ...
  * [PERCENTILE_CONT](PERCENTILE_CONT.html#GUID-CA259452-A565-41B3-A4F4-DD74B66CEDE0) and [PERCENTILE_DISC](PERCENTILE_DISC.html#GUID-7C34FDDA-C241-474F-8C5C-50CC0182E005)* [APPROX_MEDIAN](APPROX_MEDIAN.html#GUID-F6A11DF2-121A-4057-9D0B-BF1A221B5622), which is the specific case of `APPROX_PERCENTILE` where the percentile value is 0.5 
