[Previous](PREDICTION.html) [Next](PREDICTION_COST.html) JavaScript must be enabled to correctly display this content 
...
![Description of prediction_bounds.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_bounds.gif)[Descriptionof the illustration prediction_bounds.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_bounds.md)
...
The syntax of the `PREDICTION_BOUNDS` function can use an optional `GROUPING` hint when scoring a partitioned model. See [GROUPING Hint](Comments.html#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A). 

mining_attribute_clause

`mining_attribute_clause` identifies the column attributes to use as predictors for scoring. This clause behaves as described for the `PREDICTION` function. (Note that the reference to analytic syntax does not apply.) See "[mining_attribute_clause::=](PREDICTION.html#GUID-DA66A1C3-BFB2-43A1-A3FF-93D4A3DAB9C6__CJAIGCFC)". 
...
See Also:
  ...
  * [Oracle Machine Learning for SQL Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DMCON022) for information about Generalized Linear Models 
