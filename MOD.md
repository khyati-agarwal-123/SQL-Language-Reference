##  MOD {#GUID-E12A3928-2C50-45B0-B8C3-82432C751B8C} 

Syntax 

![Description of mod.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/mod.gif)[ Description of the illustration mod.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/mod.md)
...
[ FLOOR (number) ](FLOOR.md#GUID-67F61AC7-C097-4397-A122-213157BF584F) and [ REMAINDER ](REMAINDER.md#GUID-430D4C4A-5779-4EBB-90C5-4D7CA7E73556) , which is similar to ` MOD ` , but uses ` ROUND ` in its formula instead of ` FLOOR `
