...
![Description of drop_property_graph.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_property_graph.gif)[Description of the illustration drop_property_graph.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_property_graph.html)
