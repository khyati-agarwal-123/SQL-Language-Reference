##  PERCENTILE_DISC {#GUID-7C34FDDA-C241-474F-8C5C-50CC0182E005} 

Syntax 

![Description of percentile_disc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/percentile_disc.gif)[ Description of the illustration percentile_disc.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/percentile_disc.md)
...
See aggregate example for [ PERCENTILE_CONT ](PERCENTILE_CONT.md#GUID-CA259452-A565-41B3-A4F4-DD74B66CEDE0) . 
