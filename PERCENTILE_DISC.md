[Previous](PERCENTILE_CONT.html) [Next](POWER.html) JavaScript must be enabled to correctly display this content 
...
![Description of percentile_disc.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/percentile_disc.gif)[Description of the illustration percentile_disc.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/percentile_disc.html)
...
Before processing a large amount of data with the `PERCENTILE_DISC` function, consider using one of the following methods to obtain approximate results more quickly than exact results: 
  ...
  * Use the `APPROX_PERCENTILE` function instead of the `PERCENTILE_DISC` function. Refer to [APPROX_PERCENTILE](APPROX_PERCENTILE.html#GUID-70D54091-EE2F-4283-A10B-1AB5A1242FE2). 
...
See aggregate example for [PERCENTILE_CONT](PERCENTILE_CONT.html#GUID-CA259452-A565-41B3-A4F4-DD74B66CEDE0). 
