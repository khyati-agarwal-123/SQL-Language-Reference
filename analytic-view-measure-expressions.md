##  Analytic View Expressions {#GUID-F8C7ED67-A4EC-479C-975F-12F1F4B8CBA0} 
...
![Description of av_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/av_expression.gif)[ Description of the illustration av_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/av_expression.md)

*av_meas_expression* ::= 

![Description of av_meas_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/av_meas_expression.gif)[ Description of the illustration av_meas_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/av_meas_expression.md)

*lead_lag_expression* ::= 

![Description of lead_lag_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lead_lag_expression.gif)[ Description of the illustration lead_lag_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lead_lag_expression.md)
...
![Description of lead_lag_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lead_lag_clause.gif)[ Description of the illustration lead_lag_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lead_lag_clause.md)

*hierarchy_ref* ::= 

![Description of hierarchy_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hierarchy_ref.gif)[ Description of the illustration hierarchy_ref.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hierarchy_ref.md)
...
![Description of av_window_clause-gif.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/av_window_clause-gif.gif)[ Description of the illustration av_window_clause-gif.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/av_window_clause-gif.md)

*preceding_boundary* ::= 

![Description of preceding_boundary.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/preceding_boundary.gif)[ Description of the illustration preceding_boundary.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/preceding_boundary.md)

*following_boundary* ::= 

![Description of following_boundary.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/following_boundary.gif)[ Description of the illustration following_boundary.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/following_boundary.md)

*rank_expression* ::= 

![Description of rank_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rank_expression.gif)[ Description of the illustration rank_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rank_expression.md)

*rank_function_name* ::= 

![Description of rank_function_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rank_function_name.gif)[ Description of the illustration rank_function_name.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rank_function_name.md)

*rank_clause* ::= 

![Description of rank_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rank_clause.gif)[ Description of the illustration rank_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rank_clause.md)
...
![Description of share_of_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/share_of_expression.gif)[ Description of the illustration share_of_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/share_of_expression.md)

*share_clause* ::= 

![Description of share_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/share_clause.gif)[ Description of the illustration share_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/share_clause.md)

*member_expression* ::= 

![Description of member_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/member_expression.gif)[ Description of the illustration member_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/member_expression.md)

*level_member_literal* ::= 

![Description of level_member_literal.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_member_literal.gif)[ Description of the illustration level_member_literal.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_member_literal.md)

*pos_member_keys* ::= 

![Description of pos_member_keys.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pos_member_keys.gif)[ Description of the illustration pos_member_keys.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pos_member_keys.md)

*named_member_keys* ::= 

![Description of named_member_keys.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/named_member_keys.gif)[ Description of the illustration named_member_keys.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/named_member_keys.md)
...
![Description of hier_lead_lag_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_lead_lag_clause.gif)[ Description of the illustration hier_lead_lag_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_lead_lag_clause.md)
...
![Description of hier_last_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_last_expression.gif)[ Description of the illustration hier_last_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_last_expression.md)
...
![Description of qdr_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qdr_expression.gif)[ Description of the illustration qdr_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qdr_expression.md)

*qualifier* ::= 

![Description of qualifier.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qualifier.gif)[ Description of the illustration qualifier.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qualifier.md)

*av_hier_expression* ::= 

![Description of av_hier_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/av_hier_expression.gif)[ Description of the illustration av_hier_expression.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/av_hier_expression.md)

*hier_function_name* ::= 

![Description of hier_function_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_function_name.gif)[ Description of the illustration hier_function_name.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_function_name.md)
...
![Description of member_set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/member_set.gif)[ Description of the illustration member_set.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/member_set.md)
...
![Description of member_to_set_func.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/member_to_set_func.gif)[ Description of the illustration member_to_set_func.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/member_to_set_func.md)
...
![Description of hier_ancestors.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_ancestors.gif)[ Description of the illustration hier_ancestors.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_ancestors.md)
...
![Description of hier_descendants.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_descendants.gif)[ Description of the illustration hier_descendants.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_descendants.md)
...
![Description of hier_siblings.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_siblings.gif)[ Description of the illustration hier_siblings.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_siblings.md)
...
![Description of self_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/self_clause.gif)[ Description of the illustration self_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/self_clause.md)
...
![Description of hier_children.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_children.gif)[ Description of the illustration hier_children.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_children.md)
...
![Description of hier_level_members.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_level_members.gif)[ Description of the illustration hier_level_members.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_level_members.md)
...
![Description of set_to_set_func.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_to_set_func.gif)[ Description of the illustration set_to_set_func.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_to_set_func.md)
...
![Description of hier_union.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_union.gif)[ Description of the illustration hier_union.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_union.md)
...
![Description of hier_union_all.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_union_all.gif)[ Description of the illustration hier_union_all.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_union_all.md)
...
![Description of hier_intersect.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_intersect.gif)[ Description of the illustration hier_intersect.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_intersect.md)
...
![Description of hier_minus.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_minus.gif)[ Description of the illustration hier_minus.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_minus.md)
...
![Description of hier_distinct.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_distinct.gif)[ Description of the illustration hier_distinct.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_distinct.md)
...
![Description of hier_range.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_range.gif)[ Description of the illustration hier_range.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_range.md)
...
![Description of hier_window.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_window.gif)[ Description of the illustration hier_window.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_window.md)
...
![Description of hier_expand.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_expand.gif)[ Description of the illustration hier_expand.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_expand.md)
...
![Description of hier_member_set.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_member_set.gif)[ Description of the illustration hier_member_set.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_member_set.md)
...
![Description of hier_cond.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_cond.gif)[ Description of the illustration hier_cond.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_cond.md)
...
![Description of hier_position.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_position.gif)[ Description of the illustration hier_position.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_position.md)
...
![Description of hier_count.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_count.gif)[ Description of the illustration hier_count.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_count.md)
...
###  Examples of Analytic View Expressions {#GUID-595B6AC1-9204-4119-890A-0C38F933D03C} 
...
For more examples, see the tutorials on analytic views at the SQL Live website at [ https://livesql.oracle.com/apex/livesql/file/index.md ](https://livesql.oracle.com/apex/livesql/file/index.md) . 
