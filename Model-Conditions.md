...
![Description of is_any_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_any_condition.gif)[Descriptionof the illustration is_any_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_any_condition.md)
...
![Description of is_present_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/is_present_condition.gif)[Descriptionof the illustration is_present_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/is_present_condition.md)
