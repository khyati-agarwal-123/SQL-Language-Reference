##  FLASHBACK DATABASE {#GUID-BE0ACF9A-BC13-4810-B08B-33326440258B} 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Backup and Recovery User's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=BRADV017) and the ` ALTER ` ` DATABASE ` ... *flashback_mode_clause* for information on putting the database in ` FLASHBACK ` mode 
...
![Description of flashback_database.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/flashback_database.gif)[ Description of the illustration flashback_database.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/flashback_database.md)
