[Previous](EXPLAIN-PLAN.html) [Next](FLASHBACK-TABLE.html) JavaScript must be enabled to correctly display this content 
...
[Oracle Database Backup and Recovery User's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=BRADV71000) for more information on `FLASHBACK` `DATABASE`
...
See Also:
  ...
  * [Oracle Database Backup and Recovery User's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=BRADV017) and the `ALTER` `DATABASE` ... [flashback_mode_clause](ALTER-DATABASE.html#GUID-8069872F-E680-4511-ADD8-A4E30AF67986__I2155821) for information on putting the database in `FLASHBACK` mode 

  * [CREATE RESTORE POINT](CREATE-RESTORE-POINT.html#GUID-AD0FB693-7C28-4908-A870-BA884B320575) for information on restore points and guaranteed restore points 
...
![Description of flashback_database.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/flashback_database.gif)[Descriptionof the illustration flashback_database.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/flashback_database.md)
...
[Oracle Database Backup and Recovery User's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=BRADV89765) for more information on recovering data files 
...
[Oracle Data Guard Concepts and Administration](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SBYDB00717) for information on how you can use `FLASHBACK` `DATABASE` on a standby database to achieve different delays 
...
Restrictions on Flashing Back a PDB
  ...
  * If the CDB is in shared undo mode, then you can only flash back a PDB to a clean PDB restore point. Refer to the [CLEAN](CREATE-RESTORE-POINT.html#GUID-AD0FB693-7C28-4908-A870-BA884B320575__CLEAN-2B81B840) clause of `CREATE` `RESTORE` `POINT` for more information. 
...
You can determine the current SCN by querying the `CURRENT_SCN` column of the [`V$DATABASE`](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN30047) view. This in turn lets you save the SCN to a spool file, for example, before running a high-risk batch job. 
...
[Oracle Database Backup and Recovery User's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=BRADV85442) for more information about this clause 
