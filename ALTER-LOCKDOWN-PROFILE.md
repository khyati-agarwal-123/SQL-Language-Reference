...
See Also:
  ...
  * [CREATE LOCKDOWN PROFILE](CREATE-LOCKDOWN-PROFILE.html#GUID-1CDEC3A3-F3F1-4279-9370-36AACF416E0A) and [DROP LOCKDOWN PROFILE](DROP-LOCKDOWN-PROFILE.html#GUID-62D428C1-5081-43CA-B45D-7FF1B81363E7)
...
![Description of alter_lockdown_profile.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_lockdown_profile.gif)[Description of the illustration alter_lockdown_profile.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_lockdown_profile.html)

lockdown_features::= 

![Description of lockdown_features.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lockdown_features.gif)[Description of the illustration lockdown_features.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lockdown_features.html)

lockdown_options::= 

![Description of lockdown_options.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lockdown_options.gif)[Description of the illustration lockdown_options.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lockdown_options.html)

lockdown_statements::= 

![Description of lockdown_statements.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lockdown_statements.gif)[Description of the illustration lockdown_statements.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lockdown_statements.html)

statement_clauses::= 

![Description of statement_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/statement_clauses.gif)[Description of the illustration statement_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/statement_clauses.html)

clause_options::= 

![Description of clause_options.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/clause_options.gif)[Description of the illustration clause_options.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/clause_options.html)

option_values::= 

![Description of option_values.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/option_values.gif)[Description of the illustration option_values.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/option_values.html)
