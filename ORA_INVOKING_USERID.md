...
![Description of ora_invoking_userid.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_invoking_userid.gif)[Description of the illustration ora_invoking_userid.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_invoking_userid.html)
