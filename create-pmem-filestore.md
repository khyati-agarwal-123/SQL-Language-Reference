...
![Description of create_pmem_fs.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_pmem_fs.gif)[Description of the illustration create_pmem_fs.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_pmem_fs.html)
