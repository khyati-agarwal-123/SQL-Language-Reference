[Previous](RENAME.html) [Next](ROLLBACK.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [GRANT](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3) for information on granting system privileges and roles 

  * [Table 18-4](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBCIIEG "Column 1 names the object privilege. Column 2 describes the operations authorized by each object privilege.") for a listing of the object privileges for each type of object 
...
"[Revoke Operations that Use GRANT ANY OBJECT PRIVILEGE: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2133838)"
...
![Description of revoke.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/revoke.gif)[Descriptionof the illustration revoke.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/revoke.md)([revoke_system_privileges::=](REVOKE.md#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2123663), [revoke_object_privileges::=](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2123674), [revoke_roles_from_programs::=](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__BGEFHDAG)) 

revoke_system_privileges::= 

![Description of revoke_system_privileges.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/revoke_system_privileges.gif)[Descriptionof the illustration revoke_system_privileges.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/revoke_system_privileges.md)([revokee_clause::=](REVOKE.md#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2123686)) 
...
![Description of revoke_schema_privileges.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/revoke_schema_privileges.gif)[Descriptionof the illustration revoke_schema_privileges.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/revoke_schema_privileges.md)([revokee_clause::=](REVOKE.md#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2123686)) 

revoke_object_privileges::= 

![Description of revoke_object_privileges.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/revoke_object_privileges.gif)[Descriptionof the illustration revoke_object_privileges.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/revoke_object_privileges.md)([on_object_clause::=](REVOKE.md#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2123698), [revokee_clause::=](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2123686)) 

revokee_clause::= 

![Description of revokee_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/revokee_clause.gif)[Descriptionof the illustration revokee_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/revokee_clause.md)
...
![Description of revoke_roles_from_programs.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/revoke_roles_from_programs.gif)[Descriptionof the illustration revoke_roles_from_programs.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/revoke_roles_from_programs.md)
...
Specify the system privilege to be revoked. Refer to [Table 18-2](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE "Column 1 names system privileges grouped by database object. Column 2 describes the operations authorized by the system privilege.") for a list of the system privileges. 
...
"[Revoking a System Privilege from a User: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126289)" and "[Revoking a System Privilege from a Role: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126321)"
...
Oracle Database provides a shortcut for specifying all system privileges at once: Specify `ALL` `PRIVILEGES` to revoke all the system privileges listed in [Table 18-2](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE "Column 1 names system privileges grouped by database object. Column 2 describes the operations authorized by the system privilege."). 
...
"[Revoking a Role from a User: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126305)" and "[Revoking a Role from a Role: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126337)"
...
A system role cannot appear more than once in the list of roles to be revoked. For information on the predefined roles, refer to [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG4414). 
...
Specify the object privilege to be revoked. The object privileges, categorized by the type of object to which they apply, are described in [Table 18-4](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBCIIEG "Column 1 names the object privilege. Column 2 describes the operations authorized by each object privilege."). 
...
"[Revoking an Object Privilege from a User: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126353)", "[Revoking Object Privileges from PUBLIC: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126385)", and "[Revoking All Object Privileges from a User: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__BGEGFBEJ)"
...
"[Revoking an Object Privilege with CASCADE CONSTRAINTS: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126427)"
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1859) for detailed information about type dependencies and user-defined object privileges 
...
"[Revoking an Object Privilege on a Sequence from a User: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126411)"
...
"[Revoking an Object Privilege on a User from a User: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__BGEGHAEG)"
...
[CREATE DIRECTORY](CREATE-DIRECTORY.html#GUID-8E9C569A-1B06-42C4-9586-0EF83437001A) and "[Revoking an Object Privilege on a Directory from a User: Example](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__I2126438)"
...
[Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG977) for more information on revoking CBAC roles from program units 
