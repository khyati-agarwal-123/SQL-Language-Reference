...
![Description of rollback.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rollback.gif)[Descriptionof the illustration rollback.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rollback.md)
