...
Refer to [ APPROX_PERCENTILE_AGG: Examples ](APPROX_PERCENTILE_DETAIL.md#GUID-F9A0B9B5-671F-43CA-9FA7-69A2DD174F54__APPROX_PERCENTILE_AGGEXAMPLES-088B7917) for examples of using the ` TO_APPROX_PERCENTILE ` function in conjunction with the ` APPROX_PERCENTILE_DETAIL ` and ` APPROX_PERCENTILE_AGG ` functions. 
