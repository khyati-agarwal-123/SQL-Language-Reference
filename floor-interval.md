##  FLOOR (interval) {#GUID-2339112B-EA60-46F6-9BDA-63C0A99B86A1} 

Syntax 

![Description of floor_interval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/floor_interval.gif)[ Description of the illustration floor_interval.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/floor_interval.md)
