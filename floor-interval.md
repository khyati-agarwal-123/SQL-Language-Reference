...
![Description of floor_interval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/floor_interval.gif)[Descriptionof the illustration floor_interval.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/floor_interval.md)
