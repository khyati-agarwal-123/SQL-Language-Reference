[Previous](STATS_CROSSTAB.html) [Next](STATS_KS_TEST.html) JavaScript must be enabled to correctly display this content 
...
![Description of stats_f_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_f_test.gif)[Description of the illustration stats_f_test.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_f_test.html)
