##  STATS_F_TEST {#GUID-9E2A91FC-5BB3-449A-810C-DA6CB52B56ED} 

Syntax 

![Description of stats_f_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_f_test.gif)[ Description of the illustration stats_f_test.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_f_test.md)
...
**Table: STATS_F_TEST Return Values** 
