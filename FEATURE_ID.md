##  FEATURE_ID {#GUID-BA187F80-5F51-49F6-BB69-64422FB9FD90} 

Syntax 

*feature_id* ::= 

![Description of feature_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_id.gif)[ Description of the illustration feature_id.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_id.md)

Analytic Syntax 

*feature_id_analytic* ::= 

![Description of feature_id_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_id_analytic.gif)[ Description of the illustration feature_id_analytic.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_id_analytic.md)
...
The syntax of the ` FEATURE_ID ` function can use an optional ` GROUPING ` hint when scoring a partitioned model. See [ GROUPING Hint ](Comments.md#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A) . 
