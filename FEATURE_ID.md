...
![Description of feature_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_id.gif)[Description of the illustration feature_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_id.html)

Analytic Syntax

feature_id_analytic::= 

![Description of feature_id_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_id_analytic.gif)[Description of the illustration feature_id_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_id_analytic.html)
