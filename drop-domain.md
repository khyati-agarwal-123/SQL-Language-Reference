##  DROP DOMAIN {#GUID-E82527C8-5C47-43D0-9C0D-E081E78E612F} 
...
![Description of drop_domain.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_domain.gif)[ Description of the illustration drop_domain.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_domain.md)
...
You cannot specify ` IF NOT EXISTS ` with ` DROP DOMAIN ` . This results in the following error: ` ORA-11544:Incorrect IF EXISTS clause for ALTER/DROP statement ` . 
...
If a domain is associated with columns, ` DROP DOMAIN ` *domain_name* fails with ` ORA-11502:The domain  to be dropped has dependent objects.  ` This includes any tables in the recyclebin. 
