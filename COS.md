[Previous](CORR_A.html) [Next](COSH.html) JavaScript must be enabled to correctly display this content 
...
![Description of cos.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cos.gif)[Description of the illustration cos.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cos.html)
