[Previous](CREATE-PROFILE.html) [Next](CREATE-RESTORE-POINT.html) JavaScript must be enabled to correctly display this content 
...
![Description of create_property_graph.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_property_graph.gif)[Descriptionof the illustration create_property_graph.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_property_graph.md)([edge_tables_clause::=](create-property-graph.md#GUID-37364ADB-E89C-4D92-A431-F2544FEDB218__GUID-7AA07F8C-CDB4-4125-9D82-75F75066F9C7) , [graph_options](create-property-graph.html#GUID-37364ADB-E89C-4D92-A431-F2544FEDB218__GUID-998040BE-87F3-4BAC-9413-CA065505BC6D)) 
...
![Description of vertex_tables_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/vertex_tables_clause.gif)[Descriptionof the illustration vertex_tables_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/vertex_tables_clause.md)
...
![Description of vertex_tables_definition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/vertex_tables_definition.gif)[Descriptionof the illustration vertex_tables_definition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/vertex_tables_definition.md)[graph_table_level_and_properties](create-property-graph.md#GUID-37364ADB-E89C-4D92-A431-F2544FEDB218__GUID-4F67B0EB-2339-4F65-BC6C-416523E0B789)
...
![Description of graph_element_name_and_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_element_name_and_key.gif)[Descriptionof the illustration graph_element_name_and_key.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_element_name_and_key.md)
...
![Description of graph_element_object_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_element_object_name.gif)[Descriptionof the illustration graph_element_object_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_element_object_name.md)
...
![Description of graph_element_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_element_key.gif)[Descriptionof the illustration graph_element_key.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_element_key.md)
...
![Description of graph_table_label_and_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_table_label_and_properties.gif)[Descriptionof the illustration graph_table_label_and_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_table_label_and_properties.md)
...
![Description of graph_table_label_properties_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_table_label_properties_clause.gif)[Descriptionof the illustration graph_table_label_properties_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_table_label_properties_clause.md)
...
![Description of graph_table_properties_alternatives.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_table_properties_alternatives.gif)[Descriptionof the illustration graph_table_properties_alternatives.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_table_properties_alternatives.md)
...
![Description of column_name_list.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/column_name_list.gif)[Descriptionof the illustration column_name_list.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/column_name_list.md)
...
![Description of column_or_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/column_or_expression.gif)[Descriptionof the illustration column_or_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/column_or_expression.md)
...
![Description of graph_table_label_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_table_label_clause.gif)[Descriptionof the illustration graph_table_label_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_table_label_clause.md)
...
![Description of edge_tables_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/edge_tables_clause.gif)[Descriptionof the illustration edge_tables_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/edge_tables_clause.md)
...
![Description of edge_tables_definition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/edge_tables_definition.gif)[Descriptionof the illustration edge_tables_definition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/edge_tables_definition.md)[graph_table_level_and_properties](create-property-graph.md#GUID-37364ADB-E89C-4D92-A431-F2544FEDB218__GUID-4F67B0EB-2339-4F65-BC6C-416523E0B789)
...
![Description of vertex_table_reference.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/vertex_table_reference.gif)[Descriptionof the illustration vertex_table_reference.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/vertex_table_reference.md)
...
![Description of graph_options.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_options.gif)[Descriptionof the illustration graph_options.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_options.md)
...
Operations | Result  
---|---  
DROP TABLE t ; DROP [PUBLIC] SYNONYM t; DROP MATERIALIZED VIEW t; CREATE OR REPLACE [PUBLIC] SYNONYM t; | If t is used to define a graph element table e of graph G, then G becomes invalid.  
RENAME t TO t2; | If t is used to defined a graph element table e of graph G, then G becomes invalid  
ALTER TABLE for dropping an unused column C of table t ALTER TABLE | If t is used to defined a graph element table e of graph G, then G becomes invalid  
...
[ALTER PROPERTY GRAPH](alter-property-graph.html#GUID-3437140C-6244-49A2-9305-FBEB4D414761)
