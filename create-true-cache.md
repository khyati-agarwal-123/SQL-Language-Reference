...
![Description of create_true_cache.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_true_cache.gif)[Description of the illustration create_true_cache.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_true_cache.html)
