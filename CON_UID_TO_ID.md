...
![Description of con_uid_to_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_uid_to_id.gif)[Descriptionof the illustration con_uid_to_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_uid_to_id.md)
