[Previous](CON_NAME_TO_ID.html) [Next](CONCAT.html) JavaScript must be enabled to correctly display this content 
...
![Description of con_uid_to_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_uid_to_id.gif)[Description of the illustration con_uid_to_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_uid_to_id.html)
