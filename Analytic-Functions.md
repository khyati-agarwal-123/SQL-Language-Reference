[Previous](Aggregate-Functions.html) [Next](Data-Cartridge-Functions.html) JavaScript must be enabled to correctly display this content 
...
![Description of analytic_function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/analytic_function.gif)[Description of the illustration analytic_function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/analytic_function.html)

analytic_clause::= 

![Description of analytic_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/analytic_clause.gif)[Description of the illustration analytic_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/analytic_clause.html)
...
![Description of windowing_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/windowing_clause.gif)[Description of the illustration windowing_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/windowing_clause.html)
...
[Numeric Precedence](Data-Types.html#GUID-4C0B65DB-E751-4957-A1ED-5044BAFA7812) for information on numeric precedence and [Table 2-9](Data-Type-Comparison-Rules.html#GUID-98BE3A78-6E33-4181-B5CB-D96FD9DC1694__G195937 "An X in a cell indicates implicit conversion of the data types") for more information on implicit conversion 
...
The following notes apply to the `analytic_clause`: 
  ...
  * You can specify `OVER` `analytic_clause` with user-defined analytic functions as well as built-in analytic functions. See [CREATE FUNCTION](CREATE-FUNCTION.html#GUID-156AEDAC-ADD0-4E46-AA56-6D1F7CA63306). 
...
See Also:
  ...
  * Appendix C in [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-AFCE41ED-775B-4A00-AF38-C436776AE0C5) for the collation determination rules for the `OVER` `(PARTITION` `BY` ... `ORDER` `BY` ... `)` clause of an analytic function 

  * [`window_clause`](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__GUID-911420AB-72C0-42DC-8D84-8C87171996ED) in the `SELECT` statement 
...
[order_by_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2171079) of [SELECT](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) for more information on this clause 
...
You cannot specify this clause unless you have specified the `order_by_clause`. Some window boundaries defined by the `RANGE` clause let you specify only one expression in the `order_by_clause`. Refer to [Restrictions on the ORDER BY Clause](Analytic-Functions.html#GUID-527832F7-63C0-4445-8C16-307FA5084056__CIHCEIGA). 
...
[NUMTOYMINTERVAL](NUMTOYMINTERVAL.html#GUID-B98B21AA-44F7-4A9D-A646-6775A1D5F46D) and [NUMTODSINTERVAL](NUMTODSINTERVAL.html#GUID-5A7392A8-7976-4465-8839-A65EFF1A80B6) for information on converting numeric times into intervals 
...
If you specified `RANGE`: 
  ...
  * `value_expr` is a logical offset. It must be a constant or expression that evaluates to a positive numeric value or an interval literal. Refer to [Literals](Literals.html#GUID-192417E8-A79D-4A1D-9879-68272D925707) for information on interval literals. 
...
Analytic functions are commonly used in data warehousing environments. In the list of analytic functions that follows, functions followed by an asterisk (*) allow the full syntax, including the `windowing_clause`. 
  ...
  * [AVG](AVG.html#GUID-B64BCBF1-DAA0-4D88-9821-2C4D3FDE5E4A) * 
  * [BIT_AND_AGG](BIT_AND_AGG.html#GUID-82497098-6D77-48D3-89EF-C1041BF8A258)* 
  * [BIT_OR_AGG](BIT_OR_AGG.html#GUID-18B0E3CB-1C90-4625-8E36-B422FA4E04A8)* 
  * [BIT_XOR_AGG](BIT_XOR_AGG.html#GUID-1563FB7E-9CC9-4D03-859E-BE336AF01F1D)* 
  * [BOOLEAN_AND_AGG](boolean_and_agg.html#GUID-AF3C1A26-C7A1-4BD2-B15C-86B761D4D8D9)* 
  * [BOOLEAN_OR_AGG](boolean_or_agg.html#GUID-C3E187DE-BD26-4440-B0AD-51342FFA4775)* 
  * [CHECKSUM](checksum.html#GUID-3F55C5DF-F23A-4B2F-BC6F-E03B34B78BA8)* 
  ...
  * [CORR](CORR.html#GUID-E73AF5E2-38A4-436A-955C-5122C079F49C) * 
  * [COUNT](COUNT.html#GUID-AEF08B79-024D-4E3A-B362-9715FB011776) * 
  * [COVAR_POP](COVAR_POP.html#GUID-D728D05F-D2E3-405C-986F-088B8353553A) * 
  * [COVAR_SAMP](COVAR_SAMP.html#GUID-7850B9E1-83A4-41CB-8F17-DCD2E2A70C95) * 
  * [CUME_DIST](CUME_DIST.html#GUID-B12C577C-A63C-4D19-8E18-FCCBBFBF8278)
  * [DENSE_RANK](DENSE_RANK.html#GUID-BB66F574-09DF-4594-87A4-ABD83E8DC3FE)
  * [EVERY](every.html#GUID-C34D8A50-3050-4F32-941A-8C2512DEC62D)* 
  ...
  * [FIRST](FIRST.html#GUID-85AB9246-0E0A-44A1-A7E6-4E57502E9238)
  * [FIRST_VALUE](FIRST_VALUE.html#GUID-D454EC3F-370C-4C64-9B11-33FCB10D95EC) * 
  * [KURTOSIS_POP](KURTOSIS_POP.html#GUID-F820DFF7-B758-460E-AECC-053915069B9F)* 
  * [KURTOSIS_SAMP](KURTOSIS_SAMP.html#GUID-487DE503-A015-415F-B6CD-F9D095B91178)* 
  * [LAG](LAG.html#GUID-68081CD0-72BE-4C0A-AA6B-AD39FFA7BCF2)
  * [LAST](LAST.html#GUID-4E16BC0E-D3B8-4BA4-8F97-3A08891A85CC)
  * [LAST_VALUE](LAST_VALUE.html#GUID-A646AF95-C8E9-4A67-87BA-87B11AEE7B79) * 
  * [LEAD](LEAD.html#GUID-0A0481F1-E98F-4535-A739-FCCA8D1B5B77)
  * [LISTAGG](LISTAGG.html#GUID-B6E50D8E-F467-425B-9436-F7F8BF38D466)
  * [MAX](MAX.html#GUID-E5372020-A6DA-44BF-93BE-DA8C3F74CD01) * 
  * [MEDIAN](MEDIAN.html#GUID-DE15705A-AC18-4416-8487-B9E1D70CE01A)
  * [MIN](MIN.html#GUID-F7F04E18-1AD8-4D15-9491-4622AD847A74) * 
  * [NTH_VALUE](NTH_VALUE.html#GUID-F8A0E88C-67E5-4AA6-9515-95D03A7F9EA0) * 
  * [NTILE](NTILE.html#GUID-FAD7A986-AEBD-4A03-B0D2-F7F2148BA5E9)
  * [PERCENT_RANK](PERCENT_RANK.html#GUID-66A868F5-9EBA-482A-BF8C-09300B9EE165)
  * [PERCENTILE_CONT](PERCENTILE_CONT.html#GUID-CA259452-A565-41B3-A4F4-DD74B66CEDE0)
  * [PERCENTILE_DISC](PERCENTILE_DISC.html#GUID-7C34FDDA-C241-474F-8C5C-50CC0182E005)
  ...
  * [RANK](RANK.html#GUID-0950BD34-C994-41DA-A8F9-34B3FE53BBBA)
  * [RATIO_TO_REPORT](RATIO_TO_REPORT.html#GUID-9D10C275-4341-435F-ACF4-767B9CCB7390)
  * [REGR_ (Linear Regression) Functions](REGR_-Linear-Regression-Functions.html#GUID-A675B68F-2A88-4843-BE2C-FCDE9C65F9A9) * 
  * [ROW_NUMBER](ROW_NUMBER.html#GUID-D5A157F8-0F53-45BD-BF8C-AE79B1DB8C41)
  * [STDDEV](STDDEV.html#GUID-CA0C3B1F-1A4C-4CFB-ADAB-D90216C4E099) * 
  * [SKEWNESS_POP](SKEWNESS_POP.html#GUID-DF34158F-B681-4933-BA27-0A3885A9F43C)* 
  * [SKEWNESS_SAMP](SKEWNESS_SAMP.html#GUID-E71D9AEC-0AAA-4A6C-BF70-29EE9AD8F7EC)* 
  * [STDDEV_POP](STDDEV_POP.html#GUID-4F804DE5-7E20-4E08-A1BA-32DBB167B34B) * 
  * [STDDEV_SAMP](STDDEV_SAMP.html#GUID-7B2A708E-E73A-4CFE-978E-3F9C4BD37467) * 
  * [SUM](SUM.html#GUID-5610BE2C-CFE5-446F-A1F7-B924B5663220) * 
  * [VAR_POP](VAR_POP.html#GUID-B62FB4A4-BD1F-47B0-B412-31A98B70C2E4) * 
  * [VAR_SAMP](VAR_SAMP.html#GUID-314D5831-0E26-4ABF-9F46-35F78F97DA52) * 
  * [VARIANCE](VARIANCE.html#GUID-EC33717A-2509-402D-B3BB-7EECB2E4ED8B) * 



See Also:

[Oracle Database Data Warehousing Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG021) for more information on these functions and for scenarios illustrating their use 
