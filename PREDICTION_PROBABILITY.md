[Previous](PREDICTION_DETAILS.html) [Next](PREDICTION_SET.html) JavaScript must be enabled to correctly display this content 
...
![Description of prediction_probability.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_probability.gif)[Descriptionof the illustration prediction_probability.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_probability.md)

prediction_probability_ordered::= 

![Description of prediction_probability_ordered.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_probability_ordered.gif)[Descriptionof the illustration prediction_probability_ordered.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_probability_ordered.md)

Analytic Syntax

prediction_prob_analytic::= 

![Description of prediction_prob_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prediction_prob_analytic.gif)[Descriptionof the illustration prediction_prob_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prediction_prob_analytic.md)
...
The syntax of the `PREDICTION_PROBABILITY` function can use an optional `GROUPING` hint when scoring a partitioned model. See [GROUPING Hint](Comments.html#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A). 
...
The following examples are excerpted from the Oracle Machine Learning for SQL sample programs. For information about the sample programs, see Appendix A in [Oracle Machine Learning for SQL Userâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DMPRG714). 
