...
content
  ...
  1. [AI Vector Search User's Guide](index.md)
...
Type](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
...
vector_embeddings.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_embeddings.md)
...
Search](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
...
[Description of the illustration
vector_embeddings_similarity.eps](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/vector_embeddings_similarity.md)
...
[Description of the illustration
vector_embeddings_similarity_search.eps](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/vector_embeddings_similarity_search.md)
...
Vector Indexes](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-
...
Model"](https://docs.oracle.com/en/database/oracle/oracle-
database/23/vecse/img_text/basic_transform.md)
