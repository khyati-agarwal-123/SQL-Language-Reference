...
![Description of to_timestamp_tz.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_timestamp_tz.gif)[Descriptionof the illustration to_timestamp_tz.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_timestamp_tz.md)
