[Previous](RAWTONHEX.html) [Next](REFTOHEX.html) JavaScript must be enabled to correctly display this content 
...
![Description of ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ref.gif)[Description of the illustration ref.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ref.html)
...
[Oracle Database Object-Relational Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADOBJ00805) for information on `REF`s 
