##  ALTER CLUSTER {#GUID-A4E03C13-7690-4567-9B0A-DA6A21173B4D} 
...
[ CREATE CLUSTER ](CREATE-CLUSTER.md#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7) for information on creating a cluster, [ DROP CLUSTER ](DROP-CLUSTER.md#GUID-531F7DE2-AA2A-400E-BC9A-4CBEEA7B7156) and [ DROP TABLE ](DROP-TABLE.md#GUID-39D89EDC-155D-4A24-837E-D45DDA757B45) for information on removing tables from a cluster, and [ CREATE TABLE ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) ... *physical_properties* for information on adding a table to a cluster 
...
![Description of alter_cluster.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_cluster.gif)[ Description of the illustration alter_cluster.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_cluster.md)( *physical_attributes_clause::* , *size_clause::=* , [ MODIFY PARTITION ](ALTER-CLUSTER.md#GUID-A4E03C13-7690-4567-9B0A-DA6A21173B4D__BGBHGICA) , *allocate_extent_clause::=* , *deallocate_unused_clause::=* , *parallel_clause::=* ) 
...
[ CREATE CLUSTER ](CREATE-CLUSTER.md#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7) for a description of the ` SIZE ` parameter and  " [ Modifying a Cluster: Example ](ALTER-CLUSTER.md#GUID-A4E03C13-7690-4567-9B0A-DA6A21173B4D__I2135513) " 
...
*deallocate_unused_clause* for a full description of this clause and  " [ Deallocating Unused Space: Example ](ALTER-CLUSTER.md#GUID-A4E03C13-7690-4567-9B0A-DA6A21173B4D__I2135524) " 
