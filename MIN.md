##  MIN {#GUID-F7F04E18-1AD8-4D15-9491-4622AD847A74} 

Syntax 

![Description of min.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/min.gif)[ Description of the illustration min.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/min.md)
