##  TO_CLOB (bfile|blob) {#GUID-FD7D58FE-B97C-4B75-85A9-5F82FB1DE96A} 

Syntax 

![Description of to_clob_bfile_blob.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_clob_bfile_blob.gif)[ Description of the illustration to_clob_bfile_blob.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_clob_bfile_blob.md)
