[Previous](Creating-Simple-Queries.html) [Next](The-UNION-ALL-INTERSECT-MINUS-Operators.html) JavaScript must be enabled to correctly display this content 
  ...
  2. [ SQL Queries and Subqueries](SQL-Queries-and-Subqueries.html)
...
![Description of Figure 9-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sqlrf002.gif)[Description of "Figure 9-1 Hierarchical Queries"](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sqlrf002.html)
