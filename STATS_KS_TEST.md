[Previous](STATS_F_TEST.html) [Next](STATS_MODE.html) JavaScript must be enabled to correctly display this content 
...
![Description of stats_ks_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_ks_test.gif)[Description of the illustration stats_ks_test.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_ks_test.html)
