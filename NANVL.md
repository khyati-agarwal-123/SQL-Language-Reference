[Previous](MONTHS_BETWEEN.html) [Next](NCHR.html) JavaScript must be enabled to correctly display this content 
...
![Description of nanvl.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nanvl.gif)[Description of the illustration nanvl.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nanvl.html)
...
Using table `float_point_demo` created for [TO_BINARY_DOUBLE](TO_BINARY_DOUBLE.html#GUID-0BA2E065-8006-426C-A3CB-1F6B0C8F283C), insert a second entry into the table: 
