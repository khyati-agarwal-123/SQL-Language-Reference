##  NANVL {#GUID-3C094646-2A70-41F5-984C-9BC0FB31494A} 

Syntax 

![Description of nanvl.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nanvl.gif)[ Description of the illustration nanvl.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nanvl.md)
