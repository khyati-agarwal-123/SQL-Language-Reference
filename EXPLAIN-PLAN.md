##  EXPLAIN PLAN {#GUID-FD540872-4ED3-4936-96A2-362539931BA0} 
...
[ INSERT ](INSERT.md#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423) and [ SELECT ](SELECT.md#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) for information on the privileges you need to populate and query the plan table 

Syntax 

*explain_plan* ::= 

![Description of explain_plan.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/explain_plan.gif)[ Description of the illustration explain_plan.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/explain_plan.md)
