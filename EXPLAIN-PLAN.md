[Previous](DROP-VIEW.html) [Next](FLASHBACK-DATABASE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Oracle Database SQL Tuning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL271) for information on the output of `EXPLAIN` `PLAN`, how to use the SQL trace facility, and how to generate and interpret execution plans 
...
[INSERT](INSERT.html#GUID-903F8043-0254-4EE9-ACC1-CB8AC0AF3423) and [SELECT](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) for information on the privileges you need to populate and query the plan table 

Syntax

explain_plan::= 

![Description of explain_plan.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/explain_plan.gif)[Descriptionof the illustration explain_plan.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/explain_plan.md)
