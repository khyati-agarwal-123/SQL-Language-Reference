##  ALTER SYSTEM {#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB} 
...
![Description of alter_system.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_system.gif)[ Description of the illustration alter_system.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_system.md)( *archive_log_clause::=* , *checkpoint_clause::=* , *check_datafiles_clause::=* , *distributed_recov_clauses::=* , *end_session_clauses::=* , *quiesce_clauses::=* , *rolling_migration_clauses::=* , *rolling_patch_clauses::=* , *security_clauses::=* , *shutdown_dispatcher_clause::=* , *alter_system_set_clause::=* , *alter_system_reset_clause::=* , *cancel_sql_clause* ) 

*archive_log_clause* ::= 

![Description of archive_log_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/archive_log_clause.gif)[ Description of the illustration archive_log_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/archive_log_clause.md)

*checkpoint_clause* ::= 

![Description of checkpoint_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/checkpoint_clause.gif)[ Description of the illustration checkpoint_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/checkpoint_clause.md)
...
![Description of flush_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/flush_clause.gif)[ Description of the illustration flush_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/flush_clause.md)
...
![Description of end_session_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/end_session_clauses.gif)[ Description of the illustration end_session_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/end_session_clauses.md)

*quiesce_clauses* ::= 

![Description of quiesce_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/quiesce_clauses.gif)[ Description of the illustration quiesce_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/quiesce_clauses.md)
...
![Description of security_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/security_clauses.gif)[ Description of the illustration security_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/security_clauses.md)

*affinity_clauses* ::= 

![Description of affinity_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/affinity_clauses.gif)[ Description of the illustration affinity_clauses.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/affinity_clauses.md)
...
![Description of set_parameter_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_parameter_clause.gif)[ Description of the illustration set_parameter_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_parameter_clause.md)
...
![Description of cancel_sql_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cancel_sql_clause.gif)[ Description of the illustration cancel_sql_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cancel_sql_clause.md)
...
" [ Forcing a Checkpoint: Example ](ALTER-SYSTEM.md#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__I2198447) " 
...
" [ Enabling Distributed Recovery: Example ](ALTER-SYSTEM.md#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__I2198571) " 
...
" [ Clearing the Shared Pool: Example ](ALTER-SYSTEM.md#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__I2054578) " 
...
" [ Disconnecting a Session: Example ](ALTER-SYSTEM.md#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__I2198603) " 
...
" [ Terminating a Session: Example ](ALTER-SYSTEM.md#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__I2260288) " 
...
" [ Forcing a Log Switch: Example ](ALTER-SYSTEM.md#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__I2198556) " 
