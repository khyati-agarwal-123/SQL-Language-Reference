...
![Description of flush_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/flush_clause.gif)[Description of the illustration flush_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/flush_clause.html)
...
![Description of end_session_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/end_session_clauses.gif)[Description of the illustration end_session_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/end_session_clauses.html)

quiesce_clauses::= 

![Description of quiesce_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/quiesce_clauses.gif)[Description of the illustration quiesce_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/quiesce_clauses.html)

rolling_migration_clauses::= 

![Description of rolling_migration_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rolling_migration_clauses.gif)[Description of the illustration rolling_migration_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rolling_migration_clauses.html)

rolling_patch_clauses::= 

![Description of rolling_patch_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rolling_patch_clauses.gif)[Description of the illustration rolling_patch_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rolling_patch_clauses.html)

security_clauses::= 

![Description of security_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/security_clauses.gif)[Description of the illustration security_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/security_clauses.html)

affinity_clauses::= 

![Description of affinity_clauses.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/affinity_clauses.gif)[Description of the illustration affinity_clauses.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/affinity_clauses.html)

shutdown_dispatcher_clause::= 

![Description of shutdown_dispatcher_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/shutdown_dispatcher_clause.gif)[Description of the illustration shutdown_dispatcher_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/shutdown_dispatcher_clause.html)

alter_system_set_clause::= 

![Description of alter_system_set_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_system_set_clause.gif)[Description of the illustration alter_system_set_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_system_set_clause.html)

set_parameter_clause::= 

![Description of set_parameter_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_parameter_clause.gif)[Description of the illustration set_parameter_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_parameter_clause.html)

alter_system_reset_clause::= 

![Description of alter_system_reset_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_system_reset_clause.gif)[Description of the illustration alter_system_reset_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_system_reset_clause.html)
...
![Description of cancel_sql_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cancel_sql_clause.gif)[Description of the illustration cancel_sql_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cancel_sql_clause.html)
...
See Also:
  ...
  * "[Restricting Sessions: Example](ALTER-SYSTEM.html#GUID-2C638517-D73A-41CA-9D8E-A62D1A0B7ADB__I2198404)"

  * The description of the `CREATE` `TABLE` "[encryption_spec](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGDFHBD)" for information on using that feature to encrypt table columns 
...
See Also:
  ...
  * [Managing Security for Oracle Databases](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-8EF7F4E6-04DD-42B8-A2C9-649923F26587)
