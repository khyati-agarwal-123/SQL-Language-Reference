[Previous](Hierarchical-Query-Pseudocolumns.html) [Next](Version-Query-Pseudocolumns.html) JavaScript must be enabled to correctly display this content 
...
Before you use `CURRVAL` for a sequence in your session, you must first initialize the sequence with `NEXTVAL`. Refer to [CREATE SEQUENCE](CREATE-SEQUENCE.html#GUID-E9C78A8C-615A-4757-B2A8-5E6EFB130571) for information on sequences. 
