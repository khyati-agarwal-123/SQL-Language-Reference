[Previous](DROP-FUNCTION.html) [Next](DROP-INDEX.html) JavaScript must be enabled to correctly display this content 
...
![Description of drop_hierarchy.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_hierarchy.gif)[Description of the illustration drop_hierarchy.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_hierarchy.html)
