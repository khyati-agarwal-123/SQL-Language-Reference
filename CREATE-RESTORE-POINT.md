##  CREATE RESTORE POINT {#GUID-AD0FB693-7C28-4908-A870-BA884B320575} 
...
![Description of create_restore_point.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_restore_point.gif)[ Description of the illustration create_restore_point.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_restore_point.md)
...
Specify the name of the restore point. The name must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . 
