...
![Description of create_restore_point.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_restore_point.gif)[Description of the illustration create_restore_point.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_restore_point.html)
