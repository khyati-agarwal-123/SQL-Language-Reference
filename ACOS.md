[Previous](ABS.html) [Next](ADD_MONTHS.html) JavaScript must be enabled to correctly display this content 
...
![Description of acos.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/acos.gif)[Description of the illustration acos.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/acos.html)
