[Previous](KURTOSIS_POP.html) [Next](LAG.html) JavaScript must be enabled to correctly display this content 
...
![Description of kurtosis_samp.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/kurtosis_samp.gif)[Description of the illustration kurtosis_samp.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/kurtosis_samp.html)
