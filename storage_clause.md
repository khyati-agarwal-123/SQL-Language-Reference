##  storage_clause {#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15} 
...
![Description of storage_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/storage_clause.gif)[ Description of the illustration storage_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/storage_clause.md)( *size_clause::=* ) 
...
" [ Specifying Table Storage Attributes: Example ](storage_clause.md#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15__I1015842) " 
...
The ` ENCRYPT ` clause is supported for backward compatibility. However, beginning with Oracle Database 12 *c* Release 2 (12.2), you can instead specify ` ENCRYPT ` in the *tablespace_encryption_clause* . Refer to the *tablespace_encryption_clause* of ` CREATE ` ` TABLESPACE ` for more information. 
