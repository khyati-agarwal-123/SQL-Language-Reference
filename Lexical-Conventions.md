[Previous](Using-Enterprise-Manager.html) [Next](Tools-Support.html) JavaScript must be enabled to correctly display this content 
...
Case is insignificant in reserved words, keywords, identifiers, and parameters. However, case is significant in text literals and quoted names. Refer to [Text Literals](Literals.html#GUID-1824CBAA-6E16-4921-B2A6-112FB02248DA) for a syntax description of text literals. 
