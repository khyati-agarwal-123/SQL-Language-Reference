##  TRIM {#GUID-00D5C77C-19B1-4894-828F-066746235B03} 

Syntax 

![Description of trim.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/trim.gif)[ Description of the illustration trim.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/trim.md)
