...
![Description of vector_embedding.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/vector_embedding.gif)[ Description of the illustration vector_embedding.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/vector_embedding.md)
