...
![Description of compound_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/compound_expression.gif)[Descriptionof the illustration compound_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/compound_expression.md)You can use any built-in function as an expression ([Function Expressions](Function-Expressions.html#GUID-C47F0B7D-9058-481F-815E-A31FB21F3BD5)). However, in a compound expression, some combinations of functions are inappropriate and are rejected. For example, the `LENGTH` function is inappropriate within an aggregate function. 
...
See Also:
  ...
  * [Operator Precedence](About-SQL-Operators.html#GUID-FEF44762-F45C-41D9-B380-F6A61AD25338)* [Hierarchical Queries](Hierarchical-Queries.html#GUID-0118DF1D-B9A9-41EB-8556-C6E7D6A5A84E)
