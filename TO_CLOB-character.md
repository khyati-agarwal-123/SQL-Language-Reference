[Previous](TO_CLOB-bfile-blob.html) [Next](TO_DATE.html) JavaScript must be enabled to correctly display this content 
...
![Description of to_clob.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_clob.gif)[Description of the illustration to_clob.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_clob.html)
