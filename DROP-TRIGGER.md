[Previous](DROP-TABLESPACE-SET.html) [Next](DROP-TYPE.html) JavaScript must be enabled to correctly display this content 
...
[CREATE TRIGGER](CREATE-TRIGGER.html#GUID-EE0DF3AA-7ADC-4171-B8E8-138BE9224E3B) and [ALTER TRIGGER](ALTER-TRIGGER.html#GUID-085BD628-2903-46A3-9850-C0D8ED7F2EEF)
...
![Description of drop_trigger.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_trigger.gif)[Descriptionof the illustration drop_trigger.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_trigger.md)
