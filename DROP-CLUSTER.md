[Previous](DROP-AUDIT-POLICY-Unified-Auditing.html) [Next](SQL-Statements-DROP-CONTEXT-to-DROP-JAVA.html) JavaScript must be enabled to correctly display this content 
...
[CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6), [DROP TABLE](DROP-TABLE.html#GUID-39D89EDC-155D-4A24-837E-D45DDA757B45), [RENAME](RENAME.html#GUID-573347CE-3EB8-42E5-B4D5-EF71CA06FAFC), [GRANT](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3) for information on these steps 
...
![Description of drop_cluster.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_cluster.gif)[Description of the illustration drop_cluster.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_cluster.html)
...
The following examples drop the clusters created in the "[Examples](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2105031)" section of `CREATE` `CLUSTER`. 
