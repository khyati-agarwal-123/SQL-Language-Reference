##  NUMTODSINTERVAL {#GUID-5A7392A8-7976-4465-8839-A65EFF1A80B6} 

Syntax 

![Description of numtodsinterval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/numtodsinterval.gif)[ Description of the illustration numtodsinterval.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/numtodsinterval.md)
