[Previous](NULLIF.html) [Next](NUMTOYMINTERVAL.html) JavaScript must be enabled to correctly display this content 
...
![Description of numtodsinterval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/numtodsinterval.gif)[Description of the illustration numtodsinterval.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/numtodsinterval.html)
