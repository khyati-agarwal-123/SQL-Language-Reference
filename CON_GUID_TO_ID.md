[Previous](CON_DBID_TO_ID.html) [Next](con_id_to_con_name.html) JavaScript must be enabled to correctly display this content 
...
![Description of con_guid_to_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_guid_to_id.gif)[Description of the illustration con_guid_to_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_guid_to_id.html)
