[Previous](ALTER-OPERATOR.html) [Next](ALTER-PACKAGE.html) JavaScript must be enabled to correctly display this content 
...
[CREATE OUTLINE](CREATE-OUTLINE.html#GUID-7CC033AF-DB19-4616-87D9-8173939FD627) for information on creating an outline 
...
![Description of alter_outline.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_outline.gif)[Descriptionof the illustration alter_outline.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_outline.md)
...
"[Rebuilding an Outline: Example](ALTER-OUTLINE.html#GUID-49F25C82-0783-4407-88BB-613F986C2FEC__I2227342)"
