...
![Description of previous.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/previous.gif)[Descriptionof the illustration previous.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/previous.md)
