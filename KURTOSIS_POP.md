...
![Description of kurtosis_pop.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/kurtosis_pop.gif)[Descriptionof the illustration kurtosis_pop.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/kurtosis_pop.md)
