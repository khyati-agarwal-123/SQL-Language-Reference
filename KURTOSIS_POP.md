[Previous](json-type-constructor.html) [Next](KURTOSIS_SAMP.html) JavaScript must be enabled to correctly display this content 
...
![Description of kurtosis_pop.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/kurtosis_pop.gif)[Description of the illustration kurtosis_pop.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/kurtosis_pop.html)
