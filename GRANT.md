[Previous](FLASHBACK-TABLE.html) [Next](INSERT.html) JavaScript must be enabled to correctly display this content 
...
Use the `GRANT` statement to grant: 
  ...
  * Administrative privileges to users only (not to roles). [Table 18-1](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__TABLE_PHX_NNG_S1C "Column 1 names system administrative privileges. Column 2 describes the operations authorized by the privilege.")

Refer to the Database Security Guide for more information about administrative privileges [Managing Administrative Privileges](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-633842B8-4B19-4F96-A757-783BF62825A7)* System privileges to users and roles. [Table 18-2](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE "Column 1 names system privileges grouped by database object. Column 2 describes the operations authorized by the system privilege.")

Note that `ANY` system privileges, for example, `SELECT ANY TABLE`, will not work on `SYS` objects or other dictionary objects. 

  * Schema privileges to users and roles. [Table 18-3](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__TABLE_FGK_Y41_M5B "Column 1 names the schema privilege. Column 2 describes the operations authorized by the schema privilege.")

  * Roles to users, roles, and program units. The granted roles can be either user-defined (local or external) or predefined. For a list of predefined roles, refer to [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG4414). 

  * Object privileges for a particular object to users and roles. [Table 18-4](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBCIIEG "Column 1 names the object privilege. Column 2 describes the operations authorized by each object privilege.")
...
A `GRANT` operation to grant object privileges on an editionable object actualizes the object in the current edition. See [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS99922) for more information about editions and editionable objects. 
...
See Also:
  ...
  * [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG003) for information about other authorization methods and for information about [privileges](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG004)* [REVOKE](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866) for information on revoking grants 
...
![Description of grant.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grant.gif)[Descriptionof the illustration grant.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grant.md)([grant_system_privileges::=](GRANT.md#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2183500), [grant_schema_privileges::=](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__SECTION_DK5_ZLG_SYB),[grant_object_privileges::=](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2123595), [grant_roles_to_programs::=](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGEJAHIE)) 

grant_system_privileges::= 

![Description of grant_system_privileges.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grant_system_privileges.gif)[Descriptionof the illustration grant_system_privileges.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grant_system_privileges.md)([grantee_clause::=](GRANT.md#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2062307), [grantee_identified_by::=](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBEJFGF)) 
...
![Description of grant_schema_privileges.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grant_schema_privileges.gif)[Descriptionof the illustration grant_schema_privileges.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grant_schema_privileges.md)
...
![Description of grantee_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grantee_clause.gif)[Descriptionof the illustration grantee_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grantee_clause.md)

grantee_identified_by::= 

![Description of grantee_identified_by.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grantee_identified_by.gif)[Descriptionof the illustration grantee_identified_by.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grantee_identified_by.md)

grant_object_privileges::= 

![Description of grant_object_privileges.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grant_object_privileges.gif)[Descriptionof the illustration grant_object_privileges.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grant_object_privileges.md)([on_object_clause::=](GRANT.md#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2123618), [grantee_clause::=](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2062307)) 

on_object_clause::= 

![Description of on_object_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/on_object_clause.gif)[Descriptionof the illustration on_object_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/on_object_clause.md)

grant_roles_to_programs::= 

![Description of grant_roles_to_programs.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grant_roles_to_programs.gif)[Descriptionof the illustration grant_roles_to_programs.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grant_roles_to_programs.md)

program_unit::= 

![Description of program_unit.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/program_unit.gif)[Descriptionof the illustration program_unit.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/program_unit.md)
...
Specify the system privilege you want to grant. [Table 18-2](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE "Column 1 names system privileges grouped by database object. Column 2 describes the operations authorized by the system privilege.") lists the system privileges, organized by the database object operated upon. 
...
[Granting a System Privilege to a User: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2125913) and "[Granting System Privileges to a Role: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2125929)"
...
In the case of a secure application role, you need not grant such a role directly to the user. You can let the associated PL/SQL package do this, assuming the user passes appropriate security policies. For more information, see the `CREATE` `ROLE` semantics for [USING package](CREATE-ROLE.html#GUID-B2252DC5-5AE7-49B7-9048-98062993E450__BABCJFBJ) and [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG005)
...
Specify `ALL` `PRIVILEGES` to grant all of the system privileges listed in [Table 18-2](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE "Column 1 names system privileges grouped by database object. Column 2 describes the operations authorized by the system privilege."), except the `SELECT` `ANY` `DICTIONARY`, `ALTER` `DATABASE` `LINK`, and `ALTER` `PUBLIC` `DATABASE` `LINK` privileges. 
...
See Also:
  ...
  * [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG4414) for information on the Oracle predefined roles 

  * "[Granting a Role to a Role: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2125988)"* [CREATE ROLE](CREATE-ROLE.html#GUID-B2252DC5-5AE7-49B7-9048-98062993E450) for information on creating a user-defined role 
...
[CREATE USER](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C) for restrictions on usernames and passwords and "[Assigning User Passwords When Granting a System Privilege: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBDFBGH)"
...
"[Granting a Role with the ADMIN OPTION: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2125940)"
...
See Also:
  ...
  * "[Granting a Role with the DELEGATE OPTION: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBIHJFI)"* The [grant_roles_to_programs](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGEDDFEF) clause for more information on granting roles to program units 
...
You can grant a schema level privilege to any user or any role if you are a user who :
  ...
  * Has the `GRANT ANY SCHEMA PRIVILEGE` system privilege. If you specify `ALL PRIVILEGES` , all the schema level privileges in [Table 18-3](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__TABLE_FGK_Y41_M5B "Column 1 names the schema privilege. Column 2 describes the operations authorized by the schema privilege.") are granted. 
...
[Schema Privileges to Simplify Access Control in the Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-671C3472-FC6F-4E63-B5BB-6DC9D2ABC0D6)
...
Specify the object privilege you want to grant. [Table 18-4](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBCIIEG "Column 1 names the object privilege. Column 2 describes the operations authorized by each object privilege.") lists the object privileges, organized by the type of object on which they can be granted. When you grant an object privilege on a editionable object, either to a user or to a role, the object is actualized in the edition in which the grant is made. Refer to [CREATE EDITION](CREATE-EDITION.html#GUID-6CF92CA1-CAF7-4967-9B34-C02D72C23617) for information on editionable object types and editions. 
...
[Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN002) for information on the data dictionary views and "[Granting Multiple Object Privileges on Individual Columns: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2126048)"
...
"[Granting Object Privileges to a Role: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2125970)"
...
"[Granting Object Privileges on a Table to a User: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2126015)", "[Granting Object Privileges on a View: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2126026)", and "[Granting Object Privileges to a Sequence in Another Schema: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2126037)"
...
"[Granting an Object Privilege on a User: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGEEJCBE)"
...
[CREATE DIRECTORY](CREATE-DIRECTORY.html#GUID-8E9C569A-1B06-42C4-9586-0EF83437001A) and "[Granting an Object Privilege on a Directory: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2125999)"
...
[CREATE JAVA](CREATE-JAVA.html#GUID-69E13452-1F91-4F98-B154-CF5B1C198387)
...
[Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG977) for more information on granting code based access control roles to program units 
...
If you specify the `CONTAINER` clause when granting a privilege or role, then the current container must be the same container and you must specify the same `CONTAINER` clause when you revoke the privilege or role. Refer to the [CONTAINER Clause](REVOKE.html#GUID-BAAD2331-40A5-4366-86CA-BAA6B957E866__BGEDBIHI) of the `REVOKE` statement for more information. 
...
SYNONYMS: | Caution: CREATE PUBLIC SYNONYM and DROP PUBLIC SYNONYM are extremely powerful privileges that should be granted only to trusted users. Refer to Oracle Database Security Guide before granting these privileges.  
...
CHANGE NOTIFICATION | Create a registration on queries and receive database change notifications in response to DML or DDL changes to the objects associated with the registered queries. Refer to Oracle Database Development Guide for more information on database change notification.  
COMMENT ANY TABLE | Comment on a table, view, or column in any schema except SYS,AUDSYS.  
ENABLE DIAGNOSTICS | Set debug-events via ALTER SESSION or ALTER SYSTEM Set debug-actions to execute during an event via ALTER SESSION or ALTER SYSTEM Execute debug-actions immediately via ALTER SESSION or ALTER SYSTEM by specifying the IMMEDIATE keyword instead of an event name Set the event parameter in the spfile via ALTER SYSTEM  
|   
...
SELECT | Query the view with the SELECT statement, including SELECT ... FOR UPDATE. See Also:âobject_privilege for additional information on granting this object privilege on a view  
...
The following statement grants appropriate system privileges to a data warehouse manager role, which was created in the "[Creating a Role: Example](CREATE-ROLE.html#GUID-B2252DC5-5AE7-49B7-9048-98062993E450__I2082342)": 
...
The following example grants the `SELECT` object privileges to a data warehouse user role, which was created in the "[Creating a Role: Example](CREATE-ROLE.html#GUID-B2252DC5-5AE7-49B7-9048-98062993E450__I2082342)": 
...
The following statement grants the `warehouse_user` role to the `dw_manager` role. Both roles were created in the "[Creating a Role: Example](CREATE-ROLE.html#GUID-B2252DC5-5AE7-49B7-9048-98062993E450__I2082342)": 
...
To grant all privileges on the table `oe.bonuses`, which was created in "[Merging into a Table: Example](MERGE.html#GUID-5692CCB7-24D9-4C0E-81A7-A22436DC968F__I2091840)", to the user `hr` with the `GRANT` `OPTION`, issue the following statement: 
...
To grant `SELECT` and `UPDATE` privileges on the view `emp_view`, which was created in "[Creating a View: Example](CREATE-VIEW.html#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30__I2102873)", to all users, issue the following statement: 
