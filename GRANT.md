...
Refer to the Database Security Guide for more information about administrative privileges [Managing Administrative Privileges](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-633842B8-4B19-4F96-A757-783BF62825A7)
  ...
  * System privileges to users and roles. [Table 18-2](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE "Column 1 names system privileges grouped by database object. Column 2 describes the operations authorized by the system privilege.")
...
![Description of grantee_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grantee_clause.gif)[Description of the illustration grantee_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grantee_clause.html)

grantee_identified_by::= 

![Description of grantee_identified_by.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grantee_identified_by.gif)[Description of the illustration grantee_identified_by.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grantee_identified_by.html)

grant_object_privileges::= 

![Description of grant_object_privileges.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grant_object_privileges.gif)[Description of the illustration grant_object_privileges.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grant_object_privileges.html)([on_object_clause::=](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2123618), [grantee_clause::=](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2062307)) 

on_object_clause::= 

![Description of on_object_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/on_object_clause.gif)[Description of the illustration on_object_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/on_object_clause.html)
...
![Description of program_unit.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/program_unit.gif)[Description of the illustration program_unit.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/program_unit.html)
...
See Also:
  ...
  * "[Granting a Role to a Role: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__I2125988)"
...
See Also:
  ...
  * "[Granting a Role with the DELEGATE OPTION: Example](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBIHJFI)"

  * The [grant_roles_to_programs](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGEDDFEF) clause for more information on granting roles to program units 
