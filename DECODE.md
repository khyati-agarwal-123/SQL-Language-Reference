##  DECODE {#GUID-39341D91-3442-4730-BD34-D3CF5D4701CE} 

Syntax 

![Description of decode.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/decode.gif)[ Description of the illustration decode.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/decode.md)
