...
![Description of savepoint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/savepoint.gif)[Descriptionof the illustration savepoint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/savepoint.md)
