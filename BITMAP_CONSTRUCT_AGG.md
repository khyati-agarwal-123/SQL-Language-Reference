[Previous](BITMAP_BUCKET_NUMBER.html) [Next](BITMAP_COUNT.html) JavaScript must be enabled to correctly display this content 
...
![Description of bitmap_construct_agg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_construct_agg.gif)[Description of the illustration bitmap_construct_agg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_construct_agg.html)
