...
![Description of bitmap_construct_agg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitmap_construct_agg.gif)[Descriptionof the illustration bitmap_construct_agg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitmap_construct_agg.md)
