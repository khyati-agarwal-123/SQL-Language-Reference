...
![Description of sys_guid.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_guid.gif)[Descriptionof the illustration sys_guid.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_guid.md)
