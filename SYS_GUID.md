[Previous](SYS_EXTRACT_UTC.html) [Next](SYS_OP_ZONE_ID.html) JavaScript must be enabled to correctly display this content 
...
![Description of sys_guid.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_guid.gif)[Description of the illustration sys_guid.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_guid.html)
