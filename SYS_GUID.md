##  SYS_GUID {#GUID-761E36B4-32DA-497D-8829-3D4653381F9B} 

Syntax 

![Description of sys_guid.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_guid.gif)[ Description of the illustration sys_guid.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_guid.md)
