##  ORA_DST_ERROR {#GUID-02FAF3EC-D90A-42FB-A212-513314AD774A} 

Syntax 

![Description of ora_dst_error.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_dst_error.gif)[ Description of the illustration ora_dst_error.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_dst_error.md)
