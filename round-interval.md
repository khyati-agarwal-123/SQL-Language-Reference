##  ROUND (interval) {#GUID-BE2A9358-55A6-432B-AC78-535A4D1A55F2} 

Syntax 

![Description of round_interval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/round_interval.gif)[ Description of the illustration round_interval.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/round_interval.md)
