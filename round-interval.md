[Previous](ROUND-date.html) [Next](ROUND-number.html) JavaScript must be enabled to correctly display this content 
...
![Description of round_interval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/round_interval.gif)[Description of the illustration round_interval.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/round_interval.html)
