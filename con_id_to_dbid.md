...
![Description of con_id_to_dbid.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_id_to_dbid.gif)[Descriptionof the illustration con_id_to_dbid.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_id_to_dbid.md)
