[Previous](trunc-interval.html) [Next](TZ_OFFSET.html) JavaScript must be enabled to correctly display this content 
...
![Description of trunc_number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/trunc_number.gif)[Description of the illustration trunc_number.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/trunc_number.html)
