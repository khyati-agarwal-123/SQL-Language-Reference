...
![Description of cardinality.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cardinality.gif)[Descriptionof the illustration cardinality.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cardinality.md)
