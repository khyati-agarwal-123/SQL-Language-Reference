[Previous](boolean_or_agg.html) [Next](CAST.html) JavaScript must be enabled to correctly display this content 
...
![Description of cardinality.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cardinality.gif)[Description of the illustration cardinality.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cardinality.html)
