[Previous](Types-of-SQL-Statements.html) [Next](ADMINISTER-KEY-MANAGEMENT.html) JavaScript must be enabled to correctly display this content 
...
The "Semantics" section describes the purpose of the keywords, parameters, and clauses that make up the syntax, as well as restrictions and other usage notes that may apply to them. (The conventions for keywords and parameters used in this chapter are explained in the "[Preface](Preface.html#GUID-0897B474-6033-4398-AA8A-922F1C5CAF53)" of this reference.) 
