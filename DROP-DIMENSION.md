...
![Description of drop_dimension.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_dimension.gif)[Descriptionof the illustration drop_dimension.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_dimension.md)
