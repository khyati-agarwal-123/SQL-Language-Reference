[Previous](The-UNION-ALL-INTERSECT-MINUS-Operators.html) [Next](Joins.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Collation Derivation ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-27689130-A177-40F9-B05D-05855407905A)* [Linguistic Sorting and Matching](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-85328A92-CB08-4467-9F02-42E9EF9D41B7)

  * [Default Values for NLS Parameters in SQL Functions ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG-GUID-B16ADD64-24AC-46FC-B96F-D15B28C70C1D)* [NLSSORT](NLSSORT.html#GUID-781C6FE8-0924-4617-AECB-EE40DE45096D)
