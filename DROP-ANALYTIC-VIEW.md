[Previous](DISASSOCIATE-STATISTICS.html) [Next](DROP-ATTRIBUTE-DIMENSION.html) JavaScript must be enabled to correctly display this content 
...
![Description of drop_analytic_view.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_analytic_view.gif)[Description of the illustration drop_analytic_view.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_analytic_view.html)
