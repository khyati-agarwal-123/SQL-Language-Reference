##  DROP ANALYTIC VIEW {#GUID-16BF7588-87E8-4324-BCEC-242355245720} 
...
![Description of drop_analytic_view.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_analytic_view.gif)[ Description of the illustration drop_analytic_view.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_analytic_view.md)
