[Previous](Oracle-Compliance-with-SQLJRT2008.html) [Next](oracle-compliance-sql-mda.html) JavaScript must be enabled to correctly display this content 
...
[Table C-3](Oracle-Compliance-with-SQLXML2011.html#GUID-0D0F19C8-0FB7-4FDD-A55B-18839F340E17__BJEGCHBH "The first column lists the feature ID and the second column lists the feature name") describes Oracle's support for the features of SQL/XML. 
...
X070, XMLSerialize: Character string serialization and CONTENT option | Oracle supports this feature, with this restriction: In the standard, the choice of DOCUMENT or CONTENT is optional; in Oracle, you must specify one of these. Oracle extends this feature as follows: the standard requires a target data type; Oracle defaults to CLOB.  
