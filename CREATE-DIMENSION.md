[Previous](CREATE-DATABASE-LINK.html) [Next](CREATE-DIRECTORY.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [CREATE MATERIALIZED VIEW](CREATE-MATERIALIZED-VIEW.html#GUID-EE262CA4-01E5-4618-B659-6165D993CA1B) for more information on materialized views 

  * [Oracle Database SQL Tuning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL591) for more information on query rewrite, the optimizer and the SQL Access Advisor 
...
![Description of create_dimension.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_dimension.gif)[Descriptionof the illustration create_dimension.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_dimension.md)

level_clause::= 

![Description of level_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_clause.gif)[Descriptionof the illustration level_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_clause.md)

hierarchy_clause::= 

![Description of hierarchy_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hierarchy_clause.gif)[Descriptionof the illustration hierarchy_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hierarchy_clause.md)

dimension_join_clause::= 

![Description of dimension_join_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dimension_join_clause.gif)[Descriptionof the illustration dimension_join_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dimension_join_clause.md)

attribute_clause::= 

![Description of attribute_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/attribute_clause.gif)[Descriptionof the illustration attribute_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/attribute_clause.md)

extended_attribute_clause::= 

![Description of extended_attribute_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/extended_attribute_clause.gif)[Descriptionof the illustration extended_attribute_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/extended_attribute_clause.md)
...
Specify the name of the dimension. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
Specify this clause to indicate that if the specified level is `NULL`, then the level is to be skipped. This clause lets you preserve the hierarchical chain of parent-child relationship by an alternative path that skips over the specified level. See [hierarchy_clause](CREATE-DIMENSION.html#GUID-E6CD4CFC-5D06-4A8F-9DF1-C609A7EB8413__I2061857). 
