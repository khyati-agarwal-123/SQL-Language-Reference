...
![Description of var_pop.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/var_pop.gif)[Descriptionof the illustration var_pop.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/var_pop.md)
