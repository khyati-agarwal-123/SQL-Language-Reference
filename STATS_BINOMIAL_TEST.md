##  STATS_BINOMIAL_TEST {#GUID-3DDCDC0C-0DB2-479F-A6EB-E9FC0063ABF4} 

Syntax 

![Description of stats_binomial_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_binomial_test.gif)[ Description of the illustration stats_binomial_test.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_binomial_test.md)
...
**Table: STATS_BINOMIAL Return Values** 
