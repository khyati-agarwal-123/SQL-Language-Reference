[Previous](STANDARD_HASH.html) [Next](STATS_CROSSTAB.html) JavaScript must be enabled to correctly display this content 
...
![Description of stats_binomial_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_binomial_test.gif)[Description of the illustration stats_binomial_test.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_binomial_test.html)
