##  RPAD {#GUID-064CFCAE-5902-49F9-800E-0AF311AEF595} 

Syntax 

![Description of rpad.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rpad.gif)[ Description of the illustration rpad.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rpad.md)
