...
![Description of function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/function.gif)[Descriptionof the illustration function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/function.md)

single_row_function::= 

![Description of single_row_function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/single_row_function.gif)[Descriptionof the illustration single_row_function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/single_row_function.md)
