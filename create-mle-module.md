[Previous](create-mle-env.html) [Next](CREATE-OPERATOR.html) JavaScript must be enabled to correctly display this content 
...
[ JavaScript Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=GUID-EDC075CA-B50E-45D8-8A72-D060C6DB47DB)
...
![Description of create_mle_module.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_mle_module.gif)[Descriptionof the illustration create_mle_module.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_mle_module.md)
...
See Also:
  ...
  * [JavaScript Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=MLEJS-GUID-EDC075CA-B50E-45D8-8A72-D060C6DB47DB)* [DROP MLE MODULE](drop-mle-module.html#GUID-1E3DEB27-76D6-4564-BC3F-B11DB02609A7)

  * [ALTER MLE MODULE](alter-mle-module.html#GUID-9CE0DFB6-68BE-427D-AEEB-294C0FD31F8F)* [CREATE MLE ENV](create-mle-env.html#GUID-419C81FD-338D-495F-85CD-135D4D316718)
