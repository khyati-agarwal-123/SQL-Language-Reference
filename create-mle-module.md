##  CREATE MLE MODULE {#GUID-EF8D8EBC-2313-4C6C-A76E-1A739C304DCC} 
...
![Description of create_mle_module.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_mle_module.gif)[ Description of the illustration create_mle_module.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_mle_module.md)
