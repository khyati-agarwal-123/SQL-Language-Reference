[Previous](CREATE-INDEXTYPE.html) [Next](CREATE-JAVA.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [ALTER INMEMORY JOIN GROUP](ALTER-INMEMORY-JOIN-GROUP.html#GUID-AF24F413-BB14-4B5D-93BF-9EB31ACFEBEC) and [DROP INMEMORY JOIN GROUP](DROP-INMEMORY-JOIN-GROUP.html#GUID-520D0E9A-B577-4BCD-B6CB-8EB448C0686D)* [Oracle Database In-Memory Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=INMEM-GUID-3E5491C4-B345-4A8E-8B1B-8DC150C8A797) for more information on join groups 
...
![Description of create_inmemory_join_group.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_inmemory_join_group.gif)[Descriptionof the illustration create_inmemory_join_group.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_inmemory_join_group.md)
...
Specify the name of the join group to be created. The name must satisfy the requirements listed in â[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)â. 
