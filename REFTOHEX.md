[Previous](REF.html) [Next](REGEXP_COUNT.html) JavaScript must be enabled to correctly display this content 
...
![Description of reftohex.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/reftohex.gif)[Description of the illustration reftohex.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/reftohex.html)
