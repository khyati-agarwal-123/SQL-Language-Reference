...
![Description of sys_context.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_context.gif)[Descriptionof the illustration sys_context.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_context.md)
...
See Also:
  ...
  * [Using Code Based Access Control for Definer's Rights and Invoker's Rights](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-45E77E8E-587F-42AF-A163-D814264341E2)* [Oracle Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG14002) for information on using the application context feature in your application development 
