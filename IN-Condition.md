##  IN Condition {#GUID-C7961CB3-8F60-47E0-96EB-BDCF5DB1317C} 

An *in_condition* is a membership condition. It tests a value for membership in a list of values or subquery 

*in_condition* ::= 

![Description of in_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/in_condition.gif)[ Description of the illustration in_condition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/in_condition.md)
...
[ Table 6-12 ](IN-Condition.md#GUID-C7961CB3-8F60-47E0-96EB-BDCF5DB1317C__CJAFFIIG) lists the form of ` IN ` condition. 
