...
![Description of xmlcast.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlcast.gif)[Descriptionof the illustration xmlcast.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlcast.md)([datatype::=](Data-Types.md#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483__SECTION_KLC_CHG_DDC)) 
