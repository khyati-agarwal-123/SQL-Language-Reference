[Previous](SCN_TO_TIMESTAMP.html) [Next](SET.html) JavaScript must be enabled to correctly display this content 
...
![Description of sessiontimezone.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sessiontimezone.gif)[Description of the illustration sessiontimezone.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sessiontimezone.html)
