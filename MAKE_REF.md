##  MAKE_REF {#GUID-926B9963-5387-4781-88D5-A005334C1F2A} 

Syntax 

![Description of make_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/make_ref.gif)[ Description of the illustration make_ref.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/make_ref.md)
...
[ *Oracle Database Object-Relational Developer's Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADOBJ005) for more information about object views and [ DEREF ](DEREF.md#GUID-E551FFE4-619F-40CE-8303-683EFA3EB28F)
