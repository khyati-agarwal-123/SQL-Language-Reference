...
![Description of make_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/make_ref.gif)[Descriptionof the illustration make_ref.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/make_ref.md)
