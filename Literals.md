...
This section contains these topics:
  ...
  * [Text Literals](Literals.html#GUID-1824CBAA-6E16-4921-B2A6-112FB02248DA)

  * [Numeric Literals](Literals.html#GUID-F521FBA0-FFED-4079-ABC4-9052218B3FD5)

  * [Datetime Literals](Literals.html#GUID-8F4B3F82-8821-4071-84D6-FBBA21C05AC1)

  * [Interval Literals](Literals.html#GUID-DC8D1DAD-7D04-45EA-9546-82810CD09A1B)
...
![Description of integer.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/integer.gif)[Description of the illustration integer.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/integer.html)
...
![Description of number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/number.gif)[Description of the illustration number.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/number.html)
...
![Description of interval_year_to_month.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/interval_year_to_month.gif)[Description of the illustration interval_year_to_month.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/interval_year_to_month.html)
...
![Description of interval_day_to_second.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/interval_day_to_second.gif)[Description of the illustration interval_day_to_second.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/interval_day_to_second.html)
