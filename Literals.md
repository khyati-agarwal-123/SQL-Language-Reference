[Previous](Data-Type-Comparison-Rules.html) [Next](Format-Models.html) JavaScript must be enabled to correctly display this content 
...
This section contains these topics:
  ...
  * [Text Literals](Literals.html#GUID-1824CBAA-6E16-4921-B2A6-112FB02248DA)* [Numeric Literals](Literals.html#GUID-F521FBA0-FFED-4079-ABC4-9052218B3FD5)

  * [Datetime Literals](Literals.html#GUID-8F4B3F82-8821-4071-84D6-FBBA21C05AC1)* [Interval Literals](Literals.html#GUID-DC8D1DAD-7D04-45EA-9546-82810CD09A1B)
...
Text literals have properties of both the `CHAR` and `VARCHAR2` data types: 
  ...
  * A text literal can have a maximum length of 4000 bytes if the initialization parameter `MAX_STRING_SIZE` `=` `STANDARD`, and 32767 bytes if `MAX_STRING_SIZE` `=` `EXTENDED`. See [Extended Data Types](Data-Types.html#GUID-8EFA29E9-E8D8-40A6-A43E-954908C954A4) for more information. 
...
[Blank-Padded and Nonpadded Comparison Semantics](Data-Type-Comparison-Rules.html#GUID-A114F1F4-A08D-4107-B679-323DC7FEA31C__BABJBDGB)
...
![Description of integer.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/integer.gif)[Descriptionof the illustration integer.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/integer.md)
...
![Description of number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/number.gif)[Descriptionof the illustration number.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/number.md)
...
[ALTER SESSION](ALTER-SESSION.html#GUID-27186B28-7EFC-4998-B1ED-2B905CC0211B) and [Oracle Database Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10126)
...
The date function `SYSDATE` returns the current system date and time. The function `CURRENT_DATE` returns the current session date. For information on `SYSDATE`, the `TO_*` datetime functions, and the default date format, see [Datetime Functions](Single-Row-Functions.html#GUID-5652DBC2-41C7-4F07-BEDD-DAF620E35F3C). 
...
[Datetime Expressions](Datetime-Expressions.html#GUID-F72A753A-98A4-4EBD-84E9-C014CE058384) for more information 
...
[Analytic Functions](Analytic-Functions.html#GUID-527832F7-63C0-4445-8C16-307FA5084056), [NUMTODSINTERVAL](NUMTODSINTERVAL.html#GUID-5A7392A8-7976-4465-8839-A65EFF1A80B6), and [NUMTOYMINTERVAL](NUMTOYMINTERVAL.html#GUID-B98B21AA-44F7-4A9D-A646-6775A1D5F46D)
...
![Description of interval_year_to_month.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/interval_year_to_month.gif)[Descriptionof the illustration interval_year_to_month.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/interval_year_to_month.md)
...
![Description of interval_day_to_second.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/interval_day_to_second.gif)[Descriptionof the illustration interval_day_to_second.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/interval_day_to_second.md)
