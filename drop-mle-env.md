...
![Description of drop_mle_env.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_mle_env.gif)[Description of the illustration drop_mle_env.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_mle_env.html)
