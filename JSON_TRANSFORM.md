...
![Description of json_transform.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_transform.gif)[Descriptionof the illustration json_transform.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_transform.md)([operation::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-D5868C5C-960B-4C87-89D4-C8B077F9B3BB), [JSON_TRANSFORM_returning_clause::=](JSON_TRANSFORM.html#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-66E4F03C-9497-4508-B791-E07AE23CEE73), [JSON_passing_clause::=](JSON_TRANSFORM.html#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-05C58A2A-BA46-4BCB-AFBF-FEF4C23B411C) ) 

JSON_TRANSFORM_returning_clause::= 

![Description of json_transform_returning_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_transform_returning_clause.gif)[Descriptionof the illustration json_transform_returning_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_transform_returning_clause.md)
...
![Description of add_set_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/add_set_op.gif)[Descriptionof the illustration add_set_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/add_set_op.md)
...
![Description of append_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_op.gif)[Descriptionof the illustration append_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of case_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/case_op.gif)[Descriptionof the illustration case_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/case_op.md)
...
![Description of copy_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/copy_op.gif)[Descriptionof the illustration copy_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/copy_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of insert_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/insert_op.gif)[Descriptionof the illustration insert_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/insert_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of intersect_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/intersect_op.gif)[Descriptionof the illustration intersect_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/intersect_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of keep_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/keep_op.gif)[Descriptionof the illustration keep_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/keep_op.md)
...
![Description of merge_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge_op.gif)[Descriptionof the illustration merge_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of minus_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/minus_op.gif)[Descriptionof the illustration minus_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/minus_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)

nested_path_op::= 

![Description of nested_path_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nested_path_op.gif)[Descriptionof the illustration nested_path_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nested_path_op.md)
...
![Description of prepend_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prepend_op.gif)[Descriptionof the illustration prepend_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prepend_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of remove_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/remove_op.gif)[Descriptionof the illustration remove_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/remove_op.md)
...
![Description of remove_set_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/remove_set_op.gif)[Descriptionof the illustration remove_set_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/remove_set_op.md)
...
![Description of rename_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rename_op.gif)[Descriptionof the illustration rename_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rename_op.md)
...
![Description of replace_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/replace_op.gif)[Descriptionof the illustration replace_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/replace_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of set_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_op.gif)[Descriptionof the illustration set_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)

sort_op::= 

![Description of sort_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sort_op.gif)[Descriptionof the illustration sort_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sort_op.md)
...
![Description of union_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/union_op.gif)[Descriptionof the illustration union_op.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/union_op.md)[rhs_expr::=](JSON_TRANSFORM.md#GUID-DD2A821B-C688-4310-81B5-5F45090B9366__GUID-1BBA7230-9695-482E-B686-BADB0724F307)
...
![Description of rhs_expr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rhs_expr.gif)[Descriptionof the illustration rhs_expr.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rhs_expr.md)
