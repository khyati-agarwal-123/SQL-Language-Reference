##  JSON_TRANSFORM {#GUID-DD2A821B-C688-4310-81B5-5F45090B9366} 
...
For details on *JSON_passing_clause* see [ JSON_EXISTS Condition ](SQL-JSON-Conditions.md#GUID-57762C80-0C8A-4B18-9BA7-9B3F5ABDC988) . 

*operation* ::= 

![Description of operation.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/operation.gif)[ Description of the illustration operation.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/operation.md)( *append_op::=* , *case_op::=* , *copy_op::=* , *insert_op::=* , *intersect_op::=* , *keep_op::=* , *merge_op::=* , *minus_op::=* , *nested_path_op::=* , *prepend_op::=* , *remove_op::=* , *rename_op::=* , *replace_op::=* , *set_op* , *sort_op* , *union_op* ,) 
...
![Description of add_set_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/add_set_op.gif)[ Description of the illustration add_set_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/add_set_op.md)
...
![Description of append_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_op.gif)[ Description of the illustration append_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_op.md)
...
![Description of case_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/case_op.gif)[ Description of the illustration case_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/case_op.md)
...
![Description of copy_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/copy_op.gif)[ Description of the illustration copy_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/copy_op.md)
...
![Description of insert_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/insert_op.gif)[ Description of the illustration insert_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/insert_op.md)
...
![Description of intersect_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/intersect_op.gif)[ Description of the illustration intersect_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/intersect_op.md)
...
![Description of keep_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/keep_op.gif)[ Description of the illustration keep_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/keep_op.md)
...
![Description of merge_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge_op.gif)[ Description of the illustration merge_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge_op.md)
...
![Description of minus_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/minus_op.gif)[ Description of the illustration minus_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/minus_op.md)
...
![Description of nested_path_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nested_path_op.gif)[ Description of the illustration nested_path_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nested_path_op.md)
...
![Description of prepend_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/prepend_op.gif)[ Description of the illustration prepend_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/prepend_op.md)
...
![Description of remove_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/remove_op.gif)[ Description of the illustration remove_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/remove_op.md)
...
![Description of remove_set_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/remove_set_op.gif)[ Description of the illustration remove_set_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/remove_set_op.md)
...
![Description of rename_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rename_op.gif)[ Description of the illustration rename_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rename_op.md)
...
![Description of replace_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/replace_op.gif)[ Description of the illustration replace_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/replace_op.md)
...
![Description of set_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_op.gif)[ Description of the illustration set_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_op.md)
...
![Description of sort_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sort_op.gif)[ Description of the illustration sort_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sort_op.md)
...
![Description of union_op.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/union_op.gif)[ Description of the illustration union_op.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/union_op.md)
...
![Description of rhs_expr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rhs_expr.gif)[ Description of the illustration rhs_expr.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rhs_expr.md)
...
*Oracle SQL Function JSON_TRANSFORMof the JSON Developer's Guide* for a full discussion with examples. 
