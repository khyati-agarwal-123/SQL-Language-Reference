[Previous](deallocate_unused_clause.html) [Next](logging_clause.html) JavaScript must be enabled to correctly display this content 
...
A `file_specification` can appear in the following statements: 
  ...
  * `CREATE` `CONTROLFILE` (see [CREATE CONTROLFILE](CREATE-CONTROLFILE.html#GUID-9B389F28-C4D0-405D-BFE6-48237E8BD791)) 

  * `CREATE` `DATABASE` (see [CREATE DATABASE](CREATE-DATABASE.html#GUID-ECE717DF-F116-4151-927C-2E51BB9DD39C)) 

  * `ALTER` `DATABASE` (see [ALTER DATABASE](ALTER-DATABASE.html#GUID-8069872F-E680-4511-ADD8-A4E30AF67986)) 

  * `CREATE` `TABLESPACE` (see [CREATE TABLESPACE](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9)) 

  * `ALTER` `TABLESPACE` (see [ALTER TABLESPACE](ALTER-TABLESPACE.html#GUID-CA074861-55D3-4768-8995-43D4DA26365D)) 

  * `ALTER` `DISKGROUP` (see [ALTER DISKGROUP](ALTER-DISKGROUP.html#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557)) 
...
![Description of file_specification.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/file_specification.gif)[Description of the illustration file_specification.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/file_specification.html)

datafile_tempfile_spec::= 

![Description of datafile_tempfile_spec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/datafile_tempfile_spec.gif)[Description of the illustration datafile_tempfile_spec.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/datafile_tempfile_spec.html)([size_clause::=](size_clause.html#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517__CHDEAIID)) 

redo_log_file_spec::= 

![Description of redo_log_file_spec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/redo_log_file_spec.gif)[Description of the illustration redo_log_file_spec.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/redo_log_file_spec.html)([size_clause::=](size_clause.html#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517__CHDEAIID)) 
...
![Description of fully_qualified_file_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fully_qualified_file_name.gif)[Description of the illustration fully_qualified_file_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fully_qualified_file_name.html)

numeric_file_name::= 

![Description of numeric_file_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/numeric_file_name.gif)[Description of the illustration numeric_file_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/numeric_file_name.html)

incomplete_file_name::= 

![Description of incomplete_file_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/incomplete_file_name.gif)[Description of the illustration incomplete_file_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/incomplete_file_name.html)

alias_file_name::= 

![Description of alias_file_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alias_file_name.gif)[Description of the illustration alias_file_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alias_file_name.html)
...
[Oracle Automatic Storage Management Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=OSTMG03620) for more information on Oracle Managed Files, "[Specifying a Data File: Example](file_specification.html#GUID-580FA726-F712-4410-90CF-783A2DA89688__I1015815)", and "[Specifying a Log File: Example](file_specification.html#GUID-580FA726-F712-4410-90CF-783A2DA89688__I1015778)"
...
[Oracle Automatic Storage Management Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=OSTMG21000) for information on using Oracle ASM 
...
ONLINELOG | Online logs | group_group# | â  
ARCHIVELOG | Archive logs | thread_thread#_seq_sequence# | â  
...
FLASHBACK | Flashback logs | log_log# | â  
...
A template is a named collection of attributes. You can create templates and apply them to files in a disk group. You can determine the names of all Oracle ASM template names by querying the `V$ASM_TEMPLATE` data dictionary view. Refer to [diskgroup_template_clauses](ALTER-DISKGROUP.html#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557__I2168808) for instructions on creating Oracle ASM templates. 
...
[diskgroup_template_clauses](ALTER-DISKGROUP.html#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557__I2168808) for information about the default templates 
...
If you are specifying an alias during file creation, then refer to [diskgroup_directory_clauses](ALTER-DISKGROUP.html#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557__I2175401) and [diskgroup_alias_clauses](ALTER-DISKGROUP.html#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557__I2168812) for instructions on specifying the full alias name. 
...
"[Adding a Log File: Example](file_specification.html#GUID-580FA726-F712-4410-90CF-783A2DA89688__I1015789)"
...
"[Adding a Data File: Example](file_specification.html#GUID-580FA726-F712-4410-90CF-783A2DA89688__I1015826)" and "[Adding a Log File: Example](file_specification.html#GUID-580FA726-F712-4410-90CF-783A2DA89688__I1015789)"
...
The following statement adds a logfile group 5 with member log files on migration target disks `4k_disk_a` and `4k_disk_b`. After executing this statement, you can switch existing log files on disks with 512-byte block size to logs with 4K block size using the [switch_logfile_clause](ALTER-DATABASE.html#GUID-8069872F-E680-4511-ADD8-A4E30AF67986__BGBIGEHB). 
