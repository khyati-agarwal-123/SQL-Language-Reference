...
![Description of xmlcdata.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlcdata.gif)[Descriptionof the illustration xmlcdata.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlcdata.md)
