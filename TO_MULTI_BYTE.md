[Previous](TO_LOB.html) [Next](to_nchar-boolean.html) JavaScript must be enabled to correctly display this content 
...
![Description of to_multi_byte.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_multi_byte.gif)[Description of the illustration to_multi_byte.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_multi_byte.html)
