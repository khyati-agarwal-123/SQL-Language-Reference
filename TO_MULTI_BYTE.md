...
![Description of to_multi_byte.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_multi_byte.gif)[Descriptionof the illustration to_multi_byte.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_multi_byte.md)
