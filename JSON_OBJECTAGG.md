[Previous](JSON_OBJECT.html) [Next](JSON_QUERY.html) JavaScript must be enabled to correctly display this content 
...
![Description of json_objectagg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_objectagg.gif)[Descriptionof the illustration json_objectagg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_objectagg.md)
