...
![Description of nls_lower.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_lower.gif)[Descriptionof the illustration nls_lower.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_lower.md)
