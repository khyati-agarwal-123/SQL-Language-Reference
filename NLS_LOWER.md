[Previous](NLS_INITCAP.html) [Next](NLS_UPPER.html) JavaScript must be enabled to correctly display this content 
...
![Description of nls_lower.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_lower.gif)[Description of the illustration nls_lower.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_lower.html)
