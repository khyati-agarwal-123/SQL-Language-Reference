##  Types of SQL Statements {#GUID-E1749EF5-2264-44DF-99EF-AEBEB943BED6} 
...
The lists in the following sections provide a functional summary of SQL statements and are divided into these categories: 
  ...
  * [ System Control Statements ](Types-of-SQL-Statements.md#GUID-83CC2729-F33B-45D8-A6C5-0D3C654FBFC4)
...
###  Data Definition Language (DDL) Statements {#GUID-FD9A8CB4-6B9A-44E5-B114-EFB8DA76FC88} 
...
The DDL statements are: 
  ...
  * ` ALTER ` ... (All statements beginning with ` ALTER ` , except ` ALTER ` ` SESSION ` and ` ALTER ` ` SYSTEM ` —see  " [ Session Control Statements ](Types-of-SQL-Statements.md#GUID-B8AEC1B3-D1E8-4567-9EFB-8F3410CA70A4) "  and  " [ System Control Statements ](Types-of-SQL-Statements.md#GUID-83CC2729-F33B-45D8-A6C5-0D3C654FBFC4) "  ) 
  * ` ANALYZE `
...
###  Data Manipulation Language (DML) Statements {#GUID-2E008D4A-F6FD-4F34-9071-7E10419CA24D} 
...
###  Transaction Control Statements {#GUID-FEC504E9-D22D-4082-A092-07891911C5CF} 
...
All transaction control statements, except certain forms of the ` COMMIT ` and ` ROLLBACK ` commands, are supported in PL/SQL. For information on the restrictions, see [ COMMIT ](COMMIT.md#GUID-6CD5C9A7-54B9-4FA2-BA3C-D6B4492B9EE2) and [ ROLLBACK ](ROLLBACK.md#GUID-94551F0C-A47F-43DE-BC68-9B1C1ED38C93) . 

###  Session Control Statements {#GUID-B8AEC1B3-D1E8-4567-9EFB-8F3410CA70A4} 
...
###  System Control Statements {#GUID-83CC2729-F33B-45D8-A6C5-0D3C654FBFC4} 
...
###  Embedded SQL Statements {#GUID-CD76B6B5-01C4-46CA-964A-A41872D6AEB0} 
