[Previous](Sorting-Query-Results.html) [Next](Using-Subqueries.html) JavaScript must be enabled to correctly display this content 
...
You cannot specify LOB columns in the `WHERE` clause if the `WHERE` clause contains the join condition. The use of LOBs in `WHERE` clauses is also subject to other restrictions. See [Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB010) for more information. 
...
"[Using Join Queries: Examples](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2066611)"

### Band Joins

A band join is a special type of nonequijoin in which key values in one data set must fall within the specified range (âbandâ) of the second data set. The same table can serve as both the first and second data sets. 

See Also:

  * [Database SQL Tuning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL-GUID-24F34188-110F-4245-9DE7-43954092AFE0) for more information on band joins 

  * [USE_BAND Hint](Comments.html#GUID-EE3246B9-3060-4F84-8C49-4524844E6B9C)* [NO_USE_BAND Hint](Comments.html#GUID-3406DC08-3D03-483B-8EFA-9D8E33AAEB2D)
...
"[Using Self Joins: Example](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2066652)"
...
See Also:
  ...
  * [join_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2080416) for more information about using outer joins to fill gaps in sparse data 

  * [Oracle Database Data Warehousing Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG02013) for a complete discussion of group outer joins and filling gaps in sparse data 
...
In this example, `B`, the null-generated table, is outer-joined to two tables, `A` and `D`. Refer to [SELECT](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6) for the syntax for an outer join. 
...
"[Using Antijoins: Example](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2182875)"
...
"[Using Semijoins: Example](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2166436)"

[← Previous](Sorting-Query-Results.md)
