...
![Description of exists_condition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/exists_condition.gif)[Descriptionof the illustration exists_condition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/exists_condition.md)[Table 6-11](EXISTS-Condition.html#GUID-20259A83-C42B-4E0D-8DF4-9A2A66ACA8E7__CJADBJFF "The first column lists the single EXISTS condition, the second describes its operation, and the third provides an example.") shows the `EXISTS` condition. 
