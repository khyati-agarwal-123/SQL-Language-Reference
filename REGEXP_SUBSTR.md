##  REGEXP_SUBSTR {#GUID-2903904D-455F-4839-A8B2-1731EF4BD099} 

Syntax 

![Description of regexp_substr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/regexp_substr.gif)[ Description of the illustration regexp_substr.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/regexp_substr.md)
