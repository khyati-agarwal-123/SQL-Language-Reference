...
![Description of sign.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sign.gif)[Descriptionof the illustration sign.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sign.md)
