[Previous](Multilingual-Regular-Expression-Syntax.html) [Next](Perl-influenced-Extensions-in-Oracle-Regular-Expressions.html) JavaScript must be enabled to correctly display this content 
...
When applied to multilingual data, Oracle's implementation of the POSIX operators extends beyond the matching capabilities specified in the POSIX standard. [Table D-2](Regular-Expression-Operator-Multilingual-Enhancements.html#GUID-8A02D839-90A5-4FB6-AC43-7AE8CB08E8BA__G692318 "This table is described in the preceding text.") shows the relationship of the operators in the context of the POSIX standard. 
