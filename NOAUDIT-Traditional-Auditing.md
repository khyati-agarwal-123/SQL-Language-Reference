[Previous](MERGE.html) [Next](NOAUDIT-Unified-Auditing.html) JavaScript must be enabled to correctly display this content 
...
[NOAUDIT (Unified Auditing)](NOAUDIT-Unified-Auditing.html#GUID-EB92BE04-B09C-493F-952E-9629E739900E) for a description of the `NOAUDIT` statement for unified auditing 
...
![Description of noaudit.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/noaudit.gif)[Descriptionof the illustration noaudit.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/noaudit.md)([audit_operation_clause::=](NOAUDIT-Traditional-Auditing.md#GUID-9D8EAF18-4AB3-4C04-8BF7-37BD0E15434D__I2123640), [auditing_by_clause::=](NOAUDIT-Traditional-Auditing.html#GUID-9D8EAF18-4AB3-4C04-8BF7-37BD0E15434D__BGECCGIJ), [audit_schema_object_clause::=](NOAUDIT-Traditional-Auditing.html#GUID-9D8EAF18-4AB3-4C04-8BF7-37BD0E15434D__I2123651)) 

audit_operation_clause::= 

![Description of audit_operation_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/audit_operation_clause.gif)[Descriptionof the illustration audit_operation_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/audit_operation_clause.md)

auditing_by_clause::= 

![Description of auditing_by_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/auditing_by_clause.gif)[Descriptionof the illustration auditing_by_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/auditing_by_clause.md)

audit_schema_object_clause::= 

![Description of audit_schema_object_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/audit_schema_object_clause.gif)[Descriptionof the illustration audit_schema_object_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/audit_schema_object_clause.md)

auditing_on_clause::= 

![Description of auditing_on_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/auditing_on_clause.gif)[Descriptionof the illustration auditing_on_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/auditing_on_clause.md)
...
For `system_privilege`, specify the system privilege for which auditing is to be stopped. Refer to [Table 18-2](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE "Column 1 names system privileges grouped by database object. Column 2 describes the operations authorized by the system privilege.") for a list of the system privileges and the statements they authorize. 
