##  NOAUDIT (Traditional Auditing) {#GUID-9D8EAF18-4AB3-4C04-8BF7-37BD0E15434D} 
...
[ NOAUDIT (Unified Auditing) ](NOAUDIT-Unified-Auditing.md#GUID-EB92BE04-B09C-493F-952E-9629E739900E) for a description of the ` NOAUDIT ` statement for unified auditing 
...
![Description of auditing_by_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/auditing_by_clause.gif)[ Description of the illustration auditing_by_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/auditing_by_clause.md)
...
![Description of auditing_on_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/auditing_on_clause.gif)[ Description of the illustration auditing_on_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/auditing_on_clause.md)
...
For *system_privilege* , specify the system privilege for which auditing is to be stopped. Refer to [ Table 18-2 ](GRANT.md#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BABEFFEE) for a list of the system privileges and the statements they authorize. 
