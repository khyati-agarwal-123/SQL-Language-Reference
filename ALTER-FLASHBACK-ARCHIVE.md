[Previous](alter-domain.html) [Next](ALTER-FUNCTION.html) JavaScript must be enabled to correctly display this content 
...
Oracle Database Development Guide and [CREATE FLASHBACK ARCHIVE](CREATE-FLASHBACK-ARCHIVE.html#GUID-9E821EC5-8350-4729-85FE-2188EBB4139B) for more information on using Flashback Time Travel 
...
![Description of alter_flashback_archive.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_flashback_archive.gif)[Descriptionof the illustration alter_flashback_archive.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_flashback_archive.md)
...
This clause has the same semantics as the [[NO] OPTIMIZE DATA](CREATE-FLASHBACK-ARCHIVE.html#GUID-9E821EC5-8350-4729-85FE-2188EBB4139B__BGEIBJJB) clause of `CREATE` `FLASHBACK` `ARCHIVE`. 
