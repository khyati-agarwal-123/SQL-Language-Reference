##  LAG {#GUID-68081CD0-72BE-4C0A-AA6B-AD39FFA7BCF2} 

Syntax 

![Description of lag.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lag.gif)[ Description of the illustration lag.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lag.md)
