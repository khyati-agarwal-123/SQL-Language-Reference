##  USER {#GUID-AD0B927B-EFD4-4246-89B4-2D55AB3AF531} 

Syntax 

![Description of user.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/user.gif)[ Description of the illustration user.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/user.md)
