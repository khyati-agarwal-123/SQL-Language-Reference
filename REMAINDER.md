##  REMAINDER {#GUID-430D4C4A-5779-4EBB-90C5-4D7CA7E73556} 

Syntax 

![Description of remainder.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/remainder.gif)[ Description of the illustration remainder.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/remainder.md)
...
The ` MOD ` function is similar to ` REMAINDER ` except that it uses ` FLOOR ` in its formula, whereas ` REMAINDER ` uses ` ROUND ` . Refer to [ MOD ](MOD.md#GUID-E12A3928-2C50-45B0-B8C3-82432C751B8C) . 
...
Using table ` float_point_demo ` , created for the ` TO_BINARY_DOUBLE ` " [ Examples ](TO_BINARY_DOUBLE.md#GUID-0BA2E065-8006-426C-A3CB-1F6B0C8F283C__I1336203) "  , the following example divides two floating-point numbers and returns the remainder of that operation: 
