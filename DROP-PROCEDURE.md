##  DROP PROCEDURE {#GUID-D7F2B5AD-DEEE-466B-B6D3-B765EB897DCB} 
...
![Description of drop_procedure.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_procedure.gif)[ Description of the illustration drop_procedure.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_procedure.md)
