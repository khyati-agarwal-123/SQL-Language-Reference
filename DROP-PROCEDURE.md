[Previous](drop-pmem-filestore.html) [Next](DROP-PROFILE.html) JavaScript must be enabled to correctly display this content 
...
Procedures are defined using PL/SQL. Refer to [Oracle Database PL/SQL Language Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNPLS99991) for complete information on creating, altering, and dropping procedures. 
...
![Description of drop_procedure.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_procedure.gif)[Descriptionof the illustration drop_procedure.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_procedure.md)
