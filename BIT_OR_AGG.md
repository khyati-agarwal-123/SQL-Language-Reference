...
![Description of bit_or_agg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bit_or_agg.gif)[Descriptionof the illustration bit_or_agg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bit_or_agg.md)
