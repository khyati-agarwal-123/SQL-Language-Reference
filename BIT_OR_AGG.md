[Previous](BITMAP_OR_AGG.html) [Next](BIT_XOR_AGG.html) JavaScript must be enabled to correctly display this content 
...
![Description of bit_or_agg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bit_or_agg.gif)[Description of the illustration bit_or_agg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bit_or_agg.html)
