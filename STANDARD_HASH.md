[Previous](SQRT.html) [Next](STATS_BINOMIAL_TEST.html) JavaScript must be enabled to correctly display this content 
...
![Description of standard_hash.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/standard_hash.gif)[Description of the illustration standard_hash.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/standard_hash.html)
...
You can use the `STANDARD_HASH` function to create an index on an extended data type column. Refer to "[Creating an Index on an Extended Data Type Column](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__BGECBJDG)" for more information. 
