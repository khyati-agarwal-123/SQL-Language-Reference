...
You can also enable logical replication with the command [CREATE JSON RELATIONAL DUALITY VIEW](create-json-relational-duality-view.html#GUID-64B579AD-BF97-4B27-BF22-94C1FB6FD6DF)* Minimal (or subset database replication) supplemental logging must be enabled at the database or container level using `ALTER PLUGGABLE DATABASE ADD SUPPLEMENTAL LOG DATA DDL`. 
