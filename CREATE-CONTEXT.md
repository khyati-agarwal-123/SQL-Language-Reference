##  CREATE CONTEXT {#GUID-FDF62812-A884-479C-9C1B-5BD6DDEFE7FA} 
...
![Description of create_context.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_context.gif)[ Description of the illustration create_context.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_context.md)
...
" [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  for guidelines on naming a context namespace 
...
[ SYS_CONTEXT ](SYS_CONTEXT.md#GUID-B9934A5D-D97B-4E51-B01B-80C76A5BD086) and [ *Oracle Database Security Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG66353) for more information on using application contexts to retrieve user information 
