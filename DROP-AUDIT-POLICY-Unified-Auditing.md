...
![Description of drop_audit_policy.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_audit_policy.gif)[Description of the illustration drop_audit_policy.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_audit_policy.html)
