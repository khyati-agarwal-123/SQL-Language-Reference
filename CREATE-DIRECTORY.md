[Previous](CREATE-DIMENSION.html) [Next](CREATE-DISKGROUP.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * "[Large Object (LOB) Data Types](Data-Types.html#GUID-1A71C635-188E-4EC9-B821-1DBEC2B45451)" for more information on `BFILE` objects 

  * [GRANT](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3) for more information on granting object privileges 

  * [external_table_clause::=](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2129649) of `CREATE` `TABLE`
...
![Description of create_directory.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_directory.gif)[Descriptionof the illustration create_directory.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_directory.md)
...
[DROP DIRECTORY](DROP-DIRECTORY.html#GUID-3719950A-7B6A-4284-8467-B3455ECF8516) for information on removing a directory from the database 
...
Specify the name of the directory object to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
