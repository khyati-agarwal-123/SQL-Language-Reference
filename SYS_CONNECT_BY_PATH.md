[Previous](SUM.html) [Next](SYS_CONTEXT.html) JavaScript must be enabled to correctly display this content 
...
![Description of sys_connect_by_path.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_connect_by_path.gif)[Description of the illustration sys_connect_by_path.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_connect_by_path.html)
...
See Also:
  ...
  * "[Hierarchical Queries](Hierarchical-Queries.html#GUID-0118DF1D-B9A9-41EB-8556-C6E7D6A5A84E)" for more information about hierarchical queries and `CONNECT` `BY` conditions 
