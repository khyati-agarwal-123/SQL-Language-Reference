...
![Description of sys_connect_by_path.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_connect_by_path.gif)[Descriptionof the illustration sys_connect_by_path.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_connect_by_path.md)
