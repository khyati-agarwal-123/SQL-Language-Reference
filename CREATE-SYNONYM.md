[Previous](CREATE-SPFILE.html) [Next](CREATE-TABLE.html) JavaScript must be enabled to correctly display this content 
...
[Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT711) for general information on synonyms 
...
![Description of create_synonym.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_synonym.gif)[Description of the illustration create_synonym.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_synonym.html)
...
Use these clauses to specify whether the synonym is an editioned or noneditioned object if editioning is enabled for the schema object type `SYNONYM` in `schema`. For private synonyms, the default is `EDITIONABLE`. For public synonyms, the default is `NONEDITIONABLE`. For information about editioned and noneditioned objects, see [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS99923). 
...
Specify the name of the synonym to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
"[CREATE SYNONYM: Examples](CREATE-SYNONYM.html#GUID-A806C82F-1171-478E-A910-F9C6C42739B2__I2153082)" and "[Oracle Database Resolution of Synonyms: Example](CREATE-SYNONYM.html#GUID-A806C82F-1171-478E-A910-F9C6C42739B2__I2102145)"
...
See Also:
  ...
  * [CREATE DATABASE LINK](CREATE-DATABASE-LINK.html#GUID-D966642A-B19E-449D-9968-1121AF06D793) for more information on creating database links 
