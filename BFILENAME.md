...
![Description of bfilename.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bfilename.gif)[Descriptionof the illustration bfilename.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bfilename.md)
