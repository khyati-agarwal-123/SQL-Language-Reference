[Previous](AVG.html) [Next](BIN_TO_NUM.html) JavaScript must be enabled to correctly display this content 
...
![Description of bfilename.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bfilename.gif)[Description of the illustration bfilename.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bfilename.html)
...
See Also:
  ...
  * [Oracle Database SecureFiles and Large Objects Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADLOB012) and [Oracle Call Interface Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNOCI030) for more information on LOBs and for examples of retrieving `BFILE` data 

  * [CREATE DIRECTORY](CREATE-DIRECTORY.html#GUID-8E9C569A-1B06-42C4-9586-0EF83437001A)
