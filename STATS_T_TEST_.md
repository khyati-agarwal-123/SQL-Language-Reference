...
![Description of stats_t_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_t_test.gif)[Descriptionof the illustration stats_t_test.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_t_test.md)
