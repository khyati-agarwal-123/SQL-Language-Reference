...
![Description of covar_pop.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/covar_pop.gif)[Descriptionof the illustration covar_pop.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/covar_pop.md)
