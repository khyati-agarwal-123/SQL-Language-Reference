##  COVAR_POP {#GUID-D728D05F-D2E3-405C-986F-088B8353553A} 

Syntax 

![Description of covar_pop.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/covar_pop.gif)[ Description of the illustration covar_pop.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/covar_pop.md)
