[Previous](DATAOBJ_TO_PARTITION.html) [Next](DECODE.html) JavaScript must be enabled to correctly display this content 
...
![Description of dbtimezone.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dbtimezone.gif)[Description of the illustration dbtimezone.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dbtimezone.html)
