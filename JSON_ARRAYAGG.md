...
![Description of json_arrayagg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_arrayagg.gif)[Description of the illustration json_arrayagg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_arrayagg.html)(See [order_by_clause::=](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2168299) in the documentation on `SELECT` for the syntax of this clause) 
