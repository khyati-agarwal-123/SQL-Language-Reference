[Previous](INSERT.html) [Next](SQL-Statements-MERGE-to-UPDATE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT020) for a complete description of the interaction of lock modes 

  * [COMMIT](COMMIT.html#GUID-6CD5C9A7-54B9-4FA2-BA3C-D6B4492B9EE2)* [ROLLBACK](ROLLBACK.html#GUID-94551F0C-A47F-43DE-BC68-9B1C1ED38C93)
...
![Description of lock_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lock_table.gif)[Descriptionof the illustration lock_table.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lock_table.md)
...
"[References to Objects in Remote Databases](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.html#GUID-61D0B206-A5EA-473F-AD04-7067D6E3914C)" for information on specifying database links 
...
See [ROW SHARE](LOCK-TABLE.html#GUID-4C00C6D9-C5C5-46CC-AD33-A64001744A4C__BABDAHIB). 
...
[Oracle Database Administrator's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN12289) for more information about locking tables 
