##  FEATURE_DETAILS {#GUID-A42F313B-22C1-4CAC-BA3F-C418178D743F} 

Syntax 

*feature_details* ::= 

![Description of feature_details.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/feature_details.gif)[ Description of the illustration feature_details.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/feature_details.md)
