##  CREATE SEQUENCE {#GUID-E9C78A8C-615A-4757-B2A8-5E6EFB130571} 
...
![Description of create_sequence.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_sequence.gif)[ Description of the illustration create_sequence.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_sequence.md)
...
The ` KEEP ` and ` NOKEEP ` clauses apply only to the owner of the schema containing the sequence. You can control whether ` NEXTVAL ` retains its original value for other users during replay for Application Continuity by granting or revoking the ` KEEP ` ` SEQUENCE ` object privilege on the sequence. Refer to [ Table 18-4 ](GRANT.md#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3__BGBCIIEG) for more information on the ` KEEP ` ` SEQUENCE ` object privilege. 
