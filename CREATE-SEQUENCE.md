[Previous](SQL-Statements-CREATE-SEQUENCE-to-DROP-CLUSTER.html) [Next](CREATE-SPFILE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Pseudocolumns](Pseudocolumns.html#GUID-6C65C788-76AA-4A51-B011-51D53DD2521D) for more information on using the `CURRVAL` and `NEXTVAL`

  * "[How to Use Sequence Values](Sequence-Pseudocolumns.html#GUID-55228D7B-9CF1-4496-8524-3CD1DD4773FD)" for information on using sequences 

  * [ALTER SEQUENCE](ALTER-SEQUENCE.html#GUID-A6468B63-E7C9-4EF0-B048-82FE2449B26D) or [DROP SEQUENCE](DROP-SEQUENCE.html#GUID-32B640EE-47C9-46A7-9746-6125BAF8FF8C) for information on modifying or dropping a sequence 
...
![Description of create_sequence.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_sequence.gif)[Description of the illustration create_sequence.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_sequence.html)
...
Specify the name of the sequence to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
For complete semantics on the `SHARD` clause please refer to the `SHARD` clause of the [ALTER SEQUENCE](ALTER-SEQUENCE.html#GUID-A6468B63-E7C9-4EF0-B048-82FE2449B26D) statement. 
...
[Oracle Data Guard Concepts and Administration](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=SBYDB5164) for more information on session sequences 
