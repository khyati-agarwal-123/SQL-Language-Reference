...
![Description of ceil_interval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ceil_interval.gif)[Descriptionof the illustration ceil_interval.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ceil_interval.md)
