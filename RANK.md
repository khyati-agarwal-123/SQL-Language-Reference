...
![Description of rank_aggregate.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rank_aggregate.gif)[Descriptionof the illustration rank_aggregate.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rank_aggregate.md)

Analytic Syntax

rank_analytic::= 

![Description of rank_analytic.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rank_analytic.gif)[Descriptionof the illustration rank_analytic.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rank_analytic.md)
