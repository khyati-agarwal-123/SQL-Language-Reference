[Previous](allocate_extent_clause.html) [Next](deallocate_unused_clause.html) JavaScript must be enabled to correctly display this content 
  ...
  2. [ Common SQL DDL Clauses ](Common-SQL-DDL-Clauses.html)
  3. constraint
...
Constraint clauses can appear in the following statements:
  ...
  * `CREATE` `TABLE` (see [CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6)`)`

  * `ALTER` `TABLE` (see [ALTER TABLE](ALTER-TABLE.html#GUID-552E7373-BF93-477D-9DA3-B2C9386F2877)) 

  * `CREATE` `VIEW` (see [CREATE VIEW](CREATE-VIEW.html#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30)`)`

  * `ALTER` `VIEW` (see [ALTER VIEW](ALTER-VIEW.html#GUID-0DEDE960-B481-4B55-8027-EA9E4C863625)`)`
...
![Description of constraint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/constraint.gif)[Description of the illustration constraint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/constraint.html)([inline_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAGIICD), [out_of_line_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJADJGEC), [inline_ref_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAHIEIJ), [out_of_line_ref_constraint::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJABCJJF)) 

inline_constraint::= 

![Description of inline_constraint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/inline_constraint.gif)[Description of the illustration inline_constraint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/inline_constraint.html)([references_clause::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAIHHGC)) 
...
![Description of precheck_state.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/precheck_state.gif)[Description of the illustration precheck_state.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/precheck_state.html)
...
![Description of out_of_line_constraint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/out_of_line_constraint.gif)[Description of the illustration out_of_line_constraint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/out_of_line_constraint.html)([references_clause::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAIHHGC), [constraint_state::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAFFBAA)) 

inline_ref_constraint::= 

![Description of inline_ref_constraint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/inline_ref_constraint.gif)[Description of the illustration inline_ref_constraint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/inline_ref_constraint.html)([references_clause::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAIHHGC), [constraint_state::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAFFBAA)) 

out_of_line_ref_constraint::= 

![Description of out_of_line_ref_constraint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/out_of_line_ref_constraint.gif)[Description of the illustration out_of_line_ref_constraint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/out_of_line_ref_constraint.html)([references_clause::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAIHHGC), [constraint_state::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAFFBAA)) 

references_clause::= 

![Description of references_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/references_clause.gif)[Description of the illustration references_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/references_clause.html)

constraint_state::= 

![Description of constraint_state.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/constraint_state.gif)[Description of the illustration constraint_state.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/constraint_state.html)([using_index_clause::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAGEBIG), [exceptions_clause::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAEHIDE)) 

using_index_clause::= 

![Description of using_index_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_index_clause.gif)[Description of the illustration using_index_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_index_clause.html)([create_index::=](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2125762), [index_properties::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAIEIDI)) 

index_properties::= 

![Description of index_properties.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_properties.gif)[Description of the illustration index_properties.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_properties.html)([global_partitioned_index::=](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2126415), [local_partitioned_index::=](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2125897)\--part of `CREATE` `INDEX`, [index_attributes::=](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__CJAFHDJI). The `INDEXTYPE` `IS` ... clause is not valid when defining a constraint.) 

index_attributes::= 

![Description of index_attributes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_attributes.gif)[Description of the illustration index_attributes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_attributes.html)([physical_attributes_clause::=](CREATE-CLUSTER.html#GUID-4DBC701F-AFC3-486D-AA32-B5CB1D6946F7__I2127411), [logging_clause::=](logging_clause.html#GUID-C4212274-5595-4045-A599-F033772C496E__CJAHABGF), [index_compression::=](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__I2127535), [partial_index_clause::=](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__BGEJJFGA)\--all part of `CREATE` `INDEX`, `parallel_clause`: not supported in `using_index_clause`) 
...
See Also:
  ...
  * "[Check Constraint Examples](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1002719)" and "[Attribute-Level Constraints Example](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1002779)"

  * [PRECHECK Using JSON Schema](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-897ECE1B-996B-4382-AA39-AB702BEAA6A7)
...
See Also:
  ...
  * [Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG005) for more details about collations 
...
See Also:
  ...
  * [physical_attributes_clause](physical_attributes_clause.html#GUID-A15063A9-3237-43D3-B0AE-D01F6E80B393) and `PCTFREE` parameters and [storage_clause](storage_clause.html#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15)

  * "[Explicit Index Control Example](constraint.html#GUID-1055EA97-BA6F-4764-A15F-1024FD5B6DFE__I1002834)"
