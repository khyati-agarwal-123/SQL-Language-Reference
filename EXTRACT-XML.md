...
![Description of extract_xml.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/extract_xml.gif)[Descriptionof the illustration extract_xml.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/extract_xml.md)
