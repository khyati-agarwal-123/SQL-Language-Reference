[Previous](EXTRACT-datetime.html) [Next](EXTRACTVALUE.html) JavaScript must be enabled to correctly display this content 
...
The `EXTRACT` (XML) function is deprecated. It is still supported for backward compatibility. However, Oracle recommends that you use the `XMLQUERY` function instead. See [XMLQUERY](XMLQUERY.html#GUID-9E8D3220-2CF5-4C63-BDC2-0526D57B9CDB) for more information. 

Syntax

extract_xml::= 

![Description of extract_xml.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/extract_xml.gif)[Description of the illustration extract_xml.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/extract_xml.html)
...
Compare this example with the example for [EXTRACTVALUE](EXTRACTVALUE.html#GUID-20AB974B-7544-4F44-B539-787FB6145680), which returns the scalar value of the XML fragment. 
