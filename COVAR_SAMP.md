[Previous](COVAR_POP.html) [Next](CUBE_TABLE.html) JavaScript must be enabled to correctly display this content 
...
![Description of covar_samp.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/covar_samp.gif)[Description of the illustration covar_samp.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/covar_samp.html)
...
Refer to the aggregate example for [COVAR_POP](COVAR_POP.html#GUID-D728D05F-D2E3-405C-986F-088B8353553A). 

Analytic Example

Refer to the analytic example for [COVAR_POP](COVAR_POP.html#GUID-D728D05F-D2E3-405C-986F-088B8353553A). 
