...
![Description of covar_samp.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/covar_samp.gif)[Descriptionof the illustration covar_samp.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/covar_samp.md)
