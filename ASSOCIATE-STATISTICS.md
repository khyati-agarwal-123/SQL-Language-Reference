...
![Description of associate_statistics.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/associate_statistics.gif)[Description of the illustration associate_statistics.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/associate_statistics.html)

column_association::= 

![Description of column_association.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/column_association.gif)[Description of the illustration column_association.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/column_association.html)

function_association::= 

![Description of function_association.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/function_association.gif)[Description of the illustration function_association.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/function_association.html)

using_statistics_type::= 

![Description of using_statistics_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_statistics_type.gif)[Description of the illustration using_statistics_type.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_statistics_type.html)

default_cost_clause::= 

![Description of default_cost_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/default_cost_clause.gif)[Description of the illustration default_cost_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/default_cost_clause.html)

default_selectivity_clause::= 

![Description of default_selectivity_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/default_selectivity_clause.gif)[Description of the illustration default_selectivity_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/default_selectivity_clause.html)

storage_table_clause::= 

![Description of storage_table_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/storage_table_clause.gif)[Description of the illustration storage_table_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/storage_table_clause.html)
