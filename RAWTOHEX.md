[Previous](RATIO_TO_REPORT.html) [Next](RAWTONHEX.html) JavaScript must be enabled to correctly display this content 
...
![Description of rawtohex.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rawtohex.gif)[Description of the illustration rawtohex.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rawtohex.html)
...
"[RAW and LONG RAW Data Types](Data-Types.html#GUID-4FD497DD-3331-4C25-9147-3CEBEFDBFF22)" and [HEXTORAW](HEXTORAW.html#GUID-8571556F-C219-4814-A854-9F01581FFBDF)
