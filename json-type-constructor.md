...
![Description of json_constructor.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_constructor.gif)[Descriptionof the illustration json_constructor.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_constructor.md)
