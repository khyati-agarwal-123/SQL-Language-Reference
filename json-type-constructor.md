[Previous](JSON_VALUE.html) [Next](KURTOSIS_POP.html) JavaScript must be enabled to correctly display this content 
...
![Description of json_constructor.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_constructor.gif)[Description of the illustration json_constructor.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_constructor.html)
