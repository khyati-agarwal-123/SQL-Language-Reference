[Previous](USERENV.html) [Next](VALUE.html) JavaScript must be enabled to correctly display this content 
...
![Description of validate_conversion.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/validate_conversion.gif)[Description of the illustration validate_conversion.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/validate_conversion.html)
