...
![Description of validate_conversion.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/validate_conversion.gif)[Descriptionof the illustration validate_conversion.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/validate_conversion.md)
