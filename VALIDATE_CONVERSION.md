##  VALIDATE_CONVERSION {#GUID-DC485EEB-CB6D-42EF-97AA-4487884CB2CD} 

Syntax 

![Description of validate_conversion.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/validate_conversion.gif)[ Description of the illustration validate_conversion.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/validate_conversion.md)
