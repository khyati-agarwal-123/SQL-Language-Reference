...
![Description of drop_restore_point.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_restore_point.gif)[Description of the illustration drop_restore_point.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_restore_point.html)
