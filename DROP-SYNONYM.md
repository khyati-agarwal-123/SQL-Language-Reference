##  DROP SYNONYM {#GUID-C7293D40-83B8-4E60-9E90-CB907F2CA6C7} 
...
[ CREATE SYNONYM ](CREATE-SYNONYM.md#GUID-A806C82F-1171-478E-A910-F9C6C42739B2) for more information on synonyms 
...
![Description of drop_synonym.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_synonym.gif)[ Description of the illustration drop_synonym.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_synonym.md)
...
To drop the public synonym named ` customers ` , which was created in  " [ Oracle Database Resolution of Synonyms: Example ](CREATE-SYNONYM.md#GUID-A806C82F-1171-478E-A910-F9C6C42739B2__I2102145) "  , issue the following statement: 
