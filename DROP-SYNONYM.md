[Previous](DROP-SEQUENCE.html) [Next](SQL-Statements-DROP-TABLE-to-LOCK-TABLE.html) JavaScript must be enabled to correctly display this content 
...
[CREATE SYNONYM](CREATE-SYNONYM.html#GUID-A806C82F-1171-478E-A910-F9C6C42739B2) for more information on synonyms 
...
![Description of drop_synonym.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_synonym.gif)[Descriptionof the illustration drop_synonym.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_synonym.md)
