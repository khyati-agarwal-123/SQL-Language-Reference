##  TO_BLOB (raw) {#GUID-C4308DB1-5BFE-48F0-99E5-9E03B80B4585} 

Syntax 

*to_blob* ::= 

![Description of to_blob.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_blob.gif)[ Description of the illustration to_blob.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_blob.md)
