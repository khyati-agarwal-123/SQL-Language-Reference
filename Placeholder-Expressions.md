...
![Description of placeholder_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/placeholder_expression.gif)[Descriptionof the illustration placeholder_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/placeholder_expression.md)
