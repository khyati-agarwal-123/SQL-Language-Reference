[Previous](DROP-CONTEXT.html) [Next](DROP-DATABASE-LINK.html) JavaScript must be enabled to correctly display this content 
...
[Oracle Database Backup and Recovery User's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=BRADV89641) for more information on dropping the database 
...
![Description of drop_database.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_database.gif)[Description of the illustration drop_database.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_database.html)
