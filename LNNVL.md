[Previous](LN.html) [Next](LOCALTIMESTAMP.html) JavaScript must be enabled to correctly display this content 
...
![Description of lnnvl.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/lnnvl.gif)[Description of the illustration lnnvl.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/lnnvl.html)
