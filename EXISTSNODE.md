##  EXISTSNODE {#GUID-71731B1A-99E5-4B82-8243-DEEE6704796F} 

> **note:** 

The ` EXISTSNODE ` function is deprecated. It is still supported for backward compatibility. However, Oracle recommends that you use the ` XMLEXISTS ` function instead. See [ XMLEXISTS ](XMLEXISTS.md#GUID-3D0D90DB-3D4F-4685-AFF6-72B6250624B9) for more information. 

Syntax 

![Description of existsnode.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/existsnode.gif)[ Description of the illustration existsnode.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/existsnode.md)
...
[ Using XML in SQL Statements ](Using-XML-in-SQL-Statements.md#GUID-5FE21EC9-1F66-45F1-9FD8-ECA5336EDC14) for examples that specify *namespace_string* and use the "who" prefix. 
