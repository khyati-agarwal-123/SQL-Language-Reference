[Previous](Database-Objects.html) [Next](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.html) JavaScript must be enabled to correctly display this content 
...
[CREATE USER](CREATE-USER.html#GUID-F0246961-558F-480B-AC0F-14B50134621C) for additional rules for naming users and passwords 
...
See Also:
     ...
     * [Oracle SQL Reserved Words](Oracle-SQL-Reserved-Words.html#GUID-55C49D1E-BE08-4C50-A9DD-8593EB925612) for a listing of all Oracle SQL reserved words 

     * The manual for a specific product, such as [Oracle Database PL/SQL Language Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNPLS019), for a list of the reserved words of that product 
...
See Also:
     ...
     * [Oracle SQL Keywords](Oracle-SQL-Keywords.html#GUID-82EA000B-5661-41EB-AAF7-6BDDB4AB58EE) for information how to obtain a list of keywords 

     * [Data Types](Data-Types.html#GUID-A3C0D836-BADB-44E5-A5D4-265BA5968483), [About SQL Functions](About-SQL-Functions.html#GUID-D51AB228-518C-4213-8BD4-F919623D105E), and [Selecting from the DUAL Table](Selecting-from-the-DUAL-Table.html#GUID-0AB153FC-5238-4E79-8522-C9E2A04AB5E4)4. You should use characters from the ASCII repertoire in database names, global database names, and database link names, because these characters provide optimal compatibility across different platforms and operating systems. You must use only characters from the ASCII repertoire in the names of common users, common roles, and common profiles in a multitenant container database (CDB). 
...
All of these examples adhere to the rules listed in [Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA). 
