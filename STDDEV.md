##  STDDEV {#GUID-CA0C3B1F-1A4C-4CFB-ADAB-D90216C4E099} 

Syntax 

![Description of stddev.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stddev.gif)[ Description of the illustration stddev.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stddev.md)
