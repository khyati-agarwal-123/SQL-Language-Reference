[Previous](ALTER-DATABASE.html) [Next](ALTER-DATABASE-LINK.html) JavaScript must be enabled to correctly display this content 
...
If any of the checks fail, the DDL fails. When this happens you must create a TDE keystore and provision a TDE Master Key. For more see the [Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG). 
...
![Description of alter_database_dictionary.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_database_dictionary.gif)[Descriptionof the illustration alter_database_dictionary.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_database_dictionary.md)
...
Managing Security for Application Developers in the [Database Security Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DBSEG-GUID-8F585EBE-611D-4717-AD9F-CAC10A19B7E1)
