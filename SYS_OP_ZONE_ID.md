...
![Description of sys_op_zone_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_op_zone_id.gif)[Descriptionof the illustration sys_op_zone_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_op_zone_id.md)
