[Previous](ROUND-and-TRUNC-Date-Functions.html) [Next](Common-SQL-DDL-Clauses.html) JavaScript must be enabled to correctly display this content 
...
![Description of user_defined_function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/user_defined_function.gif)[Description of the illustration user_defined_function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/user_defined_function.html)
...
See Also:
  ...
  * [CREATE FUNCTION](CREATE-FUNCTION.html#GUID-156AEDAC-ADD0-4E46-AA56-6D1F7CA63306) for information on creating functions, including restrictions on user-defined functions 

  * [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS009) for a complete discussion of the creation and use of user functions 
...
[CREATE FUNCTION](CREATE-FUNCTION.html#GUID-156AEDAC-ADD0-4E46-AA56-6D1F7CA63306) for information on creating top-level functions and [CREATE PACKAGE](CREATE-PACKAGE.html#GUID-40636655-899F-47D0-95CA-D58A71C94A56) for information on specifying packaged functions 
...
[← Previous](ROUND-and-TRUNC-Date-Functions.md)
