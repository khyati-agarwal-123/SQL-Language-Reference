...
![Description of user_defined_function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/user_defined_function.gif)[Descriptionof the illustration user_defined_function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/user_defined_function.md)
