##  INSTR {#GUID-47E3A7C4-ED72-458D-A1FA-25A9AD3BE113} 

Syntax 

![Description of instr.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/instr.gif)[ Description of the illustration instr.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/instr.md)
