[Previous](STATS_T_TEST_.html) [Next](STDDEV.html) JavaScript must be enabled to correctly display this content 
...
![Description of stats_wsr_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_wsr_test.gif)[Description of the illustration stats_wsr_test.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_wsr_test.html)
