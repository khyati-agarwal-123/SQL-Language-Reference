##  STATS_WSR_TEST {#GUID-80A8A9A9-7CD9-4358-B628-6D67BD42BA5B} 

Syntax 

![Description of stats_wsr_test.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/stats_wsr_test.gif)[ Description of the illustration stats_wsr_test.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/stats_wsr_test.md)
