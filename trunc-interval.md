...
![Description of trunc_interval.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/trunc_interval.gif)[Descriptionof the illustration trunc_interval.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/trunc_interval.md)
