[Previous](APPROX_PERCENTILE_DETAIL.html) [Next](APPROX_SUM.html) JavaScript must be enabled to correctly display this content 
...
![Description of approx_rank.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_rank.gif)[Description of the illustration approx_rank.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_rank.html)
