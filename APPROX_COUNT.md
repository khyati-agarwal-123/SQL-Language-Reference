[Previous](ANY_VALUE.html) [Next](APPROX_COUNT_DISTINCT.html) JavaScript must be enabled to correctly display this content 
...
![Description of approx_count.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_count.gif)[Description of the illustration approx_count.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_count.html)
