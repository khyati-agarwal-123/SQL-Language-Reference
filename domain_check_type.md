[Previous](domain_check.html) [Next](domain_display.html) JavaScript must be enabled to correctly display this content 
...
![Description of domain_check_type_function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/domain_check_type_function.gif)[Description of the illustration domain_check_type_function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/domain_check_type_function.html)

Purpose

Use `DOMAIN_CHECK_TYPE` to convert the value expression to the data type of the domain column without checking domain constraints. If you want to check constraints, you must use [DOMAIN_CHECK](domain_check.html#GUID-599390A5-1B96-4465-82CE-DBC2345A018B). 
