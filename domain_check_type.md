...
![Description of domain_check_type_function.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/domain_check_type_function.gif)[Descriptionof the illustration domain_check_type_function.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/domain_check_type_function.md)
