##  DOMAIN_CHECK_TYPE {#GUID-9ED35142-A66C-4511-9DE1-B8BB4350DE41} 
...
Use ` DOMAIN_CHECK_TYPE ` to convert the value expression to the data type of the domain column without checking domain constraints. If you want to check constraints, you must use [ DOMAIN_CHECK ](domain_check.md#GUID-599390A5-1B96-4465-82CE-DBC2345A018B) . 
