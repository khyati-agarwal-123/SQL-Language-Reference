[Previous](JSON_DATAGUIDE.html) [Next](JSON_OBJECT.html) JavaScript must be enabled to correctly display this content 
...
![Description of json_mergepatch.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_mergepatch.gif)[Descriptionof the illustration json_mergepatch.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_mergepatch.md)
...
![Description of json_on_error_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_on_error_clause.gif)[Descriptionof the illustration json_on_error_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_on_error_clause.md)
...
See Also:
  ...
  * [RFC 7396 JSON Merge Patch](https://tools.ietf.org/html/rfc7396)* [Updating a JSON Document with JSON Merge Patch](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-31F88F28-3D92-489B-9CCD-BD1931B91F1F)
