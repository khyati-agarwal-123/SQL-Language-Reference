##  JSON_MERGEPATCH {#GUID-2004F536-BE60-4457-A1A8-AB908FFF5399} 
...
![Description of json_mergepatch.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_mergepatch.gif)[ Description of the illustration json_mergepatch.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_mergepatch.md)
...
![Description of json_on_error_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_on_error_clause.gif)[ Description of the illustration json_on_error_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_on_error_clause.md)
