[Previous](Nulls.html) [Next](Database-Objects.html) JavaScript must be enabled to correctly display this content 
  ...
  2. [ Basic Elements of Oracle SQL](Basic-Elements-of-Oracle-SQL.html)
  3. Comments 
...
![Description of hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hint.gif)[Description of the illustration hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hint.html)
...
![Description of tablespec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tablespec.gif)[Description of the illustration tablespec.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tablespec.html)
...
![Description of indexspec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/indexspec.gif)[Description of the illustration indexspec.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/indexspec.html)
...
![Description of all_rows_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/all_rows_hint.gif)[Description of the illustration all_rows_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/all_rows_hint.html)
...
![Description of append_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_hint.gif)[Description of the illustration append_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_hint.html)
...
![Description of append_values_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_values_hint.gif)[Description of the illustration append_values_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_values_hint.html)
...
![Description of first_rows_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/first_rows_hint.gif)[Description of the illustration first_rows_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/first_rows_hint.html)
...
![Description of fresh_mv_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fresh_mv_hint.gif)[Description of the illustration fresh_mv_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fresh_mv_hint.html)
...
![Description of grouping_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grouping_hint.gif)[Description of the illustration grouping_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grouping_hint.html)
...
![Description of monitor_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/monitor_hint.gif)[Description of the illustration monitor_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/monitor_hint.html)
...
![Description of native_foj_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/native_foj_hint.gif)[Description of the illustration native_foj_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/native_foj_hint.html)
...
![Description of noappend_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/noappend_hint.gif)[Description of the illustration noappend_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/noappend_hint.html)

The `NOAPPEND` hint instructs the optimizer to use conventional `INSERT` even when `INSERT` is performed in parallel mode. 

#### NOCACHE Hint 

![Description of nocache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nocache_hint.gif)[Description of the illustration nocache_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nocache_hint.html)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of no_clustering_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_clustering_hint.gif)[Description of the illustration no_clustering_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_clustering_hint.html)This hint is valid only for `INSERT` and `MERGE` operations on tables that are enabled for attribute clustering. The `NO_CLUSTERING` hint disables attribute clustering for direct-path inserts (serial or parallel). This hint overrides a `YES` `ON` `LOAD` setting in the DDL that created or altered the table. This hint has no effect on tables that are not enabled for attribute clustering. 
...
![Description of no_monitor_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_monitor_hint.gif)[Description of the illustration no_monitor_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_monitor_hint.html)
...
![Description of no_native_foj_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_native_foj_hint.gif)[Description of the illustration no_native_foj_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_native_foj_hint.html)
...
See Also:
  ...
  * [PQ_CONCURRENT_UNION Hint](Comments.html#GUID-7694D1CD-2851-49EF-8C52-91BCB5C48A40)
...
![Description of no_result_cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_result_cache_hint.gif)[Description of the illustration no_result_cache_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_result_cache_hint.html)
...
![Description of opt_param_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/opt_param_hint.gif)[Description of the illustration opt_param_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/opt_param_hint.html)
...
![Description of ordered_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ordered_hint.gif)[Description of the illustration ordered_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ordered_hint.html)
...
![Description of pq_filter_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_filter_hint.gif)[Description of the illustration pq_filter_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_filter_hint.html)
...
![Description of px_join_filter_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/px_join_filter_hint.gif)[Description of the illustration px_join_filter_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/px_join_filter_hint.html)

This hint forces the optimizer to use parallel join bitmap filtering.

#### QB_NAME Hint 

![Description of qb_name_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qb_name_hint.gif)[Description of the illustration qb_name_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qb_name_hint.html)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 
...
![Description of result_cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/result_cache_hint.gif)[Description of the illustration result_cache_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/result_cache_hint.html)
...
![Description of retry_on_row_change.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/retry_on_row_change.gif)[Description of the illustration retry_on_row_change.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/retry_on_row_change.html)
