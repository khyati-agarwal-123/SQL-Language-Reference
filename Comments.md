[Previous](Nulls.html) [Next](Database-Objects.html) JavaScript must be enabled to correctly display this content 

  1. [SQL Language Reference ](index.html)2. [ Basic Elements of Oracle SQL](Basic-Elements-of-Oracle-SQL.html)
  3. Comments 
...
Comments can make your application easier for you to read and maintain. For example, you can include a comment in a statement that describes the purpose of the statement within your application. With the exception of hints, comments within SQL statements do not affect the statement execution. Refer to [Hints](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E) on using this particular form of comment. 
...
![Description of hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hint.gif)[Descriptionof the illustration hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hint.md)
...
Oracle Database ignores hints and does not return an error under the following circumstances:
  ...
  * A global hint refers to multiple query blocks. Refer to [Specifying Multiple Query Blocks in a Global Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEIICE) for more information. 
...
![Description of tablespec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tablespec.gif)[Descriptionof the illustration tablespec.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tablespec.md)
...
![Description of indexspec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/indexspec.gif)[Descriptionof the illustration indexspec.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/indexspec.md)
...
The following examples use the `EXPLAIN` `PLAN` statement, which enables you to display the execution plan and determine if a hint is honored or ignored. Refer to [EXPLAIN PLAN](EXPLAIN-PLAN.html#GUID-FD540872-4ED3-4936-96A2-362539931BA0) for more information. 
...
Other Hints | APPEND Hint APPEND_VALUES Hint NOAPPEND Hint  
...
Â­Â­ | FRESH_MV Hint  
\-- | GATHER_OPTIMIZER_STATISTICS Hint NO_GATHER_OPTIMIZER_STATISTICS Hint  
Â­Â­ | GROUPING Hint  
...
![Description of all_rows_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/all_rows_hint.gif)[Descriptionof the illustration all_rows_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/all_rows_hint.md)
...
![Description of append_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_hint.gif)[Descriptionof the illustration append_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_hint.md)
...
The `APPEND` hint is only supported with the subquery syntax of the `INSERT` statement, not the `VALUES` clause. If you specify the `APPEND` hint with the `VALUES` clause, it is ignored and conventional insert will be used. To use direct-path `INSERT` with the `VALUES` clause, refer to "[APPEND_VALUES Hint](Comments.html#GUID-DD069661-D431-40F5-9303-DB8C1153D87D)". 

See Also:

[NOAPPEND Hint](Comments.html#GUID-86B4C4B6-28F6-4A11-8146-67ABE8331646) for information on that hint and [Oracle Database Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN01509) for information on direct-path inserts 

#### APPEND_VALUES Hint 

![Description of append_values_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_values_hint.gif)[Descriptionof the illustration append_values_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_values_hint.md)
...
[Oracle Database Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN01509) for information on direct-path inserts 

#### CACHE Hint 

![Description of cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_hint.gif)[Descriptionof the illustration cache_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of change_dupkey_error_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/change_dupkey_error_index.gif)[Descriptionof the illustration change_dupkey_error_index.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/change_dupkey_error_index.md)

Note:

The `CHANGE_DUPKEY_ERROR_INDEX`, `IGNORE_ROW_ON_DUPKEY_INDEX`, and `RETRY_ON_ROW_CHANGE` hints are unlike other hints in that they have a semantic effect. The general philosophy explained in [Hints](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E) does not apply for these three hints. 
...
This use of this hint results in error messages if specific rules are violated. Refer to [IGNORE_ROW_ON_DUPKEY_INDEX Hint](Comments.html#GUID-20390275-91A7-49DC-AAD1-A1FE943A4F75) for details. 
...
[containers_clause](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__CONTAINERS_CLAUSE-2C8DC5C8) for more information on the `CONTAINERS()` clause 

#### CURSOR_SHARING_EXACT Hint 

![Description of cursor_sharing_exact_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cursor_sharing_exact_hint.gif)[Descriptionof the illustration cursor_sharing_exact_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cursor_sharing_exact_hint.md)
...
![Description of disable_parallel_dml_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/disable_parallel_dml_hint.gif)[Descriptionof the illustration disable_parallel_dml_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/disable_parallel_dml_hint.md)
...
![Description of first_rows_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/first_rows_hint.gif)[Descriptionof the illustration first_rows_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/first_rows_hint.md)
...
[ALL_ROWS Hint](Comments.html#GUID-EAC8556A-3160-42F0-8101-4AA41BF119CD) for additional information on the `FIRST_ROWS` hint and statistics 

#### FRESH_MV Hint 

![Description of fresh_mv_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fresh_mv_hint.gif)[Descriptionof the illustration fresh_mv_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fresh_mv_hint.md)
...
The [{ ENABLE | DISABLE } ON QUERY COMPUTATION](CREATE-MATERIALIZED-VIEW.html#GUID-EE262CA4-01E5-4618-B659-6165D993CA1B__ENABLEDISABLEONQUERYCOMPUTATION-2C8E4857) clause of `CREATE` `MATERIALIZED` `VIEW` for more information on real-time materialized views 

#### FULL Hint 

![Description of full_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/full_hint.gif)[Descriptionof the illustration full_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/full_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of gather_opt_stats_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/gather_opt_stats_hint.gif)[Descriptionof the illustration gather_opt_stats_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/gather_opt_stats_hint.md)
...
![Description of grouping_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grouping_hint.gif)[Descriptionof the illustration grouping_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grouping_hint.md)
...
[Oracle Machine Learning for SQL Functions](Single-Row-Functions.html#GUID-E64F8D20-C7E2-482A-914F-2781D0AA4E64)

#### HASH Hint 

![Description of hash_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hash_hint.gif)[Descriptionof the illustration hash_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hash_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of ignore_row_on_dupkey_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ignore_row_on_dupkey_index.gif)[Descriptionof the illustration ignore_row_on_dupkey_index.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ignore_row_on_dupkey_index.md)
...
[CHANGE_DUPKEY_ERROR_INDEX Hint](Comments.html#GUID-BE83A338-FE21-444F-8CD9-455FC79C0057)

#### INDEX Hint 

![Description of index_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_hint.gif)[Descriptionof the illustration index_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB), [indexspec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABGFHCH)) 
...
![Description of index_combine_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_combine_hint.gif)[Descriptionof the illustration index_combine_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_combine_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB), [indexspec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABGFHCH)) 
...
Each parameter serves the same purpose as in [INDEX Hint](Comments.html#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930). For example, the following query uses an index join to access the `manager_id` and `department_id` columns, both of which are indexed in the `employees` table. 
...
Each parameter serves the same purpose as in the [INDEX Hint](Comments.html#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930). For example: 
...
![Description of model_min_analysis_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/model_min_analysis_hint.gif)[Descriptionof the illustration model_min_analysis_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/model_min_analysis_hint.md)

The `MODEL_MIN_ANALYSIS` hint instructs the optimizer to omit some compile-time optimizations of spreadsheet rulesâprimarily detailed dependency graph analysis. Other spreadsheet optimizations, such as creating filters to selectively populate spreadsheet access structures and limited rule pruning, are still used by the optimizer. 
...
![Description of monitor_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/monitor_hint.gif)[Descriptionof the illustration monitor_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/monitor_hint.md)
...
![Description of native_foj_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/native_foj_hint.gif)[Descriptionof the illustration native_foj_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/native_foj_hint.md)
...
See Also:
  ...
  * [NO_NATIVE_FULL_OUTER_JOIN Hint](Comments.html#GUID-BEA2DE06-77C6-49AB-9EFB-8BD9469E8649)* [Oracle Database SQL Tuning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL242) for more information about native full outer joins 
...
![Description of noappend_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/noappend_hint.gif)[Descriptionof the illustration noappend_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/noappend_hint.md)

The `NOAPPEND` hint instructs the optimizer to use conventional `INSERT` even when `INSERT` is performed in parallel mode. 

#### NOCACHE Hint 

![Description of nocache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nocache_hint.gif)[Descriptionof the illustration nocache_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nocache_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of no_clustering_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_clustering_hint.gif)[Descriptionof the illustration no_clustering_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_clustering_hint.md)This hint is valid only for `INSERT` and `MERGE` operations on tables that are enabled for attribute clustering. The `NO_CLUSTERING` hint disables attribute clustering for direct-path inserts (serial or parallel). This hint overrides a `YES` `ON` `LOAD` setting in the DDL that created or altered the table. This hint has no effect on tables that are not enabled for attribute clustering. 

See Also:

  * [clustering_when](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__CEGJBIHI) clause of `CREATE` `TABLE` for more information on the `YES` `ON` `LOAD` setting 

  * [CLUSTERING Hint](Comments.html#GUID-583D4C60-2B0E-4740-82D9-DD6F7EC38D9D)
...
![Description of no_expand_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_expand_hint.gif)[Descriptionof the illustration no_expand_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_expand_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 
...
The [USE_CONCAT Hint](Comments.html#GUID-5A12BDC8-4CD1-448F-80BF-9F02653A3F94), which is the opposite of this hint 

#### NO_FACT Hint 

![Description of no_fact_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_fact_hint.gif)[Descriptionof the illustration no_fact_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_fact_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of no_gather_opt_stats_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_gather_opt_stats_hint.gif)[Descriptionof the illustration no_gather_opt_stats_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_gather_opt_stats_hint.md)
...
Each parameter serves the same purpose as in [INDEX Hint](Comments.html#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930) with the following modifications: 
...
![Description of no_index_ffs_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_index_ffs_hint.gif)[Descriptionof the illustration no_index_ffs_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_index_ffs_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB), [indexspec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABGFHCH)) 

The `NO_INDEX_FFS` hint instructs the optimizer to exclude a fast full index scan of the specified indexes on the specified table. Each parameter serves the same purpose as in the [NO_INDEX Hint](Comments.html#GUID-0CE4D80E-76A5-4082-A2D1-5FB7D7F67366). For example: 
...
![Description of no_index_ss_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_index_ss_hint.gif)[Descriptionof the illustration no_index_ss_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_index_ss_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB), [indexspec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABGFHCH)) 

The `NO_INDEX_SS` hint instructs the optimizer to exclude a skip scan of the specified indexes on the specified table. Each parameter serves the same purpose as in the [NO_INDEX Hint](Comments.html#GUID-0CE4D80E-76A5-4082-A2D1-5FB7D7F67366). 
...
![Description of no_monitor_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_monitor_hint.gif)[Descriptionof the illustration no_monitor_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_monitor_hint.md)
...
![Description of no_native_foj_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_native_foj_hint.gif)[Descriptionof the illustration no_native_foj_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_native_foj_hint.md)
...
[NATIVE_FULL_OUTER_JOIN Hint](Comments.html#GUID-02071A47-C4B0-4139-B985-4ED6E13B78F2)

#### NO_PARALLEL Hint 

![Description of no_parallel_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_parallel_hint.gif)[Descriptionof the illustration no_parallel_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_parallel_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
See Also:
  ...
  * [Note on Parallel Hints](Comments.html#GUID-D25225CE-2DCE-4D9F-8E82-401839690A6E__CHDGEGFI) for more information on the parallel hints 
...
![Description of no_parallel_index_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_parallel_index_hint.gif)[Descriptionof the illustration no_parallel_index_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_parallel_index_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB), [indexspec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABGFHCH)) 
...
See Also:
  ...
  * [PQ_CONCURRENT_UNION Hint](Comments.html#GUID-7694D1CD-2851-49EF-8C52-91BCB5C48A40)* [Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG14131) for information about using this hint 
...
![Description of no_pq_skew_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_pq_skew_hint.gif)[Descriptionof the illustration no_pq_skew_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_pq_skew_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 

The `NO_PQ_SKEW` hint advises the optimizer that the distribution of the values of the join keys for a parallel join is not skewedâthat is, a high percentage of rows do not have the same join key values. The table specified in `tablespec` is the probe table of the hash join. 

#### NO_PUSH_PRED Hint 

![Description of no_push_pred_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_push_pred_hint.gif)[Descriptionof the illustration no_push_pred_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_push_pred_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of no_result_cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_result_cache_hint.gif)[Descriptionof the illustration no_result_cache_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_result_cache_hint.md)
...
![Description of no_star_transformation_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_star_transformation_hint.gif)[Descriptionof the illustration no_star_transformation_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_star_transformation_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 
...
![Description of no_xml_query_rewrite_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_xml_query_rewrite_hint.gif)[Descriptionof the illustration no_xml_query_rewrite_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_xml_query_rewrite_hint.md)
...
[NO_XMLINDEX_REWRITE Hint](Comments.html#GUID-382A0A51-6D6A-42A6-8CAB-3EA2606421BA)

#### NO_XMLINDEX_REWRITE Hint 

![Description of no_xmlindex_rewrite_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_xmlindex_rewrite_hint.gif)[Descriptionof the illustration no_xmlindex_rewrite_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_xmlindex_rewrite_hint.md)
...
[NO_XML_QUERY_REWRITE Hint](Comments.html#GUID-2D5833D9-E618-4AA6-A665-9706451DEDD7) for another way to disable the use of XMLIndexes 

#### NO_ZONEMAP Hint

![Description of no_zonemap_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_zonemap_hint.gif)[Descriptionof the illustration no_zonemap_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_zonemap_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
See Also:
  ...
  * [ENABLE | DISABLE PRUNING](CREATE-MATERIALIZED-ZONEMAP.html#GUID-1E5048FC-3D28-49BC-80FE-7871568B4702__CACEAADH) clause of `CREATE` `MATERIALIZED` `ZONEMAP`
...
![Description of opt_param_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/opt_param_hint.gif)[Descriptionof the illustration opt_param_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/opt_param_hint.md)
...
![Description of ordered_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ordered_hint.gif)[Descriptionof the illustration ordered_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ordered_hint.md)
...
Refer to [CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) and [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1475) for more information on parallel execution. 

See Also:

  * [CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) and [Oracle Database Concepts](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1475) for more information on parallel execution. 
...
![Description of pq_concurrent_union_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_concurrent_union_hint.gif)[Descriptionof the illustration pq_concurrent_union_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_concurrent_union_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 

The `PQ_CONCURRENT_UNION` hint instructs the optimizer to enable concurrent processing of `UNION` and `UNION` `ALL` operations. 

See Also:

  * [NO_PQ_CONCURRENT_UNION Hint](Comments.html#GUID-FE79056A-ED00-423F-8683-8055A5640356)* [Oracle Database VLDB and Partitioning Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG14131) for information about using this hint 
...
You can control the distribution of rows for parallel `INSERT` ... `SELECT` and parallel `CREATE` `TABLE` ... `AS` `SELECT` statements to direct how rows should be distributed between the producer (query) and the consumer (load) servers. Use the upper branch of the syntax by specifying a single distribution method. The values of the distribution methods and their semantics are described in [Table 2-25](Comments.html#GUID-B04E477E-7080-4D02-A660-79EB71BDE980__CHDCAGHI "This table lists the six viable distributions for load in the first column and describes the behavior of each distribution in the second column."). 
...
The values of the distributions are `HASH`, `BROADCAST`, `PARTITION`, and `NONE`. Only six combinations table distributions are valid, as described in [Table 2-26](Comments.html#GUID-B04E477E-7080-4D02-A660-79EB71BDE980__BABCCEJI "This table lists the six viable distribution combinations for joins in the first column and describes the behavior of each combination in the second column."): 
...
![Description of pq_filter_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_filter_hint.gif)[Descriptionof the illustration pq_filter_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_filter_hint.md)
...
![Description of pq_skew_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_skew_hint.gif)[Descriptionof the illustration pq_skew_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_skew_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 

The `PQ_SKEW` hint advises the optimizer that the distribution of the values of the join keys for a parallel join is highly skewedâthat is, a high percentage of rows have the same join key values. The table specified in `tablespec` is the probe table of the hash join. 

#### PUSH_PRED Hint 

![Description of push_pred_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/push_pred_hint.gif)[Descriptionof the illustration push_pred_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/push_pred_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of px_join_filter_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/px_join_filter_hint.gif)[Descriptionof the illustration px_join_filter_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/px_join_filter_hint.md)

This hint forces the optimizer to use parallel join bitmap filtering.

#### QB_NAME Hint 

![Description of qb_name_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qb_name_hint.gif)[Descriptionof the illustration qb_name_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qb_name_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 
...
![Description of result_cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/result_cache_hint.gif)[Descriptionof the illustration result_cache_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/result_cache_hint.md)
...
![Description of retry_on_row_change.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/retry_on_row_change.gif)[Descriptionof the illustration retry_on_row_change.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/retry_on_row_change.md)
...
[IGNORE_ROW_ON_DUPKEY_INDEX Hint](Comments.html#GUID-20390275-91A7-49DC-AAD1-A1FE943A4F75) and [CHANGE_DUPKEY_ERROR_INDEX Hint](Comments.html#GUID-BE83A338-FE21-444F-8CD9-455FC79C0057)

#### REWRITE Hint 

![Description of rewrite_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rewrite_hint.gif)[Descriptionof the illustration rewrite_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rewrite_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 
...
![Description of statement_queuing_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/statement_queuing_hint.gif)[Descriptionof the illustration statement_queuing_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/statement_queuing_hint.md)
...
[NO_STATEMENT_QUEUING Hint](Comments.html#GUID-0C6D937B-4C70-44AC-A3BF-570AEA897F9B)

#### UNNEST Hint 

![Description of unnest_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/unnest_hint.gif)[Descriptionof the illustration unnest_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/unnest_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 
...
See Also:
  ...
  * [Collection Unnesting: Examples](SELECT.html#GUID-CFA006CA-6FF1-4972-821E-6996142A51C6__I2071637) for more information on unnesting nested subqueries and the conditions that make a subquery block valid 
...
![Description of use_concat_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_concat_hint.gif)[Descriptionof the illustration use_concat_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_concat_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA)) 
...
![Description of use_hash_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_hash_hint.gif)[Descriptionof the illustration use_hash_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_hash_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
...
![Description of use_merge_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_merge_hint.gif)[Descriptionof the illustration use_merge_hint.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_merge_hint.md)(See [Specifying a Query Block in a Hint](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA), [tablespec::=](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABIEJEB)) 
