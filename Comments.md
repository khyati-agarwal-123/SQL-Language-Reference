##  Comments {#GUID-79B6B8FD-2DD4-471E-B9E0-0C8D20B058F6} 
...
###  Comments Within SQL Statements {#GUID-5C84C344-CEB3-4DBF-B748-337DE11CCE2A} 

Comments can make your application easier for you to read and maintain. For example, you can include a comment in a statement that describes the purpose of the statement within your application. With the exception of hints, comments within SQL statements do not affect the statement execution. Refer to [ Hints ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E) on using this particular form of comment. 
...
![Description of hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hint.gif)[ Description of the illustration hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hint.md)
...
With 19c you can use ` DBMS_XPLAN ` to find out whether a hint is used or not used. For more information, see the [ *Database SQL Tuning Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL) . 
...
![Description of tablespec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/tablespec.gif)[ Description of the illustration tablespec.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/tablespec.md)
...
![Description of indexspec.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/indexspec.gif)[ Description of the illustration indexspec.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/indexspec.md)
...
The [ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL271) describes hints and the [ ` EXPLAIN ` ` PLAN ` ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL271) . 

Hints by Functional Category 

[ Table 2-24 ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEAFGF) lists the hints by functional category and contains cross-references to the syntax and semantics for each hint. An alphabetical reference of the hints follows the table. 

**Table: Hints by Functional Category** 
...
###  Alphabetical Listing of Hints {#GUID-06C047B1-133B-4211-9949-5FE9C0659D44} 

This section provides syntax and semantics for all hints in alphabetical order. 

####  ALL_ROWS Hint {#GUID-EAC8556A-3160-42F0-8101-4AA41BF119CD} 

![Description of all_rows_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/all_rows_hint.gif)[ Description of the illustration all_rows_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/all_rows_hint.md)
...
####  APPEND Hint {#GUID-562DD503-2F99-448E-B044-737BE726B58A} 

![Description of append_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_hint.gif)[ Description of the illustration append_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_hint.md)
...
The ` APPEND ` hint is only supported with the subquery syntax of the ` INSERT ` statement, not the ` VALUES ` clause. If you specify the ` APPEND ` hint with the ` VALUES ` clause, it is ignored and conventional insert will be used. To use direct-path ` INSERT ` with the ` VALUES ` clause, refer to  " [ APPEND_VALUES Hint ](Comments.md#GUID-DD069661-D431-40F5-9303-DB8C1153D87D) "  . 

> **note:** See Also: 

[ NOAPPEND Hint ](Comments.md#GUID-86B4C4B6-28F6-4A11-8146-67ABE8331646) for information on that hint and [ *Oracle Database Administrator’s Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN01509) for information on direct-path inserts 

####  APPEND_VALUES Hint {#GUID-DD069661-D431-40F5-9303-DB8C1153D87D} 

![Description of append_values_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/append_values_hint.gif)[ Description of the illustration append_values_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/append_values_hint.md)
...
The ` APPEND_VALUES ` hint is only supported with the ` VALUES ` clause of the ` INSERT ` statement. If you specify the ` APPEND_VALUES ` hint with the subquery syntax of the ` INSERT ` statement, it is ignored and conventional insert will be used. To use direct-path ` INSERT ` with a subquery, refer to  " [ APPEND Hint ](Comments.md#GUID-562DD503-2F99-448E-B044-737BE726B58A) "  . 

> **note:** See Also: 

[ *Oracle Database Administrator’s Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN01509) for information on direct-path inserts 

####  CACHE Hint {#GUID-EECD7FE0-A8FE-4B85-91EF-7984BC77392C} 

![Description of cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_hint.gif)[ Description of the illustration cache_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  CHANGE_DUPKEY_ERROR_INDEX Hint {#GUID-BE83A338-FE21-444F-8CD9-455FC79C0057} 

![Description of change_dupkey_error_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/change_dupkey_error_index.gif)[ Description of the illustration change_dupkey_error_index.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/change_dupkey_error_index.md)

> **note:** 

The ` CHANGE_DUPKEY_ERROR_INDEX ` , ` IGNORE_ROW_ON_DUPKEY_INDEX ` , and ` RETRY_ON_ROW_CHANGE ` hints are unlike other hints in that they have a semantic effect. The general philosophy explained in [ Hints ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E) does not apply for these three hints. 
...
This use of this hint results in error messages if specific rules are violated. Refer to [ IGNORE_ROW_ON_DUPKEY_INDEX Hint ](Comments.md#GUID-20390275-91A7-49DC-AAD1-A1FE943A4F75) for details. 

> **note:** 

This hint disables both ` APPEND ` mode and parallel DML. 

####  CLUSTER Hint {#GUID-3F26577F-8D14-41BD-BB02-7A45998FDA19} 

![Description of cluster_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cluster_hint.gif)[ Description of the illustration cluster_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cluster_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  CLUSTERING Hint {#GUID-583D4C60-2B0E-4740-82D9-DD6F7EC38D9D} 

![Description of clustering_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/clustering_hint.gif)[ Description of the illustration clustering_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/clustering_hint.md)This hint is valid only for ` INSERT ` and ` MERGE ` operations on tables that are enabled for attribute clustering. The ` CLUSTERING ` hint enables attribute clustering for direct-path inserts (serial or parallel). This results in partially-clustered data, that is, data that is clustered per each insert or merge operation. This hint overrides a ` NO ` ` ON ` ` LOAD ` setting in the DDL that created or altered the table. This hint has no effect on tables that are not enabled for attribute clustering. 
...
####  COMPRESS_IMMEDIATE Hint {#GUID-814D718B-C5CC-4A5E-A697-BBBC53D6FF1B} 

**Syntax** 

![Description of compress_immediate_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/compress_immediate_hint.gif)[ Description of the illustration compress_immediate_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/compress_immediate_hint.md)

` COMPRESS_IMMEDIATE ` forces compression to happen immediately during direct load. 

When Automatic Storage Compression is enabled via ` DBMS_ILM_ADMIN.ENABLE_AUTO_OPTIMIZE ` , compression is delayed for new direct loads. Use this hint to overide the delay and compress the direct load immediately. 

####  CONTAINERS Hint {#GUID-28F7F1DB-E265-40CB-BF41-E07A1A755566} 

![Description of containers_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/containers_hint.gif)[ Description of the illustration containers_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/containers_hint.md)The ` CONTAINERS ` hint is useful in a multitenant container database (CDB). You can specify this hint in a ` SELECT ` statement that contains the ` CONTAINERS() ` clause. Such a statement lets you query data in the specified table or view across all containers in a CDB or application container. 
...
####  CURSOR_SHARING_EXACT Hint {#GUID-377022EE-3F17-417E-84FE-AE87FA5C2653} 

![Description of cursor_sharing_exact_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cursor_sharing_exact_hint.gif)[ Description of the illustration cursor_sharing_exact_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cursor_sharing_exact_hint.md)
...
####  DISABLE_PARALLEL_DML Hint {#GUID-0E97E9FE-9AE1-456A-89C3-019FB10E78E7} 

![Description of disable_parallel_dml_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/disable_parallel_dml_hint.gif)[ Description of the illustration disable_parallel_dml_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/disable_parallel_dml_hint.md)
...
####  DRIVING_SITE Hint {#GUID-DDABFD2E-FE80-4A2D-99D2-87E61EFA2182} 

![Description of driving_site_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/driving_site_hint.gif)[ Description of the illustration driving_site_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/driving_site_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  DYNAMIC_SAMPLING Hint {#GUID-72207153-4785-45D6-B1AA-CDB78D685FD1} 

![Description of dynamic_sampling_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dynamic_sampling_hint.gif)[ Description of the illustration dynamic_sampling_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dynamic_sampling_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
[ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL450) for information about dynamic sampling and the sampling levels that you can set 

####  ENABLE_PARALLEL_DML Hint {#GUID-9B25245A-9884-4031-BAE0-538B4206194E} 

![Description of enable_parallel_dml_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/enable_parallel_dml_hint.gif)[ Description of the illustration enable_parallel_dml_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/enable_parallel_dml_hint.md)
...
[ *Oracle Database VLDB and Partitioning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG1438) for information about enabling parallel DML 

####  FACT Hint {#GUID-A0F83FA9-BEDC-4343-97EC-500AD201AB5A} 

![Description of fact_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fact_hint.gif)[ Description of the illustration fact_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fact_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  FIRST_ROWS Hint {#GUID-CEA66568-0168-4AE2-AD3B-FE86CDD73894} 

![Description of first_rows_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/first_rows_hint.gif)[ Description of the illustration first_rows_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/first_rows_hint.md)
...
[ ALL_ROWS Hint ](Comments.md#GUID-EAC8556A-3160-42F0-8101-4AA41BF119CD) for additional information on the ` FIRST_ROWS ` hint and statistics 

####  FRESH_MV Hint {#GUID-5EF4198B-50B3-40D8-B12A-3D3115C69D9B} 

![Description of fresh_mv_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fresh_mv_hint.gif)[ Description of the illustration fresh_mv_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fresh_mv_hint.md)
...
####  FULL Hint {#GUID-581F6C91-1395-4ED0-81DE-59AE168FE183} 

![Description of full_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/full_hint.gif)[ Description of the illustration full_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/full_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  GATHER_OPTIMIZER_STATISTICS Hint {#GUID-6624DB8F-F071-4FA5-8B40-BDDBB4FC7214} 

![Description of gather_opt_stats_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/gather_opt_stats_hint.gif)[ Description of the illustration gather_opt_stats_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/gather_opt_stats_hint.md)
...
[ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL344) for more information on statistics gathering for bulk loads 

####  GROUPING Hint {#GUID-9693C230-2616-4123-A1ED-3C41E9566F7A} 

![Description of grouping_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grouping_hint.gif)[ Description of the illustration grouping_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grouping_hint.md)
...
In the following example, the ` GROUPING ` hint is used in the ` PREDICTION ` function. 
    ...
    ```
    SELECT PREDICTION(/*+ GROUPING */my_model USING *) pred FROM ;
    ```
...
####  HASH Hint {#GUID-B5B05B54-DB85-40D2-8332-AA88C03ADBA6} 

![Description of hash_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hash_hint.gif)[ Description of the illustration hash_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hash_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  IGNORE_ROW_ON_DUPKEY_INDEX Hint {#GUID-20390275-91A7-49DC-AAD1-A1FE943A4F75} 

![Description of ignore_row_on_dupkey_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ignore_row_on_dupkey_index.gif)[ Description of the illustration ignore_row_on_dupkey_index.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ignore_row_on_dupkey_index.md)
...
####  INDEX Hint {#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930} 

![Description of index_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_hint.gif)[ Description of the illustration index_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
####  INDEX_ASC Hint {#GUID-6FBA20C6-E981-4A1A-AAEA-131D9C4B6E62} 

![Description of index_asc_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_asc_hint.gif)[ Description of the illustration index_asc_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_asc_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 

The ` INDEX_ASC ` hint instructs the optimizer to use an index scan for the specified table. If the statement uses an index range scan, then Oracle Database scans the index entries in ascending order of their indexed values. Each parameter serves the same purpose as in [ INDEX Hint ](Comments.md#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930) . 
...
####  INDEX_DESC Hint {#GUID-6D36EF83-F808-4056-896B-BCACAB83B8BD} 

![Description of index_desc_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_desc_hint.gif)[ Description of the illustration index_desc_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_desc_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
[ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL237) for information on full scans 

####  INDEX_FFS Hint {#GUID-1D21818E-EA7E-4546-870D-B0C5CBD797CC} 

![Description of index_ffs_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_ffs_hint.gif)[ Description of the illustration index_ffs_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_ffs_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 

The ` INDEX_FFS ` hint instructs the optimizer to perform a fast full index scan rather than a full table scan. 

Each parameter serves the same purpose as in [ INDEX Hint ](Comments.md#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930) . For example: 
...
####  INDEX_JOIN Hint {#GUID-59A98AD5-94EE-48D6-BD84-CE8986E4BAE1} 

![Description of index_join_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_join_hint.gif)[ Description of the illustration index_join_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_join_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
Each parameter serves the same purpose as in [ INDEX Hint ](Comments.md#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930) . For example, the following query uses an index join to access the ` manager_id ` and ` department_id ` columns, both of which are indexed in the ` employees ` table. 
...
####  INDEX_SS Hint {#GUID-FCEE077B-6D56-48E5-A642-64EFDA4228AA} 

![Description of index_ss_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_ss_hint.gif)[ Description of the illustration index_ss_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_ss_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
[ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL238) for information on index skip scans 

####  INDEX_SS_ASC Hint {#GUID-E880F47F-06FD-4959-9D57-2D783A40D89D} 

![Description of index_ss_asc_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_ss_asc_hint.gif)[ Description of the illustration index_ss_asc_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_ss_asc_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
####  INDEX_SS_DESC Hint {#GUID-1F3EA36C-4F8F-453D-A66E-EB8FD2E85516} 

![Description of index_ss_desc_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/index_ss_desc_hint.gif)[ Description of the illustration index_ss_desc_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/index_ss_desc_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
Each parameter serves the same purpose as in the [ INDEX Hint ](Comments.md#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930) . For example: 
...
####  INMEMORY Hint {#GUID-08F70BF0-4975-446B-B29C-6215F6510668} 

![Description of inmemory_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/inmemory_hint.gif)[ Description of the illustration inmemory_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/inmemory_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 

The ` INMEMORY ` hint enables In-Memory queries. 

This hint does not instruct the optimizer to perform a full table scan. If a full table scan is desired, then also specify the [ FULL Hint ](Comments.md#GUID-581F6C91-1395-4ED0-81DE-59AE168FE183) . 

####  INMEMORY_PRUNING Hint {#GUID-CAE5C861-7A10-45C4-89DB-340D83A60758} 

![Description of inmemory_pruning_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/inmemory_pruning_hint.gif)[ Description of the illustration inmemory_pruning_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/inmemory_pruning_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 

The ` INMEMORY_PRUNING ` hint enables pruning of In-Memory queries. 

####  LEADING Hint {#GUID-C18CDA01-D24C-4861-AA10-C57DF20C7E0F} 

![Description of leading_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/leading_hint.gif)[ Description of the illustration leading_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/leading_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  MERGE Hint {#GUID-4E431B5D-F61B-4F66-B86C-E9C8660E2FE7} 

![Description of merge_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge_hint.gif)[ Description of the illustration merge_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  MODEL_MIN_ANALYSIS Hint {#GUID-7C4C7728-B202-413B-9F91-EC1B8D63F3B0} 

![Description of model_min_analysis_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/model_min_analysis_hint.gif)[ Description of the illustration model_min_analysis_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/model_min_analysis_hint.md)
...
####  MONITOR Hint {#GUID-CD628749-C7E0-4EBB-A989-E9C10325EDF7} 

![Description of monitor_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/monitor_hint.gif)[ Description of the illustration monitor_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/monitor_hint.md)
...
[ *Oracle Database SQL Tuning Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL790) for more information about real-time SQL monitoring 

####  NATIVE_FULL_OUTER_JOIN Hint {#GUID-02071A47-C4B0-4139-B985-4ED6E13B78F2} 

![Description of native_foj_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/native_foj_hint.gif)[ Description of the illustration native_foj_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/native_foj_hint.md)
...
> **note:** See Also: 
  ...
  * [ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL242) for more information about native full outer joins 




####  NOAPPEND Hint {#GUID-86B4C4B6-28F6-4A11-8146-67ABE8331646} 

![Description of noappend_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/noappend_hint.gif)[ Description of the illustration noappend_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/noappend_hint.md)

The ` NOAPPEND ` hint instructs the optimizer to use conventional ` INSERT ` even when ` INSERT ` is performed in parallel mode. 

####  NOCACHE Hint {#GUID-45FB9EE0-5CF1-42D7-8137-F2B9689369AE} 

![Description of nocache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nocache_hint.gif)[ Description of the illustration nocache_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nocache_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_CLUSTERING Hint {#GUID-48179E54-E6DB-462B-BD8D-978B3340CFD1} 

![Description of no_clustering_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_clustering_hint.gif)[ Description of the illustration no_clustering_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_clustering_hint.md)This hint is valid only for ` INSERT ` and ` MERGE ` operations on tables that are enabled for attribute clustering. The ` NO_CLUSTERING ` hint disables attribute clustering for direct-path inserts (serial or parallel). This hint overrides a ` YES ` ` ON ` ` LOAD ` setting in the DDL that created or altered the table. This hint has no effect on tables that are not enabled for attribute clustering. 
...
####  NO_EXPAND Hint {#GUID-D4C251F0-B3A3-4D7E-843E-3491608D48DB} 

![Description of no_expand_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_expand_hint.gif)[ Description of the illustration no_expand_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_expand_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
The [ USE_CONCAT Hint ](Comments.md#GUID-5A12BDC8-4CD1-448F-80BF-9F02653A3F94) , which is the opposite of this hint 

####  NO_FACT Hint {#GUID-141AB5C2-2ACF-4069-879C-4379F1AB0391} 

![Description of no_fact_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_fact_hint.gif)[ Description of the illustration no_fact_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_fact_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_GATHER_OPTIMIZER_STATISTICS Hint {#GUID-D7034ED9-BCCD-4B2C-8680-250E1FC0463A} 

![Description of no_gather_opt_stats_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_gather_opt_stats_hint.gif)[ Description of the illustration no_gather_opt_stats_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_gather_opt_stats_hint.md)
...
[ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL-GUID-769E609D-0312-43A7-9581-3F3EACF10BA9) for more information on online statistics gathering for conventional loads. 

####  NO_INDEX Hint {#GUID-0CE4D80E-76A5-4082-A2D1-5FB7D7F67366} 

![Description of no_index_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_index_hint.gif)[ Description of the illustration no_index_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_index_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
Each parameter serves the same purpose as in [ INDEX Hint ](Comments.md#GUID-EC0D9F8A-20E7-4281-A16A-6B9C993F2930) with the following modifications: 
...
####  NO_INDEX_FFS Hint {#GUID-47B18C7A-E9D4-4BEF-A566-C23A84440F02} 

![Description of no_index_ffs_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_index_ffs_hint.gif)[ Description of the illustration no_index_ffs_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_index_ffs_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 

The ` NO_INDEX_FFS ` hint instructs the optimizer to exclude a fast full index scan of the specified indexes on the specified table. Each parameter serves the same purpose as in the [ NO_INDEX Hint ](Comments.md#GUID-0CE4D80E-76A5-4082-A2D1-5FB7D7F67366) . For example: 
...
####  NO_INDEX_SS Hint {#GUID-98FC989A-BC21-4D56-AB4A-2FD73B365DCC} 

![Description of no_index_ss_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_index_ss_hint.gif)[ Description of the illustration no_index_ss_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_index_ss_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 

The ` NO_INDEX_SS ` hint instructs the optimizer to exclude a skip scan of the specified indexes on the specified table. Each parameter serves the same purpose as in the [ NO_INDEX Hint ](Comments.md#GUID-0CE4D80E-76A5-4082-A2D1-5FB7D7F67366) . 

> **note:** See Also: 

[ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL238) for information on index skip scans 

####  NO_INMEMORY Hint {#GUID-3A8628DA-7DFE-4B90-BDB0-9C98BE709376} 

![Description of no_inmemory_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_inmemory_hint.gif)[ Description of the illustration no_inmemory_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_inmemory_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 

The ` NO_INMEMORY ` hint disables In-Memory queries. 

####  NO_INMEMORY_PRUNING Hint {#GUID-54B0B0E9-5CB8-451C-B94D-1925CBC86BCA} 

![Description of no_inmemory_pruning_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_inmemory_pruning_hint.gif)[ Description of the illustration no_inmemory_pruning_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_inmemory_pruning_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 

The ` NO_INMEMORY_PRUNING ` hint disables pruning of In-Memory queries. 

####  NO_MERGE Hint {#GUID-DAB72B9A-0141-4EC3-8877-348C53BCDC03} 

![Description of no_merge_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_merge_hint.gif)[ Description of the illustration no_merge_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_merge_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_MONITOR Hint {#GUID-9F1C50DB-E9C7-4391-AE94-04D2A1E79BE5} 

![Description of no_monitor_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_monitor_hint.gif)[ Description of the illustration no_monitor_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_monitor_hint.md)

The ` NO_MONITOR ` hint disables real-time SQL monitoring for the query, even if the query is long running. 

####  NO_NATIVE_FULL_OUTER_JOIN Hint {#GUID-BEA2DE06-77C6-49AB-9EFB-8BD9469E8649} 

![Description of no_native_foj_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_native_foj_hint.gif)[ Description of the illustration no_native_foj_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_native_foj_hint.md)
...
####  NO_PARALLEL Hint {#GUID-C0F71904-C245-4B53-8B1B-8113372FD5E1} 

![Description of no_parallel_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_parallel_hint.gif)[ Description of the illustration no_parallel_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_parallel_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Reference*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10310) for more information on the ` PARALLEL_DEGREE_POLICY ` initialization parameter 




####  NOPARALLEL Hint {#GUID-AF66D0C2-230F-4E0D-8ACB-F509491731E8} 

The ` NOPARALLEL ` hint has been deprecated. Use the ` NO_PARALLEL ` hint instead. 

####  NO_PARALLEL_INDEX Hint {#GUID-5951911D-D611-40FF-BD0D-9B789D384313} 

![Description of no_parallel_index_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_parallel_index_hint.gif)[ Description of the illustration no_parallel_index_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_parallel_index_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
...
####  NOPARALLEL_INDEX Hint {#GUID-6293C7D4-3571-4EF1-B8AE-B6F4442A1477} 

The ` NOPARALLEL_INDEX ` hint has been deprecated. Use the ` NO_PARALLEL_INDEX ` hint instead. 

####  NO_PQ_CONCURRENT_UNION Hint {#GUID-FE79056A-ED00-423F-8683-8055A5640356} 

![Description of no_pq_concurrent_union_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_pq_concurrent_union_hint.gif)[ Description of the illustration no_pq_concurrent_union_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_pq_concurrent_union_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database VLDB and Partitioning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=VLDBG14131) for information about using this hint 




####  NO_PQ_SKEW Hint {#GUID-EAB1F2B4-DF52-4261-9980-8E4CA3131F33} 

![Description of no_pq_skew_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_pq_skew_hint.gif)[ Description of the illustration no_pq_skew_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_pq_skew_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_PUSH_PRED Hint {#GUID-ED064FDD-61BC-4894-AAA7-A593154CABF4} 

![Description of no_push_pred_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_push_pred_hint.gif)[ Description of the illustration no_push_pred_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_push_pred_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_PUSH_SUBQ Hint {#GUID-7DC64CF1-465E-4307-B5CF-62E0757FCECA} 

![Description of no_push_subq_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_push_subq_hint.gif)[ Description of the illustration no_push_subq_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_push_subq_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
####  NO_PX_JOIN_FILTER Hint {#GUID-99A00ADE-9D5A-47C9-9C35-A5D95ACC5A3B} 

![Description of no_px_join_filter_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_px_join_filter_hint.gif)[ Description of the illustration no_px_join_filter_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_px_join_filter_hint.md)

This hint prevents the optimizer from using parallel join bitmap filtering. 

####  NO_QUERY_TRANSFORMATION Hint {#GUID-46C06086-1E94-4E0A-9A71-E4DE9386E364} 

![Description of no_query_transformatn_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_query_transformatn_hint.gif)[ Description of the illustration no_query_transformatn_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_query_transformatn_hint.md)
...
####  NO_RESULT_CACHE Hint {#GUID-E3514C53-015B-4FF3-8C63-F37F3A14D8AF} 

![Description of no_result_cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_result_cache_hint.gif)[ Description of the illustration no_result_cache_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_result_cache_hint.md)
...
####  NO_REWRITE Hint {#GUID-0490CA0D-AECD-4FE1-861F-CDB20E6BDC34} 

![Description of no_rewrite_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_rewrite_hint.gif)[ Description of the illustration no_rewrite_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_rewrite_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
####  NOREWRITE Hint {#GUID-142D6FFF-A4D9-4B85-8372-ABA662B8BC28} 

The ` NOREWRITE ` hint has been deprecated. Use the ` NO_REWRITE ` hint instead. 

####  NO_STAR_TRANSFORMATION Hint {#GUID-F2C789CC-DA58-4848-BC9E-3FCF761787D9} 

![Description of no_star_transformation_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_star_transformation_hint.gif)[ Description of the illustration no_star_transformation_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_star_transformation_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 

The ` NO_STAR_TRANSFORMATION ` hint instructs the optimizer not to perform star query transformation. 

####  NO_STATEMENT_QUEUING Hint {#GUID-0C6D937B-4C70-44AC-A3BF-570AEA897F9B} 

![Description of no_statement_queuing_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_statement_queuing_hint.gif)[ Description of the illustration no_statement_queuing_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_statement_queuing_hint.md)
...
####  NO_UNNEST Hint {#GUID-AD766C93-F601-48E3-A339-BCA7604B10D3} 

![Description of no_unnest_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_unnest_hint.gif)[ Description of the illustration no_unnest_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_unnest_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 

Use of the ` NO_UNNEST ` hint turns off unnesting . 

####  NO_USE_BAND Hint {#GUID-3406DC08-3D03-483B-8EFA-9D8E33AAEB2D} 

![Description of no_use_band_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_use_band_hint.gif)[ Description of the illustration no_use_band_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_use_band_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_USE_CUBE Hint {#GUID-7F2CC062-A31A-43E2-9FC7-0054CB936FF0} 

![Description of no_use_cube_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_use_cube_hint.gif)[ Description of the illustration no_use_cube_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_use_cube_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_USE_HASH Hint {#GUID-47CB599E-F9A8-419E-BA25-6C97B9D6B27D} 

![Description of no_use_hash_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_use_hash_hint.gif)[ Description of the illustration no_use_hash_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_use_hash_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_USE_MERGE Hint {#GUID-9C16655C-150E-4DA1-88E0-0ED8CADCCBA5} 

![Description of no_use_merge_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_use_merge_hint.gif)[ Description of the illustration no_use_merge_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_use_merge_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_USE_NL Hint {#GUID-F6AB55F9-5638-4698-8DB3-28CCFACE0178} 

![Description of no_use_nl_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_use_nl_hint.gif)[ Description of the illustration no_use_nl_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_use_nl_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  NO_XML_QUERY_REWRITE Hint {#GUID-2D5833D9-E618-4AA6-A665-9706451DEDD7} 

![Description of no_xml_query_rewrite_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_xml_query_rewrite_hint.gif)[ Description of the illustration no_xml_query_rewrite_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_xml_query_rewrite_hint.md)
...
####  NO_XMLINDEX_REWRITE Hint {#GUID-382A0A51-6D6A-42A6-8CAB-3EA2606421BA} 

![Description of no_xmlindex_rewrite_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_xmlindex_rewrite_hint.gif)[ Description of the illustration no_xmlindex_rewrite_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_xmlindex_rewrite_hint.md)
...
[ NO_XML_QUERY_REWRITE Hint ](Comments.md#GUID-2D5833D9-E618-4AA6-A665-9706451DEDD7) for another way to disable the use of XMLIndexes 

####  NO_ZONEMAP Hint {#GUID-99F14625-AA9B-4195-9573-28CD008E7352} 

![Description of no_zonemap_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/no_zonemap_hint.gif)[ Description of the illustration no_zonemap_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/no_zonemap_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Data Warehousing Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG9164) for more information on pruning with zone maps 




####  OPTIMIZER_FEATURES_ENABLE Hint {#GUID-DAC6E490-19FB-4140-A0A3-6CC60DD3D3A9} 

This hint is fully documented in the Database Reference book. 

Please see [ Database Reference ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN-GUID-E193EC9E-B642-4C01-99EC-24E04AEA1A2C) for details. 

####  OPT_PARAM Hint {#GUID-02A8C120-F4D7-434C-829F-CF8118336FA1} 

![Description of opt_param_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/opt_param_hint.gif)[ Description of the illustration opt_param_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/opt_param_hint.md)
...
####  ORDERED Hint {#GUID-92EB25DD-5F00-4223-B39F-52B2AEB0D5CE} 

![Description of ordered_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ordered_hint.gif)[ Description of the illustration ordered_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ordered_hint.md)
...
####  PARALLEL Hint {#GUID-D25225CE-2DCE-4D9F-8E82-401839690A6E} 
...
![Description of parallel_hint_statement.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/parallel_hint_statement.gif)[ Description of the illustration parallel_hint_statement.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/parallel_hint_statement.md)

**parallel_hint_object::= ** 

![Description of parallel_hint_object.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/parallel_hint_object.gif)[ Description of the illustration parallel_hint_object.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/parallel_hint_object.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
Refer to [ CREATE TABLE ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) and [ *Oracle Database Concepts*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1475) for more information on parallel execution. 

> **note:** See Also: 

  * [ CREATE TABLE ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) and [ *Oracle Database Concepts*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT1475) for more information on parallel execution. 

  * [ *Oracle Database PL/SQL Packages and Types Reference*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS233) for information on the ` DBMS_PARALLEL_EXECUTE ` package, which provides methods to apply table changes in chunks of rows. Changes to each chunk are independently committed when there are no errors. 
...
####  PARALLEL_INDEX Hint {#GUID-D8952989-DB41-4F43-91E0-F727507E341F} 

![Description of parallel_index_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/parallel_index_hint.gif)[ Description of the illustration parallel_index_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/parallel_index_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , [ indexspec::= ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABGFHCH) ) 
...
####  PQ_CONCURRENT_UNION Hint {#GUID-7694D1CD-2851-49EF-8C52-91BCB5C48A40} 

![Description of pq_concurrent_union_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_concurrent_union_hint.gif)[ Description of the illustration pq_concurrent_union_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_concurrent_union_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
####  PQ_DISTRIBUTE Hint {#GUID-B04E477E-7080-4D02-A660-79EB71BDE980} 

![Description of pq_distribute_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_distribute_hint.gif)[ Description of the illustration pq_distribute_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_distribute_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
You can control the distribution of rows for parallel ` INSERT ` ... ` SELECT ` and parallel ` CREATE ` ` TABLE ` ... ` AS ` ` SELECT ` statements to direct how rows should be distributed between the producer (query) and the consumer (load) servers. Use the upper branch of the syntax by specifying a single distribution method. The values of the distribution methods and their semantics are described in [ Table 2-25 ](Comments.md#GUID-B04E477E-7080-4D02-A660-79EB71BDE980__CHDCAGHI) . 

**Table: Distribution Values for Load** 
...
The values of the distributions are ` HASH ` , ` BROADCAST ` , ` PARTITION ` , and ` NONE ` . Only six combinations table distributions are valid, as described in [ Table 2-26 ](Comments.md#GUID-B04E477E-7080-4D02-A660-79EB71BDE980__BABCCEJI) : 

**Table: Distribution Values for Joins** 
...
####  PQ_FILTER Hint {#GUID-191963B5-08FF-4C02-AB11-4424CC50CF19} 

![Description of pq_filter_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_filter_hint.gif)[ Description of the illustration pq_filter_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_filter_hint.md)
...
####  PQ_SKEW Hint {#GUID-C35DAFD1-B0F0-4849-B17C-5CC3638DD56C} 

![Description of pq_skew_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/pq_skew_hint.gif)[ Description of the illustration pq_skew_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/pq_skew_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  PUSH_PRED Hint {#GUID-78B69F30-7062-429A-8D78-425E58DF04F9} 

![Description of push_pred_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/push_pred_hint.gif)[ Description of the illustration push_pred_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/push_pred_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  PUSH_SUBQ Hint {#GUID-57609780-0DD4-4F29-8333-6301BCACEB53} 

![Description of push_subq_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/push_subq_hint.gif)[ Description of the illustration push_subq_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/push_subq_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
####  PX_JOIN_FILTER Hint {#GUID-56AB4452-3578-4391-A3AE-86E5AD46D377} 

![Description of px_join_filter_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/px_join_filter_hint.gif)[ Description of the illustration px_join_filter_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/px_join_filter_hint.md)

This hint forces the optimizer to use parallel join bitmap filtering. 

####  QB_NAME Hint {#GUID-33072CBF-E61E-4A6D-A118-55290B8B6578} 

![Description of qb_name_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qb_name_hint.gif)[ Description of the illustration qb_name_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qb_name_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
####  RESULT_CACHE Hint {#GUID-F4B4ECC4-E1FE-40FB-AE05-D7B8AA001986} 

![Description of result_cache_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/result_cache_hint.gif)[ Description of the illustration result_cache_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/result_cache_hint.md)
...
[ *Oracle Database Performance Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGDBA616) for information about using this hint,  *Oracle Database Reference*  for information about the [ ` RESULT_CACHE_MODE ` ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10270) initialization parameter, and [ *Oracle Call Interface Developer's Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNOCI10103) for more information about the OCI result cache and usage guidelines 

####  RETRY_ON_ROW_CHANGE Hint {#GUID-4664D3D8-6312-4C15-8E8F-4872DD7A44F8} 

![Description of retry_on_row_change.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/retry_on_row_change.gif)[ Description of the illustration retry_on_row_change.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/retry_on_row_change.md)
...
[ IGNORE_ROW_ON_DUPKEY_INDEX Hint ](Comments.md#GUID-20390275-91A7-49DC-AAD1-A1FE943A4F75) and [ CHANGE_DUPKEY_ERROR_INDEX Hint ](Comments.md#GUID-BE83A338-FE21-444F-8CD9-455FC79C0057)

####  REWRITE Hint {#GUID-F9B87932-5149-4CA6-9FAF-E66410E66F5C} 

![Description of rewrite_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rewrite_hint.gif)[ Description of the illustration rewrite_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rewrite_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Concepts*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=CNCPT411) for more information on materialized views 

  * [ *Oracle Database Data Warehousing Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG018) for more information on using ` REWRITE ` with materialized views 




####  STAR_TRANSFORMATION Hint {#GUID-A493DC0E-8F08-433D-B3C8-19AC163DB57E} 

![Description of star_transformation_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/star_transformation_hint.gif)[ Description of the illustration star_transformation_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/star_transformation_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database Data Warehousing Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=DWHSG019) for a full discussion of star transformation. 

  * [ *Oracle Database Reference*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=REFRN10213) for more information on the ` STAR_TRANSFORMATION_ENABLED ` initialization parameter. 




####  STATEMENT_QUEUING Hint {#GUID-E7FEA4C2-4344-4E6E-871C-4E17AF0EB8F3} 

![Description of statement_queuing_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/statement_queuing_hint.gif)[ Description of the illustration statement_queuing_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/statement_queuing_hint.md)
...
####  UNNEST Hint {#GUID-9F03EB3B-382E-4B11-97E9-D7FC14CF92E7} 

![Description of unnest_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/unnest_hint.gif)[ Description of the illustration unnest_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/unnest_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
> **note:** See Also: 
  ...
  * [ *Oracle Database SQL Tuning Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=TGSQL211) for additional information on subquery unnesting 




####  USE_BAND Hint {#GUID-EE3246B9-3060-4F84-8C49-4524844E6B9C} 

![Description of use_band_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_band_hint.gif)[ Description of the illustration use_band_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_band_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  USE_CONCAT Hint {#GUID-5A12BDC8-4CD1-448F-80BF-9F02653A3F94} 

![Description of use_concat_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_concat_hint.gif)[ Description of the illustration use_concat_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_concat_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) ) 
...
The [ NO_EXPAND Hint ](Comments.md#GUID-D4C251F0-B3A3-4D7E-843E-3491608D48DB) , which is the opposite of this hint 

####  USE_CUBE Hint {#GUID-D0514F31-CA97-402C-8BA4-931F8BFC62CB} 

![Description of use_cube_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_cube_hint.gif)[ Description of the illustration use_cube_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_cube_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  USE_HASH Hint {#GUID-FA1147B3-BCAA-41F9-B6A2-8DEDABF1C021} 

![Description of use_hash_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_hash_hint.gif)[ Description of the illustration use_hash_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_hash_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  USE_MERGE Hint {#GUID-BBBD2148-71AC-4CD7-80FA-F2ED3072A9A9} 

![Description of use_merge_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_merge_hint.gif)[ Description of the illustration use_merge_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_merge_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  USE_NL Hint {#GUID-56DAA0EC-54BB-4E9D-9049-BCEA934F7A89} 
...
![Description of use_nl_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_nl_hint.gif)[ Description of the illustration use_nl_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_nl_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* ) 
...
####  USE_NL_WITH_INDEX Hint {#GUID-F630F1F6-E5FC-448E-91DC-9A4D953C1114} 

![Description of use_nl_with_index_hint.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/use_nl_with_index_hint.gif)[ Description of the illustration use_nl_with_index_hint.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/use_nl_with_index_hint.md)(See [ Specifying a Query Block in a Hint ](Comments.md#GUID-D316D545-89E2-4D54-977F-FC97815CD62E__BABEBCAA) , *tablespec::=* , *indexspec::=* ) 
