[Previous](NLS_CHARSET_ID.html) [Next](NLS_COLLATION_ID.html) JavaScript must be enabled to correctly display this content 
...
![Description of nls_charset_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_charset_name.gif)[Description of the illustration nls_charset_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_charset_name.html)
