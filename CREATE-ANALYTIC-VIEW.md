...
![Description of create_analytic_view.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_analytic_view.gif)[Description of the illustration create_analytic_view.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_analytic_view.html)

classification_clause::= 

![Description of classification_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/classification_clause.gif)[Description of the illustration classification_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/classification_clause.html)

using_clause::= 

![Description of using_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_clause.gif)[Description of the illustration using_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_clause.html)
...
![Description of source_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/source_clause.gif)[Description of the illustration source_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/source_clause.html)
...
![Description of dim_by_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_by_clause.gif)[Description of the illustration dim_by_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_by_clause.html)

dim_key::= 

![Description of dim_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_key.gif)[Description of the illustration dim_key.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_key.html)

dim_ref::= 

![Description of dim_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_ref.gif)[Description of the illustration dim_ref.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_ref.html)

hier_ref::= 

![Description of hier_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_ref.gif)[Description of the illustration hier_ref.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_ref.html)

measures_clause::= 

![Description of measures_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/measures_clause.gif)[Description of the illustration measures_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/measures_clause.html)

av_measure::= 

![Description of av_measure.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/av_measure.gif)[Description of the illustration av_measure.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/av_measure.html)
...
![Description of meas_aggregate_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/meas_aggregate_clause.gif)[Description of the illustration meas_aggregate_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/meas_aggregate_clause.html)

default_measure_clause::= 

![Description of default_measure_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/default_measure_clause.gif)[Description of the illustration default_measure_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/default_measure_clause.html)

default_aggregate_clause::= 

![Description of default_aggregate_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/default_aggregate_clause.gif)[Description of the illustration default_aggregate_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/default_aggregate_clause.html)

cache_clause::= 

![Description of cache_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_clause.gif)[Description of the illustration cache_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_clause.html)

cache_specification::= 

![Description of cache_specification.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_specification.gif)[Description of the illustration cache_specification.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_specification.html)

levels_clause::= 

![Description of levels_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/levels_clause.gif)[Description of the illustration levels_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/levels_clause.html)

level_specification::= 

![Description of level_specification.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_specification.gif)[Description of the illustration level_specification.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_specification.html)
...
![Description of level_group_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_group_type.gif)[Description of the illustration level_group_type.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_group_type.html)
...
![Description of fact_columns_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fact_columns_clause.gif)[Description of the illustration fact_columns_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fact_columns_clause.html)
...
![Description of qry_transform_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qry_transform_clause.gif)[Description of the illustration qry_transform_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qry_transform_clause.html)
