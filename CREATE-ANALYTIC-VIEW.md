##  CREATE ANALYTIC VIEW {#GUID-EBA7E9BC-3F49-4AA7-9EF6-9255FE7AE466} 
...
![Description of create_analytic_view.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_analytic_view.gif)[ Description of the illustration create_analytic_view.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_analytic_view.md)
...
![Description of using_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_clause.gif)[ Description of the illustration using_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_clause.md)
...
![Description of source_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/source_clause.gif)[ Description of the illustration source_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/source_clause.md)
...
![Description of dim_by_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_by_clause.gif)[ Description of the illustration dim_by_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_by_clause.md)

*dim_key* ::= 

![Description of dim_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_key.gif)[ Description of the illustration dim_key.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_key.md)

*dim_ref* ::= 

![Description of dim_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_ref.gif)[ Description of the illustration dim_ref.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_ref.md)

*hier_ref* ::= 

![Description of hier_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_ref.gif)[ Description of the illustration hier_ref.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_ref.md)

*measures_clause* ::= 

![Description of measures_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/measures_clause.gif)[ Description of the illustration measures_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/measures_clause.md)

*av_measure* ::= 

![Description of av_measure.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/av_measure.gif)[ Description of the illustration av_measure.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/av_measure.md)
...
![Description of cache_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_clause.gif)[ Description of the illustration cache_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_clause.md)

*cache_specification* ::= 

![Description of cache_specification.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_specification.gif)[ Description of the illustration cache_specification.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_specification.md)

*levels_clause* ::= 

![Description of levels_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/levels_clause.gif)[ Description of the illustration levels_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/levels_clause.md)

*level_specification* ::= 

![Description of level_specification.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_specification.gif)[ Description of the illustration level_specification.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_specification.md)
...
![Description of level_group_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_group_type.gif)[ Description of the illustration level_group_type.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_group_type.md)
...
![Description of fact_columns_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fact_columns_clause.gif)[ Description of the illustration fact_columns_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fact_columns_clause.md)
...
![Description of qry_transform_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qry_transform_clause.gif)[ Description of the illustration qry_transform_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qry_transform_clause.md)
...
For the syntax and descriptions of analytic view expressions, see [ Analytic View Expressions ](analytic-view-measure-expressions.md#GUID-F8C7ED67-A4EC-479C-975F-12F1F4B8CBA0) . 
