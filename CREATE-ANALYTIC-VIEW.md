[Previous](COMMIT.html) [Next](CREATE-ATTRIBUTE-DIMENSION.html) JavaScript must be enabled to correctly display this content 
...
![Description of create_analytic_view.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_analytic_view.gif)[Descriptionof the illustration create_analytic_view.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_analytic_view.md)

classification_clause::= 

![Description of classification_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/classification_clause.gif)[Descriptionof the illustration classification_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/classification_clause.md)

using_clause::= 

![Description of using_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/using_clause.gif)[Descriptionof the illustration using_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/using_clause.md)
...
![Description of source_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/source_clause.gif)[Descriptionof the illustration source_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/source_clause.md)
...
![Description of dim_by_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_by_clause.gif)[Descriptionof the illustration dim_by_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_by_clause.md)

dim_key::= 

![Description of dim_key.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_key.gif)[Descriptionof the illustration dim_key.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_key.md)

dim_ref::= 

![Description of dim_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dim_ref.gif)[Descriptionof the illustration dim_ref.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dim_ref.md)

hier_ref::= 

![Description of hier_ref.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/hier_ref.gif)[Descriptionof the illustration hier_ref.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/hier_ref.md)

measures_clause::= 

![Description of measures_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/measures_clause.gif)[Descriptionof the illustration measures_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/measures_clause.md)

av_measure::= 

![Description of av_measure.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/av_measure.gif)[Descriptionof the illustration av_measure.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/av_measure.md)
...
![Description of meas_aggregate_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/meas_aggregate_clause.gif)[Descriptionof the illustration meas_aggregate_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/meas_aggregate_clause.md)

default_measure_clause::= 

![Description of default_measure_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/default_measure_clause.gif)[Descriptionof the illustration default_measure_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/default_measure_clause.md)

default_aggregate_clause::= 

![Description of default_aggregate_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/default_aggregate_clause.gif)[Descriptionof the illustration default_aggregate_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/default_aggregate_clause.md)

cache_clause::= 

![Description of cache_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_clause.gif)[Descriptionof the illustration cache_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_clause.md)

cache_specification::= 

![Description of cache_specification.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/cache_specification.gif)[Descriptionof the illustration cache_specification.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/cache_specification.md)

levels_clause::= 

![Description of levels_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/levels_clause.gif)[Descriptionof the illustration levels_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/levels_clause.md)

level_specification::= 

![Description of level_specification.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_specification.gif)[Descriptionof the illustration level_specification.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_specification.md)
...
![Description of level_group_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/level_group_type.gif)[Descriptionof the illustration level_group_type.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/level_group_type.md)
...
![Description of fact_columns_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/fact_columns_clause.gif)[Descriptionof the illustration fact_columns_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/fact_columns_clause.md)
...
![Description of qry_transform_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/qry_transform_clause.gif)[Descriptionof the illustration qry_transform_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/qry_transform_clause.md)
