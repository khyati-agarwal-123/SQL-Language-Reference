##  TO_UTC_TIMESTAMP_TZ {#GUID-1728EE3E-EC0C-4FA8-B404-99C0A445CE82} 

Syntax 

![Description of to_utc_timestamp_tz.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_utc_timestamp_tz.gif)[ Description of the illustration to_utc_timestamp_tz.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_utc_timestamp_tz.md)
...
Unsupported dates and times include the following: 
  ...
  * ` 2018-10-26T  25  :32:52+02:00 ` (the hours part, 25, is out of range) 
...
> **note:** See Also: 
  ...
  * [ ISO 8601 standard ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=iso-8601)
