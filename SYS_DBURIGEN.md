[Previous](SYS_CONTEXT.html) [Next](SYS_EXTRACT_UTC.html) JavaScript must be enabled to correctly display this content 
...
![Description of sys_dburigen.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_dburigen.gif)[Description of the illustration sys_dburigen.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_dburigen.html)
