...
![Description of sys_dburigen.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_dburigen.gif)[Descriptionof the illustration sys_dburigen.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_dburigen.md)
