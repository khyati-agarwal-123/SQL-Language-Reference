...
![Description of to_nchar_boolean.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_nchar_boolean.gif)[Descriptionof the illustration to_nchar_boolean.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_nchar_boolean.md)
