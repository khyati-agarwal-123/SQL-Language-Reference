[Previous](CREATE-TABLESPACE.html) [Next](CREATE-TRIGGER.html) JavaScript must be enabled to correctly display this content 
...
[ALTER TABLESPACE SET](ALTER-TABLESPACE-SET.html#GUID-63FEDE73-C1F1-4B7A-98ED-8C34C4073549) and [DROP TABLESPACE SET](DROP-TABLESPACE-SET.html#GUID-B14EC4C4-87C2-4E79-AB1A-044B620DF1FE)
...
[file_specification](file_specification.html#GUID-580FA726-F712-4410-90CF-783A2DA89688) and [permanent_tablespace_attrs](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9__PERMANENT_TABLESPACE_ATTRS-2B5BC183) in the documentation on `CREATE` `TABLESPACE` for the full semantics of these clauses 
