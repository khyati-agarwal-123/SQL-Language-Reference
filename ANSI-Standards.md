[Previous](Oracle-and-Standard-SQL.html) [Next](ISO-Standards.html) JavaScript must be enabled to correctly display this content 
...
You can obtain a copy of ANSI standards from this address: 
  ...
  * Fax: +1.212.398.0023
  * Web site: [`http://www.ansi.org/`](http://www.ansi.org/)A subset of ANSI standards, including the SQL standard, are INCITS standards. You can obtain these from the InterNational Committee for Information Technology Standards (INCITS) at:
