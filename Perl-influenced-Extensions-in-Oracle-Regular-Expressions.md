##  Perl-influenced Extensions in Oracle Regular Expressions {#GUID-2D2B8DEB-1343-4DA3-BBC1-5A5C79A5FC20} 

Oracle Database regular expression functions and conditions accept a number of Perl-influenced operators that are in common use, although not part of the POSIX standard. [ Table D-3 ](Perl-influenced-Extensions-in-Oracle-Regular-Expressions.md#GUID-2D2B8DEB-1343-4DA3-BBC1-5A5C79A5FC20__CEGCDCCF) lists those operators. For more complete descriptions with examples, refer to [ *Oracle Database Development Guide* ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS1012) . 
