[Previous](Regular-Expression-Operator-Multilingual-Enhancements.html) [Next](Oracle-SQL-Reserved-Words-and-Keywords.html) JavaScript must be enabled to correctly display this content 
...
Oracle Database regular expression functions and conditions accept a number of Perl-influenced operators that are in common use, although not part of the POSIX standard. [Table D-3](Perl-influenced-Extensions-in-Oracle-Regular-Expressions.html#GUID-2D2B8DEB-1343-4DA3-BBC1-5A5C79A5FC20__CEGCDCCF "First column lists Perl-influenced operators accepted by Oracle regular expression functions and conditions; second column provides descriptions.") lists those operators. For more complete descriptions with examples, refer to [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS1012). 
