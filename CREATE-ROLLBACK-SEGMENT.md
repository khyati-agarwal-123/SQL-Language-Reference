[Previous](CREATE-ROLE.html) [Next](CREATE-SCHEMA.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [ALTER ROLLBACK SEGMENT](ALTER-ROLLBACK-SEGMENT.html#GUID-B25701E3-A074-44C4-9018-C6691BEB2483) for information on altering a rollback segment 

  * [DROP ROLLBACK SEGMENT](DROP-ROLLBACK-SEGMENT.html#GUID-26B4C9D6-EFB4-4523-B84D-FAD42060D3D4) for information on removing a rollback segment 
...
![Description of create_rollback_segment.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_rollback_segment.gif)[Descriptionof the illustration create_rollback_segment.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_rollback_segment.md)([storage_clause](storage_clause.md#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15)) 
...
Specify the name of the rollback segment to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
[storage_clause](storage_clause.html#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15)
