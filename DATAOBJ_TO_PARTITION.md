...
![Description of dataobj_to_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dataobj_to_partition.gif)[Descriptionof the illustration dataobj_to_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dataobj_to_partition.md)
