[Previous](DATAOBJ_TO_MAT_PARTITION.html) [Next](DBTIMEZONE.html) JavaScript must be enabled to correctly display this content 
...
![Description of dataobj_to_partition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dataobj_to_partition.gif)[Description of the illustration dataobj_to_partition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dataobj_to_partition.html)
...
If the base table is interval partitioned, then Oracle recommends that you instead use the `DATAOBJ_TO_MAT_PARTITION` function. Refer to [DATAOBJ_TO_MAT_PARTITION](DATAOBJ_TO_MAT_PARTITION.html#GUID-195AC748-0C9E-4A68-B2BC-2411DE435375) for more information. 
