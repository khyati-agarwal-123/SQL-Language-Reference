...
![Description of replace.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/replace.gif)[Description of the illustration replace.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/replace.html)
