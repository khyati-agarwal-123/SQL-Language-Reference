##  REPLACE {#GUID-1A79BDDF-2D3B-4AD4-98E7-985B2E59DA6B} 

Syntax 

![Description of replace.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/replace.gif)[ Description of the illustration replace.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/replace.md)
