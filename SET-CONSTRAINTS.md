[Previous](SELECT.html) [Next](SET-ROLE.html) JavaScript must be enabled to correctly display this content 
...
![Description of set_constraints.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/set_constraints.gif)[Descriptionof the illustration set_constraints.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/set_constraints.md)
