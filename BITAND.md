[Previous](BIN_TO_NUM.html) [Next](BIT_AND_AGG.html) JavaScript must be enabled to correctly display this content 
...
![Description of bitand.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitand.gif)[Description of the illustration bitand.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitand.html)
...
Refer to the example for [BIN_TO_NUM](BIN_TO_NUM.html#GUID-BF061402-D7F0-4557-B7D4-1CEE6E80F3B2) for information on encoding multiple values in a single column value. 
