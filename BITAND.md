##  BITAND {#GUID-EADBED75-6AC5-4FBE-991A-E3B4D260F73B} 

Syntax 

![Description of bitand.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/bitand.gif)[ Description of the illustration bitand.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/bitand.md)
...
Refer to the example for [ BIN_TO_NUM ](BIN_TO_NUM.md#GUID-BF061402-D7F0-4557-B7D4-1CEE6E80F3B2) for information on encoding multiple values in a single column value. 
