...
![Description of boolean_or_agg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/boolean_or_agg.gif)[Descriptionof the illustration boolean_or_agg.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/boolean_or_agg.md)
