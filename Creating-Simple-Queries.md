[Previous](About-Queries-and-Subqueries.html) [Next](Hierarchical-Queries.html) JavaScript must be enabled to correctly display this content 
...
You can use comments in a `SELECT` statement to pass instructions, or hints, to the Oracle Database optimizer. The optimizer uses hints to choose an execution plan for the statement. Refer to "[Hints](Comments.html#GUID-D316D545-89E2-4D54-977F-FC97815CD62E)" for more information on hints. 
