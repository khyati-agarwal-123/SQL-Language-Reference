[Previous](CREATE-ROLLBACK-SEGMENT.html) [Next](SQL-Statements-CREATE-SEQUENCE-to-DROP-CLUSTER.html) JavaScript must be enabled to correctly display this content 
...
![Description of create_schema.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_schema.gif)[Descriptionof the illustration create_schema.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_schema.md)
...
[GRANT](GRANT.html#GUID-20B4E2C0-A7F8-4BC8-A5E8-BE61BDC41AC3)
...
The [parallel_clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2159323) in the `CREATE` `TABLE` documentation 
