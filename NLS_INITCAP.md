##  NLS_INITCAP {#GUID-42C1581B-B5AA-4D4C-A489-BC5B38A754FD} 

Syntax 

![Description of nls_initcap.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_initcap.gif)[ Description of the illustration nls_initcap.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_initcap.md)
