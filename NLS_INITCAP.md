...
![Description of nls_initcap.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/nls_initcap.gif)[Descriptionof the illustration nls_initcap.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/nls_initcap.md)
