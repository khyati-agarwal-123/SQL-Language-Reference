[Previous](APPROX_RANK.html) [Next](ASCII.html) JavaScript must be enabled to correctly display this content 
...
![Description of approx_sum.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_sum.gif)[Description of the illustration approx_sum.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_sum.html)
