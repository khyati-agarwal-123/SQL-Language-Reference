##  APPROX_SUM {#GUID-AC2A72A7-24E5-4FB8-B012-BD35CB560D6B} 

Syntax 

![Description of approx_sum.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/approx_sum.gif)[ Description of the illustration approx_sum.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/approx_sum.md)
