...
![Description of ora_hash.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_hash.gif)[Descriptionof the illustration ora_hash.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_hash.md)
