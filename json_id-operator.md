[Previous](value-expressions-graph_table.html) [Next](Expressions.html) JavaScript must be enabled to correctly display this content 
...
![Description of json_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_id.gif)[Description of the illustration json_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_id.html)
