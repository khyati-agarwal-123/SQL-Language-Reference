##  LISTAGG {#GUID-B6E50D8E-F467-425B-9436-F7F8BF38D466} 

Syntax 

![Description of listagg.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/listagg.gif)[ Description of the illustration listagg.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/listagg.md)( *listagg_overflow_clause::=* , *order_by_clause::=* , *query_partition_clause::=* ) 
