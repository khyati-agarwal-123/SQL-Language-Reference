...
![Description of drop_materialized_zonemap.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_materialized_zonemap.gif)[Description of the illustration drop_materialized_zonemap.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_materialized_zonemap.html)
