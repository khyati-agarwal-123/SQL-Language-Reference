[Previous](Basic-Elements-of-Oracle-SQL.html) [Next](Data-Type-Comparison-Rules.html) JavaScript must be enabled to correctly display this content 
...
Oracle Database provides a number of built-in data types as well as several categories for user-defined types that can be used as data types. The syntax of Oracle data types appears in the diagrams that follow. The text of this section is divided into the following sections:
  ...
  * [Oracle Built-in Data Types](Data-Types.html#GUID-7B72E154-677A-4342-A1EA-C74C1EA928E6)* [Rowid Data Types](Data-Types.html#GUID-4231B94A-97E9-4B59-91EB-E7B2D0DA438C)

  * [ANSI, DB2, and SQL/DS Data Types](Data-Types.html#GUID-0BC16006-32F1-42B1-B45E-F27A494963FF)* [User-Defined Types](Data-Types.html#GUID-7CF27C66-9908-4C02-9401-06C2F2C4021C)

  * [Oracle-Supplied Types](Data-Types.html#GUID-B3300D21-4598-4AE5-AA95-451E9F1040ED)* [Any Types](Data-Types.html#GUID-5A8C5AC6-BC32-4D78-B0DE-037162106C72)

  * [XML Types](Data-Types.html#GUID-BF935A5E-3E6C-42C0-AA18-05D3A268D7D8)* [Spatial Types](Data-Types.html#GUID-B4DF3B59-1600-4FA2-B7ED-AF7B734256BF)
...
![Description of datatype.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/datatype.gif)[Descriptionof the illustration datatype.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/datatype.md)The Oracle built-in data types appear in the figures that follows. For descriptions, refer to [Oracle Built-in Data Types](Data-Types.html#GUID-7B72E154-677A-4342-A1EA-C74C1EA928E6). 

Oracle_built_in_datatypes::= 

![Description of oracle_built_in_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/oracle_built_in_datatypes.gif)[Descriptionof the illustration oracle_built_in_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/oracle_built_in_datatypes.md)

character_datatypes::= 

![Description of character_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/character_datatypes.gif)[Descriptionof the illustration character_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/character_datatypes.md)

number_datatypes::= 

![Description of number_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/number_datatypes.gif)[Descriptionof the illustration number_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/number_datatypes.md)

long_and_raw_datatypes::= 

![Description of long_and_raw_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/long_and_raw_datatypes.gif)[Descriptionof the illustration long_and_raw_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/long_and_raw_datatypes.md)

datetime_datatypes::= 

![Description of datetime_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/datetime_datatypes.gif)[Descriptionof the illustration datetime_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/datetime_datatypes.md)

large_object_datatypes::= 

![Description of large_object_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/large_object_datatypes.gif)[Descriptionof the illustration large_object_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/large_object_datatypes.md)

rowid_datatypes::= 

![Description of rowid_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/rowid_datatypes.gif)[Descriptionof the illustration rowid_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/rowid_datatypes.md)The ANSI-supported data types appear in the figure that follows. [ANSI, DB2, and SQL/DS Data Types](Data-Types.html#GUID-0BC16006-32F1-42B1-B45E-F27A494963FF) discusses the mapping of ANSI-supported data types to Oracle built-in data types. 

ANSI_supported_datatypes::= 

![Description of ansi_supported_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ansi_supported_datatypes.gif)[Descriptionof the illustration ansi_supported_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ansi_supported_datatypes.md)For descriptions of user-defined types, refer to [User-Defined Types](Data-Types.html#GUID-7CF27C66-9908-4C02-9401-06C2F2C4021C). 

The Oracle-supplied data types appear in the figures that follows. For descriptions, refer to [Oracle-Supplied Types](Data-Types.html#GUID-B3300D21-4598-4AE5-AA95-451E9F1040ED). 

Oracle_supplied_types::= 

![Description of oracle_supplied_types.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/oracle_supplied_types.gif)[Descriptionof the illustration oracle_supplied_types.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/oracle_supplied_types.md)

any_types::= 

![Description of any_types.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/any_types.gif)[Descriptionof the illustration any_types.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/any_types.md)For descriptions of the `Any` types, refer to [Any Types](Data-Types.html#GUID-5A8C5AC6-BC32-4D78-B0DE-037162106C72). 

XML_types::= 

![Description of xml_types.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xml_types.gif)[Descriptionof the illustration xml_types.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xml_types.md)For descriptions of the XML types, refer to [XML Types](Data-Types.html#GUID-BF935A5E-3E6C-42C0-AA18-05D3A268D7D8). 

spatial_types::= 

![Description of spatial_types.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/spatial_types.gif)[Descriptionof the illustration spatial_types.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/spatial_types.md)For descriptions of the spatial types, refer to [Spatial Types](Data-Types.html#GUID-B4DF3B59-1600-4FA2-B7ED-AF7B734256BF). 
...
The sections that follow describe the Oracle data types as they are stored in Oracle Database. For information on specifying these data types as literals, refer to [Literals](Literals.html#GUID-192417E8-A79D-4A1D-9879-68272D925707). 
...
These data types are used for character data:
  ...
  * [CHAR Data Type](Data-Types.html#GUID-85E0A0DD-9E90-4AE1-9AD5-93C89FDCFC49)* [NCHAR Data Type](Data-Types.html#GUID-FE15E51B-52C6-45D7-9883-4DF47716A17D)

  * [VARCHAR2 Data Type](Data-Types.html#GUID-0DC7FFAA-F03F-4448-8487-F2592496A510)* [NVARCHAR2 Data Type](Data-Types.html#GUID-CC15FC97-BE94-4FA4-994A-6DDF7F1A9904)




For information on specifying character data types as literals, refer to [Text Literals](Literals.html#GUID-1824CBAA-6E16-4921-B2A6-112FB02248DA). 
...
[Oracle Database Globalization Support Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NLSPG002) for more information on character set support and [Data Type Comparison Rules](Data-Type-Comparison-Rules.html#GUID-1563C817-86BF-430B-99AB-322EE2E29187) for information on comparison semantics 
...
Refer to [Extended Data Types](Data-Types.html#GUID-8EFA29E9-E8D8-40A6-A43E-954908C954A4) for more information on the `MAX_STRING_SIZE` initialization parameter and the internal storage mechanisms for extended data types. 
...
[Data Type Comparison Rules](Data-Type-Comparison-Rules.html#GUID-1563C817-86BF-430B-99AB-322EE2E29187) for information on comparison semantics 
...
The Oracle Database numeric data types store positive and negative fixed and floating-point numbers, zero, infinity, and values that are the undefined result of an operationâ"not a number" or `NAN`. For information on specifying numeric data types as literals, refer to [Numeric Literals](Literals.html#GUID-F521FBA0-FFED-4079-ABC4-9052218B3FD5). 
...
[Floating-Point Numbers](Data-Types.html#GUID-F579F4B8-EF13-4CAF-9B06-03B076861C41)[Table 2-2](Data-Types.html#GUID-75209AF6-476D-4C44-A5DC-5FA70D701B78__G196646 "The first column repeats the number 7456123.89 in each row. The second column lists the various ways of specifying the NUMBER datatype. The third column shows how the number is stored depending on how the NUMBER datatype is specified.") show how Oracle stores data using different precisions and scales. 
...
Oracle Database uses the Oracle `FLOAT` data type internally when converting ANSI `FLOAT` data. Oracle `FLOAT` is available for you to use, but Oracle recommends that you use the `BINARY_FLOAT` and `BINARY_DOUBLE` data types instead, as they are more robust. Refer to [Floating-Point Numbers](Data-Types.html#GUID-F579F4B8-EF13-4CAF-9B06-03B076861C41) for more information. 
...
The Oracle implementation of floating-point data types conforms substantially with the Institute of Electrical and Electronics Engineers (IEEE) Standard for Binary Floating-Point Arithmetic, IEEE Standard 754-1985 (IEEE754). The floating-point data types conform to IEEE754 in the following areas:
  ...
  * The SQL function `SQRT` implements square root. See [SQRT](SQRT.html#GUID-E28C0B65-AAD8-4077-A82E-2FB4CD261CCA). 

  * The SQL function `REMAINDER` implements remainder. See [REMAINDER](REMAINDER.html#GUID-430D4C4A-5779-4EBB-90C5-4D7CA7E73556). 

  * Arithmetic operators conform. See [Arithmetic Operators](Arithmetic-Operators.html#GUID-46CD9FD8-FC94-44BA-AA62-30A16063EAAE). 

  * Comparison operators conform, except for comparisons with `NaN`. Oracle orders `NaN` greatest with respect to all other values, and evaluates `NaN` equal to `NaN`. See [Floating-Point Conditions](Floating-Point-Conditions.html#GUID-D7707649-2C93-4553-BF78-F461F17A634E). 

  * Conversion operators conform. See [Conversion Functions](Single-Row-Functions.html#GUID-0E5115DD-F906-4F04-BB70-DF62DD4BBF91). 

  * The default rounding mode is supported.

  * The default exception handling mode is supported.

  * The special values `INF`, -`INF`, and `NaN` are supported. See [Floating-Point Conditions](Floating-Point-Conditions.html#GUID-D7707649-2C93-4553-BF78-F461F17A634E). 
...
If any implicit conversion is needed and fails, then the operation fails. Refer to [Table 2-9](Data-Type-Comparison-Rules.html#GUID-98BE3A78-6E33-4181-B5CB-D96FD9DC1694__G195937 "An X in a cell indicates implicit conversion of the data types") for more information on implicit conversion. 
...
You can specify a `DATE` value as a literal, or you can convert a character or numeric value to a date value with the `TO_DATE` function. For examples of expressing `DATE` values in both these ways, refer to [Datetime Literals](Literals.html#GUID-8F4B3F82-8821-4071-84D6-FBBA21C05AC1). 
...
[Selecting from the DUAL Table](Selecting-from-the-DUAL-Table.html#GUID-0AB153FC-5238-4E79-8522-C9E2A04AB5E4) for a description of the `DUAL` table 
...
[TO_TIMESTAMP](TO_TIMESTAMP.html#GUID-57E09334-E3CC-4CA2-809E-F0909458BCFA) for information on converting character data to `TIMESTAMP` data 

##### TIMESTAMP WITH TIME ZONE Data Type 

`TIMESTAMP` `WITH` `TIME` `ZONE` is a variant of `TIMESTAMP` that includes a time zone region name or a time zone offset in its value. The time zone offset is the difference (in hours and minutes) between local time and UTC (Coordinated Universal Timeâformerly Greenwich Mean Time). This data type is useful for preserving local time zone information. 
...
See Also:
  ...
  * [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS00304) for examples of using this data type and [CAST](CAST.html#GUID-5A70235E-1209-4281-8521-B94497AAEF75) for information on converting character data to `TIMESTAMP` `WITH` `LOCAL` `TIME` `ZONE`
...
[Table 2-5](Data-Types.html#GUID-E405BBC7-DA9A-4DF2-9F22-E60CB9EC0705__G196492 "This table is a matrix that shows the result of combining each two datetime values \(DATE, TIMESTAMP, INTERVAL, or other numeric value\) using addition, subtraction, multiplication, and division.") is a matrix of datetime arithmetic operations. Dashes represent operations that are not supported. 
...
See Also:
  ...
  * [Datetime Format Models](Format-Models.html#GUID-49B32A81-0904-433E-B7FE-51606672183A) for information on the format elements and the session parameter [ERROR_ON_OVERLAP_TIME](ALTER-SESSION.html#GUID-DC7B8CDD-4F89-40CC-875F-F70F673711D4__I2252050). 
...
Oracle strongly recommends that you convert `LONG` `RAW` columns to binary LOB (`BLOB`) columns. LOB columns are subject to far fewer restrictions than `LONG` columns. See [TO_LOB](TO_LOB.html#GUID-35810313-029E-4CB8-8C27-DF432FA3C253) for more information. 
...
You can change the filename and path of a `BFILE` without affecting the base table by using the `BFILENAME` function. Refer to [BFILENAME](BFILENAME.html#GUID-1F767077-7C26-4962-9833-1433F1749621) for more information on this built-in SQL function. 
...
![Description of json_type_column.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_type_column.gif)[Descriptionof the illustration json_type_column.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_type_column.md)For the syntax of `JSON_column_modifier` see [JSON_column_modifier::=](SQL-JSON-Conditions.html#GUID-99B9493D-2929-4A09-BA39-A56F8E7319DA__SECTION_AFR_B3S_KBC) in `IS_JSON` condition. 
...
See Also:
  ...
  * [JSON Data Type](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-CBEDC779-39A3-43C9-AF38-861AE3FC0AEC) of the JSON Developer's Guide.
  ...
  * For the syntax of JSON modifiers see [IS JSON Condition](SQL-JSON-Conditions.html#GUID-99B9493D-2929-4A09-BA39-A56F8E7319DA)
...
You can use extended data types just as you would standard data types, with the following considerations:
  ...
  * For special considerations when creating an index on an extended data type column, or when requiring an index to enforce a primary key or unique constraint, see [Creating an Index on an Extended Data Type Column](CREATE-INDEX.html#GUID-1F89BBC0-825F-4215-AF71-7588E31D8BFE__BGECBJDG). 

  * If the partitioning key column for a list partition is an extended data type column, then the list of values that you want to specify for a partition may exceed the 4K byte limit for the partition bounds. See the [list_partitions](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABDGHIB) clause of `CREATE` `TABLE` for information on how to work around this issue. 

  * The value of the initialization parameter `MAX_STRING_SIZE` affects the following: 

    * The maximum length of a text literal. See [Text Literals](Literals.html#GUID-1824CBAA-6E16-4921-B2A6-112FB02248DA) for more information. 

    * The size limit for concatenating two character strings. See [Concatenation Operator](Concatenation-Operator.html#GUID-08C10738-706B-4290-B7CD-C279EBC90F7E) for more information. 

    * The length of the collation key returned by the `NLSSORT` function. See [NLSSORT](NLSSORT.html#GUID-781C6FE8-0924-4617-AECB-EE40DE45096D). 

    * The size of some of the attributes of the `XMLFormat` object. See [XML Format Model](Format-Models.html#GUID-C6EB69EF-74DB-4C10-A02E-210D31616552) for more information. 

    * The size of some expressions in the following XML functions: [XMLCOLATTVAL](XMLCOLATTVAL.html#GUID-AE3B6441-74D8-4033-900B-A578A79E5F0A), [XMLELEMENT](XMLELEMENT.html#GUID-DEA75423-00EA-4034-A246-4A774ADC988E), [XMLFOREST](XMLFOREST.html#GUID-68E5C67E-CE97-4BF8-B7FF-2365E062C363), [XMLPI](XMLPI.html#GUID-142604E3-7999-4803-9DF5-28BDC0701571), and [XMLTABLE](XMLTABLE.html#GUID-C4A32C58-33E5-4CF1-A1FE-039550D3ECFA). 
...
SQL expressions and conditions have been enhanced to support the new boolean data type. Links to relevant SQL syntax:
  ...
  * [BOOLEAN Expressions](boolean-expressions.html#GUID-E492D339-5AAF-43C1-95B8-88DB1CDED0D9)
...
[TO_BOOLEAN](to_boolean.html#GUID-B4FA8F5F-DD2A-4BEA-946A-B3CA60509294)
...
There are a new set of SQL functions that use the `VECTOR` data type. See [Vector Functions](Single-Row-Functions.html#GUID-C0C477F1-8210-4CA9-A5FA-0A340C409892)
...
[Datetime and Interval Data Types](Data-Types.html#GUID-7690645A-0EE3-46CA-90DE-C96DF5A01F8F)
...
Oracle normally stores an array object either in line (as part of the row data) or out of line (in a LOB), depending on its size. However, if you specify separate storage characteristics for a varray, then Oracle stores it out of line, regardless of its size. Refer to the [varray_col_properties](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__I2143624) of [CREATE TABLE](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6) for more information about varray storage. 
...
The Oracle-supplied types, along with cross-references to the documentation of their implementation and use, are described in the following sections:
  ...
  * [Any Types](Data-Types.html#GUID-5A8C5AC6-BC32-4D78-B0DE-037162106C72)* [XML Types](Data-Types.html#GUID-BF935A5E-3E6C-42C0-AA18-05D3A268D7D8)

  * [Spatial Types](Data-Types.html#GUID-B4DF3B59-1600-4FA2-B7ED-AF7B734256BF)
...
[Oracle XML DB Developerâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB0400)for information about using XMLType columns 

#### URI Data Types 

Oracle supplies a family of URI typesâ`URIType`, `DBURIType`, `XDBURIType`, and `HTTPURIType`âwhich are related by an inheritance hierarchy. `URIType` is an object type and the others are subtypes of `URIType`. Since `URIType` is the supertype, you can create columns of this type and store `DBURIType` or `HTTPURIType` type instances in this column. 
...
See Also:
  ...
  * [Oracle XML DB Developerâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB1900) for more information about these supplied types and their implementation 
