...
Oracle Database provides a number of built-in data types as well as several categories for user-defined types that can be used as data types. The syntax of Oracle data types appears in the diagrams that follow. The text of this section is divided into the following sections:
  ...
  * [Oracle Built-in Data Types](Data-Types.html#GUID-7B72E154-677A-4342-A1EA-C74C1EA928E6)

  * [Rowid Data Types](Data-Types.html#GUID-4231B94A-97E9-4B59-91EB-E7B2D0DA438C)

  * [ANSI, DB2, and SQL/DS Data Types](Data-Types.html#GUID-0BC16006-32F1-42B1-B45E-F27A494963FF)

  * [User-Defined Types](Data-Types.html#GUID-7CF27C66-9908-4C02-9401-06C2F2C4021C)

  * [Oracle-Supplied Types](Data-Types.html#GUID-B3300D21-4598-4AE5-AA95-451E9F1040ED)

  * [Any Types](Data-Types.html#GUID-5A8C5AC6-BC32-4D78-B0DE-037162106C72)

  * [XML Types](Data-Types.html#GUID-BF935A5E-3E6C-42C0-AA18-05D3A268D7D8)
...
![Description of datatype.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/datatype.gif)[Description of the illustration datatype.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/datatype.html)The Oracle built-in data types appear in the figures that follows. For descriptions, refer to [Oracle Built-in Data Types](Data-Types.html#GUID-7B72E154-677A-4342-A1EA-C74C1EA928E6). 

Oracle_built_in_datatypes::= 

![Description of oracle_built_in_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/oracle_built_in_datatypes.gif)[Description of the illustration oracle_built_in_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/oracle_built_in_datatypes.html)

character_datatypes::= 

![Description of character_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/character_datatypes.gif)[Description of the illustration character_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/character_datatypes.html)

number_datatypes::= 

![Description of number_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/number_datatypes.gif)[Description of the illustration number_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/number_datatypes.html)

long_and_raw_datatypes::= 

![Description of long_and_raw_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/long_and_raw_datatypes.gif)[Description of the illustration long_and_raw_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/long_and_raw_datatypes.html)

datetime_datatypes::= 

![Description of datetime_datatypes.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/datetime_datatypes.gif)[Description of the illustration datetime_datatypes.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/datetime_datatypes.html)
...
These data types are used for character data:
  ...
  * [CHAR Data Type](Data-Types.html#GUID-85E0A0DD-9E90-4AE1-9AD5-93C89FDCFC49)

  * [NCHAR Data Type](Data-Types.html#GUID-FE15E51B-52C6-45D7-9883-4DF47716A17D)

  * [VARCHAR2 Data Type](Data-Types.html#GUID-0DC7FFAA-F03F-4448-8487-F2592496A510)

  * [NVARCHAR2 Data Type](Data-Types.html#GUID-CC15FC97-BE94-4FA4-994A-6DDF7F1A9904)
...
![Description of json_type_column.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_type_column.gif)[Description of the illustration json_type_column.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_type_column.html)For the syntax of `JSON_column_modifier` see [JSON_column_modifier::=](SQL-JSON-Conditions.html#GUID-99B9493D-2929-4A09-BA39-A56F8E7319DA__SECTION_AFR_B3S_KBC) in `IS_JSON` condition. 
