##  GROUPING_ID {#GUID-E20A5B8E-73B6-42FD-8AFB-DD3CD6D6DC61} 

Syntax 

![Description of grouping_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grouping_id.gif)[ Description of the illustration grouping_id.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grouping_id.md)
