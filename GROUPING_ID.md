[Previous](GROUPING.html) [Next](HEXTORAW.html) JavaScript must be enabled to correctly display this content 
...
![Description of grouping_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/grouping_id.gif)[Description of the illustration grouping_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/grouping_id.html)
