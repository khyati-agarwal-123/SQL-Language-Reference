##  Graphic Syntax Diagrams {#GUID-D22097D5-1E7A-4A17-862A-F0084732B3CE} 
...
###  Required Keywords and Parameters {#GUID-6A602A21-B55A-48E7-8E76-A9A551E55A7E} 
...
###  Optional Keywords and Parameters {#GUID-6FF77DC8-764F-4130-957F-73D7511CCD5C} 
...
###  Syntax Loops {#GUID-3A6451B1-A646-4F18-BE86-0297EC6387DF} 
...
###  Multipart Diagrams {#GUID-98D4D8B3-76C2-4EF5-8EAB-E5A742C9173C} 

Read a multipart diagram as if all the main paths were joined end to end. The following example is a three-part diagram: 

*alter_java* ::= 

![Description of alter_java.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_java.gif)[ Description of the illustration alter_java.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_java.md)
