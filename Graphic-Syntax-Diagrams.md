[Previous](How-to-Read-Syntax-Diagrams.html) [Next](Backus-Naur-Form-Syntax.html) JavaScript must be enabled to correctly display this content 
  ...
  1. [SQL Language Reference ](index.html)2. [ How to Read Syntax Diagrams](How-to-Read-Syntax-Diagrams.html)
...
![Description of drop_library.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_library.gif)[Descriptionof the illustration drop_library.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_library.md)
...
![Description of alter_java.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_java.gif)[Descriptionof the illustration alter_java.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_java.md)
