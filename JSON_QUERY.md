...
![Description of json_query.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query.gif)[Description of the illustration json_query.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query.html)(`JSON_basic_path_expression`: See [Oracle Database JSON Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-8241AE93-89BE-40E6-89E2-8F9C1A9244F4)) 

JSON_query_returning_clause::= 

![Description of json_query_returning_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query_returning_clause.gif)[Description of the illustration json_query_returning_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query_returning_clause.html)

JSON_query_return_type::= 

![Description of json_query_return_type.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query_return_type.gif)[Description of the illustration json_query_return_type.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query_return_type.html)

JSON_query_wrapper_clause::= 

![Description of json_query_wrapper_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query_wrapper_clause.gif)[Description of the illustration json_query_wrapper_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query_wrapper_clause.html)

JSON_query_quotes_clause::= 

![Description of json_query_quotes_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query_quotes_clause.gif)[Description of the illustration json_query_quotes_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query_quotes_clause.html)

JSON_query_on_error_clause::= 

![Description of json_query_on_error_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query_on_error_clause.gif)[Description of the illustration json_query_on_error_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query_on_error_clause.html)

JSON_query_on_empty_clause::= 

![Description of json_query_on_empty_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query_on_empty_clause.gif)[Description of the illustration json_query_on_empty_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query_on_empty_clause.html)
...
![Description of json_query_on_mismatch_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/json_query_on_mismatch_clause.gif)[Description of the illustration json_query_on_mismatch_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/json_query_on_mismatch_clause.html)
...
See Also:
  ...
  * [Query JSON Data](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADJSN-GUID-119E5069-77F2-45DC-B6F0-A1B312945590)
