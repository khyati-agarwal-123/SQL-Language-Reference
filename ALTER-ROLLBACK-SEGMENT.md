[Previous](ALTER-ROLE.html) [Next](ALTER-SEQUENCE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [CREATE ROLLBACK SEGMENT](CREATE-ROLLBACK-SEGMENT.html#GUID-14AE3104-5B33-4E53-8E6F-6B2F037B52E9) for information on creating a rollback segment 
...
![Description of alter_rollback_segment.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/alter_rollback_segment.gif)[Descriptionof the illustration alter_rollback_segment.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/alter_rollback_segment.md)([storage_clause](storage_clause.md#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15), [size_clause::=](size_clause.html#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517__CHDEAIID)) 
...
"[Bringing a Rollback Segment Online: Example](ALTER-ROLLBACK-SEGMENT.html#GUID-B25701E3-A074-44C4-9018-C6691BEB2483__CCHHDICB)"
...
[storage_clause](storage_clause.html#GUID-C5A67610-3160-41E9-8D48-03206BD5ED15) for syntax and additional information 
...
[size_clause](size_clause.html#GUID-E97FADC2-A6E1-4D68-9F79-DCA271B86517) for information on that clause, and "[Resizing a Rollback Segment: Example](ALTER-ROLLBACK-SEGMENT.html#GUID-B25701E3-A074-44C4-9018-C6691BEB2483__CCHDICDB)"

Examples

The following examples use the `rbs_one` rollback segment, which was created in "[Creating a Rollback Segment: Example](CREATE-ROLLBACK-SEGMENT.html#GUID-14AE3104-5B33-4E53-8E6F-6B2F037B52E9__CCHIHJDF)". 
