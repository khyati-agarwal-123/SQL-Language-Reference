...
![Description of xmlpatch.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlpatch.gif)[Descriptionof the illustration xmlpatch.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlpatch.md)
