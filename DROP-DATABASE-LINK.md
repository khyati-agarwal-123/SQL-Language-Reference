...
![Description of drop_database_link.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_database_link.gif)[Descriptionof the illustration drop_database_link.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_database_link.md)
