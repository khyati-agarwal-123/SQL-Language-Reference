[Previous](DROP-DATABASE.html) [Next](DROP-DIMENSION.html) JavaScript must be enabled to correctly display this content 
...
[CREATE DATABASE LINK](CREATE-DATABASE-LINK.html#GUID-D966642A-B19E-449D-9968-1121AF06D793) for information on creating database links 
...
![Description of drop_database_link.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_database_link.gif)[Description of the illustration drop_database_link.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_database_link.html)
...
The following statement drops the public database link named `remote`, which was created in "[Defining a Public Database Link: Example](CREATE-DATABASE-LINK.html#GUID-D966642A-B19E-449D-9968-1121AF06D793__I2133775)": 
