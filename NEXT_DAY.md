[Previous](NEW_TIME.html) [Next](NLS_CHARSET_DECL_LEN.html) JavaScript must be enabled to correctly display this content 
...
![Description of next_day.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/next_day.gif)[Description of the illustration next_day.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/next_day.html)
