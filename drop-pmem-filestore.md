...
![Description of drop_pmem_fs.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_pmem_fs.gif)[Descriptionof the illustration drop_pmem_fs.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_pmem_fs.md)
