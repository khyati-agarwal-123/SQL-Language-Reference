...
![Description of type_constructor_expression.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/type_constructor_expression.gif)[Descriptionof the illustration type_constructor_expression.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/type_constructor_expression.md)
