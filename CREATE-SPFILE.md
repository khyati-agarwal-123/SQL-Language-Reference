...
![Description of create_spfile.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_spfile.gif)[Descriptionof the illustration create_spfile.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_spfile.md)
