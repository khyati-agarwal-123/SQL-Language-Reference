##  CREATE SPFILE {#GUID-D3E295B7-A3A4-43D3-8BBD-5CBE171A2E52} 
...
The method of starting up the database with a server parameter file depends on whether you create a default or nondefault server parameter file. Refer to  " [ Creating a Server Parameter File: Examples ](CREATE-SPFILE.md#GUID-D3E295B7-A3A4-43D3-8BBD-5CBE171A2E52__I2087518) "  for examples of how to use server parameter files. 
...
![Description of create_spfile.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_spfile.gif)[ Description of the illustration create_spfile.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_spfile.md)
...
> **note:** See Also: 
  ...
  * *file_specification* for the syntax of traditional and Oracle ASM filenames and [ ALTER DISKGROUP ](ALTER-DISKGROUP.md#GUID-22D73AB6-7063-4627-A2ED-18D521ED2557) for information on modifying the characteristics of an Oracle ASM file 
