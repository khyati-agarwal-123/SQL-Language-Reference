...
![Description of drop_directory.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_directory.gif)[Descriptionof the illustration drop_directory.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_directory.md)
