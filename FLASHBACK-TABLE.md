##  FLASHBACK TABLE {#GUID-FA9AF2FD-2DAD-4387-9E62-14AFC26EA85C} 
...
![Description of flashback_table.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/flashback_table.gif)[ Description of the illustration flashback_table.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/flashback_table.md)
...
[ CREATE RESTORE POINT ](CREATE-RESTORE-POINT.md#GUID-AD0FB693-7C28-4908-A870-BA884B320575) for information on creating restore points 
