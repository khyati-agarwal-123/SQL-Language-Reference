##  COLLECT {#GUID-A0A74602-2A97-449B-A3EC-847D38D3DA90} 

Syntax 

![Description of collect.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/collect.gif)[ Description of the illustration collect.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/collect.md)
