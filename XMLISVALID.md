##  XMLISVALID {#GUID-012BB50C-30E4-46BA-8199-A8480453F79E} 

Syntax 

![Description of xmlisvalid.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/xmlisvalid.gif)[ Description of the illustration xmlisvalid.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/xmlisvalid.md)
