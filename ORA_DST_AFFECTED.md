...
![Description of ora_dst_affected.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_dst_affected.gif)[Descriptionof the illustration ora_dst_affected.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_dst_affected.md)
