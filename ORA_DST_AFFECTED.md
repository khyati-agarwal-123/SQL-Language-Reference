##  ORA_DST_AFFECTED {#GUID-EE288E4B-DE55-4104-813C-11E28F7B474A} 

Syntax 

![Description of ora_dst_affected.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_dst_affected.gif)[ Description of the illustration ora_dst_affected.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_dst_affected.md)
