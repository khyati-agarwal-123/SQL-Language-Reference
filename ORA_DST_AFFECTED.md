[Previous](ORA_DM_PARTITION_NAME.html) [Next](ORA_DST_CONVERT.html) JavaScript must be enabled to correctly display this content 
...
![Description of ora_dst_affected.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ora_dst_affected.gif)[Description of the illustration ora_dst_affected.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ora_dst_affected.html)
