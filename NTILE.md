##  NTILE {#GUID-FAD7A986-AEBD-4A03-B0D2-F7F2148BA5E9} 

Syntax 

![Description of ntile.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/ntile.gif)[ Description of the illustration ntile.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/ntile.md)
...
" [ About SQL Expressions ](About-SQL-Expressions.md#GUID-68789A5C-B142-496F-ADEE-837F75F95B2B) "  for information on valid forms of *expr* and [ Table 2-9 ](Data-Type-Comparison-Rules.md#GUID-98BE3A78-6E33-4181-B5CB-D96FD9DC1694__G195937) for more information on implicit conversion 
