[Previous](drop-domain.html) [Next](DROP-FLASHBACK-ARCHIVE.html) JavaScript must be enabled to correctly display this content 
...
[CREATE EDITION](CREATE-EDITION.html#GUID-6CF92CA1-CAF7-4967-9B34-C02D72C23617) for a listing of editionable object types 
...
![Description of drop_edition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_edition.gif)[Description of the illustration drop_edition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_edition.html)
...
See Also:
  ...
  * [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS-GUID-E6DBE175-2598-430F-9D0A-AB22CAE7DDDA)

  * [Oracle Database PL/SQL Packages and Types Reference](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ARPLS-GUID-40AD8944-D7E0-4ACA-9A05-3DC502F47D27)
...
For examples that use this statement, refer to [CREATE EDITION](CREATE-EDITION.html#GUID-6CF92CA1-CAF7-4967-9B34-C02D72C23617). 
