##  DROP EDITION {#GUID-726082F7-C931-4975-8F2B-5EA814A51AB0} 
...
[ CREATE EDITION ](CREATE-EDITION.md#GUID-6CF92CA1-CAF7-4967-9B34-C02D72C23617) for a listing of editionable object types 
...
![Description of drop_edition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/drop_edition.gif)[ Description of the illustration drop_edition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/drop_edition.md)
...
For examples that use this statement, refer to [ CREATE EDITION ](CREATE-EDITION.md#GUID-6CF92CA1-CAF7-4967-9B34-C02D72C23617) . 
