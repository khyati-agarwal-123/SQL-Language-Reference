##  TO_NCHAR (number) {#GUID-B0FA1B2F-3285-46C4-96DA-3C7AED48987C} 

Syntax 

*to_nchar_number* ::= 

![Description of to_nchar_number.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/to_nchar_number.gif)[ Description of the illustration to_nchar_number.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/to_nchar_number.md)
