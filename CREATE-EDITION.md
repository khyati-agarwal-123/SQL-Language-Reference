##  CREATE EDITION {#GUID-6CF92CA1-CAF7-4967-9B34-C02D72C23617} 
...
![Description of create_edition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_edition.gif)[ Description of the illustration create_edition.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_edition.md)

Semantics 

*edition* 

Specify the name of the edition to be created. The name must satisfy the requirements listed in  " [ Database Object Naming Rules ](Database-Object-Names-and-Qualifiers.md#GUID-75337742-67FD-4EC0-985F-741C93D918DA) "  . 
