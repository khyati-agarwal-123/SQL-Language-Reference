[Previous](create-domain.html) [Next](CREATE-FLASHBACK-ARCHIVE.html) JavaScript must be enabled to correctly display this content 
...
See Also:
  ...
  * [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS99923) for a more complete discussion of editionable object types and editions 

  * The `ALTER` `DATABASE` "[DEFAULT EDITION Clause](ALTER-DATABASE.html#GUID-8069872F-E680-4511-ADD8-A4E30AF67986__BABEADGC)" for information on designating an edition as the default edition for the database 
...
![Description of create_edition.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/create_edition.gif)[Descriptionof the illustration create_edition.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/create_edition.md)

Semantics

edition

Specify the name of the edition to be created. The name must satisfy the requirements listed in "[Database Object Naming Rules](Database-Object-Names-and-Qualifiers.html#GUID-75337742-67FD-4EC0-985F-741C93D918DA)". 
...
The following very simple examples are intended to show the syntax for creating and working with an edition. For realistic examples of using editions refer to [Oracle Database Development Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADFNS99913). 
