##  MERGE {#GUID-5692CCB7-24D9-4C0E-81A7-A22436DC968F} 
...
![Description of merge.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge.gif)[ Description of the illustration merge.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge.md)
...
![Description of merge_update_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge_update_clause.gif)[ Description of the illustration merge_update_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge_update_clause.md)

*merge_insert_clause* ::= 

![Description of merge_insert_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge_insert_clause.gif)[ Description of the illustration merge_insert_clause.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge_insert_clause.md)
...
Use the ` INTO ` clause to specify the target table or view you are updating or inserting into. In order to merge data into a view, the view must be updatable. Refer to  " [ Notes on Updatable Views ](CREATE-VIEW.md#GUID-61D2D2B4-DACC-4C7C-89EB-7E50D9594D30__CEGCADFA) "  for more information. 
