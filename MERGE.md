...
![Description of merge.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge.gif)[Description of the illustration merge.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge.html)
...
![Description of merge_update_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge_update_clause.gif)[Description of the illustration merge_update_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge_update_clause.html)

merge_insert_clause::= 

![Description of merge_insert_clause.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/merge_insert_clause.gif)[Description of the illustration merge_insert_clause.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/merge_insert_clause.html)
