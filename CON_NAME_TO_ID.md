[Previous](con_id_to_uid.html) [Next](CON_UID_TO_ID.html) JavaScript must be enabled to correctly display this content 
...
![Description of con_name_to_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_name_to_id.gif)[Description of the illustration con_name_to_id.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_name_to_id.html)
