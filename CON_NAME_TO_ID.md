##  CON_NAME_TO_ID {#GUID-714E0914-5018-4E32-AB1E-134FDD0B28FE} 

Syntax 

![Description of con_name_to_id.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/con_name_to_id.gif)[ Description of the illustration con_name_to_id.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/con_name_to_id.md)
