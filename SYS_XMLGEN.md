##  SYS_XMLGEN {#GUID-1AC25984-F4AB-468E-BF53-561275AD44E8} 
...
![Description of sys_xmlgen.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_xmlgen.gif)[ Description of the illustration sys_xmlgen.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_xmlgen.md)
...
" [ XML Format Model ](Format-Models.md#GUID-C6EB69EF-74DB-4C10-A02E-210D31616552) "  for a description of the ` XMLFormat ` type and how to use its attributes to format ` SYS_XMLGen ` results 
