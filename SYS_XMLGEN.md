[Previous](SYS_XMLAGG.html) [Next](SYSDATE.html) JavaScript must be enabled to correctly display this content 
...
The `SYS_XMLGen` function is deprecated. It is still supported for backward compatibility. However, Oracle recommends that you use the SQL/XML generation functions instead. See [Oracle XML DB Developer's Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADXDB1620) for more information. 

Syntax

![Description of sys_xmlgen.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/sys_xmlgen.gif)[Description of the illustration sys_xmlgen.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/sys_xmlgen.html)
...
"[XML Format Model](Format-Models.html#GUID-C6EB69EF-74DB-4C10-A02E-210D31616552)" for a description of the `XMLFormat` type and how to use its attributes to format `SYS_XMLGen` results 
