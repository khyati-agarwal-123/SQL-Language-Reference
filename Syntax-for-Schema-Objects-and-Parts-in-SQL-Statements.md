##  Syntax for Schema Objects and Parts in SQL Statements {#GUID-1164C6E0-ABAB-49C2-8821-6B6C5047FEDD} 
...
![Description of database_object_or_part.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/database_object_or_part.gif)[ Description of the illustration database_object_or_part.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/database_object_or_part.md)( [ dblink::= ](Syntax-for-Schema-Objects-and-Parts-in-SQL-Statements.md#GUID-3B6E39A1-A538-4A8C-A314-932851A22777__BABGJDDB) ) 
...
###  How Oracle Database Resolves Schema Object References {#GUID-08B73ED6-2ABA-4737-B8A1-F7BD0456AEDB} 
...
[ *Oracle Database PL/SQL Language Reference*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=LNPLS017) for information about how PL/SQL resolves identifier names 

###  References to Objects in Other Schemas {#GUID-1822C16B-47E9-4690-862F-8E6A85F7D2EA} 
...
###  References to Objects in Remote Databases {#GUID-61D0B206-A5EA-473F-AD04-7067D6E3914C} 
...
####  Creating Database Links {#GUID-CB1CA5F9-D8E8-4A62-B343-DAF66C9B9199} 

You create a database link with the statement [ CREATE DATABASE LINK ](CREATE-DATABASE-LINK.md#GUID-D966642A-B19E-449D-9968-1121AF06D793) . The statement lets you specify this information about the database link: 
...
#####  Database Link Names {#GUID-3B6E39A1-A538-4A8C-A314-932851A22777} 
...
![Description of dblink.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dblink.gif)[ Description of the illustration dblink.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dblink.md)
...
[ *Oracle Database Administrator’s Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN02901) for more information on connection qualifiers 
...
[ *Oracle Database Net Services Administrator's Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=NETAG002)

#####  Username and Password {#GUID-DAF7C095-2C80-4E77-A01A-C0693D1070E7} 
...
#####  Database Connect String {#GUID-400255FF-792A-42D9-8BC4-BA5B88F71338} 
...
####  References to Database Links {#GUID-537665D2-E232-4DAC-9640-B9C2A1340D91} 
...
[ *Oracle Database Administrator’s Guide*  ](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN029) for more information on remote name resolution 

###  References to Partitioned Tables and Indexes {#GUID-FED2E424-3F06-4B2B-88D2-DE043CA6E0E4} 
...
The ` CREATE ` ` TABLE ` [ INTERVAL Clause ](CREATE-TABLE.md#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABGCEFI) for more information on interval partitions 
...
###  References to Object Type Attributes and Methods {#GUID-30AFCEEA-2BC7-4C84-AC14-292BA44D3103} 
