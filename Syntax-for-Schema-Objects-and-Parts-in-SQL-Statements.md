[Previous](Database-Object-Names-and-Qualifiers.html) [Next](Pseudocolumns.html) JavaScript must be enabled to correctly display this content 
...
You create a database link with the statement [CREATE DATABASE LINK](CREATE-DATABASE-LINK.html#GUID-D966642A-B19E-449D-9968-1121AF06D793). The statement lets you specify this information about the database link: 
...
![Description of dblink.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/dblink.gif)[Descriptionof the illustration dblink.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/dblink.md)
...
[Oracle Database Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN02901)for more information on connection qualifiers 
...
[Oracle Database Administratorâs Guide](https://docs.oracle.com/pls/topic/lookup?ctx=en/database/oracle/oracle-database/23/sqlrf&id=ADMIN029) for more information on remote name resolution 
...
The `CREATE` `TABLE` [INTERVAL Clause](CREATE-TABLE.html#GUID-F9CE0CC3-13AE-4744-A43C-EAC7A71AAAB6__BABGCEFI) for more information on interval partitions 
