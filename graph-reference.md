...
![Description of graph_reference.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_reference.gif)[Description of the illustration graph_reference.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_reference.html)
...
![Description of graph_name.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img/graph_name.gif)[Description of the illustration graph_name.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/img_text/graph_name.html)
